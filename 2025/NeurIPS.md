# 3D Gaussian Splatting Papers Accepted to NeurIPS2025

#### [1] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
- **🧑‍🔬 作者**：Yumeng He, Yunbo Wang, Xiaokang Yang
- **🏫 单位**：Shanghai Jiao Tong University
- **🔗 链接**：[[中英摘要](../abs/2405.20791.md)] [[arXiv:2405.20791](https://arxiv.org/abs/2405.20791)] [[Code](https://github.com/raynehe/MetaGS)]
...
#### [3] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [4] Learning Efficient Fuse-and-Refine for Feed-Forward 3D Gaussian Splatting
...
#### [5] Segment then Splat: A Unified Approach for 3D Open-Vocabulary Segmentation based on Gaussian Splatting
...
#### [6] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [7] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [8] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [9] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [10] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [11] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [12] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [13] Metropolis-Hastings Sampling for 3D Gaussian Reconstruction
...
#### [14] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [15] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [35] TRIM: Scalable 3D Gaussian Diffusion Inference with Temporal and Spatial Trimming
...
#### [36] Novel View Synthesis from A Few Glimpses via Test-Time Natural Video Completion
