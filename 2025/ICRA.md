# 3D Gaussian Splatting Papers Accepted to ICRA2025
...
#### [6] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [7] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [8] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [9] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [10] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [12] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [13] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [14] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [15] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [16] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [17] LiDAR-enhanced 3D Gaussian Splatting Mapping
...
#### [18] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [19] Large-Scale Gaussian Splatting SLAM
...
#### [20] Gaussian-LIC2: LiDAR-Inertial-Camera Gaussian Splatting SLAM
