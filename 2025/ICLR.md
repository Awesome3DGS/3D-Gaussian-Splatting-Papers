...
#### [7] GS-CPR: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [8] OmniRe: Omni Urban Scene Reconstruction
...
#### [9] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [10] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](../abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：🏆 Accepted to ICLR 2025

#### [11] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [13] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [14] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [15] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [16] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [17] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [18] Reflective Gaussian Splatting
...
#### [19] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [21] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [22] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [23] SC-OmniGS: Self-Calibrating Omnidirectional Gaussian Splatting
...
#### [24] Flow Distillation Sampling: Regularizing 3D Gaussians with Pre-trained Matching Priors
...
#### [25] OMG: Opacity Matters in Material Modeling with Gaussian Splatting
...
#### [26] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [27] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [28] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [29] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [31] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [32] Swift4D:Adaptive divide-and-conquer Gaussian Splatting for compact and efficient reconstruction of dynamic scene
...
#### [33] 3D-Spatial MultiModal Memory
...
#### [34] Optimizing 4D Gaussians for Dynamic Scene Video from Single Landscape Images
