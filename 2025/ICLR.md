# 3D Gaussian Splatting Papers Accepted to ICLR2025

#### [1] MoDGS: Dynamic Gaussian Splatting from Casually-captured Monocular Videos with Depth Priors
...
#### [3] GS-CPR: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [5] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [6] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：🏆 Accepted to ICLR 2025

#### [7] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [8] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [9] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [10] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [15] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [16] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [17] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [18] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [19] SC-OmniGS: Self-Calibrating Omnidirectional Gaussian Splatting
...
#### [20] Flow Distillation Sampling: Regularizing 3D Gaussians with Pre-trained Matching Priors
...
#### [21] OMG: Opacity Matters in Material Modeling with Gaussian Splatting
...
#### [22] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [23] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [24] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [25] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [26] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [27] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [28] Swift4D:Adaptive divide-and-conquer Gaussian Splatting for compact and efficient reconstruction of dynamic scene
...
#### [29] 3D-Spatial MultiModal Memory
