...
#### [1] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [2] Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [3] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [5] Gaussian Eigen Models for Human Heads
...
#### [6] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [7] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [8] RNG: Relightable Neural Gaussians
...
#### [9] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [11] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [13] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [14] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [15] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [16] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [17] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [18] Geometry Field Splatting with Gaussian Surfels
...
#### [19] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [20] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [21] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [22] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [23] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [24] GuardSplat: Efficient and Robust Watermarking for 3D Gaussian Splatting
...
#### [25] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [28] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [29] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [30] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [32] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [33] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [34] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [35] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [36] GASP: Gaussian Avatars with Synthetic Priors
...
#### [37] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [38] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [39] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [40] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [41] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [42] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [43] Ref-GS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [44] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [45] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [46] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [47] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [49] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [50] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [51] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [52] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [53] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [54] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [55] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [56] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [57] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [58] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [59] NTR-Gaussian: Nighttime Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [60] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [61] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
...
#### [62] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [63] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [66] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [67] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [68] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [69] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [70] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [71] RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars
...
#### [72] Rethinking End-to-End 2D to 3D Scene Segmentation in Gaussian Splatting
...
#### [73] RoGSplat: Learning Robust Generalizable Human Gaussian Splatting from Sparse Multi-View Images
...
#### [74] BARD-GS: Blur-Aware Reconstruction of Dynamic Scenes via Gaussian Splatting
...
#### [75] RigGS: Rigging of 3D Gaussians for Modeling Articulated Objects in Videos
...
#### [76] Instant Gaussian Stream: Fast and Generalizable Streaming of Dynamic Scene Reconstruction via Gaussian Splatting
...
#### [77] TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented Reality via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jinbo Yan, Rui Peng, Zhiyan Wang, Luyang Tang, Jiayu Yang, Jie Liang, Jiahao Wu, Ronggang Wang
...
#### [78] PanoGS: Gaussian-based Panoptic Segmentation for 3D Open Vocabulary Scene Understanding
...
#### [79] DashGaussian: Optimizing 3D Gaussian Splatting in 200 Seconds
...
#### [80] 4DGC: Rate-Aware 4D Gaussian Compression for Efficient Streamable Free-Viewpoint Video
...
#### [81] Hardware-Rasterized Ray-Based Gaussian Splatting
...
#### [82] NexusGS: Sparse View Synthesis with Epipolar Depth Priors in 3D Gaussian Splatting
...
#### [83] HoGS: Unified Near and Far Object Reconstruction via Homogeneous Gaussian Splatting
...
#### [84] From Sparse to Dense: Camera Relocalization with Scene-Specific Detector from Feature Gaussian Splatting
...
#### [85] COB-GS: Clear Object Boundaries in 3DGS Segmentation Based on Boundary-Adaptive Gaussian Splitting
...
#### [86] GaussianUDF: Inferring Unsigned Distance Functions through 3D Gaussian Splatting
...
#### [87] PartRM: Modeling Part-Level Dynamics with Large Cross-State Reconstruction Model
...
#### [88] Thin-Shell-SfT: Fine-Grained Monocular Non-rigid 3D Surface Tracking with Neural Deformation Fields
...
#### [89] EVolSplat: Efficient Volume-based Gaussian Splatting for Urban View Synthesis
...
#### [90] Feature4X: Bridging Any Monocular Video to 4D Agentic AI with Versatile Gaussian Feature Fields
...
#### [91] Photorealistic Simulation-Ready Garments from a Single Pose
...
#### [92] CoMapGS: Covisibility Map-based Gaussian Splatting for Sparse Novel View Synthesis
...
#### [93] RainyGS: Efficient Rain Synthesis with Physically-Based Gaussian Splatting
...
#### [94] EVPGS: Enhanced View Prior Guidance for Splatting-based Extrapolated View Synthesis
