...
#### [1] Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [2] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [3] Gaussian Eigen Models for Human Heads
...
#### [5] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [6] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [7] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [9] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [10] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [11] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [12] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [13] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [14] GuardSplat: Efficient and Robust Watermarking for 3D Gaussian Splatting
...
#### [15] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [16] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [17] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [18] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [19] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [20] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [22] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [23] GASP: Gaussian Avatars with Synthetic Priors
...
#### [24] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [25] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [27] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [28] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [29] Ref-GS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [30] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [33] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [34] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [35] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [36] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [37] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [38] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [39] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [40] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [41] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [42] NTR-Gaussian: Nighttime Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [43] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [44] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
...
#### [45] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [46] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [47] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [48] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [49] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [50] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [51] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [52] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [53] Rethinking End-to-End 2D to 3D Scene Segmentation in Gaussian Splatting
...
#### [54] RoGSplat: Learning Robust Generalizable Human Gaussian Splatting from Sparse Multi-View Images
...
#### [55] BARD-GS: Blur-Aware Reconstruction of Dynamic Scenes via Gaussian Splatting
...
#### [56] Instant Gaussian Stream: Fast and Generalizable Streaming of Dynamic Scene Reconstruction via Gaussian Splatting
...
#### [57] TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented Reality via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jinbo Yan, Rui Peng, Zhiyan Wang, Luyang Tang, Jiayu Yang, Jie Liang, Jiahao Wu, Ronggang Wang
