# 3D Gaussian Splatting Papers Accepted to CVPR2025
...
#### [3] DOF-GS: Adjustable Depth-of-Field 3D Gaussian Splatting for Refocusing,Defocus Rendering and Blur Removal
...
#### [23] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [24] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [25] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [26] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [27] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [28] Geometry Field Splatting with Gaussian Surfels
...
#### [29] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [30] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [31] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [32] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [33] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [34] GuardSplat: Efficient and Robust Watermarking for 3D Gaussian Splatting
...
#### [36] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [37] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
...
#### [38] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [39] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [40] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [41] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [43] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [44] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [45] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [46] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [47] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [48] GASP: Gaussian Avatars with Synthetic Priors
...
#### [49] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [50] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [51] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [52] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [53] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [54] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [55] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [56] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [57] Gaussian Splatting for Efficient Satellite Image Photogrammetry
...
#### [58] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [59] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [60] Ref-GS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [61] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [62] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [64] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [66] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [67] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [68] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [69] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：🏆 Accepted to CVPR 2025

#### [70] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [71] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [72] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [73] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [74] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [75] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [76] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [77] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [78] NTR-Gaussian: Nighttime Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [79] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [80] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
...
#### [81] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [82] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [83] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [84] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [85] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [86] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [87] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [88] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [89] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [90] RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars
...
#### [91] Rethinking End-to-End 2D to 3D Scene Segmentation in Gaussian Splatting
...
#### [92] RoGSplat: Learning Robust Generalizable Human Gaussian Splatting from Sparse Multi-View Images
...
#### [93] BARD-GS: Blur-Aware Reconstruction of Dynamic Scenes via Gaussian Splatting
...
#### [94] RigGS: Rigging of 3D Gaussians for Modeling Articulated Objects in Videos
...
#### [95] Instant Gaussian Stream: Fast and Generalizable Streaming of Dynamic Scene Reconstruction via Gaussian Splatting
...
#### [96] TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented Reality via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jinbo Yan, Rui Peng, Zhiyan Wang, Luyang Tang, Jiayu Yang, Jie Liang, Jiahao Wu, Ronggang Wang
...
#### [97] PanoGS: Gaussian-based Panoptic Segmentation for 3D Open Vocabulary Scene Understanding
...
#### [98] DashGaussian: Optimizing 3D Gaussian Splatting in 200 Seconds
...
#### [99] 4DGC: Rate-Aware 4D Gaussian Compression for Efficient Streamable Free-Viewpoint Video
...
#### [100] Hardware-Rasterized Ray-Based Gaussian Splatting
...
#### [101] NexusGS: Sparse View Synthesis with Epipolar Depth Priors in 3D Gaussian Splatting
...
#### [102] HoGS: Unified Near and Far Object Reconstruction via Homogeneous Gaussian Splatting
...
#### [103] From Sparse to Dense: Camera Relocalization with Scene-Specific Detector from Feature Gaussian Splatting
...
#### [104] COB-GS: Clear Object Boundaries in 3DGS Segmentation Based on Boundary-Adaptive Gaussian Splitting
...
#### [105] GaussianUDF: Inferring Unsigned Distance Functions through 3D Gaussian Splatting
...
#### [106] PartRM: Modeling Part-Level Dynamics with Large Cross-State Reconstruction Model
...
#### [107] Thin-Shell-SfT: Fine-Grained Monocular Non-rigid 3D Surface Tracking with Neural Deformation Fields
...
#### [108] EVolSplat: Efficient Volume-based Gaussian Splatting for Urban View Synthesis
...
#### [109] Feature4X: Bridging Any Monocular Video to 4D Agentic AI with Versatile Gaussian Feature Fields
...
#### [110] Photorealistic Simulation-Ready Garments from a Single Pose
...
#### [111] CoMapGS: Covisibility Map-based Gaussian Splatting for Sparse Novel View Synthesis
...
#### [112] RainyGS: Efficient Rain Synthesis with Physically-Based Gaussian Splatting
...
#### [113] EVPGS: Enhanced View Prior Guidance for Splatting-based Extrapolated View Synthesis
...
#### [115] DiET-GS: Diffusion Prior and Event Stream-Assisted Motion Deblurring 3D Gaussian Splatting
...
#### [116] Free360: Layered Gaussian Splatting for Unbounded 360-Degree View Synthesis from Extremely Sparse and Unposed Views
...
#### [117] LITA-GS: Illumination-Agnostic Novel View Synthesis via Reference-Free 3D Gaussian Splatting and Physical Priors
...
#### [118] Scene4U: Hierarchical Layered 3D Scene Reconstruction from Single Panoramic Image for Your Immerse Exploration
...
#### [119] Monocular and Generalizable Gaussian Talking Head Animation
...
#### [120] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
...
#### [121] DropGaussian: Structural Regularization for Sparse-view Gaussian Splatting
...
#### [122] Luminance-GS: Adapting 3D Gaussian Splatting to Challenging Lighting Conditions with View-Adaptive Curve Adjustment
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [123] Toward Real-world BEV Perception: Depth Uncertainty Estimation via Gaussian Splatting
...
#### [124] Scene Splatter: Momentum 3D Scene Generation from Single Image with Video Diffusion Model
...
#### [125] WildGS-SLAM: Monocular Gaussian Splatting SLAM in Dynamic Environments
...
#### [126] PanoDreamer: Consistent Text to 360-Degree Scene Generation
...
#### [127] HiMoR: Monocular Deformable Gaussian Reconstruction with Hierarchical Motion Representation
...
#### [128] BIGS: Bimanual Category-agnostic Interaction Reconstruction from Monocular Videos via 3D Gaussian Splatting
...
#### [129] DropoutGS: Dropping Out Gaussians for Better Sparse-view Rendering
...
#### [130] ODHSR: Online Dense 3D Reconstruction of Humans and Scenes from Monocular Videos
...
#### [131] SmallGS: Gaussian Splatting-based Camera Pose Estimation for Small-Baseline Videos
...
#### [132] Sparse2DGS: Geometry-Prioritized Gaussian Splatting for Surface Reconstruction from Sparse Views
...
#### [133] SparSplat: Fast Multi-View Reconstruction with Generalizable 2D Gaussian Splatting
...
#### [134] SGCR: Spherical Gaussians for Efficient 3D Curve Reconstruction
...
#### [135] Time of the Flight of the Gaussians: Optimizing Depth Indirectly in Dynamic Radiance Fields
- **🧑‍🔬 作者**：Xinran Yang, Donghao Ji, Yuanqi Li, Jie Guo, Yanwen Guo, Junyuan Xie
...
#### [136] SVAD: From Single Image to 3D Avatar via Synthetic Data Generation with Video Diffusion and Data Augmentation
- **🧑‍🔬 作者**：Yonwoo Choi
- **🏫 单位**：SECERNAI
...
#### [137] Steepest Descent Density Control for Compact 3D Gaussian Splatting
