...
#### [6] Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [7] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [9] Gaussian Eigen Models for Human Heads
...
#### [10] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [11] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [12] RNG: Relightable Neural Gaussians
...
#### [13] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [17] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [18] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [19] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [20] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [21] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [22] Geometry Field Splatting with Gaussian Surfels
...
#### [23] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [24] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [25] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [26] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [27] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [28] GuardSplat: Efficient and Robust Watermarking for 3D Gaussian Splatting
...
#### [29] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [30] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
...
#### [31] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [32] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [33] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [34] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [35] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [36] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [37] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [38] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [39] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [40] GASP: Gaussian Avatars with Synthetic Priors
...
#### [41] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [42] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [43] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [44] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [45] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [46] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [47] Ref-GS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [48] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [49] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [51] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [53] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [54] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [55] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [56] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [57] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [58] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [59] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [60] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [62] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [63] NTR-Gaussian: Nighttime Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [64] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [65] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
...
#### [66] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [67] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [68] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [69] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [70] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [71] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [72] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [73] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [74] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [75] RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars
...
#### [76] Rethinking End-to-End 2D to 3D Scene Segmentation in Gaussian Splatting
...
#### [77] RoGSplat: Learning Robust Generalizable Human Gaussian Splatting from Sparse Multi-View Images
...
#### [78] BARD-GS: Blur-Aware Reconstruction of Dynamic Scenes via Gaussian Splatting
...
#### [79] RigGS: Rigging of 3D Gaussians for Modeling Articulated Objects in Videos
...
#### [80] Instant Gaussian Stream: Fast and Generalizable Streaming of Dynamic Scene Reconstruction via Gaussian Splatting
...
#### [81] TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented Reality via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jinbo Yan, Rui Peng, Zhiyan Wang, Luyang Tang, Jiayu Yang, Jie Liang, Jiahao Wu, Ronggang Wang
...
#### [82] PanoGS: Gaussian-based Panoptic Segmentation for 3D Open Vocabulary Scene Understanding
...
#### [83] DashGaussian: Optimizing 3D Gaussian Splatting in 200 Seconds
...
#### [84] 4DGC: Rate-Aware 4D Gaussian Compression for Efficient Streamable Free-Viewpoint Video
...
#### [85] Hardware-Rasterized Ray-Based Gaussian Splatting
...
#### [86] NexusGS: Sparse View Synthesis with Epipolar Depth Priors in 3D Gaussian Splatting
...
#### [87] HoGS: Unified Near and Far Object Reconstruction via Homogeneous Gaussian Splatting
...
#### [88] From Sparse to Dense: Camera Relocalization with Scene-Specific Detector from Feature Gaussian Splatting
...
#### [89] COB-GS: Clear Object Boundaries in 3DGS Segmentation Based on Boundary-Adaptive Gaussian Splitting
...
#### [90] GaussianUDF: Inferring Unsigned Distance Functions through 3D Gaussian Splatting
...
#### [91] PartRM: Modeling Part-Level Dynamics with Large Cross-State Reconstruction Model
...
#### [92] Thin-Shell-SfT: Fine-Grained Monocular Non-rigid 3D Surface Tracking with Neural Deformation Fields
...
#### [93] EVolSplat: Efficient Volume-based Gaussian Splatting for Urban View Synthesis
...
#### [94] Feature4X: Bridging Any Monocular Video to 4D Agentic AI with Versatile Gaussian Feature Fields
...
#### [95] Photorealistic Simulation-Ready Garments from a Single Pose
...
#### [96] CoMapGS: Covisibility Map-based Gaussian Splatting for Sparse Novel View Synthesis
...
#### [97] RainyGS: Efficient Rain Synthesis with Physically-Based Gaussian Splatting
...
#### [98] EVPGS: Enhanced View Prior Guidance for Splatting-based Extrapolated View Synthesis
...
#### [99] ReasonGrounder: LVLM-Guided Hierarchical Feature Splatting for Open-Vocabulary 3D Visual Grounding and Reasoning
...
#### [100] DiET-GS: Diffusion Prior and Event Stream-Assisted Motion Deblurring 3D Gaussian Splatting
...
#### [101] Free360: Layered Gaussian Splatting for Unbounded 360-Degree View Synthesis from Extremely Sparse and Unposed Views
...
#### [102] LITA-GS: Illumination-Agnostic Novel View Synthesis via Reference-Free 3D Gaussian Splatting and Physical Priors
...
#### [104] Monocular and Generalizable Gaussian Talking Head Animation
...
#### [105] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
...
#### [106] DropGaussian: Structural Regularization for Sparse-view Gaussian Splatting
...
#### [107] Luminance-GS: Adapting 3D Gaussian Splatting to Challenging Lighting Conditions with View-Adaptive Curve Adjustment
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [108] Toward Real-world BEV Perception: Depth Uncertainty Estimation via Gaussian Splatting
...
#### [109] Scene Splatter: Momentum 3D Scene Generation from Single Image with Video Diffusion Model
...
#### [110] WildGS-SLAM: Monocular Gaussian Splatting SLAM in Dynamic Environments
...
#### [112] HiMoR: Monocular Deformable Gaussian Reconstruction with Hierarchical Motion Representation
...
#### [113] BIGS: Bimanual Category-agnostic Interaction Reconstruction from Monocular Videos via 3D Gaussian Splatting
...
#### [114] DropoutGS: Dropping Out Gaussians for Better Sparse-view Rendering
...
#### [115] ODHSR: Online Dense 3D Reconstruction of Humans and Scenes from Monocular Videos
...
#### [116] SmallGS: Gaussian Splatting-based Camera Pose Estimation for Small-Baseline Videos
...
#### [117] Sparse2DGS: Geometry-Prioritized Gaussian Splatting for Surface Reconstruction from Sparse Views
...
#### [118] SparSplat: Fast Multi-View Reconstruction with Generalizable 2D Gaussian Splatting
...
#### [119] SGCR: Spherical Gaussians for Efficient 3D Curve Reconstruction
...
#### [120] Time of the Flight of the Gaussians: Optimizing Depth Indirectly in Dynamic Radiance Fields
- **🧑‍🔬 作者**：Xinran Yang, Donghao Ji, Yuanqi Li, Jie Guo, Yanwen Guo, Junyuan Xie
...
#### [121] SVAD: From Single Image to 3D Avatar via Synthetic Data Generation with Video Diffusion and Data Augmentation
- **🧑‍🔬 作者**：Yonwoo Choi
- **🏫 单位**：SECERNAI
...
#### [122] Steepest Descent Density Control for Compact 3D Gaussian Splatting
