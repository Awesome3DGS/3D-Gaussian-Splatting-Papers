# 3D Gaussian Splatting Papers Accepted to RAL 2025

#### [1] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [2] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [3] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [4] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [5] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [6] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [7] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [8] Robust LiDAR-Camera Calibration with 2D Gaussian Splatting
...
#### [9] EGS-SLAM: RGB-D Gaussian Splatting SLAM with Events
