# 3D Gaussian Splatting Papers Accepted to IROS2025
...
#### [2] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [3] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [4] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [5] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [6] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [7] 3D Gaussian Splatting for Fine-Detailed Surface Reconstruction in Large-Scale Scene
...
#### [8] ArtGS:3D Gaussian Splatting for Interactive Visual-Physical Modeling and Manipulation of Articulated Objects
...
#### [9] SGLoc: Semantic Localization System for Camera Pose Estimation from 3D Gaussian Splatting Representation
