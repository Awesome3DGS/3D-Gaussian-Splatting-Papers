# 3D Gaussian Splatting Papers Accepted to ICIP2025

#### [1] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [2] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [3] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [4] Pose-free 3D Gaussian splatting via shape-ray estimation
...
#### [5] ICP-3DGS: SfM-free 3D Gaussian Splatting for Large-scale Unbounded Scenes
