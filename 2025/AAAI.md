...
#### [3] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [4] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [5] PointTalk: Audio-Driven Dynamic Lip Point Cloud for 3D Gaussian-based Talking Head Synthesis
...
#### [6] 3D2-Actor: Learning Pose-Conditioned 3D-Aware Denoiser for Realistic Gaussian Avatar Modeling
...
#### [10] KeyGS: A Keyframe-Centric Gaussian Splatting Method for Monocular Image Sequences
...
#### [11] HOGSA: Bimanual Hand-Object Interaction Understanding with 3D Gaussian Splatting Based Data Augmentation
...
#### [12] FatesGS: Fast and Accurate Sparse-View Surface Reconstruction using Gaussian Splatting with Depth-Feature Consistency
...
#### [13] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [14] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [15] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [16] Large Images are Gaussians: High-Quality Large Image Representation with Levels of 2D Gaussian Splatting
...
#### [17] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [18] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [19] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
#### [20] Enhancing Close-up Novel View Synthesis via Pseudo-labeling
