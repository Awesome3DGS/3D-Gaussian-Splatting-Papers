# 3D Gaussian Splatting Papers Accepted to AAAI2025
...
#### [8] 3D2-Actor: Learning Pose-Conditioned 3D-Aware Denoiser for Realistic Gaussian Avatar Modeling
...
#### [9] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [10] EGSRAL: An Enhanced 3D Gaussian Splatting based Renderer with Automated Labeling for Large-Scale Driving Scene
...
#### [11] GaussianPainter: Painting Point Cloud into 3D Gaussians with Normal Guidance
...
#### [12] KeyGS: A Keyframe-Centric Gaussian Splatting Method for Monocular Image Sequences
...
#### [13] HOGSA: Bimanual Hand-Object Interaction Understanding with 3D Gaussian Splatting Based Data Augmentation
...
#### [14] FatesGS: Fast and Accurate Sparse-View Surface Reconstruction using Gaussian Splatting with Depth-Feature Consistency
...
#### [15] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [16] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [17] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [18] Large Images are Gaussians: High-Quality Large Image Representation with Levels of 2D Gaussian Splatting
...
#### [19] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
- **🧑‍🔬 作者**：Hanyang Kong, Xingyi Yang, Xinchao Wang
- **🏫 单位**: National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2502.20378.md)] [[arXiv:2502.20378](https://arxiv.org/abs/2502.20378)] [Code]
- **📝 说明**：🏆 Accepted to AAAI 2025

#### [20] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [21] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
#### [22] Enhancing Close-up Novel View Synthesis via Pseudo-labeling
