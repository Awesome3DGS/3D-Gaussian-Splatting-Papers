...
#### [39] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [40] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [41] GauRast: Enhancing GPU Triangle Rasterizers to Accelerate 3D Gaussian Splatting
...
#### [42] VizFlyt: Perception-centric Pedagogical Framework For Autonomous Aerial Robots
...
#### [44] Robust LiDAR-Camera Calibration with 2D Gaussian Splatting
...
#### [45] FIORD: A Fisheye Indoor-Outdoor Dataset with LIDAR Ground Truth for 3D Scene Reconstruction and Benchmarking
...
#### [46] Compressing 3D Gaussian Splatting by Noise-Substituted Vector Quantization
...
#### [47] Video4DGen: Enhancing Video and 4D Generation through Mutual Optimization
...
#### [48] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [49] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [50] Novel Demonstration Generation with Gaussian Splatting Enables Robust One-Shot Manipulation
...
#### [51] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [53] Immersive Teleoperation Framework for Locomanipulation Tasks
...
#### [54] PIN-WM: Learning Physics-INformed World Models for Non-Prehensile Manipulation
...
#### [55] iVR-GS: Inverse Volume Rendering for Explorable Visualization via Editable 3D Gaussian Splatting
...
#### [56] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [57] GarmentGS: Point-Cloud Guided Gaussian Splatting for High-Fidelity Non-Watertight 3D Garment Reconstruction
...
#### [58] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [59] Multiview Geometric Regularization of Gaussian Splatting for Accurate Radiance Fields
...
#### [60] A3FR: Agile 3D Gaussian Splatting with Incremental Gaze Tracked Foveated Rendering in Virtual Reality
...
#### [61] NLI4VolVis: Natural Language Interaction for Volume Visualization via LLM Multi-Agents and Editable 3D Gaussian Splatting
...
#### [62] TexGS-VolVis: Expressive Scene Editing for Volume Visualization via Textured Gaussian Splatting
...
#### [63] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
...
#### [64] LT-Gaussian: Long-Term Map Update Using 3D Gaussian Splatting for Autonomous Driving
...
#### [65] EGS-SLAM: RGB-D Gaussian Splatting SLAM with Events
...
#### [66] GS4Buildings: Prior-Guided Gaussian Splatting for 3D Building Reconstruction
...
#### [67] IntelliCap: Intelligent Guidance for Consistent View Sampling
...
#### [68] UnPose: Uncertainty-Guided Diffusion Priors for Zero-Shot Pose Estimation
...
#### [69] LabelGS: Label-Aware 3D Gaussian Splatting for 3D Scene Segmentation
...
#### [70] RadGS-Reg: Registering Spine CT with Biplanar X-rays via Joint 3D Radiative Gaussians Reconstruction and 3D/3D Registration
...
#### [71] GS-TG: 3D Gaussian Splatting Accelerator with Tile Grouping for Reducing Redundant Sorting while Preserving Rasterization Efficiency
- **🧑‍🔬 作者**：Joongho Jo, Jongsun Park
- **🏫 单位**：Korea University
- **🔗 链接**：[[中英摘要](./abs/2509.00911.md)] [[arXiv:2509.00911](https://arxiv.org/abs/2509.00911)] [Code]
- **📝 说明**: 🏆 Accepted to DAC 2025

#### [72] Towards Integrating Multi-Spectral Imaging with Gaussian Splatting
...
#### [73] Efficient Geometry Compression and Communication for 3D Gaussian Splatting Point Clouds
...
#### [74] On the Geometric Accuracy of Implicit and Primitive-based Representations Derived from View Rendering Constraints
