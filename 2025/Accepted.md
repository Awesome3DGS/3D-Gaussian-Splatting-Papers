...
#### [1] EndoGaussian: Gaussian Splatting for Deformable Surgical Scene Reconstruction
...
#### [2] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [3] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [4] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [5] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [7] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [8] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [9] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [10] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [13] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
- **🧑‍🔬 作者**：Soumava Paul, Prakhar Kaushik, Alan Yuille
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2411.15966.md)] [[arXiv:2411.15966](https://arxiv.org/abs/2411.15966)] [[Code](https://github.com/mvp18/gaussian-scenes)]
- **📝 说明**： 🏆 Accepted to TMLR 2025

#### [14] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [15] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [16] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [17] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [18] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
...
#### [19] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [20] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [21] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [22] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [23] Learning High-Fidelity Robot Self-Model with Articulated 3D Gaussian Splatting
...
#### [24] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
- **📝 说明**： 🏆 Accepted to ML4H 2025

#### [25] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [26] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [27] GauRast: Enhancing GPU Triangle Rasterizers to Accelerate 3D Gaussian Splatting
...
#### [28] Gaussian Blending Unit: An Edge GPU Plug-in for Real-Time Gaussian-Based Rendering in AR/VR
...
#### [29] FIORD: A Fisheye Indoor-Outdoor Dataset with LIDAR Ground Truth for 3D Scene Reconstruction and Benchmarking
...
#### [30] Compressing 3D Gaussian Splatting by Noise-Substituted Vector Quantization
...
#### [31] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [32] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [34] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [35] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [36] Immersive Teleoperation Framework for Locomanipulation Tasks
...
#### [37] PIN-WM: Learning Physics-INformed World Models for Non-Prehensile Manipulation
...
#### [39] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [40] GarmentGS: Point-Cloud Guided Gaussian Splatting for High-Fidelity Non-Watertight 3D Garment Reconstruction
...
#### [41] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [42] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [43] Multiview Geometric Regularization of Gaussian Splatting for Accurate Radiance Fields
...
#### [44] A3FR: Agile 3D Gaussian Splatting with Incremental Gaze Tracked Foveated Rendering in Virtual Reality
...
#### [45] NLI4VolVis: Natural Language Interaction for Volume Visualization via LLM Multi-Agents and Editable 3D Gaussian Splatting
...
#### [46] TexGS-VolVis: Expressive Scene Editing for Volume Visualization via Textured Gaussian Splatting
...
#### [47] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
...
#### [48] LT-Gaussian: Long-Term Map Update Using 3D Gaussian Splatting for Autonomous Driving
...
#### [49] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [50] GS4Buildings: Prior-Guided Gaussian Splatting for 3D Building Reconstruction
...
#### [51] IntelliCap: Intelligent Guidance for Consistent View Sampling
...
#### [52] UnPose: Uncertainty-Guided Diffusion Priors for Zero-Shot Pose Estimation
...
#### [53] LabelGS: Label-Aware 3D Gaussian Splatting for 3D Scene Segmentation
...
#### [54] GS-TG: 3D Gaussian Splatting Accelerator with Tile Grouping for Reducing Redundant Sorting while Preserving Rasterization Efficiency
- **🧑‍🔬 作者**：Joongho Jo, Jongsun Park
- **🏫 单位**：Korea University
- **🔗 链接**：[[中英摘要](./abs/2509.00911.md)] [[arXiv:2509.00911](https://arxiv.org/abs/2509.00911)] [Code]
- **📝 说明**： 🏆 Accepted to DAC 2025

#### [55] Towards Integrating Multi-Spectral Imaging with Gaussian Splatting
...
#### [56] Efficient Geometry Compression and Communication for 3D Gaussian Splatting Point Clouds
...
#### [57] On the Geometric Accuracy of Implicit and Primitive-based Representations Derived from View Rendering Constraints
...
#### [58] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [59] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [60] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [61] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [62] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
...
#### [63] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [64] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [65] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [66] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
...
#### [67] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [69] From Volume Rendering to 3D Gaussian Splatting: Theory and Applications
...
#### [70] Learning Disentangled Speech- and Expression-Driven Blendshapes for 3D Talking Face Animation
...
#### [71] CLM: Removing the GPU Memory Barrier for 3D Gaussian Splatting
...
#### [72] EOGS++: Earth Observation Gaussian Splatting with Internal Camera Refinement and Direct Panchromatic Rendering
...
#### [73] FisheyeGaussianLift: BEV Feature Lifting for Surround-View Fisheye Camera Perception
...
#### [74] ReCoGS: Real-time ReColoring for Gaussian Splatting scenes
...
#### [75] Dreamcrafter: Immersive Editing of 3D Radiance Fields Through Flexible, Generative Inputs and Outputs
