...
#### [7] LGM: Large Multi-View Gaussian Model for High-Resolution 3D Content Creation
...
#### [8] Radiative Gaussian Splatting for Efficient X-ray Novel View Synthesis
...
#### [9] BAGS: Blur Agnostic Gaussian Splatting through Multi-Scale Kernel Modeling
...
#### [10] Reconstruction and Simulation of Elastic Objects with Spring-Mass 3D Gaussians
...
#### [12] BAD-Gaussians: Bundle Adjusted Deblur Gaussian Splatting
...
#### [13] View-Consistent 3D Editing with Gaussian Splatting
...
#### [14] Mini-Splatting: Representing Scenes with a Constrained Number of Gaussians
...
#### [15] HAC: Hash-grid Assisted Context for 3D Gaussian Splatting Compression
...
#### [17] MVSplat: Efficient 3D Gaussian Splatting from Sparse Multi-View Images
...
#### [19] CG-SLAM: Efficient Dense RGB-D SLAM in a Consistent Uncertainty-aware 3D Gaussian Field
...
#### [20] CoherentGS: Sparse Novel View Synthesis with Coherent 3D Gaussians
...
#### [22] Surface Reconstruction from Gaussian Splatting via Novel Stereo Views
...
#### [24] PhysAvatar: Learning the Physics of Dressed 3D Avatars from Visual Observations
...
#### [25] DreamScene360: Unconstrained Text-to-3D Scene Generation with Panoramic Gaussian Splatting
...
#### [26] GScream: Learning 3D Geometry and Feature Consistent Gaussian Splatting for Object Removal
...
#### [27] TalkingGaussian: Structure-Persistent 3D Talking Head Synthesis via Gaussian Splatting
...
#### [28] MirrorGaussian: Reflecting 3D Gaussians for Reconstructing Mirror Reflections
...
#### [29] CoR-GS: Sparse-View 3D Gaussian Splatting via Co-Regularization
...
#### [30] Fast Generalizable Gaussian Splatting Reconstruction from Multi-View Stereo
...
#### [31] GaussianFormer: Scene as Gaussians for Vision-Based 3D Semantic Occupancy Prediction
...
#### [33] SuperGaussian: Repurposing Video Models for 3D Super Resolution
...
#### [34] VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors
...
#### [35] GSD: View-Guided Gaussian Splatting Diffusion for 3D Reconstruction
...
#### [36] LaRa: Efficient Large-Baseline Radiance Fields
...
#### [37] GaussReg: Fast 3D Registration with Gaussian Splatting
...
#### [38] MIGS: Multi-Identity Gaussian Splatting via Tensor Decomposition
...
#### [41] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [42] Generalizable Human Gaussians for Sparse View Synthesis
...
#### [44] 3D Gaussian Parametric Head Model
...
#### [45] 6DGS: 6D Pose Estimation from a Single Image and a 3D Gaussian Splatting Model
...
#### [46] Expressive Whole-Body 3D Gaussian Avatar
...
#### [47] EmoTalk3D: High-Fidelity Free-View Synthesis of Emotional 3D Talking Head
...
#### [48] 3iGS: Factorised Tensorial Illumination for 3D Gaussian Splatting
