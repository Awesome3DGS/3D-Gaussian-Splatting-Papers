...
#### [48] VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors
...
#### [49] GSD: View-Guided Gaussian Splatting Diffusion for 3D Reconstruction
...
#### [50] LaRa: Efficient Large-Baseline Radiance Fields
...
#### [51] GaussReg: Fast 3D Registration with Gaussian Splatting
...
#### [52] MIGS: Multi-Identity Gaussian Splatting via Tensor Decomposition
...
#### [54] iHuman: Instant Animatable Digital Humans From Monocular Videos
...
#### [55] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [56] Generalizable Human Gaussians for Sparse View Synthesis
...
#### [57] Connecting Consistency Distillation to Score Distillation for Text-to-3D Generation
...
#### [58] 3D Gaussian Parametric Head Model
...
#### [59] 6DGS: 6D Pose Estimation from a Single Image and a 3D Gaussian Splatting Model
...
#### [60] Expressive Whole-Body 3D Gaussian Avatar
...
#### [61] EmoTalk3D: High-Fidelity Free-View Synthesis of Emotional 3D Talking Head
...
#### [62] 3iGS: Factorised Tensorial Illumination for 3D Gaussian Splatting
...
#### [63] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [64] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [65] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [66] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [67] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [68] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [69] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [70] Gaussian Heritage: 3D Digitization of Cultural Heritage with Integrated Object Segmentation
...
#### [71] Flash-Splat: 3D Reflection Removal with Flash Cues and Gaussian Splats
...
#### [72] Few-shot Novel View Synthesis using Depth Aware 3D Gaussian Splatting
...
#### [73] Scalable Indoor Novel-View Synthesis using Drone-Captured 360 Imagery with 3D Gaussian Splatting
