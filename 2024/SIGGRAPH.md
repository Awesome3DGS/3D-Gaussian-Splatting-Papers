# 3D Gaussian Splatting Papers Accepted to SIGGRAPH2024
...
#### [4] GaussianObject: Just Taking Four Images to Get A High-Quality 3D Object with Gaussian Splatting
...
#### [5] StyleGaussian: Instant 3D Style Transfer with Gaussian Splatting
...
#### [6] LetsGo: Large-Scale Garage Modeling and Rendering via LiDAR-Assisted Gaussian Primitives
...
#### [7] Gaussian Opacity Fields: Efficient and Compact Surface Reconstruction in Unbounded Scenes
...
#### [9] RTG-SLAM: Real-time 3D Reconstruction at Scale using Gaussian Splatting
...
#### [10] A Construct-Optimize Approach to Sparse View Synthesis without Camera Pose
...
#### [11] LayGA: Layered Gaussian Avatars for Animatable Clothing Transfer
...
#### [12] GaussianPrediction: Dynamic 3D Gaussian Prediction for Motion Extrapolation and Free View Synthesis
