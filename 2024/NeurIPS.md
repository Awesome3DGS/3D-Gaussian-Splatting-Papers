...
#### [24] From Chaos to Clarity: 3DGS in the Dark
...
#### [25] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [27] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [28] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [29] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [30] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [31] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [32] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [33] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [34] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [35] DreamMesh4D: Video-to-4D Generation with Sparse-Controlled Gaussian-Mesh Hybrid Representation
...
#### [36] MotionGS: Exploring Explicit Motion Guidance for Deformable 3D Gaussian Splatting
...
#### [37] Generalizable and Animatable Gaussian Head Avatar
...
#### [38] Neural Material Adaptor for Visual Grounding of Intrinsic Dynamics
...
#### [39] Learning Interaction-aware 3D Gaussian Splatting for One-shot Hand Avatars
...
#### [40] DN-4DGS: Denoised Deformable Network with Temporal-Spatial Aggregation for Dynamic Scene Rendering
...
#### [41] Neural Signed Distance Function Inference through Splatting 3D Gaussians Pulled on Zero-Level Set
...
#### [42] Fully Explicit Dynamic Gaussian Splatting
...
#### [43] 3DGS-Enhancer: Enhancing Unbounded 3D Gaussian Splatting with View-consistent 2D Diffusion Priors
...
#### [44] Binocular-Guided 3D Gaussian Splatting with View Consistency for Sparse View Synthesis
...
#### [45] DiffGS: Functional Gaussian Splatting Diffusion
...
#### [46] SCube: Instant Large-Scale Scene Reconstruction using VoxSplats
...
#### [47] Normal-GS: 3D Gaussian Splatting with Normal-Involved Rendering
...
#### [49] Grid4D: 4D Decomposed Hash Encoding for High-fidelity Dynamic Gaussian Splatting
...
#### [50] MVSDet: Multi-View Indoor 3D Object Detection via Efficient Plane Sweeps
...
#### [51] Geometry Cloak: Preventing TGS-based 3D Reconstruction from Copyrighted Images
...
#### [52] Epipolar-Free 3D Gaussian Splatting for Generalizable Novel View Synthesis
...
#### [53] GS-Blur: A 3D Scene-Based Dataset for Realistic Image Deblurring
...
#### [54] GaussianMarker: Uncertainty-Aware Copyright Protection of 3D Gaussian Splatting
...
#### [55] GVKF: Gaussian Voxel Kernel Functions for Highly Efficient Surface Reconstruction in Open Scenes
...
#### [56] FewViewGS: Gaussian Splatting with Few View Matching and Multi-stage Training
...
#### [57] Structure Consistent Gaussian Splatting with Matching Prior for Few-shot Novel View Synthesis
...
#### [58] MVSplat360: Feed-Forward 360 Scene Synthesis from Sparse Views
...
#### [59] ProEdit: Simple Progression is All You Need for High-Quality 3D Scene Editing
...
#### [60] HiCoM: Hierarchical Coherent Motion for Streamable Dynamic Scene with 3D Gaussian Splatting
...
#### [61] GaussianCut: Interactive segmentation via graph cut for 3D Gaussian Splatting
...
#### [62] DG-SLAM: Robust Dynamic Gaussian Splatting SLAM with Hybrid Pose Optimization
...
#### [63] 4D Gaussian Splatting in the Wild with Uncertainty-Aware Regularization
...
#### [64] Gaussian Splatting Under Attack: Investigating Adversarial Noise in 3D Objects
...
#### [65] QUEEN: QUantized Efficient ENcoding of Dynamic Gaussians for Streaming Free-viewpoint Videos
