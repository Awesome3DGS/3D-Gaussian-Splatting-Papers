...
#### [20] GaussCtrl: Multi-View Consistent Text-Driven 3D Gaussian Splatting Editing
...
#### [26] GeoGaussian: Geometry-aware Gaussian Splatting for Scene Rendering
...
#### [32] MVSplat: Efficient 3D Gaussian Splatting from Sparse Multi-View Images
...
#### [35] CG-SLAM: Efficient Dense RGB-D SLAM in a Consistent Uncertainty-aware 3D Gaussian Field
...
#### [36] latentSplat: Autoencoding Variational Gaussians for Fast Generalizable 3D Reconstruction
...
#### [37] CoherentGS: Sparse Novel View Synthesis with Coherent 3D Gaussians
...
#### [38] CityGaussian: Real-time High-quality Large-Scale Scene Rendering with Gaussians
...
#### [39] Feature Splatting: Language-Driven Physics-Based Scene Synthesis and Editing
...
#### [40] Surface Reconstruction from Gaussian Splatting via Novel Stereo Views
...
#### [41] Per-Gaussian Embedding-Based Deformation for Deformable 3D Gaussian Splatting
...
#### [42] PhysAvatar: Learning the Physics of Dressed 3D Avatars from Visual Observations
...
#### [43] Dual-Camera Smooth Zoom on Mobile Phones
...
#### [44] DreamScene360: Unconstrained Text-to-3D Scene Generation with Panoramic Gaussian Splatting
...
#### [45] GScream: Learning 3D Geometry and Feature Consistent Gaussian Splatting for Object Removal
...
#### [46] TalkingGaussian: Structure-Persistent 3D Talking Head Synthesis via Gaussian Splatting
...
#### [47] DGE: Direct Gaussian 3D Editing by Consistent Multi-view Editing
...
#### [48] SAGS: Structure-Aware 3D Gaussian Splatting
...
#### [50] CoR-GS: Sparse-View 3D Gaussian Splatting via Co-Regularization
...
#### [51] Fast Generalizable Gaussian Splatting Reconstruction from Multi-View Stereo
...
#### [52] GaussianFormer: Scene as Gaussians for Vision-Based 3D Semantic Occupancy Prediction
...
#### [53] DGD: Dynamic 3D Gaussians Distillation
...
#### [54] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [56] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [57] VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors
...
#### [58] GSD: View-Guided Gaussian Splatting Diffusion for 3D Reconstruction
...
#### [59] LaRa: Efficient Large-Baseline Radiance Fields
...
#### [60] GaussReg: Fast 3D Registration with Gaussian Splatting
...
#### [61] MIGS: Multi-Identity Gaussian Splatting via Tensor Decomposition
...
#### [63] iHuman: Instant Animatable Digital Humans From Monocular Videos
...
#### [64] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [65] Generalizable Human Gaussians for Sparse View Synthesis
...
#### [66] Connecting Consistency Distillation to Score Distillation for Text-to-3D Generation
...
#### [67] 3D Gaussian Parametric Head Model
...
#### [68] 6DGS: 6D Pose Estimation from a Single Image and a 3D Gaussian Splatting Model
...
#### [69] Expressive Whole-Body 3D Gaussian Avatar
...
#### [70] EmoTalk3D: High-Fidelity Free-View Synthesis of Emotional 3D Talking Head
...
#### [71] 3iGS: Factorised Tensorial Illumination for 3D Gaussian Splatting
...
#### [72] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [73] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [74] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [76] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [77] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [78] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [79] Gaussian Heritage: 3D Digitization of Cultural Heritage with Integrated Object Segmentation
...
#### [80] Flash-Splat: 3D Reflection Removal with Flash Cues and Gaussian Splats
...
#### [81] Few-shot Novel View Synthesis using Depth Aware 3D Gaussian Splatting
...
#### [82] Scalable Indoor Novel-View Synthesis using Drone-Captured 360 Imagery with 3D Gaussian Splatting
...
#### [83] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
