...
#### [8] GaussianGrasper: 3D Language Gaussian Splatting for Open-vocabulary Robotic Grasping
...
#### [9] NEDS-SLAM: A Novel Neural Explicit Dense Semantic SLAM Framework using 3D Gaussian Splatting
...
#### [10] Mirror-3DGS: Incorporating Mirror Reflections into 3D Gaussian Splatting
...
#### [11] HoloGS: Instant Depth-based 3D Gaussian Splatting with Microsoft HoloLens 2
...
#### [12] FastScene: Text-Driven Fast 3D Indoor Scene Generation via Panoramic Gaussian Splatting
...
#### [18] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [19] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [20] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [21] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [22] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [23] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [24] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [25] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
