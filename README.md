...
#### [2] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [3] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [5] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [6] RNG: Relightable Neural Gaussians
...
#### [7] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [8] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [9] Gaussian Heritage: 3D Digitization of Cultural Heritage with Integrated Object Segmentation
...
#### [11] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [13] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [14] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [15] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [17] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [18] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [19] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [20] Low Latency Point Cloud Rendering with Learned Splatting
...
#### [21] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
- **🧑‍🔬 作者**：Gennady Sidorov, Malik Mohrat, Ksenia Lebedeva, Ruslan Rakhimov, Sergey Kolyubin
...
#### [22] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [23] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [24] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [25] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [26] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [27] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [28] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [29] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [30] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [31] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [32] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [33] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [34] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [35] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [36] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [37] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [38] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [39] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [40] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [41] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [42] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [43] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [44] SRIF: Semantic Shape Registration Empowered by Diffusion-based Image Morphing and Flow Estimation
...
#### [45] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [46] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [47] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [48] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [49] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [50] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [51] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [52] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [53] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [54] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [55] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [56] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [57] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [58] AdR-Gaussian: Accelerating Gaussian Splatting with Adaptive Radius
...
#### [59] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [60] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [61] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [62] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [63] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [64] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [65] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [66] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [67] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [68] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [69] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [70] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [71] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [72] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [73] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [74] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [75] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [76] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [77] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [78] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [79] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [80] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [81] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [82] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [83] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [84] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [85] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [86] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [87] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [88] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [89] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [90] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [91] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [92] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [93] OmniRe: Omni Urban Scene Reconstruction
...
#### [94] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [95] G-Style: Stylized Gaussian Splatting
...
#### [96] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [97] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [98] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [99] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [100] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [101] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [102] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [103] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [104] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [105] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [106] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [107] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [108] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [109] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [110] Subsurface Scattering for 3D Gaussian Splatting
...
#### [111] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [112] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [113] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [114] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [115] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [116] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [117] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [118] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [119] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [120] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [121] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [122] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [123] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [124] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [125] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [126] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [127] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [128] 3D Gaussian Editing with A Single Image
...
#### [129] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [130] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [131] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [132] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [133] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [134] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [135] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [136] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [137] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [138] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [139] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [140] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [141] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [142] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [143] IG-SLAM: Instant Gaussian SLAM
...
#### [144] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [145] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [146] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [147] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [148] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [149] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [150] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [151] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [152] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [153] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [154] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [155] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [156] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [157] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [158] Gaussian Splatting Lucas-Kanade
...
#### [159] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [160] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [161] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [162] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [163] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [164] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [165] PICA: Physics-Integrated Clothed Avatar
...
#### [166] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [167] Gaussian Eigen Models for Human Heads
...
#### [169] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [170] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [171] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [172] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [173] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [174] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [175] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [176] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [177] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [178] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [179] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [180] Lightweight Predictive 3D Gaussian Splats
...
#### [181] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [182] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [183] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [184] On Scaling Up 3D Gaussian Splatting Training
...
#### [185] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [186] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [187] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [188] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [189] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [190] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [191] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [192] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [193] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [194] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [195] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [196] E2GS: Event Enhanced Gaussian Splatting
...
#### [197] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [198] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [199] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [200] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [201] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [202] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [203] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [204] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [205] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [206] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [207] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [208] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [209] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [210] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [211] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [212] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [213] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [214] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [215] From Chaos to Clarity: 3DGS in the Dark
...
#### [216] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [217] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [218] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [219] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [220] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [221] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [222] Generalizable Human Gaussians from Single-View Image
...
#### [223] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [224] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [225] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [226] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [227] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [228] Localized Gaussian Point Management
...
#### [229] Gaussian Representation for Deformable Image Registration
...
#### [230] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [231] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [232] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [233] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [234] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [235] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [236] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [237] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [238] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [239] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [240] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [241] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [242] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [243] Tetrahedron Splatting for 3D Generation
...
#### [244] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [245] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [246] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [247] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
