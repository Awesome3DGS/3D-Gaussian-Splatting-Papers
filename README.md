...
#### [1] KeyGS: A Keyframe-Centric Gaussian Splatting Method for Monocular Image Sequences
...
#### [2] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [3] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [4] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [5] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [6] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [7] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [8] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [9] Learning Radiance Fields from a Single Snapshot Compressive Image
...
- **🔗 链接**：[[中英摘要](./abs/2412.19483.md)] [[arXiv:2412.19483](https://arxiv.org/abs/2412.19483)] [[Code](https://github.com/WUCVGL/SCISplat)]
- **📝 说明**：🏆 Accepted for publication at EVGEN2025, WACV-25 Workshop

#### [10] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [11] Reflective Gaussian Splatting
...
#### [12] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [13] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [14] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [15] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [16] GSAVS: Gaussian Splatting-based Autonomous Vehicle Simulator
- **🧑‍🔬 作者**：Rami Wilson
- **🏫 单位**: UCSanta Cruz
- **🔗 链接**：[[中英摘要](./abs/2412.18816.md)] [[arXiv:2412.18816](https://arxiv.org/abs/2412.18816)] [Code]
- **📝 说明**：

#### [17] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [18] Resolution-Robust 3D MRI Reconstruction with 2D Diffusion Priors: Diverse-Resolution Training Outperforms Interpolation
- **🧑‍🔬 作者**：Anselm Krainovic, Stefan Ruschke, Reinhard Heckel
- **🏫 单位**：School of Computation, Information and Technology, Technical University of Munich ⟐ School of Medicine and Health, Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2412.18584.md)] [[arXiv:2412.18584](https://arxiv.org/abs/2412.18584)] [Code]
- **📝 说明**：

#### [19] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [20] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [21] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [22] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [23] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [24] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [25] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [26] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [27] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [28] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [29] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [30] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [31] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [32] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [33] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [34] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [35] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [36] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [37] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [38] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [39] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [40] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [41] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [42] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [43] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [44] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [45] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [46] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [47] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [48] EOGS: Gaussian Splatting for Earth Observation
...
#### [49] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [50] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [51] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [52] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [53] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [54] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [55] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [56] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [57] Deformable Radial Kernel Splatting
...
#### [58] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [59] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [60] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [61] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [62] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [63] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [64] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [65] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [66] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [67] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [68] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [69] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [70] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [71] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [72] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [73] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [74] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [75] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [76] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [77] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [78] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [79] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [80] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [81] GASP: Gaussian Avatars with Synthetic Priors
...
#### [82] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [83] Faster and Better 3D Splatting via Group Training
...
#### [84] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [85] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [86] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [87] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [88] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [89] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [90] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [91] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [92] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [93] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [94] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [95] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [96] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [97] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [98] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [99] Street Gaussians without 3D Object Tracker
...
#### [100] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [101] Extrapolated Urban View Synthesis Benchmark
...
#### [102] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [103] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [104] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [105] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [106] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [107] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [108] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [109] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [110] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [111] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [112] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [113] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [114] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [115] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [116] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [117] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [118] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [119] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [120] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [121] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [122] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [123] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [124] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [125] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [126] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [127] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [128] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [129] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [130] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [131] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [132] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [133] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [134] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [135] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [136] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [137] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [138] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [139] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [140] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [141] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [142] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [143] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [144] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [145] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [146] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [147] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [148] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [149] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [150] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [151] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [152] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [153] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [154] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [155] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [156] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [157] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [158] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [159] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [160] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [161] Neural Surface Priors for Editable Gaussian Splatting
...
#### [162] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [163] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [164] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [165] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [166] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [167] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [168] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [169] Geometry Field Splatting with Gaussian Surfels
...
#### [170] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [171] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [172] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [173] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [174] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [175] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [176] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [177] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [178] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [179] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [180] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [181] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [182] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [183] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [184] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [185] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [186] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [187] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [188] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [189] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [190] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [191] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [192] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [193] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [194] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [195] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [196] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [197] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [198] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [199] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [200] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [201] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [202] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [203] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [204] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [205] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [206] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [207] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [208] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [209] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [210] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [211] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [212] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [213] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [214] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [215] VeGaS: Video Gaussian Splatting
...
#### [216] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [217] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [218] Efficient Density Control for 3D Gaussian Splatting
...
#### [219] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [220] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [221] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [222] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [223] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [224] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [225] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [226] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [227] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [228] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [229] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [230] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [231] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [232] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [233] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [234] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [235] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [236] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [237] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [238] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [239] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [240] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [241] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [242] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [243] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [244] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [245] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [246] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [247] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [248] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [249] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [250] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [251] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [252] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [253] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [254] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [255] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [256] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [257] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [258] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [259] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [260] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [261] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [262] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [263] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [264] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [265] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [266] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [267] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [268] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [269] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [270] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [271] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [272] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [273] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [274] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [275] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [276] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [277] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [278] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [279] 3D Vision-Language Gaussian Splatting
...
#### [280] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [281] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [282] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [283] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [284] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [285] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [286] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [287] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [288] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [289] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [290] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [291] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [292] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [293] Variational Bayes Gaussian Splatting
...
#### [294] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [295] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [296] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [297] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [298] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [299] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [300] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [301] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [302] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [303] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [304] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [305] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [306] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [307] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [308] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [309] RNG: Relightable Neural Gaussians
...
#### [310] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [311] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [312] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [313] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [314] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [315] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [316] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [317] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [318] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [319] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [320] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [321] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [322] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [323] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [324] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [325] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [326] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [327] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [328] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [329] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [330] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [331] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [332] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [333] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [334] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [335] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [336] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [337] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [338] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [339] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [340] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [341] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [342] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [343] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [344] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [345] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [346] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [347] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [348] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [349] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [350] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [351] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [352] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [353] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [354] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [355] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [356] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [357] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [358] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [359] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [360] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [361] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [362] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [363] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [364] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [365] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [366] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [367] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [368] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [369] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [370] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [371] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [372] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [373] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [374] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [375] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [376] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [377] OmniRe: Omni Urban Scene Reconstruction
...
#### [378] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [379] G-Style: Stylized Gaussian Splatting
...
#### [380] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [381] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [382] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [383] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [384] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [385] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [386] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [387] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [388] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [389] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [390] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [391] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [392] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [393] Subsurface Scattering for 3D Gaussian Splatting
...
#### [394] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [395] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [396] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [397] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [398] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [399] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [400] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [401] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [402] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [403] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [404] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [405] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [406] 3D Gaussian Editing with A Single Image
...
#### [407] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [408] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [409] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [410] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [411] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [412] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [413] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [414] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [415] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [416] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [417] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [418] IG-SLAM: Instant Gaussian SLAM
...
#### [419] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [420] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [421] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [422] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [423] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [424] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [425] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [426] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [427] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [428] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [429] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [430] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [431] Gaussian Splatting Lucas-Kanade
...
#### [432] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [433] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [434] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [435] PICA: Physics-Integrated Clothed Avatar
...
#### [436] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [437] Gaussian Eigen Models for Human Heads
...
#### [439] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [440] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [441] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [442] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [443] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [444] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [445] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [446] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [447] Lightweight Predictive 3D Gaussian Splats
...
#### [448] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [449] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [450] On Scaling Up 3D Gaussian Splatting Training
...
#### [451] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [452] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [453] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [454] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [455] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [456] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [457] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [458] E2GS: Event Enhanced Gaussian Splatting
...
#### [459] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [460] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [461] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [462] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [463] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [464] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [465] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [466] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [467] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [468] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [469] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [470] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [471] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [472] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [473] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [474] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [475] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [476] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [477] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [478] Generalizable Human Gaussians from Single-View Image
...
#### [479] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [480] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [481] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [482] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [483] Localized Gaussian Point Management
...
#### [484] Gaussian Representation for Deformable Image Registration
...
#### [485] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [486] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [487] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [488] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [489] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [490] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [491] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [492] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [493] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [494] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
