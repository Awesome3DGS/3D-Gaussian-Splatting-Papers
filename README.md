...
#### [1] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [2] 4D Driving Scene Generation With Stereo Forcing
...
#### [3] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [4] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [5] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [6] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
...
#### [7] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [8] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [10] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [11] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [12] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [13] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [14] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [15] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [16] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [17] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [18] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [19] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [20] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [21] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [22] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [23] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
...
#### [25] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
...
#### [26] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [27] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [28] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [29] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [30] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [31] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [32] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [33] Camera Splatting for Continuous View Optimization
...
#### [34] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [35] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [37] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [38] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [39] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [40] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [41] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [42] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
...
#### [43] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [44] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [45] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [46] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [47] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [48] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [49] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [50] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [51] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [52] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [53] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [54] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [55] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [56] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [57] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [58] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [59] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [60] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [61] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [62] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [63] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [64] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [65] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [66] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [67] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [68] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [69] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [70] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [71] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [72] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [73] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [74] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [75] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [76] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [77] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [78] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [79] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [80] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [81] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [82] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [83] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [84] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [85] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [86] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [87] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [88] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [89] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [90] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [91] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [92] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [93] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [94] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [95] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [96] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [97] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [98] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [99] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [100] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [101] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [102] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [103] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [104] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [105] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [106] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [107] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [108] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [109] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [110] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [111] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [112] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [113] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [114] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [115] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [116] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [117] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [118] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [119] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [120] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [121] SAGOnline: Segment Any Gaussians Online
...
#### [122] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [123] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [124] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [125] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [126] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [127] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [128] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [129] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [130] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [131] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [132] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [133] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [134] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [135] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [136] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [137] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [138] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [139] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [140] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [141] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [142] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [143] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [144] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [145] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [146] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [147] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [148] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [149] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [150] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [151] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [152] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [153] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [154] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [155] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [156] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [158] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [159] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [160] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [161] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [162] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [163] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [164] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [165] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [166] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [167] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [168] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [169] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [170] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [171] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [172] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [173] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [174] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [175] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [176] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [177] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [178] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [179] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [180] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [181] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [182] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [183] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [184] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [185] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [186] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [187] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [188] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [189] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [190] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [191] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [192] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [193] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [194] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [195] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [196] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [197] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [198] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [199] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [200] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [201] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [202] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [203] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [204] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [205] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [206] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [207] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [208] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [209] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [210] Masks make discriminative models great again!
...
#### [211] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [212] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [213] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
