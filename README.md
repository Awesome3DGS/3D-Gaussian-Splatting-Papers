...
#### [1] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [2] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [4] GS-Blur: A 3D Scene-Based Dataset for Realistic Image Deblurring
...
#### [5] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [6] Epipolar-Free 3D Gaussian Splatting for Generalizable Novel View Synthesis
...
#### [7] Geometry Cloak: Preventing TGS-based 3D Reconstruction from Copyrighted Images
...
#### [8] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [9] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [10] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [11] MVSDet: Multi-View Indoor 3D Object Detection via Efficient Plane Sweeps
...
#### [12] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
- **🧑‍🔬 作者**：Takuma Nishimura, Andreea Dogaru, Martin Oeggerli, Bernhard Egger
...
#### [13] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [15] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [16] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [17] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [18] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [19] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [20] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [21] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [22] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [23] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [24] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [25] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [26] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [27] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [28] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [29] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [30] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [31] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [32] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [33] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [34] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [35] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [36] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [37] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [38] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [39] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [40] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [41] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [42] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [43] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [44] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [45] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [46] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [47] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [48] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [49] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [50] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [51] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [52] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [53] 3D Vision-Language Gaussian Splatting
...
#### [54] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [55] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [56] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [57] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [58] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [59] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [60] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [61] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [62] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [63] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [64] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [65] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [66] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [67] Variational Bayes Gaussian Splatting
...
#### [68] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [69] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [70] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [71] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [72] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [73] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [74] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [75] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [76] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [77] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [78] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [79] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [80] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [81] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [82] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [83] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [84] RNG: Relightable Neural Gaussians
...
#### [85] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [86] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [87] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [88] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [89] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [90] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [91] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [92] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [93] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [94] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [95] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [96] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [97] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [98] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [99] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [100] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [101] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [102] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [103] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [104] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [105] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [106] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [107] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [108] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [109] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [110] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [111] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [112] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [113] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [114] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [115] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [116] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [117] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [118] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [119] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [120] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [121] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [122] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [123] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [124] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [125] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [126] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [127] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [128] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [129] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [130] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [131] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [132] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [133] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [134] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [135] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [136] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [137] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [138] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [139] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [140] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [141] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [142] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [143] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [144] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [145] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [146] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [147] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [148] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [149] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [150] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [151] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [152] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [153] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [154] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [155] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [156] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [157] OmniRe: Omni Urban Scene Reconstruction
...
#### [158] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [159] G-Style: Stylized Gaussian Splatting
...
#### [160] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [161] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [162] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [163] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [164] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [165] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [166] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [167] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [168] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [169] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [170] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [171] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [172] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [173] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [174] Subsurface Scattering for 3D Gaussian Splatting
...
#### [175] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [176] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [177] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [178] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [179] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [180] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [181] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [182] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [183] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [184] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [185] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [186] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [187] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [188] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [189] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [190] 3D Gaussian Editing with A Single Image
...
#### [191] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [192] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [193] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [194] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [195] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [196] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [197] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
...
#### [198] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [199] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [200] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [201] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [202] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [203] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [204] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [205] IG-SLAM: Instant Gaussian SLAM
...
#### [206] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [207] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [208] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [209] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [210] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [211] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [212] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [213] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [214] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [215] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [216] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [217] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [218] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [219] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [220] Gaussian Splatting Lucas-Kanade
...
#### [221] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [222] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [223] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [224] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [225] PICA: Physics-Integrated Clothed Avatar
...
#### [226] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [227] Gaussian Eigen Models for Human Heads
...
#### [229] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [230] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [231] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [232] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [233] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [234] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [235] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [236] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [237] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [238] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [239] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [240] Lightweight Predictive 3D Gaussian Splats
...
#### [241] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [242] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [243] On Scaling Up 3D Gaussian Splatting Training
...
#### [244] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [245] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [246] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [247] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [249] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [252] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [253] E2GS: Event Enhanced Gaussian Splatting
...
#### [254] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [255] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [256] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [257] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [258] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [259] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [260] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [261] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [262] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [263] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [264] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [265] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [266] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [267] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [268] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [269] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [270] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [271] From Chaos to Clarity: 3DGS in the Dark
...
#### [272] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [273] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [274] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [275] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [276] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [277] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [278] Generalizable Human Gaussians from Single-View Image
...
#### [279] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [280] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [281] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [282] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [283] Localized Gaussian Point Management
...
#### [284] Gaussian Representation for Deformable Image Registration
...
#### [285] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [286] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [287] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [288] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [289] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [290] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [291] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [292] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [293] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [294] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [295] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [296] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [297] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [298] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
