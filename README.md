...
#### [1] HouseTour: A Virtual Real Estate A(I)gent
...
#### [2] InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation
...
#### [3] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
...
#### [4] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [5] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [6] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [7] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [8] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [9] HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars
...
#### [11] Fix False Transparency by Noise Guided Splatting
...
#### [12] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [13] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [14] DriveGen3D: Boosting Feed-Forward Driving Scene Generation with Efficient Video Diffusion
...
#### [15] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [16] Terra: Explorable Native 3D World Model with Point Latents
...
#### [17] Leveraging Learned Image Prior for 3D Gaussian Compression
...
#### [18] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [19] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [20] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [21] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [22] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [23] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [24] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [25] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [26] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [27] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [28] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [29] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [30] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [31] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [32] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [33] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [34] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [35] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [36] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [37] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [38] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [39] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [40] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [41] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [42] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [43] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [44] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [45] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [46] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [47] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [48] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [49] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [50] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [51] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [52] ReSplat: Learning Recurrent Gaussian Splats
...
#### [53] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [54] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [55] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [56] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [57] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [58] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [59] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [60] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [61] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [62] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [63] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [64] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [66] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [67] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [69] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [70] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [71] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [72] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [73] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [74] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [75] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [76] HART: Human Aligned Reconstruction Transformer
...
#### [77] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [78] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [79] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [80] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [81] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [82] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [83] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [84] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [85] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [86] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [87] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [88] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [89] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [90] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [91] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [92] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [93] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [94] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [95] Learning Unified Representation of 3D Gaussian Splatting
...
#### [96] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [97] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [98] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [99] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [100] Large Material Gaussian Model for Relightable 3D Generation
...
#### [101] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [102] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [103] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [104] 4D Driving Scene Generation With Stereo Forcing
...
#### [105] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [106] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [107] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [108] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [109] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [110] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [111] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [112] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [113] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [114] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [115] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [116] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [117] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [118] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [119] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [120] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [121] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [122] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [123] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [124] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [125] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [126] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [127] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [128] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [129] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [130] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [131] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [132] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [133] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [135] Camera Splatting for Continuous View Optimization
...
#### [136] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [137] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [138] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [139] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [141] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [142] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [143] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [144] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [145] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [146] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [147] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [148] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [149] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [150] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [151] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [152] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [153] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [154] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [155] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [156] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [157] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [158] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [159] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [160] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [161] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [162] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [163] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [164] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [165] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [166] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [167] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [168] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [170] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [171] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [172] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [173] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [174] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [175] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [176] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [177] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [178] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [179] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [180] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [181] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [182] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [183] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [184] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [185] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [186] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [187] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [188] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [189] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [190] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [191] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [192] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [193] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [194] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [195] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [196] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [197] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [198] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [199] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [200] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [201] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [202] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [203] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [204] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [205] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [206] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [207] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [208] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [209] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [210] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [211] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [212] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [213] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [214] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [215] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [216] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [217] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [218] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [219] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [220] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [221] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [222] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [223] SAGOnline: Segment Any Gaussians Online
...
#### [224] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [225] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [226] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [227] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [228] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [229] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [230] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [231] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [232] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [233] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [234] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [235] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [236] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [237] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [238] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [239] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [240] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [241] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [242] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [243] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [244] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [245] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [246] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [247] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [248] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [249] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [250] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [251] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [252] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [253] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [254] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [255] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [256] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [257] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [258] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [259] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [260] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [261] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [262] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [263] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [264] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [265] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [266] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [267] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [268] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [269] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [270] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [271] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [272] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [273] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [274] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [275] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [276] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [277] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [278] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [279] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [280] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [281] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [282] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [283] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [284] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [285] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [286] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [287] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [288] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [289] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [290] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [291] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [292] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [293] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [294] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [295] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [296] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [297] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [298] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [299] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [300] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [301] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [302] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [303] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [304] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [305] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [306] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [307] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [308] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [309] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [310] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [311] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [312] Masks make discriminative models great again!
...
#### [313] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [314] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [315] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
