...
#### [1] Grid4D: 4D Decomposed Hash Encoding for High-fidelity Dynamic Gaussian Splatting
...
#### [2] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [4] ODGS: 3D Scene Reconstruction from Omnidirectional Images with 3D Gaussian Splattings
...
#### [5] Normal-GS: 3D Gaussian Splatting with Normal-Involved Rendering
...
#### [6] SCube: Instant Large-Scale Scene Reconstruction using VoxSplats
...
#### [7] DiffGS: Functional Gaussian Splatting Diffusion
...
#### [8] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [9] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [10] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [11] Binocular-Guided 3D Gaussian Splatting with View Consistency for Sparse View Synthesis
...
#### [12] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [13] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [14] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [15] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [16] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [17] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [18] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [19] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [20] 3DGS-Enhancer: Enhancing Unbounded 3D Gaussian Splatting with View-consistent 2D Diffusion Priors
...
#### [21] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [22] Fully Explicit Dynamic Gaussian Splatting
...
#### [23] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [24] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [25] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [26] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [27] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [28] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [29] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [30] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [31] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [32] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [33] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [34] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [35] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [36] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [37] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [38] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [39] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [40] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [41] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [42] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [43] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [44] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [45] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [46] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [47] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [48] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [50] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [51] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [52] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [53] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [54] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [55] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [56] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [57] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [58] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [59] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [60] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [61] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [62] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [63] Variational Bayes Gaussian Splatting
...
#### [66] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [67] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [68] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [69] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [70] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [71] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [72] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [73] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [74] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [75] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [76] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [77] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [78] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [80] RNG: Relightable Neural Gaussians
...
#### [81] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [82] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [83] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [84] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [85] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [86] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [87] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [88] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [89] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [90] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [91] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [92] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [93] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [94] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [95] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [96] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [98] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [99] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [100] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [101] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [102] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [103] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [104] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [105] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [106] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [107] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [108] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [109] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [110] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [111] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [112] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [113] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [114] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [115] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [116] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [117] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [118] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [119] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [120] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [121] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [122] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [123] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [125] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [126] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [127] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [128] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [129] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [130] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [131] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [132] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [133] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [134] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [135] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [136] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [137] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [138] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [139] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [140] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [141] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [142] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [143] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [144] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [145] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [146] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [147] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [148] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [149] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [150] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [151] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [152] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [153] OmniRe: Omni Urban Scene Reconstruction
...
#### [154] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [155] G-Style: Stylized Gaussian Splatting
...
#### [156] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [157] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [158] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [159] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [160] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [161] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [162] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [163] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [164] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [165] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [166] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [167] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [168] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [169] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [170] Subsurface Scattering for 3D Gaussian Splatting
...
#### [171] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [172] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [173] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [174] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [175] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [176] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [177] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [178] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [179] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [180] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [181] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [182] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [183] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [186] 3D Gaussian Editing with A Single Image
...
#### [187] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [188] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [189] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [190] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [191] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [192] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [193] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
...
#### [194] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [196] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [197] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [198] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [199] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [201] IG-SLAM: Instant Gaussian SLAM
...
#### [203] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [205] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [206] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [207] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [208] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [209] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [212] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [213] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [214] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [215] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [216] Gaussian Splatting Lucas-Kanade
...
#### [217] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [218] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [219] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [220] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [222] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [224] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [225] Gaussian Eigen Models for Human Heads
...
#### [227] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [228] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [229] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [230] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [231] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [232] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [233] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [234] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [238] Lightweight Predictive 3D Gaussian Splats
...
#### [239] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [242] On Scaling Up 3D Gaussian Splatting Training
...
#### [243] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [246] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [247] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [252] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [254] E2GS: Event Enhanced Gaussian Splatting
...
#### [257] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [258] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [259] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [260] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [261] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [262] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [263] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [264] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [265] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [266] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [267] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [268] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [272] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [274] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [275] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [276] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [277] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [278] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [279] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [280] Generalizable Human Gaussians from Single-View Image
...
#### [281] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [282] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [283] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [286] Localized Gaussian Point Management
...
#### [287] Gaussian Representation for Deformable Image Registration
...
#### [288] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [289] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [294] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [295] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [296] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [297] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [301] Tetrahedron Splatting for 3D Generation
...
#### [303] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [304] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [305] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
