...
- **2025**
  ...
  - [[3DV](./2025/3DV.md)] (9 篇)
    [[WACV](./2025/WACV.md)] (10 篇)
    [[AAAI](./2025/AAAI.md)] (13 篇)
    [[ICLR](./2025/ICLR.md)] (7 篇)
    [[ICASSP](./2025/ICASSP.md)] (4 篇)
...
- **🏫 单位**: Kyung Hee University, South Korea ⟐ University of Electronic Science and Technology of China (UESTC), Chengdu, China ⟐ LTCI, T´el´ecom Paris, Institut Polytechnique de Paris, France and Universita degli Studi di Padova, Padua, Italy ⟐ CNRS, CentraleSupelec, Laboratoire des Signaux et Systemes, Universite Paris-Saclay, France
...
#### [1] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [2] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [3] SplatVoxel: History-Aware Novel View Streaming without Temporal Training
...
#### [4] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [5] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [6] RoGSplat: Learning Robust Generalizable Human Gaussian Splatting from Sparse Multi-View Images
...
#### [7] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [8] Rethinking End-to-End 2D to 3D Scene Segmentation in Gaussian Splatting
...
#### [9] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [10] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [12] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [14] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [15] AV-Surf: Surface-Enhanced Geometry-Aware Novel-View Acoustic Synthesis
- **🧑‍🔬 作者**：Hadam Baek, Hannie Shin, Jiyoung Seo, Chanwoo Kim, Saerom Kim, Hyeongbok Kim, Sangpil Kim
- **🏫 单位**: Korea University ⟐ Testworks
- **🔗 链接**：[[中英摘要](./abs/2503.12806.md)] [[arXiv:2503.12806](https://arxiv.org/abs/2503.12806)] [[Code](https://avsurf.github.io/)]
- **📝 说明**：

#### [16] Deblur Gaussian Splatting SLAM
...
#### [17] MTGS: Multi-Traversal Gaussian Splatting
...
#### [18] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [19] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
- **🧑‍🔬 作者**：Songen Gu, Haoxuan Song, Binjie Liu, Qian Yu, Sanyi Zhang, Haiyong Jiang, Jin Huang, Feng Tian
...
#### [20] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [21] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [23] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [24] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [25] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [26] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [27] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [28] FloPE: Flower Pose Estimation for Precision Pollination
- **🧑‍🔬 作者**：Rashik Shrestha, Madhav Rijal, Trevor Smith, Yu Gu
- **🏫 单位**: West Virginia University
- **🔗 链接**：[[中英摘要](./abs/2503.11692.md)] [[arXiv:2503.11692](https://arxiv.org/abs/2503.11692)] [Code]
- **📝 说明**：

#### [29] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [30] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [31] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [32] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [33] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [34] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [35] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [36] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
- **🧑‍🔬 作者**：Zhiqi Li, Chengrui Dong, Yiming Chen, Zhangchi Huang, Peidong Liu
...
#### [37] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [38] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [39] 3D Student Splatting and Scooping
...
#### [40] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [41] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [42] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [43] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [45] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [46] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [47] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [48] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [49] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [50] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [51] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [52] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [53] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
- **🔗 链接**：[[中英摘要](./abs/2503.08224.md)] [[arXiv:2503.08224](https://arxiv.org/abs/2503.08224)] [Code]
- **📝 说明**：

#### [54] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [55] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [56] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [57] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [58] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [59] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [60] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [61] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [62] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [63] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [64] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
- **📝 说明**：🏆 Accepted to AAAI2025

#### [65] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [66] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [67] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [68] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [69] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [70] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [71] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [72] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [73] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [74] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [75] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [76] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [77] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [78] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [79] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [80] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [81] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [82] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [84] LiDAR-enhanced 3D Gaussian Splatting Mapping
- **🧑‍🔬 作者**：Jian Shen, Huai Yu, Ji Wu, Wen Yang, Gui-Song Xia
...
#### [85] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [86] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [87] STGA: Selective-Training Gaussian Head Avatars
...
#### [88] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [89] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [90] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [91] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [92] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [93] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [94] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [95] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [96] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [97] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [98] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [99] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [100] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [101] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [102] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [103] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [104] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [105] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [106] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [107] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [108] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [109] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [110] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [111] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [112] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [113] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [114] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [115] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [116] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [117] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [118] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [119] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [120] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [121] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [122] Seeing A 3D World in A Grain of Sand
...
#### [123] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [124] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [125] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [126] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [127] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [129] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [130] LUCAS: Layered Universal Codec Avatars
...
#### [131] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [132] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [133] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [134] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [135] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [136] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [137] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [138] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [139] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
- **🧑‍🔬 作者**：Kim Jun-Seong, GeonU Kim, Kim Yu-Ji, Yu-Chiang Frank Wang, Jaesung Choe, Tae-Hyun Oh
- **🏫 单位**: POSTECH ⟐ NVIDIA ⟐ KAIST
- **🔗 链接**：[[中英摘要](./abs/2502.16652.md)] [[arXiv:2502.16652](https://arxiv.org/abs/2502.16652)] [Code]
- **📝 说明**：
...
#### [141] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [142] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [143] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [144] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [145] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [146] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [147] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [148] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [149] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [150] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [151] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [152] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [153] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [154] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
- **🧑‍🔬 作者**：Sheng-Yu Huang, Zi-Ting Chou, Yu-Chiang Frank Wang
- **🏫 单位**: Graduate Institute of Communication Engineering, National Taiwan University ⟐ NVIDIA, Taiwan
- **🔗 链接**：[[中英摘要](./abs/2502.11801.md)] [[arXiv:2502.11801](https://arxiv.org/abs/2502.11801)] [Code]
- **📝 说明**：

#### [155] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [156] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [157] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [158] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [159] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [160] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [161] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [162] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [163] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [164] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [165] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [166] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [167] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [168] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [169] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [170] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [171] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [172] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [173] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [174] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [175] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [176] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [177] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [178] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [179] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [180] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [181] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [182] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [183] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [185] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [186] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [187] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [188] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [189] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [190] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [191] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [192] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [193] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [194] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [195] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [196] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [197] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [198] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [199] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [200] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [201] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [202] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [203] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [204] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [205] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [206] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [209] GSTAR: Gaussian Surface Tracking and Reconstruction
- **🧑‍🔬 作者**：Chengwei Zheng, Lixin Xue, Juan Zarate, Jie Song
- **🏫 单位**：ETH Zurich ⟐ HKUST(GZ) ⟐ HKUST
- **🔗 链接**：[[中英摘要](./abs/2501.10283.md)] [[arXiv:2501.10283](https://arxiv.org/abs/2501.10283)] [Code]
- **📝 说明**：


#### [210] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [211] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [212] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [213] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [214] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [215] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [216] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [217] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [218] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [219] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [220] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [221] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [222] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [223] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [224] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
- **🔗 链接**：[[中英摘要](./abs/2501.05379.md)] [[arXiv:2501.05379](https://arxiv.org/abs/2501.05379)] [Code]
- **📝 说明**：

#### [225] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [226] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [227] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [228] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [229] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2501.03714.md)] [[arXiv:2501.03714](https://arxiv.org/abs/2501.03714)] [Code]
- **📝 说明**：

#### [230] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [231] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [232] Gaussian Masked Autoencoders
...
#### [233] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [234] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [235] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [236] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [237] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [238] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [239] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [240] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [241] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [242] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [243] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [244] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [245] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [246] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [247] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [248] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [249] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [250] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [251] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [252] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [253] Reflective Gaussian Splatting
...
#### [254] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [255] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [256] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [257] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [258] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [259] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [260] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [261] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [262] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [263] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [264] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [265] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [266] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [267] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [268] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [269] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [270] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [271] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [272] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [273] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [274] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [275] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [276] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [277] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [278] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [279] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [280] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [281] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [282] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [283] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [284] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [285] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [286] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [287] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [288] EOGS: Gaussian Splatting for Earth Observation
...
#### [289] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [290] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [291] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [292] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [293] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [294] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [295] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [296] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [297] Deformable Radial Kernel Splatting
...
#### [298] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [299] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [300] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [301] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [302] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [303] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [304] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [305] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [306] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [307] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [308] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
- **🔗 链接**：[[中英摘要](./abs/2412.09982.md)] [[arXiv:2412.09982](https://arxiv.org/abs/2412.09982)] [Code]
- **📝 说明**：

#### [309] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [310] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [311] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [312] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [313] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [314] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [315] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [316] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [317] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [318] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [319] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [320] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [321] GASP: Gaussian Avatars with Synthetic Priors
...
#### [322] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [323] Faster and Better 3D Splatting via Group Training
...
#### [324] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [325] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [326] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [327] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [328] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [329] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [330] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [331] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
- **🔗 链接**：[[中英摘要](./abs/2412.06250.md)] [[arXiv:2412.06250](https://arxiv.org/abs/2412.06250)] [Code]
- **📝 说明**：

#### [332] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [333] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [334] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [335] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [336] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [337] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [338] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [339] Street Gaussians without 3D Object Tracker
...
#### [340] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [341] Extrapolated Urban View Synthesis Benchmark
...
#### [342] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [343] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [344] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [345] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [346] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [347] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [348] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [349] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [350] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [351] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [352] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2412.03844.md)] [[arXiv:2412.03844](https://arxiv.org/abs/2412.03844)] [Code]
- **📝 说明**：

#### [353] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [354] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [355] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [356] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [357] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [358] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [359] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [360] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [361] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [362] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [363] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [364] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [365] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [366] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [367] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [368] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [369] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [370] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [371] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [372] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [373] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [374] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [375] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2412.00905.md)] [[arXiv:2412.00905](https://arxiv.org/abs/2412.00905)] [Code]
- **📝 说明**：

#### [376] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [377] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [378] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [379] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [380] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [381] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [382] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [383] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [384] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [385] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [386] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [387] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2411.19654.md)] [[arXiv:2411.19654](https://arxiv.org/abs/2411.19654)] [Code]
- **📝 说明**：

#### [388] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [389] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [390] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [391] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [392] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [393] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
- **🔗 链接**：[[中英摘要](./abs/2411.19235.md)] [[arXiv:2411.19235](https://arxiv.org/abs/2411.19235)] [Code]
- **📝 说明**：

#### [394] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [395] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [396] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [397] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [398] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
- **🔗 链接**：[[中英摘要](./abs/2411.18625.md)] [[arXiv:2411.18625](https://arxiv.org/abs/2411.18625)] [Code]
- **📝 说明**：

#### [399] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [400] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [401] Neural Surface Priors for Editable Gaussian Splatting
...
#### [402] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [403] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [404] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [405] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [406] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [407] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [408] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [409] Geometry Field Splatting with Gaussian Surfels
...
#### [410] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [411] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [412] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [413] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [414] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [415] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [416] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [417] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [418] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [419] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [420] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [421] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [422] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [423] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [424] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [425] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [426] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [427] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [428] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [429] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [430] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [431] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [432] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [433] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [434] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [435] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [436] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [437] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [438] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [439] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [440] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [441] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [442] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [443] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [444] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [445] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [446] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [447] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [448] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [449] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [450] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [451] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [452] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [453] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [454] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [455] VeGaS: Video Gaussian Splatting
...
#### [456] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [457] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [458] Efficient Density Control for 3D Gaussian Splatting
...
#### [459] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [460] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [461] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [462] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [463] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [464] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [465] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [466] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [467] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [468] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [469] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [470] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [471] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [472] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [473] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [474] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [475] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [476] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [477] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [478] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [479] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [480] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [481] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [482] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [483] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [484] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [485] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [486] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [487] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [488] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [489] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [490] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
- **🔗 链接**：[[中英摘要](./abs/2410.17249.md)] [[arXiv:2410.17249](https://arxiv.org/abs/2410.17249)] [Code]
- **📝 说明**：

#### [491] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [492] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [493] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [494] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [495] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [496] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [497] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [498] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [499] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [500] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [501] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [502] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [503] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [504] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [505] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [506] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [507] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [508] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [509] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [510] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [511] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [512] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [513] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [514] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [515] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [516] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [517] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [518] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [519] 3D Vision-Language Gaussian Splatting
...
#### [520] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [521] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [522] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [523] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [524] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [525] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [526] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [527] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [528] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [529] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
- **🧑‍🔬 作者**：Zhongpai Gao, Benjamin Planche, Meng Zheng, Anwesa Choudhuri, Terrence Chen, Ziyan Wu
- **🏫 单位**：United Imaging Intelligence, Boston MA, USA
- **🔗 链接**：[[中英摘要](./abs/2410.04974.md)] [[arXiv:2410.04974](https://arxiv.org/abs/2410.04974)] [Code]
- **📝 说明**：

#### [530] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [531] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [532] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [533] Variational Bayes Gaussian Splatting
...
#### [534] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [535] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [536] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [537] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [538] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [539] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [540] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [541] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [542] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [543] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [544] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [545] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [546] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [547] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [548] RNG: Relightable Neural Gaussians
...
- **🔗 链接**：[[中英摘要](./abs/2409.19702.md)] [[arXiv:2409.19702](https://arxiv.org/abs/2409.19702)] [Code]
- **📝 说明**：

#### [549] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [550] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [551] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [552] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [553] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [554] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [555] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [556] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [557] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [558] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [559] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [560] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [561] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [562] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [563] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [564] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [565] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [566] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [567] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [568] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [569] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [570] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [571] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [572] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [573] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [574] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [575] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [576] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [577] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [578] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [579] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [580] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [581] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [582] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [583] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [584] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [585] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [586] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [587] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [588] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [589] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [590] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [591] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [592] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [593] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [594] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [595] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [596] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [597] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [598] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [599] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [600] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [601] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [602] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [603] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [604] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [605] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [606] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [607] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [608] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [609] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [610] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [611] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [612] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [613] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [614] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [615] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [616] OmniRe: Omni Urban Scene Reconstruction
...
#### [617] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [618] G-Style: Stylized Gaussian Splatting
...
#### [619] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [620] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [621] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [622] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [623] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [624] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
- **🔗 链接**：[[中英摘要](./abs/2408.13770.md)] [[arXiv:2408.13770](https://arxiv.org/abs/2408.13770)] [Code]
- **📝 说明**：

#### [625] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [626] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [627] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [628] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [629] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [630] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [631] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [632] Subsurface Scattering for 3D Gaussian Splatting
...
#### [633] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [634] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [635] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [636] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [637] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [638] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [639] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [640] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [641] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [642] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [643] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [644] 3D Gaussian Editing with A Single Image
...
#### [645] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [646] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [647] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [648] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [649] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [650] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [651] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [652] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [653] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [654] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [655] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [656] IG-SLAM: Instant Gaussian SLAM
...
#### [657] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [658] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [659] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [660] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [661] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [662] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [663] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [664] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [665] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [666] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [667] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [668] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [669] Gaussian Splatting Lucas-Kanade
...
#### [670] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [671] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [672] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [673] PICA: Physics-Integrated Clothed Avatar
...
#### [674] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [675] Gaussian Eigen Models for Human Heads
...
- **🔗 链接**：[[中英摘要](./abs/2407.04545.md)] [[arXiv:2407.04545](https://arxiv.org/abs/2407.04545)] [Code]
- **📝 说明**：

#### [676] Segment Any 4D Gaussians
...
#### [677] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [678] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [679] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [680] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [681] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [682] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [683] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [684] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [685] Lightweight Predictive 3D Gaussian Splats
...
#### [686] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [687] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [688] On Scaling Up 3D Gaussian Splatting Training
...
#### [689] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [690] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [691] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [692] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [693] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [694] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [695] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [696] E2GS: Event Enhanced Gaussian Splatting
...
#### [697] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [698] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [699] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [700] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [701] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
- **🧑‍🔬 作者**：Alex Hanson, Allen Tu, Vasu Singla, Mayuka Jayawardhana, Matthias Zwicker, Tom Goldstein
- **🏫 单位**：University of Maryland, College Park
- **🔗 链接**：[[中英摘要](./abs/2406.10219.md)] [[arXiv:2406.10219](https://arxiv.org/abs/2406.10219)] [Code]
- **📝 说明**：

#### [702] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [703] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [704] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [705] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [706] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [707] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [708] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [709] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [710] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [711] Generalizable Human Gaussians from Single-View Image
...
#### [712] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [713] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [714] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [715] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [716] Localized Gaussian Point Management
...
#### [717] Gaussian Representation for Deformable Image Registration
...
#### [718] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [719] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [720] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [721] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [722] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [723] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [724] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [725] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [726] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
