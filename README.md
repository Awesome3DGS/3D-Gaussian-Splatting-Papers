...
#### [2] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [3] 3D Gaussian Editing with A Single Image
...
#### [4] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [5] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [6] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [7] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [8] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [9] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [10] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
...
#### [11] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [13] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [14] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [15] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [16] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [17] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [18] IG-SLAM: Instant Gaussian SLAM
...
#### [19] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [20] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [21] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [22] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [23] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [24] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [25] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [26] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [27] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [28] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [29] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [30] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [31] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [32] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [33] Gaussian Splatting Lucas-Kanade
...
#### [34] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [35] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [36] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [38] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [39] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [40] PICA: Physics-Integrated Clothed Avatar
...
#### [41] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [42] Gaussian Eigen Models for Human Heads
...
#### [44] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [45] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [46] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [47] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [48] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [49] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [50] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [51] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [52] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [53] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [54] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [55] Lightweight Predictive 3D Gaussian Splats
...
#### [56] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [57] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [58] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [59] On Scaling Up 3D Gaussian Splatting Training
...
#### [60] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [61] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [62] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [63] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [64] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [65] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [66] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [67] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [68] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [69] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [70] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [71] E2GS: Event Enhanced Gaussian Splatting
...
#### [72] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [73] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [74] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [75] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [76] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [77] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [78] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [79] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [80] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [81] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [82] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [83] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [84] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [85] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [86] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [87] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [88] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [89] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [90] From Chaos to Clarity: 3DGS in the Dark
...
#### [91] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [92] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [93] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [94] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [95] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [96] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [97] Generalizable Human Gaussians from Single-View Image
...
#### [98] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [99] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [100] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [101] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [102] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [103] Localized Gaussian Point Management
...
#### [104] Gaussian Representation for Deformable Image Registration
...
#### [105] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [106] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [107] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [108] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [109] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [110] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [111] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [112] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [113] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [114] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [115] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [116] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [117] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [118] Tetrahedron Splatting for 3D Generation
...
#### [119] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [120] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [121] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [122] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
