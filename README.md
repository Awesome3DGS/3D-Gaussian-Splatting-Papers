...
#### [2] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [3] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [4] Gaussian Splatting Lucas-Kanade
...
#### [5] iHuman: Instant Animatable Digital Humans From Monocular Videos
...
#### [6] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [8] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [9] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [10] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [11] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [13] PICA: Physics-Integrated Clothed Avatar
...
#### [14] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [15] Gaussian Eigen Models for Human Heads
...
#### [17] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [18] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [19] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [20] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [21] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [23] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [24] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [25] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [26] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [27] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [28] Lightweight Predictive 3D Gaussian Splats
...
#### [29] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [30] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [31] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [32] On Scaling Up 3D Gaussian Splatting Training
...
#### [33] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [34] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [36] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [37] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [38] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [39] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [40] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [42] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [43] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [44] E2GS: Event Enhanced Gaussian Splatting
...
#### [45] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [46] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [47] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [48] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [49] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [50] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [51] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [52] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [53] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [54] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [55] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [56] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [57] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [58] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [59] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [60] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [61] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [62] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [63] From Chaos to Clarity: 3DGS in the Dark
...
#### [64] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [65] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [66] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [67] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [68] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [69] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [70] Generalizable Human Gaussians from Single-View Image
...
#### [71] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [72] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [73] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [74] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [75] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [76] Localized Gaussian Point Management
...
#### [77] Gaussian Representation for Deformable Image Registration
...
#### [78] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [79] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [80] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [81] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [82] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [83] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [84] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [85] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [86] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [87] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [88] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [89] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [90] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [91] Tetrahedron Splatting for 3D Generation
...
#### [92] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [93] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [94] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [95] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
