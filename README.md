...
- **2025**
  ...
  - [[3DV](./2025/3DV.md)] (21 篇)
    ...
    [[ICRA](./2025/ICRA.md)] (21 篇)
  - [[CVPR](./2025/CVPR.md)] (157 篇)
    [[ICCV](./2025/ICCV.md)] (93 篇)
    [[ACM MM](./2025/ACMMM.md)] (17 篇)
    [[MICCAI](./2025/MICCAI.md)] (5 篇)
    [[SIGGRAPH](./2025/SIGGRAPH.md)] (23 篇)
  - [[ICML](./2025/ICML.md)] (7 篇)
    [[IROS](./2025/IROS.md)] (13 篇)
    [[ICME](./2025/ICME.md)] (8 篇)
    [[ICIP](./2025/ICIP.md)] (4 篇)
    [[BMVC](./2025/BMVC.md)] (2 篇)
  - [[NeurIPS](./2025/NeurIPS.md)] (2 篇)
    [[others](./2025/Accepted.md)] (74 篇)
...
- **归档时间**
  ...
  - [[2024/07/01](./archive/202407.md)] (176 篇)
    ...
    [[2025/04/01](./archive/202504.md)] (211 篇)
  - [[2025/07/01](./archive/202507.md)] (229 篇)

---

#### [1] Beyond Darkness: Thermal-Supervised 3D Gaussian Splatting for Low-Light Novel View Synthesis
...
#### [2] TR-Gaussians: High-fidelity Real-time Rendering of Planar Transmission and Reflection with 3D Gaussian Splatting
...
#### [4] GUIDE: Gaussian Unified Instance Detection for Enhanced Obstacle Perception in Autonomous Driving
...
#### [5] Neo: Real-Time On-Device 3D Gaussian Splatting with Reuse-and-Update Sorting Acceleration
...
#### [6] Reconstructing 3D Scenes in Native High Dynamic Range
...
#### [7] Changes in Real Time: Online Scene Change Detection with Multi-View Fusion
...
#### [8] SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images
...
#### [9] 3D Gaussian and Diffusion-Based Gaze Redirection
...
#### [10] RealisticDreamer: Guidance Score Distillation for Few-shot Gaussian Splatting
...
#### [11] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
...
#### [12] Depth-Consistent 3D Gaussian Splatting via Physical Defocus Modeling and Multi-View Geometric Supervision
...
#### [13] Multivariate Gaussian Representation Learning for Medical Action Evaluation
...
#### [14] TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting
...
#### [15] AHA! Animating Human Avatars in Diverse Scenes with Gaussian Splatting
...
#### [16] Lumos3D: A Single-Forward Framework for Low-Light 3D Scene Restoration
...
#### [17] A Shared-Autonomy Construction Robotic System for Overhead Works
...
#### [18] OUGS: Active View Selection via Object-aware Uncertainty Estimation in 3DGS
...
#### [19] SkelSplat: Robust Multi-view 3D Human Pose Estimation with Differentiable Gaussian Rendering
...
#### [20] Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric
...
#### [21] DIMO: Diverse 3D Motion Generation for Arbitrary Objects
...
#### [22] YoNoSplat: You Only Need One Model for Feedforward 3D Gaussian Splatting
...
#### [23] 4DSTR: Advancing Generative 4D Gaussians with Spatial-Temporal Rectification for High-Quality and Consistent 4D Generation
...
#### [25] MUGSQA: Novel Multi-Uncertainty-Based Gaussian Splatting Quality Assessment Method, Dataset, and Benchmarks
...
#### [26] ConeGS: Error-Guided Densification Using Pixel Cones for Improved Reconstruction with Fewer Primitives
...
#### [27] Robust and High-Fidelity 3D Gaussian Splatting: Fusing Pose Priors and Geometry Constraints for Texture-Deficient Outdoor Scenes
...
#### [28] Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning
...
#### [29] DIAL-GS: Dynamic Instance Aware Reconstruction for Label-free Street Scenes with 4D Gaussian Splatting
...
#### [30] Inpaint360GS: Efficient Object-Aware 3D Inpainting via Gaussian Splatting for 360° Scenes
...
#### [31] Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field
...
#### [32] StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video
...
#### [34] Efficient representation of 3D spatial data for defense-related applications
...
#### [37] Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions
...
#### [38] UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction
...
#### [39] FastGS: Training 3D Gaussian Splatting in 100 Seconds
...
#### [40] CaRF: Enhancing Multi-View Consistency in Referring 3D Gaussian Splatting Segmentation
...
#### [41] Improving Multi-View Reconstruction via Texture-Guided Gaussian-Mesh Joint Optimization
...
#### [42] DentalSplat: Dental Occlusion Novel View Synthesis from Sparse Intra-Oral Photographs
...
#### [43] PercHead: Perceptual Head Model for Single-Image 3D Head Reconstruction & Editing
...
#### [44] Object-Centric 3D Gaussian Splatting for Strawberry Plant Reconstruction and Phenotyping
...
#### [45] 3D Gaussian Radiation Field Modeling for Integrated RIS-FAS Systems: Analysis and Optimization
...
#### [46] GauDP: Reinventing Multi-Agent Collaboration through Gaussian-Image Synergy in Diffusion Policies
...
#### [47] 4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Guassian Splatting
...
#### [48] Diff4Splat: Controllable 4D Scene Generation with Latent Dynamic Reconstruction Models
...
#### [49] Object-Aware 4D Human Motion Generation
...
#### [50] SAGS: Self-Adaptive Alias-Free Gaussian Splatting for Dynamic Surgical Endoscopic Reconstruction
...
#### [51] DC4GS: Directional Consistency-Driven Adaptive Density Control for 3D Gaussian Splatting
...
#### [52] HEIR: Learning Graph-Based Motion Hierarchies
...
#### [53] AgriGS-SLAM: Orchard Mapping Across Seasons via Multi-View Gaussian Splatting SLAM
...
#### [54] 6D Channel Knowledge Map Construction via Bidirectional Wireless Gaussian Splatting
...
#### [55] JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting
...
#### [56] Learning Disentangled Speech- and Expression-Driven Blendshapes for 3D Talking Face Animation
...
#### [57] EA3D: Online Open-World 3D Object Extraction from Streaming Videos
...
#### [58] AtlasGS: Atlanta-world Guided Surface Reconstruction with Implicit Structured Gaussians
...
#### [59] DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes
...
#### [60] NVSim: Novel View Synthesis Simulator for Large Scale Indoor Navigation
...
#### [61] LagMemo: Language 3D Gaussian Splatting Memory for Multi-modal Open-vocabulary Multi-goal Visual Navigation
...
#### [62] PlanarGS: High-Fidelity Indoor 3D Gaussian Splatting Guided by Vision-Language Planar Priors
...
#### [63] Explicit Memory through Online 3D Gaussian Splatting Improves Class-Agnostic Video Segmentation
...
#### [64] VR-Drive: Viewpoint-Robust End-to-End Driving with Feed-Forward 3D Gaussian Splatting
...
#### [65] EndoWave: Rational-Wavelet 4D Gaussian Splatting for Endoscopic Reconstruction
...
#### [66] Gen-LangSplat: Generalized Language Gaussian Splatting with Pre-Trained Feature Compression
- **🧑‍🔬 作者**：Pranav Saxena
...
#### [67] Region-Adaptive Learned Hierarchical Encoding for 3D Gaussian Splatting Data
...
#### [68] LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering
...
#### [69] RoGER-SLAM: A Robust Gaussian Splatting SLAM System for Noisy and Low-light Environment Resilience
...
#### [70] DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss
...
#### [71] DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum
...
#### [72] STG-Avatar: Animatable Human Avatars via Spacetime Gaussian
...
#### [73] Towards Physically Executable 3D Gaussian for Embodied Navigation
...
#### [74] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
#### [75] OnlineSplatter: Pose-Free Online 3D Reconstruction for Free-Moving Objects
...
#### [76] COS3D: Collaborative Open-Vocabulary 3D Segmentation
...
#### [77] Extreme Views: 3DGS Filter for Novel View Synthesis from Out-of-Distribution Camera Poses
...
#### [78] Re-Activating Frozen Primitives for 3D Gaussian Splatting
...
#### [79] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [80] GRASPLAT: Enabling dexterous grasping through novel view synthesis
...
#### [81] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [82] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [83] From Volume Rendering to 3D Gaussian Splatting: Theory and Applications
...
#### [84] HouseTour: A Virtual Real Estate A(I)gent
...
#### [85] InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation
...
#### [86] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
...
#### [87] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [88] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [89] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [90] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [91] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [92] HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars
...
#### [93] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [94] Fix False Transparency by Noise Guided Splatting
...
#### [95] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [96] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [97] DriveGen3D: Boosting Feed-Forward Driving Scene Generation with Efficient Video Diffusion
...
#### [98] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [99] Terra: Explorable Native 3D World Model with Point Latents
...
#### [100] Leveraging Learned Image Prior for 3D Gaussian Compression
...
#### [101] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [102] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [103] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [104] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [105] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [106] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [107] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [108] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [109] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [110] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [111] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [112] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [113] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [114] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [115] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [116] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [117] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [118] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [119] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [120] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [121] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [122] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [123] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [124] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [125] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [126] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [127] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [128] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [129] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [130] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [131] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [132] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [133] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [134] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [135] ReSplat: Learning Recurrent Gaussian Splats
...
#### [136] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [137] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [138] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [139] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [140] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [141] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [142] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [143] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [144] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [145] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [146] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [147] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [148] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [149] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [150] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [152] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [153] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [154] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [155] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [156] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [157] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [158] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [159] HART: Human Aligned Reconstruction Transformer
...
#### [160] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [161] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [162] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [163] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [164] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [165] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [166] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [167] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [168] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [169] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [170] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [171] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [173] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [174] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [175] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [176] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [177] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [178] Learning Unified Representation of 3D Gaussian Splatting
...
#### [179] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [180] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [181] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [182] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [183] Large Material Gaussian Model for Relightable 3D Generation
...
#### [184] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [185] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [186] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [187] 4D Driving Scene Generation With Stereo Forcing
...
#### [188] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [189] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [190] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [191] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [192] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [193] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [194] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [195] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [196] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
- **🧑‍🔬 作者**：Zijing Guo, Yunyang Zhao, Lin Wang
- **🏫 单位**：Shanghai Jiao Tong University
- **🔗 链接**：[[中英摘要](./abs/2509.18956.md)] [[arXiv:2509.18956](https://arxiv.org/abs/2509.18956)] [Code]
- **📝 说明**:

#### [197] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [198] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [199] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [200] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [201] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [202] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [203] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [204] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [205] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [206] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [207] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [208] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [209] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [210] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [211] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [212] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [213] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [214] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [215] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [216] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [217] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [218] Camera Splatting for Continuous View Optimization
...
#### [219] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [220] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [221] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [222] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [223] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [224] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [225] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [226] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [227] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [228] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [229] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [230] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [231] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [232] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [233] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [234] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [235] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [236] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [237] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [238] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [239] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [240] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [241] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [242] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [243] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [244] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [245] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [246] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [247] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [248] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [249] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [250] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [251] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [252] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [253] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [254] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [255] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [256] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [257] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [258] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [259] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [260] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [261] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [262] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [263] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [264] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [265] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [266] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [267] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [268] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [269] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [270] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [271] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [272] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [273] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [274] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [275] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [276] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [277] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [278] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [279] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [280] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [281] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [282] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [283] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [284] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [285] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [286] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [287] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [288] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [289] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [290] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [291] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [292] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [293] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [294] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [295] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [296] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [297] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [298] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [299] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [300] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [301] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [302] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [303] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [304] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [305] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [306] SAGOnline: Segment Any Gaussians Online
...
#### [307] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [308] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [309] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [310] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [311] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [312] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [313] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [314] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [315] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [316] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [317] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [318] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [319] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [320] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [321] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [322] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [323] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [324] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [325] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [326] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [327] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [328] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [329] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [330] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [331] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [332] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [333] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [334] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [335] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [336] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [337] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [338] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [339] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [340] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [341] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [342] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [343] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [344] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [345] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [346] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [347] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [348] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [349] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [350] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [351] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [352] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [353] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [354] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [355] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [356] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [357] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [358] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [359] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [360] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [361] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [362] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [363] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [364] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [365] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [366] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [367] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [368] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [369] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [370] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [371] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [372] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [373] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [374] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [375] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [376] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [377] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [378] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [379] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [380] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [381] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [382] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [383] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [384] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [385] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [386] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [387] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [388] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [389] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [390] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [391] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [392] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [393] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [394] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [395] Masks make discriminative models great again!
...
#### [396] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [397] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [398] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
