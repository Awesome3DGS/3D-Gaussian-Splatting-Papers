...
- **2025**
  ...
  - [[3DV](./2025/3DV.md)] (20 篇)
    ...
    [[AAAI](./2025/AAAI.md)] (24 篇)
    [[ICLR](./2025/ICLR.md)] (42 篇)
    [[ICASSP](./2025/ICASSP.md)] (5 篇)
    [[ICRA](./2025/ICRA.md)] (20 篇)
  - [[CVPR](./2025/CVPR.md)] (157 篇)
    [[ICCV](./2025/ICCV.md)] (79 篇)
    [[ACM MM](./2025/ACMMM.md)] (12 篇)
    [[MICCAI](./2025/MICCAI.md)] (5 篇)
    [[SIGGRAPH](./2025/SIGGRAPH.md)] (19 篇)
  - [[ICML](./2025/ICML.md)] (7 篇)
    [[IROS](./2025/IROS.md)] (13 篇)
    [[ICME](./2025/ICME.md)] (8 篇)
    [[ICIP](./2025/ICIP.md)] (4 篇)
    [[others](./2025/Accepted.md)] (59 篇)
...
- **归档时间**
  ...
  - [[2024/07/01](./archive/202407.md)] (177 篇)
    [[2024/10/01](./archive/202410.md)] (102 篇)
    [[2025/01/01](./archive/202501.md)] (199 篇)
    [[2025/04/01](./archive/202504.md)] (214 篇)
...
#### [2] Efficient Geometry Compression and Communication for 3D Gaussian Splatting Point Clouds
...
#### [3] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [5] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [6] Im2Haircut: Single-view Strand-based Hair Reconstruction for Human Avatars
...
#### [8] GS-TG: 3D Gaussian Splatting Accelerator with Tile Grouping for Reducing Redundant Sorting while Preserving Rasterization Efficiency
...
#### [9] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [10] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [11] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [12] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [13] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [14] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [15] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [16] RadGS-Reg: Registering Spine CT with Biplanar X-rays via Joint 3D Radiative Gaussians Reconstruction and 3D/3D Registration
...
#### [17] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [18] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [19] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [20] Seam360GS: Seamless 360° Gaussian Splatting from Real-World Omnidirectional Images
...
#### [21] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [22] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [23] LabelGS: Label-Aware 3D Gaussian Splatting for 3D Scene Segmentation
...
#### [24] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [25] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [26] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [27] GSVisLoc: Generalizable Visual Localization for Gaussian Splatting Scene Representations
...
#### [28] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [29] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [30] GWM: Towards Scalable Gaussian World Models for Robotic Manipulation
...
#### [31] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [32] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [33] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
...
#### [34] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [35] UnPose: Uncertainty-Guided Diffusion Priors for Zero-Shot Pose Estimation
...
#### [36] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [37] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [38] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [39] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [40] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [41] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [42] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [43] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [44] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [45] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [46] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [47] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [48] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [49] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [50] LongSplat: Robust Unposed 3D Gaussian Splatting for Casual Long Videos
...
#### [51] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [52] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [53] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [54] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [55] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [56] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [57] IntelliCap: Intelligent Guidance for Consistent View Sampling
...
#### [58] Quantifying and Alleviating Co-Adaptation in Sparse-View 3D Gaussian Splatting
...
#### [59] WIPES: Wavelet-based Visual Primitives
...
#### [60] TiP4GEN: Text to Immersive Panorama 4D Scene Generation
...
#### [61] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [62] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [63] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [64] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [65] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [66] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [67] E-4DGS: High-Fidelity Dynamic Reconstruction from the Multi-view Event Cameras
...
#### [68] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [69] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [70] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [71] SVG-Head: Hybrid Surface-Volumetric Gaussians for High-Fidelity Head Reconstruction and Real-Time Editing
...
#### [72] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [73] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [75] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [76] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [77] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [78] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [79] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [80] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [81] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [82] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [83] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [84] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [85] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [86] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [87] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [88] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [89] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [90] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
...
#### [91] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [92] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [93] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [94] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [95] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [96] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [97] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [98] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [99] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [101] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [102] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [103] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [104] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [105] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [106] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [107] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [108] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [109] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [110] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [111] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [112] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [113] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [114] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [115] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [116] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [117] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [118] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [119] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [120] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [121] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [122] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [123] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [124] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [125] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [126] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [127] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [128] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [129] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [130] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [131] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [132] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [133] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [134] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [135] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [136] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [137] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
...
#### [138] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [139] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [140] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [142] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [143] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [144] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [145] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [146] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [147] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [148] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [149] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [150] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [151] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [152] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [153] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [154] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [155] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [156] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [157] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [158] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [159] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [160] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [161] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [162] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [163] LocalDyGS: Multi-view Global Dynamic Scene Modeling via Adaptive Local Implicit Feature Decoupling
...
#### [164] 3D Gaussian Splatting Driven Multi-View Robust Physical Adversarial Camouflage Generation
...
#### [165] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [166] Masks make discriminative models great again!
...
#### [167] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [168] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [169] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
- **🧑‍🔬 作者**：Xingjun Wang, Lianlei Shan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2507.00363.md)] [[arXiv:2507.00363](https://arxiv.org/abs/2507.00363)] [Code]
- **📝 说明**:

#### [170] MILo: Mesh-In-the-Loop Gaussian Splatting for Detailed and Efficient Surface Reconstruction
...
#### [171] AttentionGS: Towards Initialization-Free 3D Gaussian Splatting via Structural Attention
...
#### [172] TVG-SLAM: Robust Gaussian Splatting SLAM with Tri-view Geometric Constraints
...
#### [173] Confident Splatting: Confidence-Based Compression of 3D Gaussian Splatting via Learnable Beta Distributions
...
#### [174] Part Segmentation and Motion Estimation for Articulated Objects with Dynamic 3D Gaussians
...
#### [175] Few-Shot Identity Adaptation for 3D Talking Heads via Global Gaussian Field
...
#### [176] SAR-GS: 3D Gaussian Splatting for Synthetic Aperture Radar Target Reconstruction
...
#### [177] MADrive: Memory-Augmented Driving Scene Modeling
...
#### [178] Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image
...
#### [179] Virtual Memory for 3D Gaussian Splatting
...
#### [180] SOF: Sorted Opacity Fields for Fast Unbounded Surface Reconstruction
...
#### [181] GRAND-SLAM: Local Optimization for Globally Consistent Large-Scale Multi-Agent Gaussian SLAM
...
#### [182] 4Real-Video-V2: Fused View-Time Attention and Feedforward Reconstruction for 4D Scene Generation
...
#### [183] BulletGen: Improving 4D Reconstruction with Bullet-Time Generation
...
#### [184] 2D Triangle Splatting for Direct Differentiable Mesh Training
...
#### [185] Part2GS: Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [186] GraphGSOcc: Semantic-Geometric Graph Transformer with Dynamic-Static Decoupling for 3D Gaussian Splatting-based Occupancy Prediction
...
#### [187] 3DGS-IEval-15K: A Large-scale Image Quality Evaluation Database for 3D Gaussian-Splatting
...
#### [188] HRGS: Hierarchical Gaussian Splatting for Memory-Efficient High-Resolution 3D Reconstruction
...
#### [189] GAF: Gaussian Action Field as a Dynamic World Model for Robotic Manipulation
...
#### [190] GRaD-Nav++: Vision-Language Model Enabled Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [191] PF-LHM: 3D Animatable Avatar Reconstruction from Pose-free Articulated Human Images
...
#### [192] Micro-macro Gaussian Splatting with Enhanced Scalability for Unconstrained Scene Reconstruction
...
#### [193] Metropolis-Hastings Sampling for 3D Gaussian Reconstruction
...
#### [194] Efficient multi-view training for 3D Gaussian Splatting
...
#### [195] Generative 4D Scene Gaussian Splatting with Object View-Synthesis Priors
...
#### [196] PointGS: Point Attention-Aware Sparse View Synthesis with Gaussian Splatting
...
#### [197] DGS-LRM: Real-Time Deformable 3D Gaussian Reconstruction From Monocular Videos
...
#### [198] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [199] SemanticSplat: Feed-Forward 3D Scene Understanding with Language-Aware Gaussian Fields
...
#### [200] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
#### [201] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [202] TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
#### [203] ODG: Occupancy Prediction Using Dual Gaussians
...
#### [204] UniForward: Unified 3D Scene and Semantic Field Reconstruction via Feed-Forward Gaussian Splatting from Only Sparse-View Images
...
#### [205] STREAMINGGS: Voxel-Based Streaming 3D Gaussian Splatting with Memory Optimization and Architectural Support
...
#### [206] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [207] Gaussian2Scene: 3D Scene Representation Learning via Self-supervised Learning with 3D Gaussian Splatting
- **🧑‍🔬 作者**：Keyi Liu, Weidong Yang, Ben Fei, Ying He
- **🏫 单位**：Fudan University ⟐ The Chinese University of Hong Kong ⟐ Nanyang Technological University
- **🔗 链接**：[[中英摘要](./abs/2506.08777.md)] [[arXiv:2506.08777](https://arxiv.org/abs/2506.08777)] [Code]
- **📝 说明**:

#### [208] SceneSplat++: A Large Dataset and Comprehensive Benchmark for Language Gaussian Splatting
...
#### [209] TraGraph-GS: Trajectory Graph-based Gaussian Splatting for Arbitrary Large-Scale Scene Rendering
...
#### [210] Complex-Valued Holographic Radiance Fields
...
#### [211] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
...
#### [212] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **🧑‍🔬 作者**：Shuja Khalid, Mohamed Ibrahim, Yang Liu
- **🏫 单位**：Huawei Canada
- **🔗 链接**：[[中英摘要](./abs/2506.07897.md)] [[arXiv:2506.07897](https://arxiv.org/abs/2506.07897)] [Code]
- **📝 说明**:

#### [213] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [214] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [215] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [216] PIG: Physically-based Multi-Material Interaction with 3D Gaussians
...
#### [217] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [218] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [219] Hybrid Mesh-Gaussian Representation for Efficient Indoor Scene Reconstruction
...
#### [220] Gaussian Mapping for Evolving Scenes
...
#### [221] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [222] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [223] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [224] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [225] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [226] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [227] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [228] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [229] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [230] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [231] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [232] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [233] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [234] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [235] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [236] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [237] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [238] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [239] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [240] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [241] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
- **🧑‍🔬 作者**：Yang Xiao, Guoan Xu, Qiang Wu, Wenjing Jia
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2506.03872.md)] [[arXiv:2506.03872](https://arxiv.org/abs/2506.03872)] [Code]
- **📝 说明**:

#### [242] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [243] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [244] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [245] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [246] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [247] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [248] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [249] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [250] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [251] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [252] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [253] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [256] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [257] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [258] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [259] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [260] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
...
#### [261] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [262] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [263] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [264] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [265] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [266] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [267] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [268] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [269] Hyperspectral Gaussian Splatting
...
#### [270] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [271] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [272] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [273] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [274] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [275] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [276] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [277] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [278] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [279] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [280] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [281] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [282] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [283] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [284] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [285] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [286] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [287] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [288] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [289] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [290] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [291] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [292] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [293] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [294] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [295] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
- **🧑‍🔬 作者**：Zhuodong Jiang, Haoran Wang, Guoxi Huang, Brett Seymour, Nantheera Anantrasirichai
- **🏫 单位**：University of Bristol ⟐ Submerged Resources Centre
- **🔗 链接**：[[中英摘要](./abs/2505.15737.md)] [[arXiv:2505.15737](https://arxiv.org/abs/2505.15737)] [Code]
- **📝 说明**:

#### [296] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [297] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [298] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [299] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [300] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [301] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [302] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [303] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [304] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [305] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [306] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [307] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [308] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [309] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [310] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [311] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [312] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [313] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [314] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [315] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [316] Neural Video Compression using 2D Gaussian Splatting
...
#### [317] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [318] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [319] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [320] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [321] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [322] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [323] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [324] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [325] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [326] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [327] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [328] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [329] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [330] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [331] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [332] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [333] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [334] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jongwon Lee, Timothy Bretl
- **🏫 单位**：University of Illinois Urbana-Champaign
- **🔗 链接**：[[中英摘要](./abs/2504.20379.md)] [[arXiv:2504.20379](https://arxiv.org/abs/2504.20379)] [Code]
- **📝 说明**:

#### [335] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [336] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [337] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [338] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [339] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [340] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [341] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
...
#### [342] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [343] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [344] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [345] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [346] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [347] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [348] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [349] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [350] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [351] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [352] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [353] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [354] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [355] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [356] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [357] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [358] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [359] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [360] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [361] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [362] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [363] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [364] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [365] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [366] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [367] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [368] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [369] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [370] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [371] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [372] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [373] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [374] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [375] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [376] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [377] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [378] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [379] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [380] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [381] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [382] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [383] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [384] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [385] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [386] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [387] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [388] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [389] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [390] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [391] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [392] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [393] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [394] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [395] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [396] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [397] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [398] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [399] Digital-twin imaging based on descattering Gaussian splatting
...
#### [400] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [401] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [402] BOGausS: Better Optimized Gaussian Splatting
...
#### [403] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [404] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [405] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [406] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [407] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [408] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [409] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
