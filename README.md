...
#### [2] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [3] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [5] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [6] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
- **🔗 链接**：[[中英摘要](./abs/2412.13547.md)] [[arXiv:2412.13547](https://arxiv.org/abs/2412.13547)] [Code]
- **📝 说明**：

#### [8] EOGS: Gaussian Splatting for Earth Observation
...
#### [9] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [10] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [11] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [12] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [13] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [14] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2412.12096.md)] [[arXiv:2412.12096](https://arxiv.org/abs/2412.12096)] [Code]
- **📝 说明**：

#### [15] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [16] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [17] Deformable Radial Kernel Splatting
...
#### [18] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [19] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [20] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [21] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [22] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
- **🔗 链接**：[[中英摘要](./abs/2412.10209.md)] [[arXiv:2412.10209](https://arxiv.org/abs/2412.10209)] [Code]
- **📝 说明**：

#### [23] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
- **🔗 链接**：[[中英摘要](./abs/2412.10051.md)] [[arXiv:2412.10051](https://arxiv.org/abs/2412.10051)] [Code]
- **📝 说明**：

#### [24] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [25] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [26] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [27] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [28] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [29] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [30] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [31] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [32] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [33] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [34] PointTalk: Audio-Driven Dynamic Lip Point Cloud for 3D Gaussian-based Talking Head Synthesis
...
#### [35] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [36] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [37] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [38] GASP: Gaussian Avatars with Synthetic Priors
...
#### [39] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [40] Faster and Better 3D Splatting via Group Training
...
#### [41] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [42] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [43] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [44] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [45] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [46] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [47] 4D Gaussian Splatting with Scale-aware Residual Field and Adaptive Optimization for Real-time Rendering of Temporally Complex Dynamic Scenes
...
#### [48] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [49] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [50] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [51] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [52] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [53] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [54] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [55] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [56] Template-free Articulated Gaussian Splatting for Real-time Reposable Dynamic View Synthesis
...
#### [57] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [58] Street Gaussians without 3D Object Tracker
...
#### [59] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [60] Extrapolated Urban View Synthesis Benchmark
...
#### [61] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [62] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [63] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [64] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [65] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [66] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [67] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [68] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [69] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [71] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [72] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [73] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [74] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [75] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [76] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [77] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [78] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [79] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [80] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [81] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [82] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [83] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [84] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [85] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [86] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [87] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [88] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [89] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [90] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [91] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [92] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [93] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [94] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [95] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [96] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [97] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [98] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [99] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [100] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [101] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [102] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [103] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [104] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [105] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [106] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [107] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [108] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [109] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [110] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [111] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [112] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [113] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [114] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [115] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [116] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [117] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [118] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [119] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [120] Neural Surface Priors for Editable Gaussian Splatting
...
#### [121] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [122] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [123] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [124] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [125] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [126] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [127] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [128] Geometry Field Splatting with Gaussian Surfels
...
#### [129] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [130] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [131] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [132] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [133] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [134] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [135] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [136] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [137] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [138] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [139] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [140] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [141] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [142] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [143] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [144] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [145] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [146] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [147] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [148] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [149] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [150] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [151] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [152] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [153] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [154] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [155] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [156] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [157] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [158] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [159] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [160] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [161] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [162] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [163] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [164] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [165] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [166] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [167] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [168] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [169] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [170] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [171] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [172] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [173] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [174] VeGaS: Video Gaussian Splatting
...
#### [175] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [176] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [177] Efficient Density Control for 3D Gaussian Splatting
...
#### [178] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [179] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [180] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [181] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [182] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [183] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [184] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [185] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [186] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [187] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [188] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [189] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [190] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [191] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [192] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [193] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [194] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [195] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [196] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [197] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [198] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [199] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [200] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [201] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [202] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [203] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [204] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [205] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [206] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [207] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [208] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [209] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [210] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [211] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [212] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [213] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [214] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [215] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [216] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [217] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [218] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [219] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [220] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [221] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [222] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [223] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [224] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [225] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [226] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [227] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [228] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [229] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [230] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [231] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [232] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [233] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [234] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [235] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [236] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [237] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [238] 3D Vision-Language Gaussian Splatting
...
#### [239] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [240] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [241] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [242] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [243] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [244] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [245] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [246] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [247] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [248] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [249] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [250] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [251] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [252] Variational Bayes Gaussian Splatting
...
#### [253] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [254] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [255] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [256] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [257] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [258] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [259] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [260] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [261] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [262] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [263] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [264] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [265] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [266] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [267] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [268] RNG: Relightable Neural Gaussians
...
#### [269] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [270] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [271] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [272] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [273] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [274] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [275] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [276] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [277] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [278] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [279] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [280] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [281] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [282] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [283] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [284] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [285] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [286] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [287] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [288] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [289] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [290] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [291] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [292] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [293] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [294] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [295] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [296] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [297] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [298] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [299] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [300] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [301] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [302] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [303] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [304] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [305] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [306] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [307] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [308] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [309] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [310] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [311] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [312] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [313] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [314] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [315] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [316] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [317] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [318] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [319] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [320] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [321] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [322] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [323] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [324] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [325] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [326] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [327] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [328] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [329] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [330] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [331] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [332] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [333] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [334] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [335] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [336] OmniRe: Omni Urban Scene Reconstruction
...
#### [337] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [338] G-Style: Stylized Gaussian Splatting
...
#### [339] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [340] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [341] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [342] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [343] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [344] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [345] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [346] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [347] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [348] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [349] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [350] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [351] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [352] Subsurface Scattering for 3D Gaussian Splatting
...
#### [353] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [354] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [355] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [356] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [357] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [358] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [359] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [360] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [361] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [362] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [363] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [364] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [365] 3D Gaussian Editing with A Single Image
...
#### [366] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [367] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [368] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [369] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [370] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [371] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [372] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [373] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [374] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [375] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [376] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [377] IG-SLAM: Instant Gaussian SLAM
...
#### [378] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [379] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [380] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [381] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [382] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [383] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [384] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [385] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [386] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [387] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [388] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [389] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [390] Gaussian Splatting Lucas-Kanade
...
#### [391] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [392] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [393] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [394] PICA: Physics-Integrated Clothed Avatar
...
#### [395] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [396] Gaussian Eigen Models for Human Heads
...
#### [398] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [399] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [400] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [401] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [402] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [403] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [404] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [405] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [406] Lightweight Predictive 3D Gaussian Splats
...
#### [407] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [408] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [409] On Scaling Up 3D Gaussian Splatting Training
...
#### [410] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [411] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [412] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [413] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [414] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [415] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [416] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [417] E2GS: Event Enhanced Gaussian Splatting
...
#### [418] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [419] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [420] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [421] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [422] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [423] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [424] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [425] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [426] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [427] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [428] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [429] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [430] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [431] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [432] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [433] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [434] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [435] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [436] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [437] Generalizable Human Gaussians from Single-View Image
...
#### [438] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [439] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [440] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [441] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [442] Localized Gaussian Point Management
...
#### [443] Gaussian Representation for Deformable Image Registration
...
#### [444] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [445] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [446] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [447] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [448] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [449] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [450] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [451] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [452] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [453] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [454] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
