...
#### [6] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [7] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [9] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [10] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [12] Gaussian Masked Autoencoders
...
#### [13] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [14] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [15] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [16] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [17] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [18] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [19] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [20] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [22] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [23] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [24] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [25] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [26] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [27] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [28] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [29] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [30] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [31] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [32] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [33] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [34] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [35] Reflective Gaussian Splatting
...
#### [36] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [37] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [38] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [39] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [40] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [41] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [42] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [43] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [44] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [45] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [46] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [48] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [49] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [50] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [51] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [52] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [53] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [54] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [55] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [56] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [57] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [58] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [59] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [60] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [61] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [62] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [63] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [64] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [65] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [66] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [67] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [68] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [69] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [70] EOGS: Gaussian Splatting for Earth Observation
...
#### [71] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [72] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [73] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [74] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [75] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [76] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [77] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [78] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [79] Deformable Radial Kernel Splatting
...
#### [80] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [81] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [82] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [83] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [84] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [85] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [86] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [87] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [88] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [89] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [90] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [91] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [92] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [93] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [94] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [95] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [96] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [97] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [98] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [99] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [100] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [101] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [102] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [103] GASP: Gaussian Avatars with Synthetic Priors
...
#### [104] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [105] Faster and Better 3D Splatting via Group Training
...
#### [106] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [107] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [108] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [109] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [110] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [111] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [112] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [113] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [114] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [115] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [116] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [117] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [118] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [119] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [120] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [121] Street Gaussians without 3D Object Tracker
...
#### [122] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [123] Extrapolated Urban View Synthesis Benchmark
...
#### [124] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [125] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [126] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [127] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [128] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [129] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [130] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [131] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [132] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [133] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [134] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [135] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [136] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [137] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [138] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [139] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [140] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [141] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [142] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [143] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [144] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [145] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [146] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [147] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [148] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [149] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [150] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [151] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [152] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [153] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [154] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [155] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [156] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [157] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [158] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [159] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [160] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [161] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [162] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [163] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [164] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [165] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [166] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [167] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [168] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [169] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [170] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [171] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [172] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [173] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [174] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [175] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [176] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [177] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [178] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [179] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [180] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [181] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [182] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [183] Neural Surface Priors for Editable Gaussian Splatting
...
#### [184] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [185] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [186] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [187] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [188] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [189] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [190] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [191] Geometry Field Splatting with Gaussian Surfels
...
#### [192] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [193] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [194] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [195] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [196] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [197] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [198] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [199] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [200] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [201] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [202] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [203] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [204] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [205] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [206] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [207] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [208] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [209] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [210] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [211] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [212] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [213] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [214] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [215] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [216] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [217] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [218] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [219] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [220] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [221] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [222] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [223] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [224] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [225] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [226] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [227] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [228] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [229] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [230] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [231] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [232] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [233] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [234] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [235] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [236] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [237] VeGaS: Video Gaussian Splatting
...
#### [238] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [239] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [240] Efficient Density Control for 3D Gaussian Splatting
...
#### [241] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [242] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [243] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [244] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [245] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [246] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [247] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [248] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [249] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [250] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [251] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [252] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [253] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [254] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [255] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [256] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [257] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [258] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [259] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [260] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [261] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [262] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [263] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [264] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [265] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [266] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [267] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [268] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [269] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [270] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [271] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [272] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [273] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [274] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [275] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [276] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [277] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [278] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [279] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [280] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [281] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [282] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [283] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [284] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [285] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [286] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [287] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [288] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [289] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [290] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [291] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [292] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [293] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [294] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [295] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [296] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [297] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [298] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [299] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [300] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [301] 3D Vision-Language Gaussian Splatting
...
#### [302] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [303] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [304] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [305] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [306] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [307] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [308] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [309] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [310] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [311] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [312] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [313] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [314] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [315] Variational Bayes Gaussian Splatting
...
#### [316] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [317] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [318] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [319] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [320] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [321] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [322] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [323] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [324] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [325] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [326] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [327] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [328] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [329] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [330] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [331] RNG: Relightable Neural Gaussians
...
#### [332] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [333] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [334] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [335] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [336] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [337] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [338] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [339] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [340] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [341] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [342] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [343] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [344] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [345] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [346] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [347] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [348] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [349] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [350] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [351] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [352] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [353] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [354] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [355] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [356] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [357] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [358] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [359] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [360] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [361] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [362] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [363] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [364] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [365] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [366] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [367] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [368] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [369] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [370] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [371] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [372] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [373] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [374] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [375] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [376] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [377] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [378] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [379] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [380] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [381] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [382] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [383] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [384] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [385] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [386] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [387] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [388] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [389] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [390] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [391] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [392] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [393] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [394] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [395] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [396] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [397] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [398] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [399] OmniRe: Omni Urban Scene Reconstruction
...
#### [400] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [401] G-Style: Stylized Gaussian Splatting
...
#### [402] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [403] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [404] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [405] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [406] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [407] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [408] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [409] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [410] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [411] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [412] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [413] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [414] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [415] Subsurface Scattering for 3D Gaussian Splatting
...
#### [416] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [417] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [418] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [419] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [420] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [421] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [422] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [423] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [424] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [425] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [426] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [427] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [428] 3D Gaussian Editing with A Single Image
...
#### [429] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [430] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [431] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [432] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [433] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [434] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [435] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [436] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [437] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [438] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [439] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [440] IG-SLAM: Instant Gaussian SLAM
...
#### [441] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [442] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [443] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [444] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [445] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [446] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [447] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [448] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [449] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [450] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [451] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [452] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [453] Gaussian Splatting Lucas-Kanade
...
#### [454] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [455] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [456] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [457] PICA: Physics-Integrated Clothed Avatar
...
#### [458] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [459] Gaussian Eigen Models for Human Heads
...
#### [461] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [462] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [463] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [464] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [465] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [466] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [467] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [468] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [469] Lightweight Predictive 3D Gaussian Splats
...
#### [470] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [471] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [472] On Scaling Up 3D Gaussian Splatting Training
...
#### [473] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [474] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [475] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [476] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [477] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [478] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [479] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [480] E2GS: Event Enhanced Gaussian Splatting
...
#### [481] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [482] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [483] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [484] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [485] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [486] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [487] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [488] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [489] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [490] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [491] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [492] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [493] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [494] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [495] Generalizable Human Gaussians from Single-View Image
...
#### [496] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [497] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [498] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [499] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [500] Localized Gaussian Point Management
...
#### [501] Gaussian Representation for Deformable Image Registration
...
#### [502] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [503] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [504] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [505] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [506] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [507] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [508] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [509] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [510] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
