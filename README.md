...
#### [1] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [2] PanoDreamer: Consistent Text to 360-Degree Scene Generation
...
#### [3] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
- **🧑‍🔬 作者**：Isha Sharma, Dieter Schmalstieg
...
#### [5] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [6] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [7] Video4DGen: Enhancing Video and 4D Generation through Mutual Optimization
...
#### [8] WildGS-SLAM: Monocular Gaussian Splatting SLAM in Dynamic Environments
...
#### [9] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [10] Compressing 3D Gaussian Splatting by Noise-Substituted Vector Quantization
...
#### [11] Scene Splatter: Momentum 3D Scene Generation from Single Image with Video Diffusion Model
...
#### [12] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [13] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [14] Digital-twin imaging based on descattering Gaussian splatting
...
#### [15] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [16] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [17] Diffusion-Guided Gaussian Splatting for Large-Scale Unconstrained 3D Reconstruction and Novel View Synthesis
...
#### [18] Toward Real-world BEV Perception: Depth Uncertainty Estimation via Gaussian Splatting
...
#### [19] BOGausS: Better Optimized Gaussian Splatting
...
#### [20] FIORD: A Fisheye Indoor-Outdoor Dataset with LIDAR Ground Truth for 3D Scene Reconstruction and Benchmarking
...
#### [21] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [22] 3DBonsai: Structure-Aware Bonsai Modeling Using Conditioned 3D Gaussian Splatting
...
#### [23] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [24] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [25] Luminance-GS: Adapting 3D Gaussian Splatting to Challenging Lighting Conditions with View-Adaptive Curve Adjustment
...
#### [26] 3D Gaussian Inverse Rendering with Approximated Global Illumination
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [27] DropGaussian: Structural Regularization for Sparse-view Gaussian Splatting
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [28] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
...
#### [29] Monocular and Generalizable Gaussian Talking Head Animation
...
#### [30] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [31] Robust LiDAR-Camera Calibration with 2D Gaussian Splatting
...
#### [32] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [33] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [34] Scene4U: Hierarchical Layered 3D Scene Reconstruction from Single Panoramic Image for Your Immerse Exploration
...
#### [35] LITA-GS: Illumination-Agnostic Novel View Synthesis via Reference-Free 3D Gaussian Splatting and Physical Priors
...
#### [36] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
...
#### [37] Free360: Layered Gaussian Splatting for Unbounded 360-Degree View Synthesis from Extremely Sparse and Unposed Views
...
#### [38] StochasticSplats: Stochastic Rasterization for Sorting-Free 3D Gaussian Splatting
...
#### [40] DiET-GS: Diffusion Prior and Event Stream-Assisted Motion Deblurring 3D Gaussian Splatting
...
#### [41] Learning 3D-Gaussian Simulators from RGB Videos
...
#### [42] ExScene: Free-View 3D Scene Reconstruction with Gaussian Splatting from a Single Image
...
#### [43] Gaussian Blending Unit: An Edge GPU Plug-in for Real-Time Gaussian-Based Rendering in AR/VR
...
#### [44] Enhancing 3D Gaussian Splatting Compression via Spatial Condition-based Prediction
...
#### [45] ReasonGrounder: LVLM-Guided Hierarchical Feature Splatting for Open-Vocabulary 3D Visual Grounding and Reasoning
- **🧑‍🔬 作者**：Zhenyang Liu, Yikai Wang, Sixiao Zheng, Tongying Pan, Longfei Liang, Yanwei Fu, Xiangyang Xue
- **🏫 单位**：Fudan University ⟐ Nanyang Technological University ⟐ Shanghai Innovation Institute ⟐ NeuHelium Co., Ltd
- **🔗 链接**：[[中英摘要](./abs/2503.23297.md)] [[arXiv:2503.23297](https://arxiv.org/abs/2503.23297)] [Code]
- **📝 说明**：🏆 Accepted to CVPR 2025

#### [46] NeuralGS: Bridging Neural Fields and 3D Gaussian Splatting for Compact 3D Representations
...
#### [47] CityGS-X: A Scalable Architecture for Efficient and Geometrically Accurate Large-Scale Scene Reconstruction
...
#### [48] FreeSplat++: Generalizable 3D Gaussian Splatting for Efficient Indoor Scene Reconstruction
...
#### [49] VizFlyt: Perception-centric Pedagogical Framework For Autonomous Aerial Robots
...
#### [50] TranSplat: Lighting-Consistent Cross-Scene Object Transfer with 3D Gaussian Splatting
...
#### [51] Audio-Plane: Audio Factorization Plane Gaussian Splatting for Real-Time Talking Head Synthesis
...
#### [52] EndoLRMGS: Complete Endoscopic Scene Reconstruction combining Large Reconstruction Modelling and Gaussian Splatting
...
#### [53] AH-GS: Augmented 3D Gaussian Splatting for High-Frequency Detail Representation
...
#### [54] Follow Your Motion: A Generic Temporal Consistency Portrait Editing Framework with Trajectory Guidance
...
#### [55] ABC-GS: Alignment-Based Controllable Style Transfer for 3D Gaussian Splatting
- **🧑‍🔬 作者**：Wenjie Liu, Zhongliang Liu, Xiaoyan Yang, Man Sha, Yang Li
- **🏫 单位**：School of Computer Science and Technology, East China Normal University, Shanghai, China ⟐ School of Software Engineering, East China Normal University, Shanghai, China ⟐ Shanghai Chinafortune Co Ltd, Shanghai, China
- **🔗 链接**：[[中英摘要](./abs/2503.22218.md)] [[arXiv:2503.22218](https://arxiv.org/abs/2503.22218)] [[Code](https://github.com/vpx-ecnu/ABC-GS)]
- **📝 说明**：🏆 Accepted to ICME 2025

#### [56] Segment then Splat: A Unified Approach for 3D Open-Vocabulary Segmentation based on Gaussian Splatting
...
#### [57] Disentangled 4D Gaussian Splatting: Towards Faster and More Efficient Dynamic Scene Rendering
...
#### [58] EVPGS: Enhanced View Prior Guidance for Splatting-based Extrapolated View Synthesis
...
#### [59] X^2-Gaussian: 4D Radiative Gaussian Splatting for Continuous-time Tomographic Reconstruction
...
#### [60] Semantic Consistent Language Gaussian Splatting for Point-Level Open-vocabulary Querying
...
#### [61] STAMICS: Splat, Track And Map with Integrated Consistency and Semantics for Dense RGB-D SLAM
...
#### [62] Frequency-Aware Gaussian Splatting Decomposition
...
#### [63] TC-GS: Tri-plane based compression for 3D Gaussian Splatting
...
#### [64] High-Quality Spatial Reconstruction and Orthoimage Generation Using Efficient 2D Gaussian Splatting
...
#### [65] SparseGS-W: Sparse-View 3D Gaussian Splatting in the Wild with Generative Priors
...
#### [66] Divide-and-Conquer: Dual-Hierarchical Optimization for Semantic 4D Gaussian Spatting
...
#### [67] MATT-GS: Masked Attention-based 3DGS for Robot Perception and Object Detection
...
#### [68] GS-Marker: Generalizable and Robust Watermarking for 3D Gaussian Splatting
...
#### [69] LLGS: Unsupervised Gaussian Splatting for Image Enhancement and Reconstruction in Pure Dark Environment
...
#### [70] StableGS: A Floater-Free Framework for 3D Gaussian Splatting
...
#### [71] ReconDreamer++: Harmonizing Generative and Reconstructive Models for Driving Scene Representation
...
#### [72] GI-SLAM: Gaussian-Inertial SLAM
...
#### [73] Unraveling the Effects of Synthetic Data on End-to-End Autonomous Driving
...
#### [74] PanopticSplatting: End-to-End Panoptic Gaussian Splatting
...
#### [75] SceneSplat: Gaussian Splatting-based Scene Understanding with Vision-Language Pretraining
...
#### [76] Real-time Global Illumination for Dynamic 3D Gaussian Scenes
...
#### [77] GaussianFocus: Constrained Attention Focus for 3D Gaussian Splatting
...
#### [78] GS-LTS: 3D Gaussian Splatting-Based Adaptive Modeling for Long-Term Service Robots
...
#### [79] Is there anything left? Measuring semantic residuals of objects removed from 3D Gaussian Splatting
...
#### [80] Splat-LOAM: Gaussian Splatting LiDAR Odometry and Mapping
...
#### [81] ProtoGS: Efficient and High-Quality Rendering with 3D Gaussian Prototypes
...
#### [82] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [83] Optimized Minimal 3D Gaussian Splatting
...
#### [84] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [86] GauRast: Enhancing GPU Triangle Rasterizers to Accelerate 3D Gaussian Splatting
...
#### [87] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [88] OccluGaussian: Occlusion-Aware Gaussian Splatting for Large Scene Reconstruction and Rendering
...
#### [89] Repurposing 2D Diffusion Models with Gaussian Atlas for 3D Generation
...
#### [90] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [91] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [92] Uncertainty-Aware Diffusion Guided Refinement of 3D Scenes
...
#### [93] CHROME: Clothed Human Reconstruction with Occlusion-Resilience and Multiview-Consistency from a Single Image
...
#### [94] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [95] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [96] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [97] SplatVoxel: History-Aware Novel View Streaming without Temporal Training
...
#### [98] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [99] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [100] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [101] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [102] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [103] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [104] DeGauss: Dynamic-Static Decomposition with Gaussian Splatting for Distractor-free 3D Reconstruction
...
#### [105] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [106] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [107] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [108] Deblur Gaussian Splatting SLAM
...
#### [109] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [110] MTGS: Multi-Traversal Gaussian Splatting
...
#### [111] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [112] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [113] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [114] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [115] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [116] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [117] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [118] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [119] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [120] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [121] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [122] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [123] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [124] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [125] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [126] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
...
#### [127] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [128] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [129] 3D Student Splatting and Scooping
...
#### [130] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [131] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [132] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [133] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [135] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [136] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [137] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [138] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [139] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [140] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [141] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [142] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [143] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [144] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [145] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [146] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [147] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [148] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [149] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [150] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [151] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [152] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [153] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [154] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [155] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [156] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [157] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zexu Huang, Min Xu, Stuart Perry
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2503.06462.md)] [[arXiv:2503.06462](https://arxiv.org/abs/2503.06462)] [Code]
- **📝 说明**：

#### [158] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [159] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [160] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [161] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [162] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [163] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [164] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [165] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [166] Self-Modeling Robots by Photographing
...
#### [167] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [168] STGA: Selective-Training Gaussian Head Avatars
...
#### [169] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [170] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [171] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [172] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [173] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [174] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [175] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [176] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [177] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [178] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [179] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [180] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [181] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [182] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [183] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [184] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [185] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [186] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [187] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [188] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [189] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [190] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [191] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [192] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [193] Seeing A 3D World in A Grain of Sand
...
#### [194] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [195] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [196] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [197] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [198] LUCAS: Layered Universal Codec Avatars
...
#### [199] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [200] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [201] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [202] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [203] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [204] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [205] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [206] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [207] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [208] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [209] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [210] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [211] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [212] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [213] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [214] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [215] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [216] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [217] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [218] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [219] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [220] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [221] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [222] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [223] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [224] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [225] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [226] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [227] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [228] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [229] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [230] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [231] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [232] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [233] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [234] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [235] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [236] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [237] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [238] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [239] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [241] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [242] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [243] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [244] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [245] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [246] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [247] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [248] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [249] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [250] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [251] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [252] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [253] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [254] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [255] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [256] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [257] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [258] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [259] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [260] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [261] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [262] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [263] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [264] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [265] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [266] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [267] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [268] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [269] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [270] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [271] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [272] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [273] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [274] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [275] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [276] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [277] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [278] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [279] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [280] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [281] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [282] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [283] Gaussian Masked Autoencoders
...
#### [284] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [285] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [286] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [287] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [288] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [289] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [290] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [291] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [292] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [293] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [294] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [295] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [296] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [297] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [298] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [299] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [300] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [301] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [302] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [303] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [304] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [305] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [306] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [307] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [308] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [309] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [310] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [311] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [312] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [313] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [314] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [315] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [316] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [317] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [318] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [319] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [320] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [321] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [322] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [323] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [324] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [325] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [326] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [327] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [328] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [329] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [330] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [331] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [332] EOGS: Gaussian Splatting for Earth Observation
...
#### [333] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [334] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [335] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [336] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [337] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [338] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [339] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [340] Deformable Radial Kernel Splatting
...
#### [341] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [342] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [343] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [344] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [345] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [346] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [347] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [348] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [349] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [350] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [351] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [352] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [353] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [354] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [355] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [356] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [357] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [358] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [359] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [360] Faster and Better 3D Splatting via Group Training
...
#### [361] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [362] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [363] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [364] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [365] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [366] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [367] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [368] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [369] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [370] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [371] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [372] Street Gaussians without 3D Object Tracker
...
#### [373] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [374] Extrapolated Urban View Synthesis Benchmark
...
#### [375] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [376] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [377] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [378] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [379] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [380] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [381] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [382] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [383] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [384] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [385] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [386] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [387] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [388] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [389] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [390] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [391] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [392] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [393] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [394] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [395] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [396] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [397] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [398] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [399] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [400] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [401] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [402] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [403] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [404] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [405] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [406] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [407] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [408] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [409] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [410] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [411] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [412] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [413] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [414] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [415] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [416] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [417] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [418] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [419] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [420] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [421] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [422] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [423] Neural Surface Priors for Editable Gaussian Splatting
...
#### [424] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [425] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [426] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [427] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [428] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [429] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [430] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [431] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [432] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [433] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [434] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [435] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [436] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [437] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [438] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [439] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [440] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [441] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [442] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [443] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [444] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [445] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [446] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [447] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [448] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [449] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [450] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [451] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [452] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [453] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [454] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [455] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [456] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [457] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [458] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [459] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [460] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [461] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [462] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [463] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [464] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [465] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [466] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [467] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [468] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [469] VeGaS: Video Gaussian Splatting
...
#### [470] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [471] Efficient Density Control for 3D Gaussian Splatting
...
#### [472] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [473] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [474] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [475] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [476] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [477] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [478] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [479] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [480] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [481] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [482] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [483] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [484] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [485] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [486] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [487] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [488] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [489] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [490] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [491] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [492] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [493] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [494] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [495] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [496] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [497] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [498] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [499] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [500] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [501] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [502] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [503] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [504] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [505] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [506] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [507] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [508] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [509] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [510] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [511] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [512] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [513] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [514] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [515] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [516] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [517] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [518] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [519] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [520] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [521] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [526] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [527] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [528] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [529] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [530] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [542] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [543] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [544] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [545] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [546] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [547] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [548] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [549] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [550] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [551] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [552] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [553] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [554] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [555] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [556] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [557] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [558] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [559] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [560] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [561] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [562] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [563] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [564] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [565] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [566] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [567] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [568] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [569] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [570] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [571] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [572] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [573] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [576] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [577] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [578] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [579] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [580] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [581] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [582] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [583] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [584] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [585] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [586] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [587] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [588] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [589] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [590] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [591] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [592] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [593] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [594] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [595] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [596] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [597] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [598] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [599] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [600] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [601] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [602] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [603] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [604] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [605] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [606] G-Style: Stylized Gaussian Splatting
...
#### [607] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [608] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [609] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [610] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [611] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [612] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [613] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [614] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [615] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [616] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [617] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [618] Subsurface Scattering for 3D Gaussian Splatting
...
#### [619] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [620] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [621] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [622] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [623] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [624] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [625] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [626] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [627] 3D Gaussian Editing with A Single Image
...
#### [628] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [629] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [630] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [631] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [632] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [633] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [634] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [635] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [636] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [637] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [638] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [639] IG-SLAM: Instant Gaussian SLAM
...
#### [640] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [641] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [642] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [643] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [644] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [645] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [646] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [647] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [648] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [649] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [650] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [651] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [652] Gaussian Splatting Lucas-Kanade
...
#### [653] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [654] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [655] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [656] PICA: Physics-Integrated Clothed Avatar
...
#### [657] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [659] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [660] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [661] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [662] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [663] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [664] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [665] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [666] Lightweight Predictive 3D Gaussian Splats
...
#### [667] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [668] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [669] On Scaling Up 3D Gaussian Splatting Training
...
#### [670] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [671] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [672] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [673] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [674] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [675] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [676] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [677] E2GS: Event Enhanced Gaussian Splatting
...
#### [678] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [679] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [680] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [681] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [682] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [683] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [684] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [685] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [686] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [687] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [688] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [689] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [690] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [691] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [692] Localized Gaussian Point Management
...
#### [693] Gaussian Representation for Deformable Image Registration
...
#### [694] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [695] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [696] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [697] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [698] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [699] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [700] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
