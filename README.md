...
#### [2] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [3] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [4] SC-OmniGS: Self-Calibrating Omnidirectional Gaussian Splatting
...
#### [5] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [6] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [7] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [8] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [10] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [11] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [13] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [14] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [16] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [17] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [18] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [19] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [20] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [22] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [23] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [24] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [25] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [26] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [27] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [28] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [29] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [30] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [31] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [32] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [33] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [34] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [35] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [36] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [37] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [38] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [39] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [40] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [41] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [42] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [43] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [44] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [45] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [46] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [47] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [48] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [49] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [50] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [51] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [52] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [53] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [54] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [55] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [56] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [57] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [58] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [59] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [60] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [61] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [62] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [63] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [64] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [65] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [66] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [67] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [68] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [69] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [70] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [71] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [72] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [73] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [74] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [75] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [76] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [77] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [78] Gaussian Masked Autoencoders
...
#### [79] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [80] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [81] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [82] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [83] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [84] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [85] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [86] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [87] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [88] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [89] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [90] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [91] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [92] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [93] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [94] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [100] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [101] Reflective Gaussian Splatting
...
#### [102] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [103] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [104] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [105] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [106] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [107] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [108] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [109] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [110] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [111] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [112] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [113] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [114] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [115] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [116] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [117] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [118] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [119] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [120] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [121] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [122] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [123] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [124] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [125] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [126] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [127] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [128] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [129] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [130] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [131] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [132] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [133] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [134] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [135] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [136] EOGS: Gaussian Splatting for Earth Observation
...
#### [137] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [138] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [139] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [140] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [141] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [142] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [143] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [144] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [145] Deformable Radial Kernel Splatting
...
#### [146] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [147] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [148] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [149] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [150] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [151] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [152] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [153] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [154] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [155] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [156] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [157] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [158] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [159] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [160] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [161] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [162] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [163] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [164] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [165] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [166] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [167] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [168] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [169] GASP: Gaussian Avatars with Synthetic Priors
...
#### [170] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [171] Faster and Better 3D Splatting via Group Training
...
#### [172] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [173] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [174] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [175] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [176] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [177] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [178] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [179] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [180] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [181] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [182] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [183] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [184] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [185] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [186] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [187] Street Gaussians without 3D Object Tracker
...
#### [188] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [189] Extrapolated Urban View Synthesis Benchmark
...
#### [190] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [191] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [192] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [193] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [194] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [195] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [196] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [197] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [198] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [199] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [200] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [201] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [202] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [203] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [204] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [205] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [206] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [207] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [208] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [209] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [210] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [211] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [212] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [213] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [214] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [215] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [216] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [217] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [218] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [219] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [220] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [221] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [222] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [223] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [224] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [225] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [226] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [227] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [228] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [229] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [230] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [231] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [232] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [233] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [234] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [235] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [236] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [237] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [238] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [239] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [240] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [241] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [242] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [243] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [244] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [245] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [246] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [247] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [249] Neural Surface Priors for Editable Gaussian Splatting
...
#### [250] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [251] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [252] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [253] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [254] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [255] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [256] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [257] Geometry Field Splatting with Gaussian Surfels
...
#### [258] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [259] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [260] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [261] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [262] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [263] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [264] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [265] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [266] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [267] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [268] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [269] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [270] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [271] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [272] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [273] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [274] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [275] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [276] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [277] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [278] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [279] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [280] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [281] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [282] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [283] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [284] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [285] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [286] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [287] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [288] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [289] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [290] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [291] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [292] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [293] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [294] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [295] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [296] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [297] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [298] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [299] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [300] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [301] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [302] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [303] VeGaS: Video Gaussian Splatting
...
#### [304] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [305] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [306] Efficient Density Control for 3D Gaussian Splatting
...
#### [307] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [308] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [309] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [310] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [311] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [312] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [313] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [314] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [315] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [316] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [317] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [318] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [319] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [320] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [321] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [322] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [323] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [324] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [325] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [326] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [327] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [328] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [329] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [330] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [331] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [332] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [333] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [334] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [335] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [336] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [337] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [338] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [339] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [340] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [341] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [342] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [343] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [344] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [345] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [346] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [347] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [348] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [349] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [350] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [351] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [352] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [353] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [354] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [355] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [356] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [357] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [358] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [359] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [360] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [361] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [362] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [363] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [364] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [365] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [366] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [367] 3D Vision-Language Gaussian Splatting
...
#### [368] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [369] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [370] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [371] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [372] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [373] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [374] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [375] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [376] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [377] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [378] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [379] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [380] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [381] Variational Bayes Gaussian Splatting
...
#### [382] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [383] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [384] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [385] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [386] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [387] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [388] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [389] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [390] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [391] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [392] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [393] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [394] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [395] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [396] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [397] RNG: Relightable Neural Gaussians
...
#### [398] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [399] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [400] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [401] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [402] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [403] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [404] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [405] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [406] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [407] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [408] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [409] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [410] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [411] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [412] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [413] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [414] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [415] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [416] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [417] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [418] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [419] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [420] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [421] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [422] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [423] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [424] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [425] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [426] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [427] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [428] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [429] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [430] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [431] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [432] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [433] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [434] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [435] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [436] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [437] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [438] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [439] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [440] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [441] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [442] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [443] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [444] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [445] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [446] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [447] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [448] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [449] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [450] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [451] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [452] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [453] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [454] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [455] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [456] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [457] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [458] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [459] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [460] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [461] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [462] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [463] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [464] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [465] OmniRe: Omni Urban Scene Reconstruction
...
#### [466] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [467] G-Style: Stylized Gaussian Splatting
...
#### [468] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [469] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [470] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [471] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [472] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [473] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [474] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [475] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [476] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [477] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [478] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [479] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [480] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [481] Subsurface Scattering for 3D Gaussian Splatting
...
#### [482] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [483] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [484] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [485] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [486] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [487] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [488] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [489] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [490] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [491] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [492] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [493] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [494] 3D Gaussian Editing with A Single Image
...
#### [495] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [496] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [497] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [498] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [499] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [500] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [501] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [502] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [503] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [504] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [505] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [506] IG-SLAM: Instant Gaussian SLAM
...
#### [507] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [508] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [509] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [510] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [511] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [512] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [513] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [514] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [515] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [516] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [517] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [518] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [519] Gaussian Splatting Lucas-Kanade
...
#### [520] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [521] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [522] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [523] PICA: Physics-Integrated Clothed Avatar
...
#### [524] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [525] Gaussian Eigen Models for Human Heads
...
#### [527] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [528] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [529] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [530] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [531] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [532] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [533] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [534] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [535] Lightweight Predictive 3D Gaussian Splats
...
#### [536] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [537] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [538] On Scaling Up 3D Gaussian Splatting Training
...
#### [539] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [540] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [541] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [542] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [543] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [544] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [545] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [546] E2GS: Event Enhanced Gaussian Splatting
...
#### [547] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [548] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [549] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [550] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [551] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [552] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [553] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [554] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [555] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [556] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [557] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [558] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [559] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [560] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [561] Generalizable Human Gaussians from Single-View Image
...
#### [562] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [563] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [564] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [565] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [566] Localized Gaussian Point Management
...
#### [567] Gaussian Representation for Deformable Image Registration
...
#### [568] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [569] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [570] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [571] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [572] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [573] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [574] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [575] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [576] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
