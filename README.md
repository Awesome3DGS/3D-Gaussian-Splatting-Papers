...
- **2025**
  ...
  - [[CVPR](./2025/CVPR.md)] (157 篇)
    [[ICCV](./2025/ICCV.md)] (106 篇)
    [[ACM MM](./2025/ACMMM.md)] (21 篇)
    [[MICCAI](./2025/MICCAI.md)] (7 篇)
    [[SIGGRAPH](./2025/SIGGRAPH.md)] (31 篇)
  - [[ICML](./2025/ICML.md)] (7 篇)
    [[IROS](./2025/IROS.md)] (17 篇)
    [[ICME](./2025/ICME.md)] (8 篇)
    [[ICIP](./2025/ICIP.md)] (4 篇)
    [[BMVC](./2025/BMVC.md)] (3 篇)
  - [[NeurIPS](./2025/NeurIPS.md)] (28 篇)
    [[others](./2025/Accepted.md)] (94 篇)
...
#### [1] GS-Checker: Tampering Localization for 3D Gaussian Splatting
...
#### [2] Material-informed Gaussian Splatting for 3D World Reconstruction in a Digital Twin
...
#### [3] Active3D: Active High-Fidelity 3D Reconstruction via Hierarchical Uncertainty Quantification
...
#### [5] STAvatar: Soft Binding and Temporal Density Control for Monocular 3D Head Avatars Reconstruction
...
#### [6] Proxy-Free Gaussian Splats Deformation with Splat-Based Surface Estimation
...
#### [7] DensifyBeforehand: LiDAR-assisted Content-aware Densification for Efficient and Quality 3D Gaussian Splatting
...
#### [8] IDSplat: Instance-Decomposed 3D Gaussian Splatting for Driving Scenes
...
#### [9] NVGS: Neural Visibility for Occlusion Culling in 3D Gaussian Splatting
...
#### [10] MetroGS: Efficient and Stable Reconstruction of Geometrically Accurate High-Fidelity Large-Scale Scenes
...
#### [11] Neural Texture Splatting: Expressive 3D Gaussian Splatting for View Synthesis, Geometry, and Dynamic Reconstruction
...
#### [12] Splatonic: Architecture Support for 3D Gaussian Splatting SLAM via Sparse Processing
...
#### [13] NeAR: Coupled Neural Asset-Renderer Stack
...
#### [14] PhysGS: Bayesian-Inferred Gaussian Splatting for Physical Property Estimation
...
#### [15] ReCoGS: Real-time ReColoring for Gaussian Splatting scenes
...
#### [16] SegSplat: Feed-forward Gaussian Splatting and Open-Set Semantic Segmentation
...
#### [17] Observer Actor: Active Vision Imitation Learning with Sparse View Gaussian Splatting
...
#### [18] RoboArmGS: High-Quality Robotic Arm Splatting via Bézier Curve Refinement
...
#### [19] Novel View Synthesis from A Few Glimpses via Test-Time Natural Video Completion
...
#### [20] Frequency-Adaptive Sharpness Regularization for Improving 3D Gaussian Splatting Generalization
...
#### [21] CUS-GS: A Compact Unified Structured Gaussian Splatting Framework for Multimodal Scene Representation
...
#### [22] AEGIS: Preserving privacy of 3D Facial Avatars with Adversarial Perturbations
...
#### [23] FisheyeGaussianLift: BEV Feature Lifting for Surround-View Fisheye Camera Perception
...
#### [24] SING3R-SLAM: Submap-based Indoor Monocular Gaussian SLAM with 3D Reconstruction Priors
...
#### [25] PEGS: Physics-Event Enhanced Large Spatiotemporal Motion Reconstruction via 3D Gaussian Splatting
...
#### [26] SPAGS: Sparse-View Articulated Object Reconstruction from Single State via Planar Gaussian Splatting
...
#### [27] RoomPlanner: Explicit Layout Planner for Easier LLM-Driven 3D Room Generation
...
#### [28] PhysMorph-GS: Differentiable Shape Morphing via Joint Optimization of Physics and Rendering Objectives
...
#### [29] Gradient-Driven Natural Selection for Compact 3D Gaussian Splatting
...
#### [30] One Walk is All You Need: Data-Efficient 3D RF Scene Reconstruction with Human Movements
...
#### [31] Vorion: A RISC-V GPU with Hardware-Accelerated 3D Gaussian Rendering and Training
...
#### [32] TRIM: Scalable 3D Gaussian Diffusion Inference with Temporal and Spatial Trimming
...
#### [33] EOGS++: Earth Observation Gaussian Splatting with Internal Camera Refinement and Direct Panchromatic Rendering
...
#### [34] Optimizing 3D Gaussian Splattering for Mobile GPUs
...
#### [35] LEGO-SLAM: Language-Embedded Gaussian Optimization SLAM
...
#### [36] Clustered Error Correction with Grouped 4D Gaussian Splatting
...
#### [37] Rad-GS: Radar-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [38] CuriGS: Curriculum-Guided Gaussian Splatting for Sparse View Synthesis
...
#### [39] Gaussian Blending: Rethinking Alpha Blending in 3D Gaussian Splatting
...
#### [40] Gaussian See, Gaussian Do: Semantic 3D Motion Transfer from Multiview Video
...
#### [41] SparseSurf: Sparse-View 3D Gaussian Splatting for Surface Reconstruction
...
#### [42] Interaction-Aware 4D Gaussian Splatting for Dynamic Hand-Object Interaction Reconstruction
...
#### [43] IBGS: Image-Based Gaussian Splatting
...
#### [44] Dental3R: Geometry-Aware Pairing for Intraoral 3D Reconstruction from Sparse-View Photographs
...
#### [45] GEN3D: Generating Domain-Free 3D Scenes from a Single Image
...
#### [46] iGaussian: Real-Time Camera Pose Estimation via Feed-Forward 3D Gaussian Splatting Inversion
...
- **📝 说明**: 🏆 Accepted to IROS 2026

#### [47] Training-Free Multi-View Extension of IC-Light for Textual Position-Aware Scene Relighting
...
#### [48] Opt3DGS: Optimizing 3D Gaussian Splatting with Adaptive Exploration and Curvature-Aware Exploitation
...
#### [49] SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting
...
#### [50] SymGS : Leveraging Local Symmetries for 3D Gaussian Splatting Compression
...
#### [51] Monocular 3D Lane Detection via Structure Uncertainty-Aware Network with Curve-Point Queries
...
#### [52] Beyond Darkness: Thermal-Supervised 3D Gaussian Splatting for Low-Light Novel View Synthesis
...
#### [53] TR-Gaussians: High-fidelity Real-time Rendering of Planar Transmission and Reflection with 3D Gaussian Splatting
...
#### [54] SplatSearch: Instance Image Goal Navigation for Mobile Robots using 3D Gaussian Splatting and Diffusion Models
...
#### [55] GUIDE: Gaussian Unified Instance Detection for Enhanced Obstacle Perception in Autonomous Driving
...
#### [56] Neo: Real-Time On-Device 3D Gaussian Splatting with Reuse-and-Update Sorting Acceleration
...
#### [57] Reconstructing 3D Scenes in Native High Dynamic Range
...
#### [58] Changes in Real Time: Online Scene Change Detection with Multi-View Fusion
...
#### [59] SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images
...
#### [60] 3D Gaussian and Diffusion-Based Gaze Redirection
...
#### [61] RealisticDreamer: Guidance Score Distillation for Few-shot Gaussian Splatting
...
#### [62] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
...
#### [63] Depth-Consistent 3D Gaussian Splatting via Physical Defocus Modeling and Multi-View Geometric Supervision
...
#### [64] Multivariate Gaussian Representation Learning for Medical Action Evaluation
...
#### [65] TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting
...
#### [66] AHA! Animating Human Avatars in Diverse Scenes with Gaussian Splatting
...
#### [67] Lumos3D: A Single-Forward Framework for Low-Light 3D Scene Restoration
...
#### [68] OUGS: Active View Selection via Object-aware Uncertainty Estimation in 3DGS
...
#### [69] SkelSplat: Robust Multi-view 3D Human Pose Estimation with Differentiable Gaussian Rendering
...
#### [70] Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric
...
#### [71] YoNoSplat: You Only Need One Model for Feedforward 3D Gaussian Splatting
...
#### [72] 4DSTR: Advancing Generative 4D Gaussians with Spatial-Temporal Rectification for High-Quality and Consistent 4D Generation
...
#### [73] GFix: Perceptually Enhanced Gaussian Splatting Video Compression
...
#### [74] MUGSQA: Novel Multi-Uncertainty-Based Gaussian Splatting Quality Assessment Method, Dataset, and Benchmarks
...
#### [75] ConeGS: Error-Guided Densification Using Pixel Cones for Improved Reconstruction with Fewer Primitives
...
#### [76] Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning
...
#### [77] DIAL-GS: Dynamic Instance Aware Reconstruction for Label-free Street Scenes with 4D Gaussian Splatting
...
#### [78] Inpaint360GS: Efficient Object-Aware 3D Inpainting via Gaussian Splatting for 360° Scenes
...
#### [79] Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field
...
#### [80] StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video
...
#### [81] 4D3R: Motion-Aware Neural Reconstruction and Rendering of Dynamic Scenes from Monocular Videos
...
#### [82] Efficient representation of 3D spatial data for defense-related applications
...
#### [84] Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions
...
#### [85] UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction
...
#### [86] FastGS: Training 3D Gaussian Splatting in 100 Seconds
...
#### [87] CaRF: Enhancing Multi-View Consistency in Referring 3D Gaussian Splatting Segmentation
...
#### [88] Improving Multi-View Reconstruction via Texture-Guided Gaussian-Mesh Joint Optimization
...
#### [90] PercHead: Perceptual Head Model for Single-Image 3D Head Reconstruction & Editing
...
#### [91] Object-Centric 3D Gaussian Splatting for Strawberry Plant Reconstruction and Phenotyping
...
#### [92] 3D Gaussian Radiation Field Modeling for Integrated RIS-FAS Systems: Analysis and Optimization
...
#### [93] 4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Guassian Splatting
...
#### [94] Diff4Splat: Controllable 4D Scene Generation with Latent Dynamic Reconstruction Models
...
#### [95] Object-Aware 4D Human Motion Generation
...
#### [96] SAGS: Self-Adaptive Alias-Free Gaussian Splatting for Dynamic Surgical Endoscopic Reconstruction
...
#### [97] AgriGS-SLAM: Orchard Mapping Across Seasons via Multi-View Gaussian Splatting SLAM
...
#### [98] 6D Channel Knowledge Map Construction via Bidirectional Wireless Gaussian Splatting
...
#### [99] JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting
...
#### [100] DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes
...
#### [101] NVSim: Novel View Synthesis Simulator for Large Scale Indoor Navigation
...
#### [102] LagMemo: Language 3D Gaussian Splatting Memory for Multi-modal Open-vocabulary Multi-goal Visual Navigation
...
#### [103] EndoWave: Rational-Wavelet 4D Gaussian Splatting for Endoscopic Reconstruction
...
#### [104] Gen-LangSplat: Generalized Language Gaussian Splatting with Pre-Trained Feature Compression
- **🧑‍🔬 作者**：Pranav Saxena
...
#### [105] Region-Adaptive Learned Hierarchical Encoding for 3D Gaussian Splatting Data
...
#### [106] LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering
...
#### [107] RoGER-SLAM: A Robust Gaussian Splatting SLAM System for Noisy and Low-light Environment Resilience
...
#### [108] DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss
...
#### [109] DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum
...
#### [110] Towards Physically Executable 3D Gaussian for Embodied Navigation
...
#### [111] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
#### [112] Extreme Views: 3DGS Filter for Novel View Synthesis from Out-of-Distribution Camera Poses
...
#### [113] Re-Activating Frozen Primitives for 3D Gaussian Splatting
...
#### [114] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [115] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [116] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [117] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [118] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [119] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [120] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [121] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [122] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [123] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [124] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [125] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [126] Terra: Explorable Native 3D World Model with Point Latents
...
#### [127] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [128] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [129] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [130] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [131] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [132] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [133] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [134] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [135] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [136] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [137] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [138] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [139] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [140] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [141] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [142] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [143] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [144] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [145] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [146] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [147] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [148] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [149] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [150] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [151] ReSplat: Learning Recurrent Gaussian Splats
...
#### [152] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [153] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [154] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [155] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [156] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [157] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [158] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [159] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [160] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [161] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [162] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [164] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [165] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [166] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [167] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [168] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [169] HART: Human Aligned Reconstruction Transformer
...
#### [170] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [171] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [172] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [173] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [174] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [176] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [177] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [178] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [179] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [180] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [181] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [182] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [183] Learning Unified Representation of 3D Gaussian Splatting
...
#### [184] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [185] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [186] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [187] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [188] Large Material Gaussian Model for Relightable 3D Generation
...
#### [189] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [190] 4D Driving Scene Generation With Stereo Forcing
...
#### [191] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [192] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
...
#### [200] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [201] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [202] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [203] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [204] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
- **🧑‍🔬 作者**：Ranran Huang, Krystian Mikolajczyk
- **🏫 单位**：Imperial College London
- **🔗 链接**：[[中英摘要](./abs/2509.17246.md)] [[arXiv:2509.17246](https://arxiv.org/abs/2509.17246)] [Code]
- **📝 说明**:

#### [205] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [206] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
...
#### [207] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [208] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [209] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [210] Camera Splatting for Continuous View Optimization
...
#### [211] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [212] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [213] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [214] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [215] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [216] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [217] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [218] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [219] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [220] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [221] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [222] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [223] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [224] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [225] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [226] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [227] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [228] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [229] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [230] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [231] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [232] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [233] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [234] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [235] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [236] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [237] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [238] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [239] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [240] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [241] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [242] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [243] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [244] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [245] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [246] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [247] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [248] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [249] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [250] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [251] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [252] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [253] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [254] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [255] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [256] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [257] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [258] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [259] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [260] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [261] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [262] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [263] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [264] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [265] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [266] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [267] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [268] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [269] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [270] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [271] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [272] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [273] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [274] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [275] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [276] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [277] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [278] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [279] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [280] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [281] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [282] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [283] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [284] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [285] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [286] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [287] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [288] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [289] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [290] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [291] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [292] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [293] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [294] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [295] SAGOnline: Segment Any Gaussians Online
...
#### [296] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [297] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [298] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [299] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [300] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [301] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [302] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [303] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [304] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [305] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [306] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [307] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [308] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [309] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [310] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [311] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [312] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [313] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [314] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [315] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [316] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [317] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [318] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [319] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [320] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [321] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [323] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [324] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [325] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [326] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [327] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [328] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [329] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [330] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [331] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [332] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [333] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [334] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [335] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [336] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [337] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [338] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [339] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [340] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [341] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [342] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [343] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [344] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [345] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [346] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [347] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [348] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [349] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [350] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [351] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [352] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [353] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [354] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [355] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [356] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [357] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [358] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [359] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [360] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [361] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [362] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [363] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [364] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [365] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [366] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [367] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [368] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [369] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [370] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [371] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [372] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [373] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [374] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [375] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [376] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [377] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [378] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [379] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [380] Masks make discriminative models great again!
...
#### [381] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [382] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [383] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
