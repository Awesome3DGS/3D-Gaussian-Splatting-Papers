...
#### [10] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [11] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [12] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [13] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [14] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [15] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [16] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**: Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [17] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [18] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [19] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [20] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [21] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [22] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [23] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [24] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [25] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [26] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [27] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [28] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**: The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [29] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [30] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [31] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [32] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [33] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [34] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [35] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [36] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [37] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [38] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [39] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [40] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [41] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [42] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [43] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [44] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [45] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [46] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [47] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [48] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [49] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [50] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [51] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [52] Gaussian Masked Autoencoders
...
#### [53] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [54] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [55] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [56] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [57] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [58] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [59] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [60] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [61] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [62] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [63] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [64] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [65] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [66] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [67] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [68] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [69] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [70] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [71] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [72] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [73] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [74] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [75] Reflective Gaussian Splatting
...
#### [76] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [77] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [78] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [79] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [80] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [81] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [82] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [83] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [84] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [85] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [86] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [87] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [88] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [89] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [90] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [91] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [92] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [93] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [94] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [95] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [96] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [97] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [98] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [99] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [100] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [101] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [102] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [103] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [104] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [105] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [106] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [107] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [108] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [109] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [110] EOGS: Gaussian Splatting for Earth Observation
...
#### [111] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [112] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [113] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [114] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [115] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [116] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [117] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [118] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [119] Deformable Radial Kernel Splatting
...
#### [120] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [121] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [122] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [123] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [124] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [125] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [126] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [127] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [128] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [129] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [130] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [131] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [132] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [133] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [134] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [135] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [136] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [137] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [138] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [139] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [140] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [141] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [142] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [143] GASP: Gaussian Avatars with Synthetic Priors
...
#### [144] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [145] Faster and Better 3D Splatting via Group Training
...
#### [146] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [147] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [148] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [149] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [150] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [151] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [152] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [153] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [154] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [155] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [156] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [157] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [158] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [159] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [160] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [161] Street Gaussians without 3D Object Tracker
...
#### [162] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [163] Extrapolated Urban View Synthesis Benchmark
...
#### [164] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [165] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [166] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [167] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [168] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [169] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [170] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [171] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [172] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [173] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [174] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [175] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [176] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [177] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [178] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [179] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [180] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [181] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [182] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [183] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [184] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [185] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [186] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [187] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [188] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [189] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [190] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [191] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [192] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [193] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [194] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [195] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [196] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [197] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [198] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [199] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [200] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [201] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [202] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [203] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [204] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [205] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [206] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [207] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [208] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [209] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [210] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [211] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [212] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [213] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [214] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [215] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [216] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [217] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [218] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [219] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [220] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [221] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [222] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [223] Neural Surface Priors for Editable Gaussian Splatting
...
#### [224] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [225] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [226] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [227] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [228] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [229] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [230] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [231] Geometry Field Splatting with Gaussian Surfels
...
#### [232] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [233] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [234] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [235] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [236] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [237] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [238] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [239] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [240] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [241] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [242] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [243] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [244] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [245] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [246] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [247] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [248] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [249] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [250] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [251] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [252] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [253] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [254] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [255] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [256] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [257] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [258] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [259] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [260] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [261] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [262] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [263] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [264] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [265] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [266] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [267] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [268] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [269] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [270] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [271] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [272] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [273] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [274] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [275] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [276] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [277] VeGaS: Video Gaussian Splatting
...
#### [278] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [279] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [280] Efficient Density Control for 3D Gaussian Splatting
...
#### [281] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [282] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [283] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [284] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [285] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [286] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [287] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [288] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [289] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [290] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [291] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [292] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [293] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [294] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [295] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [296] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [297] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [298] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [299] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [300] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [301] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [302] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [303] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [304] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [305] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [306] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [307] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [308] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [309] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [310] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [311] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [312] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [313] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [314] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [315] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [316] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [317] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [318] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [319] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [320] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [321] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [322] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [323] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [324] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [325] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [326] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [327] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [328] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [329] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [330] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [331] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [332] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [333] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [334] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [335] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [336] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [337] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [338] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [339] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [340] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [341] 3D Vision-Language Gaussian Splatting
...
#### [342] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [343] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [344] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [345] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [346] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [347] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [348] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [349] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [350] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [351] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [352] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [353] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [354] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [355] Variational Bayes Gaussian Splatting
...
#### [356] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [357] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [358] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [359] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [360] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [361] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [362] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [363] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [364] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [365] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [366] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [367] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [368] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [369] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [370] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [371] RNG: Relightable Neural Gaussians
...
#### [372] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [373] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [374] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [375] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [376] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [377] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [378] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [379] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [380] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [381] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [382] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [383] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [384] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [385] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [386] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [387] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [388] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [389] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [390] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [391] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [392] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [393] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [394] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [395] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [396] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [397] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [398] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [399] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [400] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [401] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [402] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [403] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [404] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [405] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [406] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [407] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [408] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [409] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [410] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [411] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [412] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [413] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [414] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [415] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [416] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [417] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [418] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [419] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [420] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [421] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [422] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [423] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [424] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [425] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [426] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [427] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [428] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [429] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [430] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [431] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [432] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [433] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [434] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [435] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [436] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [437] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [438] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [439] OmniRe: Omni Urban Scene Reconstruction
...
#### [440] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [441] G-Style: Stylized Gaussian Splatting
...
#### [442] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [443] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [444] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [445] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [446] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [447] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [448] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [449] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [450] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [451] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [452] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [453] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [454] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [455] Subsurface Scattering for 3D Gaussian Splatting
...
#### [456] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [457] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [458] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [459] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [460] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [461] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [462] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [463] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [464] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [465] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [466] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [467] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [468] 3D Gaussian Editing with A Single Image
...
#### [469] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [470] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [471] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [472] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [473] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [474] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [475] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [476] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [477] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [478] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [479] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [480] IG-SLAM: Instant Gaussian SLAM
...
#### [481] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [482] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [483] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [484] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [485] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [486] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [487] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [488] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [489] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [490] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [491] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [492] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [493] Gaussian Splatting Lucas-Kanade
...
#### [494] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [495] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [496] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [497] PICA: Physics-Integrated Clothed Avatar
...
#### [498] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [499] Gaussian Eigen Models for Human Heads
...
#### [501] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [502] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [503] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [504] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [505] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [506] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [507] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [508] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [509] Lightweight Predictive 3D Gaussian Splats
...
#### [510] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [511] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [512] On Scaling Up 3D Gaussian Splatting Training
...
#### [513] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [514] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [515] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [516] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [517] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [518] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [519] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [520] E2GS: Event Enhanced Gaussian Splatting
...
#### [521] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [522] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [523] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [524] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [525] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [526] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [527] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [528] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [529] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [530] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [531] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [532] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [533] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [534] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [535] Generalizable Human Gaussians from Single-View Image
...
#### [536] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [537] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [538] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [539] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [540] Localized Gaussian Point Management
...
#### [541] Gaussian Representation for Deformable Image Registration
...
#### [542] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [543] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [544] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [545] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [546] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [547] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [548] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [549] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [550] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
