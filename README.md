...
#### [1] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [2] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [6] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [7] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [8] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [9] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [10] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [11] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [12] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [13] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [14] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [15] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [16] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [17] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [18] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [19] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [20] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
#### [21] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [22] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [23] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [24] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [25] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [26] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [27] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [28] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [29] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [30] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [31] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [32] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [33] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [34] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [35] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [36] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [37] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [38] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [39] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [40] LiDAR-enhanced 3D Gaussian Splatting Mapping
- **🧑‍🔬 作者**：Jian Shen, Huai Yu, Ji Wu, Wen Yang, Gui-Song Xia
...
#### [41] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [42] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [43] STGA: Selective-Training Gaussian Head Avatars
...
#### [44] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [45] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [46] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [47] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [48] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [49] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [50] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [51] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [52] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [53] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [54] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [55] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [56] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [57] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [58] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [59] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [60] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [61] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [62] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [63] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [64] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [65] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [66] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [67] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [68] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [69] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [70] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [71] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [72] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [73] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [74] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [75] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [76] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [77] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [78] Seeing A 3D World in A Grain of Sand
...
#### [79] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [80] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [81] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [82] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [83] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [84] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [85] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [86] LUCAS: Layered Universal Codec Avatars
...
#### [87] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [88] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [89] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [90] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [91] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [92] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [93] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [94] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [95] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [96] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [97] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [98] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [99] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [100] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [101] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [102] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [103] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [104] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [105] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [106] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [107] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [108] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [109] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [110] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [111] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [112] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [113] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [114] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [115] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [116] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [117] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [118] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [119] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [120] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [121] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [122] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [123] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [124] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [125] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [126] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [127] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [128] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [129] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [130] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [131] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [132] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [133] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [134] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [135] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [136] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [137] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [138] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [139] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [141] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [142] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [143] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [144] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [145] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [146] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [147] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [148] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [149] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [150] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [151] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [152] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [153] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [154] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [155] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [156] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [157] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [158] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [159] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [160] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [161] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [162] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [163] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [164] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [165] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [166] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [167] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [168] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [169] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [170] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [171] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [172] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [173] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [174] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [175] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [176] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [177] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [178] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [179] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [180] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [181] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [182] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [183] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [184] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [185] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [186] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [187] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [188] Gaussian Masked Autoencoders
...
#### [189] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [190] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [191] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [192] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [193] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [194] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [195] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [196] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [197] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [198] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [199] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [200] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [201] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [202] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [203] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [204] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [205] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [206] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [207] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [208] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [209] Reflective Gaussian Splatting
...
#### [210] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [211] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [212] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [213] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [214] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [215] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [216] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [217] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [218] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [219] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [220] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [221] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [222] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [223] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [224] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [225] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [226] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [227] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [228] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [229] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [230] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [231] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [232] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [233] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [234] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [235] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [236] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [237] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [238] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [239] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [240] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [241] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [242] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [243] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [244] EOGS: Gaussian Splatting for Earth Observation
...
#### [245] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [246] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [247] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [248] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [249] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [250] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [251] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [252] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [253] Deformable Radial Kernel Splatting
...
#### [254] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [255] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [256] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [257] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [258] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [259] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [260] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [261] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [262] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [263] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [264] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [265] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [266] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [267] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [268] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [269] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [270] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [271] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [272] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [273] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [274] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [275] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [276] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [277] GASP: Gaussian Avatars with Synthetic Priors
...
#### [278] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [279] Faster and Better 3D Splatting via Group Training
...
#### [280] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [281] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [282] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [283] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [284] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [285] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [286] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [287] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [288] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [289] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [290] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [291] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [292] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [293] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [294] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [295] Street Gaussians without 3D Object Tracker
...
#### [296] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [297] Extrapolated Urban View Synthesis Benchmark
...
#### [298] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [299] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [300] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [301] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [302] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [303] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [304] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [305] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [306] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [307] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [308] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [309] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [310] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [311] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [312] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [313] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [314] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [315] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [316] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [317] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [318] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [319] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [320] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [321] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [322] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [323] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [324] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [325] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [326] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [327] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [328] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [329] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [330] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [331] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [332] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [333] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [334] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [335] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [336] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [337] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [338] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [339] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [340] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [341] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [342] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [343] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [344] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [345] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [346] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [347] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [348] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [349] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [350] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [351] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [352] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [353] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [354] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [355] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [356] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [357] Neural Surface Priors for Editable Gaussian Splatting
...
#### [358] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [359] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [360] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [361] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [362] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [363] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [364] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [365] Geometry Field Splatting with Gaussian Surfels
...
#### [366] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [367] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [368] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [369] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [370] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [371] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [372] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [373] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [374] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [375] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [376] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [377] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [378] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [379] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [380] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [381] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [382] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [383] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [384] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [385] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [386] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [387] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [388] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [389] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [390] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [391] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [392] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [393] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [394] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [395] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [396] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [397] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [398] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [399] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [400] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [401] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [402] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [403] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [404] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [405] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [406] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [407] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [408] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [409] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [410] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [411] VeGaS: Video Gaussian Splatting
...
#### [412] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [413] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [414] Efficient Density Control for 3D Gaussian Splatting
...
#### [415] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [416] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [417] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [418] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [419] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [420] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [421] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [422] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [423] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [424] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [425] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [426] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [427] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [428] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [429] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [430] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [431] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [432] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [433] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [434] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [435] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [436] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [437] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [438] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [439] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [440] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [441] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [442] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [443] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [444] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [445] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [446] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [447] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [448] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [449] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [450] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [451] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [452] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [453] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [454] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [455] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [456] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [457] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [458] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [459] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [460] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [461] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [462] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [463] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [464] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [465] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [466] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [467] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [468] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [469] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [470] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [471] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [472] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [473] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [474] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [475] 3D Vision-Language Gaussian Splatting
...
#### [476] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [477] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [478] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [479] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [480] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [481] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [482] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [483] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [484] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [485] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
- **🧑‍🔬 作者**：Zhongpai Gao, Benjamin Planche, Meng Zheng, Anwesa Choudhuri, Terrence Chen, Ziyan Wu
- **🏫 单位**：United Imaging Intelligence, Boston MA, USA
- **🔗 链接**：[[中英摘要](./abs/2410.04974.md)] [[arXiv:2410.04974](https://arxiv.org/abs/2410.04974)] [Code]
- **📝 说明**：

#### [486] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [487] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [488] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [489] Variational Bayes Gaussian Splatting
...
#### [490] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [491] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [492] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [493] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [494] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [495] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [496] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [497] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [498] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [499] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [500] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [501] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [502] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [503] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [504] RNG: Relightable Neural Gaussians
...
#### [505] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [506] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [507] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [508] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [509] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [510] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [511] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [512] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [513] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [514] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [515] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [516] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [517] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [518] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [519] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [520] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [521] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [522] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [523] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [524] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [525] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [526] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [527] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [528] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [529] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [530] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [531] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [532] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [533] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [534] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [535] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [536] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [537] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [538] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [539] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [540] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [541] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [542] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [543] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [544] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [545] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [546] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [547] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [548] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [549] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [550] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [551] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [552] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [553] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [554] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [555] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [556] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [557] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [558] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [559] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [560] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [561] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [562] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [563] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [564] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [565] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [566] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [567] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [568] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [569] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [570] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [571] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [572] OmniRe: Omni Urban Scene Reconstruction
...
#### [573] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [574] G-Style: Stylized Gaussian Splatting
...
#### [575] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [576] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [577] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [578] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [579] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [580] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [581] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [582] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [583] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [584] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [585] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [586] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [587] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [588] Subsurface Scattering for 3D Gaussian Splatting
...
#### [589] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [590] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [591] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [592] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [593] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [594] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [595] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [596] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [597] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [598] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [599] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [600] 3D Gaussian Editing with A Single Image
...
#### [601] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [602] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [603] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [604] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [605] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [606] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [607] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [608] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [609] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [610] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [611] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [612] IG-SLAM: Instant Gaussian SLAM
...
#### [613] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [614] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [615] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [616] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [617] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [618] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [619] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [620] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [621] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [622] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [623] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [624] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [625] Gaussian Splatting Lucas-Kanade
...
#### [626] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [627] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [628] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [629] PICA: Physics-Integrated Clothed Avatar
...
#### [630] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [631] Gaussian Eigen Models for Human Heads
...
#### [633] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [634] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [635] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [636] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [637] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [638] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [639] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [640] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [641] Lightweight Predictive 3D Gaussian Splats
...
#### [642] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [643] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [644] On Scaling Up 3D Gaussian Splatting Training
...
#### [645] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [646] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [647] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [648] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [649] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [650] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [651] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [652] E2GS: Event Enhanced Gaussian Splatting
...
#### [653] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [654] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [655] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [656] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [657] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [658] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [659] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [660] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [661] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [662] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [663] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [664] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [665] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [666] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [667] Generalizable Human Gaussians from Single-View Image
...
#### [668] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [669] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [670] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [671] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [672] Localized Gaussian Point Management
...
#### [673] Gaussian Representation for Deformable Image Registration
...
#### [674] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [675] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [676] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [677] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [678] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [679] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [680] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [681] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [682] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
