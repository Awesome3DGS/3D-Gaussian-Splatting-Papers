...
#### [1] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [2] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [5] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [6] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [7] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [9] Gaussian Splatting Lucas-Kanade
...
#### [10] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [11] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [12] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [13] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [14] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [15] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [16] PICA: Physics-Integrated Clothed Avatar
...
#### [17] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [20] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [21] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [22] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [23] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [24] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [25] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [26] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [27] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [28] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [29] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [30] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [31] Lightweight Predictive 3D Gaussian Splats
...
#### [32] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [33] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [34] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [35] On Scaling Up 3D Gaussian Splatting Training
...
#### [36] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [37] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [38] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [39] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [40] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [41] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [42] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [43] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [44] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [45] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [46] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [47] E2GS: Event Enhanced Gaussian Splatting
...
#### [48] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [49] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [50] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [51] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [52] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [53] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [54] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [55] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [56] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [57] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [58] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [59] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [60] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [61] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [62] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [63] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [64] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [65] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [66] From Chaos to Clarity: 3DGS in the Dark
...
#### [67] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [68] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [69] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [70] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [71] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [72] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [73] Generalizable Human Gaussians from Single-View Image
...
#### [74] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [75] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [76] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [77] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [78] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [79] Localized Gaussian Point Management
...
#### [80] Gaussian Representation for Deformable Image Registration
...
#### [81] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [82] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [83] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [84] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [85] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [86] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [87] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [88] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [89] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [90] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [91] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [92] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [93] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [94] Tetrahedron Splatting for 3D Generation
...
#### [95] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [96] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [97] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [98] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
