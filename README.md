...
#### [2] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [3] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [5] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [6] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [7] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [8] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [9] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [10] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [11] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [12] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [13] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [14] From Chaos to Clarity: 3DGS in the Dark
...
#### [15] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [16] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [17] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [19] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [20] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [21] Generalizable Human Gaussians from Single-View Image
...
#### [22] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [23] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [24] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [25] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [26] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [27] Localized Gaussian Point Management
...
#### [28] Superpoint Gaussian Splatting for Real-Time High-Fidelity Dynamic Scene Reconstruction
...
#### [29] Gaussian Representation for Deformable Image Registration
...
#### [30] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [31] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [32] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [33] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [34] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [35] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [36] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [37] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [38] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [39] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [40] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [41] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [42] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [43] Tetrahedron Splatting for 3D Generation
...
#### [44] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [45] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [46] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [48] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [49] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
