...
#### [1] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [3] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [4] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [5] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [6] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [8] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [9] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [10] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [12] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [13] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [14] Generalizable Human Gaussians from Single-View Image
...
#### [15] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [16] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [17] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [18] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [19] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [20] Localized Gaussian Point Management
...
#### [21] Superpoint Gaussian Splatting for Real-Time High-Fidelity Dynamic Scene Reconstruction
...
#### [22] Gaussian Representation for Deformable Image Registration
...
#### [23] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [24] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [25] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [26] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [27] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [28] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [29] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [30] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [33] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [34] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [35] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [36] Tetrahedron Splatting for 3D Generation
...
#### [37] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [38] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [39] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [40] SuperGaussian: Repurposing Video Models for 3D Super Resolution
...
#### [41] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [42] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
