...
#### [2] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [3] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [4] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [5] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [6] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [7] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [8] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [9] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [10] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [11] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [12] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [13] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [14] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [15] OmniRe: Omni Urban Scene Reconstruction
...
#### [16] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [17] G-Style: Stylized Gaussian Splatting
...
#### [18] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [19] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [20] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [21] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [22] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [23] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [24] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [25] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [26] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [28] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [29] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [30] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [31] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [32] Subsurface Scattering for 3D Gaussian Splatting
...
#### [33] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [34] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [35] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [36] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [37] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [38] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [39] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [40] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [41] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [42] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [43] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [44] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [45] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [46] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [47] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [48] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [49] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [50] 3D Gaussian Editing with A Single Image
...
#### [51] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [52] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [53] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [54] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [55] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [56] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [57] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [58] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [59] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [60] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [61] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [62] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [63] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [64] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [65] IG-SLAM: Instant Gaussian SLAM
...
#### [66] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [67] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [68] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [69] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [70] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [71] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [72] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [73] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [74] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [75] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [76] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [77] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [78] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [79] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [80] Gaussian Splatting Lucas-Kanade
...
#### [81] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [82] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [83] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [84] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [85] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [86] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [87] PICA: Physics-Integrated Clothed Avatar
...
#### [88] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [89] Gaussian Eigen Models for Human Heads
...
#### [91] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [92] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [93] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [94] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [95] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [96] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [97] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [98] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [100] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [101] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [102] Lightweight Predictive 3D Gaussian Splats
...
#### [103] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [104] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [105] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [106] On Scaling Up 3D Gaussian Splatting Training
...
#### [107] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [108] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [109] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [110] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [111] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [112] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [113] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [114] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [115] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [116] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [117] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [118] E2GS: Event Enhanced Gaussian Splatting
...
#### [119] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [120] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [121] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [122] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [123] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [124] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [125] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [126] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [127] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [128] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [129] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [130] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [131] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [132] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [133] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [134] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [135] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [136] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [137] From Chaos to Clarity: 3DGS in the Dark
...
#### [138] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [139] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [140] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [141] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [142] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [143] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [144] Generalizable Human Gaussians from Single-View Image
...
#### [145] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [146] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [147] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [148] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [149] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [150] Localized Gaussian Point Management
...
#### [151] Gaussian Representation for Deformable Image Registration
...
#### [152] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [153] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [154] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [155] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [156] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [157] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [158] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [159] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [160] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [161] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [162] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [163] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [164] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [165] Tetrahedron Splatting for 3D Generation
...
#### [166] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [167] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [168] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [169] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
