...
#### [1] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [2] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [3] 3iGS: Factorised Tensorial Illumination for 3D Gaussian Splatting
...
#### [4] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [5] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [8] IG-SLAM: Instant Gaussian SLAM
...
#### [9] EmoTalk3D: High-Fidelity Free-View Synthesis of Emotional 3D Talking Head
...
#### [10] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [11] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [12] Expressive Whole-Body 3D Gaussian Avatar
...
#### [13] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [14] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [15] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [16] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [17] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [18] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [19] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [20] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [21] PlacidDreamer: Advancing Harmony in Text-to-3D Generation
...
#### [22] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [23] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [24] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [25] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [26] Gaussian Splatting Lucas-Kanade
...
#### [27] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [28] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [29] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [30] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [31] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [32] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [33] PICA: Physics-Integrated Clothed Avatar
...
#### [34] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [35] Gaussian Eigen Models for Human Heads
...
#### [37] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [38] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [39] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [40] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [41] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [42] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [43] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [44] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [45] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [46] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [47] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [48] Lightweight Predictive 3D Gaussian Splats
...
#### [49] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [50] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [51] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [53] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [54] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [55] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [56] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [57] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [58] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [59] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [60] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [61] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [62] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [63] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [64] E2GS: Event Enhanced Gaussian Splatting
...
#### [65] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [66] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [67] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [68] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [69] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [70] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [71] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [72] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [73] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [74] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [75] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [76] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [77] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [78] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [79] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [80] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [81] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [82] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [83] From Chaos to Clarity: 3DGS in the Dark
...
#### [84] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [85] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [86] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [87] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [88] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [89] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [90] Generalizable Human Gaussians from Single-View Image
...
#### [91] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [92] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [93] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [94] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [95] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [96] Localized Gaussian Point Management
...
#### [97] Gaussian Representation for Deformable Image Registration
...
#### [98] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [99] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [100] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [101] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [102] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [103] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [104] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [105] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [106] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [107] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [108] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [109] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [110] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [111] Tetrahedron Splatting for 3D Generation
...
#### [112] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [113] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [114] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [115] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
