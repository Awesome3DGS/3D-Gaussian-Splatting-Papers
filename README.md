...
#### [1] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [2] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [5] 4DTAM: Non-Rigid Tracking and Mapping via Dynamic Surface Gaussians
...
#### [6] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [7] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [8] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [9] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [10] Hyperspectral Gaussian Splatting
...
#### [11] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [12] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [13] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [14] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [15] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [16] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
...
#### [17] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [18] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [19] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [20] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [21] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
...
#### [22] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [23] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [24] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [25] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [26] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [27] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [28] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [29] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [30] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [31] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [32] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [33] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [34] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [35] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [36] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [37] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [38] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [39] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [40] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [41] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [42] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [43] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [44] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [45] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [46] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [47] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [48] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [49] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [50] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [51] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [52] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [53] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [54] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [55] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [56] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [57] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [58] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [59] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [60] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [61] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [62] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [63] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [64] Large-Scale Gaussian Splatting SLAM
...
#### [65] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [66] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [67] Neural Video Compression using 2D Gaussian Splatting
...
#### [68] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [69] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [70] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [71] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [72] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [73] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [74] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [75] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [76] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [77] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [78] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [79] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [80] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [81] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [82] SignSplat: Rendering Sign Language via Gaussian Splatting
...
#### [83] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [84] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [85] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [86] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [87] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [88] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [89] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [90] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [91] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [92] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [93] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [94] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [95] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [96] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [97] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [98] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [99] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [100] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [101] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [102] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [103] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [104] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [105] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [106] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [107] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [108] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [109] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [110] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [111] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [112] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [113] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [114] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [115] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [116] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [119] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [120] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [121] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [122] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [123] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [124] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [125] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [126] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [127] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [128] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [129] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [130] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [131] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [132] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [133] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [134] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [135] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [136] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [137] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [138] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [139] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [140] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [141] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [142] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [143] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [144] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [145] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [146] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [147] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [148] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [149] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [150] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [151] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [152] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [153] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [154] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [155] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [156] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [157] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [158] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [159] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [160] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [161] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [162] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [163] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [164] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [165] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [166] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [167] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [168] Digital-twin imaging based on descattering Gaussian splatting
...
#### [169] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [170] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [171] BOGausS: Better Optimized Gaussian Splatting
...
#### [172] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [173] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [174] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [175] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [176] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [177] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [178] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [179] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
