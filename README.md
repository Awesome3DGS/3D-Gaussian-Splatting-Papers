...
#### [2] Gaussian Eigen Models for Human Heads
...
#### [5] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [6] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [7] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [8] VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors
...
#### [10] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [11] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [12] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [13] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [14] Learning 3D Gaussians for Extremely Sparse-View Cone-Beam CT Reconstruction
...
#### [15] EndoSparse: Real-Time Sparse View Synthesis of Endoscopic Scenes using Gaussian Splatting
...
#### [16] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [17] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [18] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [19] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [20] Lightweight Predictive 3D Gaussian Splats
...
#### [21] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [22] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [23] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [24] On Scaling Up 3D Gaussian Splatting Training
...
#### [25] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [26] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [27] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [28] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [29] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [30] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [31] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [32] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [34] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [35] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [36] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [37] E2GS: Event Enhanced Gaussian Splatting
...
#### [38] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [39] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [40] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [41] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [42] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [43] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [44] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [45] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [46] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [48] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [49] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [50] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [51] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [52] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [53] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [54] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [55] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [57] From Chaos to Clarity: 3DGS in the Dark
...
#### [58] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [59] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [60] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [61] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [62] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [63] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [64] Generalizable Human Gaussians from Single-View Image
...
#### [65] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [66] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [67] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [68] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [69] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [70] Localized Gaussian Point Management
...
#### [71] Gaussian Representation for Deformable Image Registration
...
#### [72] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [73] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [74] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [75] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [76] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [77] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [78] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [79] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [80] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [81] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [82] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [83] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [84] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [85] Tetrahedron Splatting for 3D Generation
...
#### [86] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [87] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [88] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [89] SuperGaussian: Repurposing Video Models for 3D Super Resolution
