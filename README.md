...
- **🔗 链接**：[[中英摘要](./abs/2412.04457.md)] [[arXiv:2412.04457](https://arxiv.org/abs/2412.04457)] [Code]
- **📝 说明**：
...
#### [8] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [9] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [10] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [11] NeRF and Gaussian Splatting SLAM in the Wild
...
#### [12] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [14] Gaussian Splatting Under Attack: Investigating Adversarial Noise in 3D Objects
...
#### [23] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [24] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [25] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [26] Diffusion Models with Anisotropic Gaussian Splatting for Image Inpainting
...
#### [27] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [28] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.01553.md)] [[arXiv:2412.01553](https://arxiv.org/abs/2412.01553)] [Code]
- **📝 说明**：

#### [29] GFreeDet: Exploiting Gaussian Splatting and Foundation Models for Model-free Unseen Object Detection in the BOP Challenge 2024
...
#### [39] Instant3dit: Multiview Inpainting for Fast Editing of 3D Objects
...
#### [40] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [41] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [42] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [43] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [44] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [45] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [46] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [47] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [48] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [49] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [50] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [51] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [52] AGS-Mesh: Adaptive Gaussian Splatting and Meshing with Geometric Priors for Indoor Room Reconstruction Using Smartphones
...
#### [53] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [54] Gaussians-to-Life: Text-Driven Animation of 3D Gaussian Splatting Scenes
...
#### [55] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [56] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [57] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [58] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [59] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [60] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [61] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [62] Neural Surface Priors for Editable Gaussian Splatting
...
#### [63] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [64] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [65] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [66] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [67] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [68] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [69] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [70] Geometry Field Splatting with Gaussian Surfels
...
#### [71] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [72] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [73] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [74] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [75] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [76] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [77] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [78] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [79] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [80] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [81] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [82] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [83] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [84] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [85] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [86] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [87] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [88] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [89] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [90] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [91] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [92] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [93] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [94] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [95] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [96] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [97] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [98] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [99] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [100] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [101] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [102] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [103] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [104] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [105] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [106] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [107] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [108] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [109] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [110] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [111] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [112] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [113] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [114] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [115] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [116] VeGaS: Video Gaussian Splatting
...
#### [117] Direct and Explicit 3D Generation from a Single Image
...
#### [118] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [119] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [120] Efficient Density Control for 3D Gaussian Splatting
...
#### [121] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
...
#### [122] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [123] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [124] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [125] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [126] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [127] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [128] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [129] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [130] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [131] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [132] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [133] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [134] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [135] Object and Contact Point Tracking in Demonstrations Using 3D Gaussian Splatting
...
#### [136] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [137] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [138] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [139] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [140] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [141] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [142] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [143] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [144] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [145] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [146] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [147] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [148] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [149] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
...
#### [150] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [151] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [152] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [153] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [154] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [155] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [156] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [157] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [158] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [159] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [160] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [161] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [162] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [163] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [164] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [165] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [166] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [167] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [169] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [170] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [171] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [173] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [176] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [177] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [178] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [179] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [180] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [181] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [182] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [183] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [210] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [211] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [212] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [213] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [214] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [215] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [216] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [217] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [218] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [219] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [220] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [221] RNG: Relightable Neural Gaussians
...
#### [222] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [223] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [224] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [225] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [226] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [227] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [228] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [229] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [230] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [231] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [232] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [233] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [234] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [235] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [236] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [237] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [238] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [239] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [240] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [241] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [242] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [243] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [244] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [245] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [246] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [247] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [248] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [249] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [250] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [251] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [252] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [253] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [254] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [255] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [256] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [257] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [258] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [259] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [260] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [261] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [262] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [263] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [264] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [265] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [266] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [267] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [268] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [269] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [270] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [271] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [272] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [273] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [274] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [275] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [276] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [277] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [278] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [279] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [280] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [281] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [282] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [283] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [284] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [285] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [286] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [287] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [288] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [289] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [290] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [291] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [292] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [293] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [294] OmniRe: Omni Urban Scene Reconstruction
...
#### [295] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [296] G-Style: Stylized Gaussian Splatting
...
#### [297] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [298] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [299] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [300] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [301] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [302] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [303] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [304] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [305] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [306] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [307] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [308] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [309] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [310] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [311] Subsurface Scattering for 3D Gaussian Splatting
...
#### [312] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [313] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [314] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [315] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [316] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [317] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [318] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [319] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [320] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [321] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [322] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [323] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [324] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [325] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [326] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [327] 3D Gaussian Editing with A Single Image
...
#### [328] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [329] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [330] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [331] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [332] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [333] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [334] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [335] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [336] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [337] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [338] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [339] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [340] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [341] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [342] IG-SLAM: Instant Gaussian SLAM
...
#### [343] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [344] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [345] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [346] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [347] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [348] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [349] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [350] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [351] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [352] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [353] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [354] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [355] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [356] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [357] Gaussian Splatting Lucas-Kanade
...
#### [358] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [359] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [360] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [361] PICA: Physics-Integrated Clothed Avatar
...
#### [362] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [363] Gaussian Eigen Models for Human Heads
...
#### [365] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [366] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [367] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [368] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [369] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [370] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [371] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [372] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [373] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [374] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [375] Lightweight Predictive 3D Gaussian Splats
...
#### [376] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [377] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [378] On Scaling Up 3D Gaussian Splatting Training
...
#### [379] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [380] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [381] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [382] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [383] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [384] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [385] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [386] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [387] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [388] E2GS: Event Enhanced Gaussian Splatting
...
#### [389] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [390] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [391] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [392] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [393] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [394] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [395] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [396] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [397] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [398] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [399] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [400] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [401] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [402] From Chaos to Clarity: 3DGS in the Dark
...
#### [403] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [404] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [405] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [406] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [407] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [408] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [409] Generalizable Human Gaussians from Single-View Image
...
#### [410] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [411] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [412] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [413] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [414] Localized Gaussian Point Management
...
#### [415] Gaussian Representation for Deformable Image Registration
...
#### [416] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
