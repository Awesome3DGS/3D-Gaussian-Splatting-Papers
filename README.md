...
#### [2] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [3] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [5] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [6] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [7] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [8] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [9] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [10] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [11] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [12] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [15] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [16] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [20] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [21] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [22] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [23] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [24] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [25] HART: Human Aligned Reconstruction Transformer
...
#### [26] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [27] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [28] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [29] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [30] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [31] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [32] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [33] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [34] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [36] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [37] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [38] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [39] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [40] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [41] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [42] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [43] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [44] Learning Unified Representation of 3D Gaussian Splatting
...
#### [45] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [46] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [47] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [48] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [49] Large Material Gaussian Model for Relightable 3D Generation
...
#### [50] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [51] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [52] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [53] 4D Driving Scene Generation With Stereo Forcing
...
#### [54] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [55] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [56] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [57] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
...
#### [58] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [59] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [60] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [61] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [62] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [63] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [64] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [66] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [67] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [68] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [69] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [70] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [71] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [72] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [73] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [74] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [75] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [76] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
...
#### [77] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [78] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [79] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [80] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [81] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [82] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [83] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [84] Camera Splatting for Continuous View Optimization
...
#### [85] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [86] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [87] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [88] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [89] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [90] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [91] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [92] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [93] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
...
#### [94] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [95] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [96] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [97] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [98] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [99] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [100] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [101] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [102] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [103] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [104] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [105] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [106] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [107] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [108] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [109] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [110] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [111] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [112] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [113] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [114] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [115] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [116] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [117] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [118] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [119] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [120] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [121] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [122] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [123] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [124] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [125] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [126] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [127] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [128] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [129] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [130] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [131] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [132] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [133] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [134] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [135] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [136] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [137] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [138] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [139] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [140] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [141] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [142] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [143] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [144] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [145] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [146] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [147] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [148] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [149] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [150] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [151] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [152] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [153] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [154] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [155] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [156] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [157] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [158] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [159] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [160] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [161] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [162] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [163] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [164] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [165] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [166] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [167] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [168] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [169] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [170] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [171] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [172] SAGOnline: Segment Any Gaussians Online
...
#### [173] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [174] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [175] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [176] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [177] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [178] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [179] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [180] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [181] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [182] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [183] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [184] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [185] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [186] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [187] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [188] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [189] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [190] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [191] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [192] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [193] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [194] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [195] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [196] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [197] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [198] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [199] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [200] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [201] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [202] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [203] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [204] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [205] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [206] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [207] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [208] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [209] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [210] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [211] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [212] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [213] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [214] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [215] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [216] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [217] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [218] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [219] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [220] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [221] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [222] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [223] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [224] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [225] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [226] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [227] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [228] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [229] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [230] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [231] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [232] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [233] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [234] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [235] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [236] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [237] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [238] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [239] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [240] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [241] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [242] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [243] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [244] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [245] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [246] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [247] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [248] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [249] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [250] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [251] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [252] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [253] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [254] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [255] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [256] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [257] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [258] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [259] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [260] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [261] Masks make discriminative models great again!
...
#### [262] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [263] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [264] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
