...
#### [1] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [2] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [3] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [4] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [5] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [6] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [7] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [8] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [9] SPHERE: Semantic-PHysical Engaged REpresentation for 3D Semantic Scene Completion
...
#### [10] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [11] AD-GS: Alternating Densification for Sparse-Input 3D Gaussian Splatting
...
#### [12] T2Bs: Text-to-Character Blendshapes via Video Generation
...
#### [13] On the Geometric Accuracy of Implicit and Primitive-based Representations Derived from View Rendering Constraints
...
#### [14] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [15] HairGS: Hair Strand Reconstruction based on 3D Gaussian Splatting
...
#### [16] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [17] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [18] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [19] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [20] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [21] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [22] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [23] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [24] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [25] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [26] Efficient Geometry Compression and Communication for 3D Gaussian Splatting Point Clouds
...
#### [27] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [28] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [29] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [30] Im2Haircut: Single-view Strand-based Hair Reconstruction for Human Avatars
...
#### [31] Towards Integrating Multi-Spectral Imaging with Gaussian Splatting
...
#### [32] GS-TG: 3D Gaussian Splatting Accelerator with Tile Grouping for Reducing Redundant Sorting while Preserving Rasterization Efficiency
...
#### [33] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [34] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [35] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [36] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [37] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [38] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [39] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [40] RadGS-Reg: Registering Spine CT with Biplanar X-rays via Joint 3D Radiative Gaussians Reconstruction and 3D/3D Registration
...
#### [41] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [42] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [43] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [44] Seam360GS: Seamless 360° Gaussian Splatting from Real-World Omnidirectional Images
...
#### [45] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [46] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [47] LabelGS: Label-Aware 3D Gaussian Splatting for 3D Scene Segmentation
...
#### [48] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [49] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [50] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [51] GSVisLoc: Generalizable Visual Localization for Gaussian Splatting Scene Representations
...
#### [52] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [53] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [54] GWM: Towards Scalable Gaussian World Models for Robotic Manipulation
...
#### [55] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [56] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [57] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
...
#### [58] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [59] UnPose: Uncertainty-Guided Diffusion Priors for Zero-Shot Pose Estimation
...
#### [60] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [61] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [62] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [63] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [64] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [65] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [66] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [67] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [69] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [70] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [71] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [72] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [73] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [74] LongSplat: Robust Unposed 3D Gaussian Splatting for Casual Long Videos
...
#### [75] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [76] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [77] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [78] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [79] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [80] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [81] IntelliCap: Intelligent Guidance for Consistent View Sampling
...
#### [82] Quantifying and Alleviating Co-Adaptation in Sparse-View 3D Gaussian Splatting
...
#### [83] WIPES: Wavelet-based Visual Primitives
...
#### [84] TiP4GEN: Text to Immersive Panorama 4D Scene Generation
...
#### [85] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [86] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [87] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [88] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [89] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [90] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [91] E-4DGS: High-Fidelity Dynamic Reconstruction from the Multi-view Event Cameras
...
#### [92] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [93] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [94] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [95] SVG-Head: Hybrid Surface-Volumetric Gaussians for High-Fidelity Head Reconstruction and Real-Time Editing
...
#### [96] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [97] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [98] SAGOnline: Segment Any Gaussians Online
...
#### [99] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [100] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [101] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [102] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [103] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [104] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [105] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [106] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [107] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [108] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [109] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [110] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [111] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [112] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [113] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [114] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
...
#### [115] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [116] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [117] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [118] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [119] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [120] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [121] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [122] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [123] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [124] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [125] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [126] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [127] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [128] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [129] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [130] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [131] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [132] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [133] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [134] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [135] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [136] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [137] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [138] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [139] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [140] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [141] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [142] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [143] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [144] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [145] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [146] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [147] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [148] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [149] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [150] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [151] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [152] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [153] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [154] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [155] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [156] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [157] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [158] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [159] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [160] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [161] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
...
#### [162] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [163] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [164] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [165] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [166] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [167] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [168] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [169] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [170] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [171] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [172] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [173] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [174] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [175] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [176] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [177] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [179] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [180] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [181] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [182] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [183] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [184] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [185] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [186] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [187] LocalDyGS: Multi-view Global Dynamic Scene Modeling via Adaptive Local Implicit Feature Decoupling
...
#### [188] 3D Gaussian Splatting Driven Multi-View Robust Physical Adversarial Camouflage Generation
...
#### [189] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [190] Masks make discriminative models great again!
...
#### [191] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [192] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [193] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
- **🧑‍🔬 作者**：Xingjun Wang, Lianlei Shan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2507.00363.md)] [[arXiv:2507.00363](https://arxiv.org/abs/2507.00363)] [Code]
- **📝 说明**:

#### [194] MILo: Mesh-In-the-Loop Gaussian Splatting for Detailed and Efficient Surface Reconstruction
...
#### [195] AttentionGS: Towards Initialization-Free 3D Gaussian Splatting via Structural Attention
...
#### [196] TVG-SLAM: Robust Gaussian Splatting SLAM with Tri-view Geometric Constraints
...
#### [197] Confident Splatting: Confidence-Based Compression of 3D Gaussian Splatting via Learnable Beta Distributions
...
#### [198] Part Segmentation and Motion Estimation for Articulated Objects with Dynamic 3D Gaussians
...
#### [199] Few-Shot Identity Adaptation for 3D Talking Heads via Global Gaussian Field
...
#### [200] SAR-GS: 3D Gaussian Splatting for Synthetic Aperture Radar Target Reconstruction
...
#### [201] MADrive: Memory-Augmented Driving Scene Modeling
...
#### [202] Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image
- **🧑‍🔬 作者**：Pufan Li, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2506.21152.md)] [[arXiv:2506.21152](https://arxiv.org/abs/2506.21152)] [Code]
- **📝 说明**:

#### [203] Virtual Memory for 3D Gaussian Splatting
...
#### [204] SOF: Sorted Opacity Fields for Fast Unbounded Surface Reconstruction
...
#### [205] GRAND-SLAM: Local Optimization for Globally Consistent Large-Scale Multi-Agent Gaussian SLAM
...
#### [206] 4Real-Video-V2: Fused View-Time Attention and Feedforward Reconstruction for 4D Scene Generation
...
#### [207] BulletGen: Improving 4D Reconstruction with Bullet-Time Generation
...
#### [208] 2D Triangle Splatting for Direct Differentiable Mesh Training
...
#### [209] Part2GS: Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [210] GraphGSOcc: Semantic-Geometric Graph Transformer with Dynamic-Static Decoupling for 3D Gaussian Splatting-based Occupancy Prediction
...
#### [211] 3DGS-IEval-15K: A Large-scale Image Quality Evaluation Database for 3D Gaussian-Splatting
...
#### [212] HRGS: Hierarchical Gaussian Splatting for Memory-Efficient High-Resolution 3D Reconstruction
...
#### [213] GAF: Gaussian Action Field as a Dynamic World Model for Robotic Manipulation
...
#### [214] GRaD-Nav++: Vision-Language Model Enabled Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [215] PF-LHM: 3D Animatable Avatar Reconstruction from Pose-free Articulated Human Images
...
#### [216] Micro-macro Gaussian Splatting with Enhanced Scalability for Unconstrained Scene Reconstruction
...
#### [217] Metropolis-Hastings Sampling for 3D Gaussian Reconstruction
...
#### [218] Efficient multi-view training for 3D Gaussian Splatting
...
#### [219] Generative 4D Scene Gaussian Splatting with Object View-Synthesis Priors
...
#### [220] PointGS: Point Attention-Aware Sparse View Synthesis with Gaussian Splatting
...
#### [221] DGS-LRM: Real-Time Deformable 3D Gaussian Reconstruction From Monocular Videos
...
#### [222] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [223] SemanticSplat: Feed-Forward 3D Scene Understanding with Language-Aware Gaussian Fields
...
#### [224] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
#### [225] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [226] TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
#### [227] ODG: Occupancy Prediction Using Dual Gaussians
...
#### [228] UniForward: Unified 3D Scene and Semantic Field Reconstruction via Feed-Forward Gaussian Splatting from Only Sparse-View Images
...
#### [229] STREAMINGGS: Voxel-Based Streaming 3D Gaussian Splatting with Memory Optimization and Architectural Support
...
#### [230] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [231] Gaussian2Scene: 3D Scene Representation Learning via Self-supervised Learning with 3D Gaussian Splatting
- **🧑‍🔬 作者**：Keyi Liu, Weidong Yang, Ben Fei, Ying He
- **🏫 单位**：Fudan University ⟐ The Chinese University of Hong Kong ⟐ Nanyang Technological University
- **🔗 链接**：[[中英摘要](./abs/2506.08777.md)] [[arXiv:2506.08777](https://arxiv.org/abs/2506.08777)] [Code]
- **📝 说明**:

#### [232] SceneSplat++: A Large Dataset and Comprehensive Benchmark for Language Gaussian Splatting
...
#### [233] TraGraph-GS: Trajectory Graph-based Gaussian Splatting for Arbitrary Large-Scale Scene Rendering
...
#### [234] Complex-Valued Holographic Radiance Fields
...
#### [235] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
...
#### [236] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **🧑‍🔬 作者**：Shuja Khalid, Mohamed Ibrahim, Yang Liu
- **🏫 单位**：Huawei Canada
- **🔗 链接**：[[中英摘要](./abs/2506.07897.md)] [[arXiv:2506.07897](https://arxiv.org/abs/2506.07897)] [Code]
- **📝 说明**:

#### [237] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [238] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [239] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [240] PIG: Physically-based Multi-Material Interaction with 3D Gaussians
...
#### [241] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [242] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [243] Hybrid Mesh-Gaussian Representation for Efficient Indoor Scene Reconstruction
...
#### [244] Gaussian Mapping for Evolving Scenes
...
#### [245] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [246] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [247] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [248] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [249] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [250] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [251] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [252] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [253] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [254] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [255] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [256] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [257] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [258] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [259] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [260] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [261] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [262] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [263] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [264] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [265] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
- **🧑‍🔬 作者**：Yang Xiao, Guoan Xu, Qiang Wu, Wenjing Jia
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2506.03872.md)] [[arXiv:2506.03872](https://arxiv.org/abs/2506.03872)] [Code]
- **📝 说明**:

#### [266] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [267] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [268] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [269] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [270] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [271] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [272] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [273] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [274] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [275] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [276] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [277] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [278] Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
#### [279] Understanding while Exploring: Semantics-driven Active Mapping
...
#### [280] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [281] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [282] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [283] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [284] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
...
#### [285] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [286] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [287] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [288] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [289] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [290] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [291] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [292] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [293] Hyperspectral Gaussian Splatting
...
#### [294] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [295] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [296] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [297] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [298] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [299] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [300] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [301] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [302] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [303] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [304] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [305] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [306] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [307] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [308] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [309] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [310] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [311] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [312] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [313] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [314] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [315] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [316] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [317] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [318] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [319] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
- **🧑‍🔬 作者**：Zhuodong Jiang, Haoran Wang, Guoxi Huang, Brett Seymour, Nantheera Anantrasirichai
- **🏫 单位**：University of Bristol ⟐ Submerged Resources Centre
- **🔗 链接**：[[中英摘要](./abs/2505.15737.md)] [[arXiv:2505.15737](https://arxiv.org/abs/2505.15737)] [Code]
- **📝 说明**:

#### [320] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [321] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [322] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [323] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [324] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [325] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [326] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [327] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [328] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [329] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [330] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [331] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [332] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [333] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [334] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [335] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [336] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [337] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [338] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [339] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [340] Neural Video Compression using 2D Gaussian Splatting
...
#### [341] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [342] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [343] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [344] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [345] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [346] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [347] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [348] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [349] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [350] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [351] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [352] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [353] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [354] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [355] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [356] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [357] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [358] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jongwon Lee, Timothy Bretl
- **🏫 单位**：University of Illinois Urbana-Champaign
- **🔗 链接**：[[中英摘要](./abs/2504.20379.md)] [[arXiv:2504.20379](https://arxiv.org/abs/2504.20379)] [Code]
- **📝 说明**:

#### [359] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [360] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [361] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [362] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [363] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [364] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [365] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
...
#### [366] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [375] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [376] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [377] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [378] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [379] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [380] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [381] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [382] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [383] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [384] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [385] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [386] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [387] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [388] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [389] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [390] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [391] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [392] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [393] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [394] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [395] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [396] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [397] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [398] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [399] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [400] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [401] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [402] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [403] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [404] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [405] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [406] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [407] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [408] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [409] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [410] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [411] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [412] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [413] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [414] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [415] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [416] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [417] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [418] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [419] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [420] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [421] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [422] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [423] Digital-twin imaging based on descattering Gaussian splatting
...
#### [424] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [425] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [426] BOGausS: Better Optimized Gaussian Splatting
...
#### [427] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [428] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [429] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [430] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [431] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [432] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [433] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
