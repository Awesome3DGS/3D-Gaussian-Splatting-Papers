...
#### [13] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [14] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [15] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [16] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [17] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [18] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [19] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [21] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [22] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [23] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [24] Gaussian Masked Autoencoders
...
#### [25] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [26] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [27] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [28] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [29] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [30] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [31] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [32] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [33] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [34] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [35] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [36] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [37] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [38] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [39] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [41] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [42] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [43] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [44] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [45] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [46] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [47] Reflective Gaussian Splatting
...
#### [48] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [49] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [50] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [51] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [52] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [53] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [54] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [55] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [56] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [57] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [58] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [59] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [60] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [61] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [62] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [63] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [64] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [65] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [66] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [67] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [68] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [69] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [70] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [71] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [72] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [73] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [74] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [75] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [76] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [77] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [78] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [79] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [80] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [81] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [82] EOGS: Gaussian Splatting for Earth Observation
...
#### [83] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [84] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [85] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [86] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [87] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [88] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [89] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [90] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [91] Deformable Radial Kernel Splatting
...
#### [92] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [93] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [94] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [95] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [96] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [97] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [98] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [99] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [100] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [101] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [102] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [103] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [104] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [105] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [106] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [107] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [108] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [109] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [110] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [111] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [112] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [113] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [114] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [115] GASP: Gaussian Avatars with Synthetic Priors
...
#### [116] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [117] Faster and Better 3D Splatting via Group Training
...
#### [118] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [119] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [120] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [121] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [122] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [123] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [124] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [125] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [126] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [127] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [128] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [129] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [130] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [131] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [132] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [133] Street Gaussians without 3D Object Tracker
...
#### [134] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [135] Extrapolated Urban View Synthesis Benchmark
...
#### [136] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [137] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [138] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [139] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [140] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [141] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [142] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [143] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [144] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [145] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [146] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [147] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [148] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [149] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [150] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [151] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [152] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [153] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [154] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [155] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [156] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [157] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [158] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [159] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [160] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [161] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [162] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [163] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [164] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [165] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [166] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [167] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [168] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [169] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [170] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [171] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [172] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [173] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [174] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [175] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [176] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [177] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [178] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [179] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [180] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [181] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [182] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [183] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [184] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [185] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [186] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [187] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [188] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [189] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [190] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [191] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [192] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [193] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [194] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [195] Neural Surface Priors for Editable Gaussian Splatting
...
#### [196] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [197] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [198] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [199] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [200] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [201] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [203] Geometry Field Splatting with Gaussian Surfels
...
#### [204] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [205] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [206] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [207] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [208] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [209] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [210] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [211] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [212] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [213] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [214] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [215] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [216] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [217] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [218] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [219] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [220] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [221] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [222] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [223] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [224] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [225] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [226] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [227] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [228] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [229] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [230] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [231] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [232] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [233] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [234] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [235] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [236] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [237] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [238] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [239] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [240] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [241] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [242] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [243] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [244] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [245] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [246] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [247] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [248] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [249] VeGaS: Video Gaussian Splatting
...
#### [250] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [251] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [252] Efficient Density Control for 3D Gaussian Splatting
...
#### [253] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [254] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [255] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [256] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [257] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [258] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [259] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [260] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [261] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [262] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [263] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [264] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [265] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [266] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [267] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [268] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [269] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [270] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [271] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [272] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [273] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [274] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [275] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [276] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [277] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [278] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [279] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [280] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [281] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [282] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [283] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [284] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [285] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [286] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [287] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [288] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [289] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [290] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [291] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [292] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [293] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [294] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [295] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [296] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [297] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [298] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [299] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [300] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [301] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [302] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [303] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [304] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [305] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [306] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [307] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [308] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [309] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [310] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [311] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [312] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [313] 3D Vision-Language Gaussian Splatting
...
#### [314] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [315] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [316] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [317] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [318] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [319] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [320] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [321] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [322] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [323] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [324] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [325] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [326] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [327] Variational Bayes Gaussian Splatting
...
#### [328] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [329] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [330] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [331] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [332] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [333] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [334] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [335] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [336] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [337] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [338] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [339] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [340] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [341] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [342] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [343] RNG: Relightable Neural Gaussians
...
#### [344] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [345] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [346] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [347] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [348] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [349] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [350] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [351] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [352] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [353] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [354] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [355] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [356] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [357] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [358] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [359] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [360] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [361] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [362] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [363] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [364] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [365] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [366] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [367] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [368] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [369] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [370] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [371] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [372] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [373] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [374] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [375] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [376] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [377] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [378] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [379] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [380] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [381] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [382] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [383] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [384] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [385] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [386] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [387] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [388] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [389] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [390] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [391] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [392] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [393] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [394] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [395] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [396] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [397] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [398] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [399] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [400] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [401] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [402] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [403] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [404] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [405] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [406] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [407] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [408] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [409] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [410] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [411] OmniRe: Omni Urban Scene Reconstruction
...
#### [412] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [413] G-Style: Stylized Gaussian Splatting
...
#### [414] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [415] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [416] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [417] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [418] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [419] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [420] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [421] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [422] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [423] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [424] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [425] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [426] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [427] Subsurface Scattering for 3D Gaussian Splatting
...
#### [428] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [429] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [430] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [431] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [432] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [433] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [434] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [435] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [436] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [437] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [438] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [439] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [440] 3D Gaussian Editing with A Single Image
...
#### [441] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [442] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [443] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [444] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [445] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [446] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [447] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [448] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [449] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [450] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [451] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [452] IG-SLAM: Instant Gaussian SLAM
...
#### [453] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [454] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [455] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [456] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [457] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [458] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [459] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [460] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [461] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [462] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [463] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [464] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [465] Gaussian Splatting Lucas-Kanade
...
#### [466] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [467] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [468] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [469] PICA: Physics-Integrated Clothed Avatar
...
#### [470] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [471] Gaussian Eigen Models for Human Heads
...
#### [473] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [474] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [475] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [476] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [477] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [478] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [479] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [480] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [481] Lightweight Predictive 3D Gaussian Splats
...
#### [482] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [483] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [484] On Scaling Up 3D Gaussian Splatting Training
...
#### [485] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [486] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [487] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [488] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [489] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [490] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [491] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [492] E2GS: Event Enhanced Gaussian Splatting
...
#### [493] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [494] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [495] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [496] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [497] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [498] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [499] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [500] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [501] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [502] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [503] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [504] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [505] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [506] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [507] Generalizable Human Gaussians from Single-View Image
...
#### [508] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [509] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [510] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [511] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [512] Localized Gaussian Point Management
...
#### [513] Gaussian Representation for Deformable Image Registration
...
#### [514] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [515] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [516] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [517] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [518] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [519] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [520] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [521] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [522] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
