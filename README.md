...
- **2025**
  ...
  - [[3DV](./2025/3DV.md)] (19 篇)
    [[WACV](./2025/WACV.md)] (15 篇)
    [[AAAI](./2025/AAAI.md)] (22 篇)
    [[ICLR](./2025/ICLR.md)] (34 篇)
    [[ICASSP](./2025/ICASSP.md)] (5 篇)
    [[ICRA](./2025/ICRA.md)] (14 篇)
  - [[CVPR](./2025/CVPR.md)] (122 篇)
    [[SIGGRAPH](./2025/SIGGRAPH.md)] (4 篇)
    [[ICML](./2025/ICML.md)] (1 篇)
    [[ICME](./2025/ICME.md)] (6 篇)
    [[others](./2025/Accepted.md)] (24 篇)
...
#### [1] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [2] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [3] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [4] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [5] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [6] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [7] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [8] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [9] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [11] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [12] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [13] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [14] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [15] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [16] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [17] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [18] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [19] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [20] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [21] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [22] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [23] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [24] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [25] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [26] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [27] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [28] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [29] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [30] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [31] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [32] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [33] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [34] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [35] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [36] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [37] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [38] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [39] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [40] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [41] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [42] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [43] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [44] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [45] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [46] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [47] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [48] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [49] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [50] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [51] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [52] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [53] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [54] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [55] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [56] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [57] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [58] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [59] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [60] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [61] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [62] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [63] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [64] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [65] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [66] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [67] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [68] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [69] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [70] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [71] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [72] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [73] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [74] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [75] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [76] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [77] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [78] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [79] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [80] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [81] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [82] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [83] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [84] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [85] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [86] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [87] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [88] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [89] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [90] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [91] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [92] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [93] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [94] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [95] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [96] Digital-twin imaging based on descattering Gaussian splatting
...
#### [97] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [98] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [99] BOGausS: Better Optimized Gaussian Splatting
...
#### [100] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [103] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [104] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [105] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [106] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [107] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
...
#### [108] StochasticSplats: Stochastic Rasterization for Sorting-Free 3D Gaussian Splatting
...
#### [111] NeuralGS: Bridging Neural Fields and 3D Gaussian Splatting for Compact 3D Representations
...
#### [112] CityGS-X: A Scalable Architecture for Efficient and Geometrically Accurate Large-Scale Scene Reconstruction
...
#### [113] FreeSplat++: Generalizable 3D Gaussian Splatting for Efficient Indoor Scene Reconstruction
...
#### [114] TranSplat: Lighting-Consistent Cross-Scene Object Transfer with 3D Gaussian Splatting
...
#### [115] Audio-Plane: Audio Factorization Plane Gaussian Splatting for Real-Time Talking Head Synthesis
...
#### [116] EndoLRMGS: Complete Endoscopic Scene Reconstruction combining Large Reconstruction Modelling and Gaussian Splatting
...
#### [117] AH-GS: Augmented 3D Gaussian Splatting for High-Frequency Detail Representation
...
#### [118] Follow Your Motion: A Generic Temporal Consistency Portrait Editing Framework with Trajectory Guidance
...
#### [119] Segment then Splat: A Unified Approach for 3D Open-Vocabulary Segmentation based on Gaussian Splatting
...
#### [120] Disentangled 4D Gaussian Splatting: Towards Faster and More Efficient Dynamic Scene Rendering
...
#### [121] X^2-Gaussian: 4D Radiative Gaussian Splatting for Continuous-time Tomographic Reconstruction
...
#### [122] Semantic Consistent Language Gaussian Splatting for Point-Level Open-vocabulary Querying
...
#### [123] STAMICS: Splat, Track And Map with Integrated Consistency and Semantics for Dense RGB-D SLAM
...
#### [124] Frequency-Aware Gaussian Splatting Decomposition
...
#### [125] High-Quality Spatial Reconstruction and Orthoimage Generation Using Efficient 2D Gaussian Splatting
...
#### [126] SparseGS-W: Sparse-View 3D Gaussian Splatting in the Wild with Generative Priors
...
#### [127] MATT-GS: Masked Attention-based 3DGS for Robot Perception and Object Detection
...
#### [128] GS-Marker: Generalizable and Robust Watermarking for 3D Gaussian Splatting
...
#### [129] LLGS: Unsupervised Gaussian Splatting for Image Enhancement and Reconstruction in Pure Dark Environment
...
#### [130] StableGS: A Floater-Free Framework for 3D Gaussian Splatting
...
#### [131] ReconDreamer++: Harmonizing Generative and Reconstructive Models for Driving Scene Representation
...
#### [132] GI-SLAM: Gaussian-Inertial SLAM
...
#### [133] Unraveling the Effects of Synthetic Data on End-to-End Autonomous Driving
...
#### [134] PanopticSplatting: End-to-End Panoptic Gaussian Splatting
...
#### [135] SceneSplat: Gaussian Splatting-based Scene Understanding with Vision-Language Pretraining
...
#### [136] Real-time Global Illumination for Dynamic 3D Gaussian Scenes
...
#### [137] GaussianFocus: Constrained Attention Focus for 3D Gaussian Splatting
...
#### [138] GS-LTS: 3D Gaussian Splatting-Based Adaptive Modeling for Long-Term Service Robots
...
#### [139] Is there anything left? Measuring semantic residuals of objects removed from 3D Gaussian Splatting
...
#### [140] Splat-LOAM: Gaussian Splatting LiDAR Odometry and Mapping
...
#### [141] ProtoGS: Efficient and High-Quality Rendering with 3D Gaussian Prototypes
...
#### [142] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [143] Optimized Minimal 3D Gaussian Splatting
...
#### [144] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [145] 4D Gaussian Splatting SLAM
...
#### [146] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [147] OccluGaussian: Occlusion-Aware Gaussian Splatting for Large Scene Reconstruction and Rendering
...
#### [148] Repurposing 2D Diffusion Models with Gaussian Atlas for 3D Generation
...
#### [149] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [150] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [151] Uncertainty-Aware Diffusion Guided Refinement of 3D Scenes
...
#### [152] CHROME: Clothed Human Reconstruction with Occlusion-Resilience and Multiview-Consistency from a Single Image
...
#### [153] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [154] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [155] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [156] SplatVoxel: History-Aware Novel View Streaming without Temporal Training
...
#### [157] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [158] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [159] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [160] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [161] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [162] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [163] DeGauss: Dynamic-Static Decomposition with Gaussian Splatting for Distractor-free 3D Reconstruction
...
#### [164] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [165] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [166] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [167] Deblur Gaussian Splatting SLAM
...
#### [168] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [169] MTGS: Multi-Traversal Gaussian Splatting
...
#### [170] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [171] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [172] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [173] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [174] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [175] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [176] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [177] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [178] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [179] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [180] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [181] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [182] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [183] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [184] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [185] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
...
#### [186] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [187] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [188] 3D Student Splatting and Scooping
...
#### [189] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [190] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [191] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [192] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [194] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [195] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [196] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [197] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [198] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [199] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [200] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [201] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [202] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [203] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [204] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [205] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [206] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [207] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [208] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [209] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [210] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [211] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [212] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [213] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [214] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [215] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [216] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zexu Huang, Min Xu, Stuart Perry
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2503.06462.md)] [[arXiv:2503.06462](https://arxiv.org/abs/2503.06462)] [Code]
- **📝 说明**：

#### [217] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [218] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [219] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [220] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [221] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [222] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [223] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [224] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [225] Self-Modeling Robots by Photographing
...
#### [226] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [227] STGA: Selective-Training Gaussian Head Avatars
...
#### [228] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [229] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [230] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [231] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [232] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [233] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [234] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [235] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [236] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [237] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [238] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [239] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [240] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [241] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [242] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [243] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [244] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [245] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [246] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [247] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [248] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [249] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [250] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [251] Seeing A 3D World in A Grain of Sand
...
#### [252] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [253] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [254] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [255] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [256] LUCAS: Layered Universal Codec Avatars
...
#### [257] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [258] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [259] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [260] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [261] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [262] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [263] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [264] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [265] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [266] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [267] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [268] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [269] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [270] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [271] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [272] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [273] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [274] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [275] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [276] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [277] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [278] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [279] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [280] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [281] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [282] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [283] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [284] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [285] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [286] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [287] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [288] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [289] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [290] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [291] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [292] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [293] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [294] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [295] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [296] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [298] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [299] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [300] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [301] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [302] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [303] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [304] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [305] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [306] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [307] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [308] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [309] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [310] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [311] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [312] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [313] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [314] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [315] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [316] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [317] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [318] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [319] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [320] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [321] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [322] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [323] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [324] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [325] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [326] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [327] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [328] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [329] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [330] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [331] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [332] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [333] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [334] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [335] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [336] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [337] Gaussian Masked Autoencoders
...
#### [338] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [339] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [340] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [341] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [342] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [343] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [344] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [345] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [346] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [347] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [348] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [349] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [350] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [351] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [352] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [353] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [354] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [355] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [356] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [357] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [358] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [359] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [360] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [361] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [362] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [363] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [364] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [365] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [366] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [367] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [368] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [369] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [370] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [371] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [372] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [373] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [374] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [375] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [376] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [377] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [378] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [379] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [380] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [381] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [382] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [383] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [384] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [385] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [386] EOGS: Gaussian Splatting for Earth Observation
...
#### [387] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [388] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [389] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [390] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [391] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [392] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [393] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [394] Deformable Radial Kernel Splatting
...
#### [395] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [396] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [397] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [398] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [399] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [400] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [401] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [402] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [403] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [404] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [405] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [406] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [407] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [408] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [409] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [410] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [411] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [412] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [413] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [414] Faster and Better 3D Splatting via Group Training
...
#### [415] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [416] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [417] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [418] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [419] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [420] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [421] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [422] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [423] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [424] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [425] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [426] Street Gaussians without 3D Object Tracker
...
#### [427] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [428] Extrapolated Urban View Synthesis Benchmark
...
#### [429] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [430] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [431] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [432] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [433] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [434] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [435] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [436] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [437] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [438] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [439] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [440] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [441] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [442] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [443] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [444] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [445] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [446] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [447] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [448] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [449] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [450] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [451] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [452] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [453] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [454] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [455] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [456] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [457] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [458] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [459] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [460] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [461] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [462] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [463] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [464] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [465] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [466] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [467] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [468] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [469] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [470] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [471] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [472] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [473] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [474] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [475] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [476] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
- **🧑‍🔬 作者**：Lei Liu, Zhenghao Chen, Dong Xu
...
#### [477] Neural Surface Priors for Editable Gaussian Splatting
...
#### [478] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [479] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [480] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [481] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [482] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [483] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [484] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [485] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [486] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [487] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [488] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [489] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [490] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [491] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [492] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [493] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [494] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [495] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [496] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [497] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [498] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [499] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [500] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [501] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [502] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [503] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [504] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [505] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [506] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [507] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [508] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [509] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [510] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [511] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [512] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [513] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [514] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [515] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [516] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [517] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [518] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [519] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [520] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [521] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [522] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [523] VeGaS: Video Gaussian Splatting
...
#### [524] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [525] Efficient Density Control for 3D Gaussian Splatting
...
#### [526] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [527] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [528] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [529] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [530] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [531] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [532] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [533] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [534] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [535] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [536] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [537] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [538] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [539] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [540] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [541] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [542] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [543] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [544] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [545] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [546] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [547] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [548] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [549] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [550] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [551] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [552] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [553] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [554] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [555] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [556] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [557] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [558] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [559] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [560] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [561] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [562] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [563] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [564] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [565] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [566] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [567] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [568] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [569] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [570] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [571] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [572] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [573] 3D Vision-Language Gaussian Splatting
...
#### [574] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [575] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [576] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [577] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [578] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [579] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [580] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [581] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [582] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [583] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [584] Variational Bayes Gaussian Splatting
...
#### [585] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [586] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [587] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [588] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [589] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [590] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [591] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [592] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [593] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [594] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [595] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [596] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [597] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [598] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [599] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [600] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [601] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [602] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [603] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [604] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [605] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [606] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [607] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [608] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [609] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [610] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [611] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [612] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [613] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [614] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [635] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [636] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [637] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [638] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [639] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [640] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [641] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [642] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [643] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [644] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [645] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [646] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [647] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [648] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [649] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [650] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [651] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [652] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [653] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [654] G-Style: Stylized Gaussian Splatting
...
#### [655] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [656] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [657] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [658] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [659] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [660] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [661] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [662] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [663] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [664] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [665] Subsurface Scattering for 3D Gaussian Splatting
...
#### [666] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [667] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [668] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [669] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [670] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [671] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [672] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [673] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [674] 3D Gaussian Editing with A Single Image
...
#### [675] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [676] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [677] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [678] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [679] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [680] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [681] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [682] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [683] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [684] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [685] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [686] IG-SLAM: Instant Gaussian SLAM
...
#### [687] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [688] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [689] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [690] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [691] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [692] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [693] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [694] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [695] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [696] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [697] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [698] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [699] Gaussian Splatting Lucas-Kanade
...
#### [700] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [701] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [702] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [703] PICA: Physics-Integrated Clothed Avatar
...
#### [704] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [706] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [707] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [708] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [709] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [710] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [711] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [712] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [713] Lightweight Predictive 3D Gaussian Splats
...
#### [714] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [715] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [716] On Scaling Up 3D Gaussian Splatting Training
...
#### [717] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [718] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [719] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [720] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [721] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [722] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [723] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [724] E2GS: Event Enhanced Gaussian Splatting
...
#### [725] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [726] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [727] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [728] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [729] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [730] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [731] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [732] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [733] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [734] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [735] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [736] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [737] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [738] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [739] Localized Gaussian Point Management
...
#### [740] Gaussian Representation for Deformable Image Registration
...
#### [741] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [742] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [743] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [744] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [745] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [746] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [747] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
