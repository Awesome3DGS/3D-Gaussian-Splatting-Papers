...
- **2024**
  ...
  - [[NeurIPS](./2024/NeurIPS.md)] (70 篇)
    ...
    [[others](./2024/Accepted.md)] (26 篇)

- **2025**

  - [[3DV](./2025/3DV.md)] (20 篇)
    [[WACV](./2025/WACV.md)] (15 篇)
    [[AAAI](./2025/AAAI.md)] (23 篇)
    [[ICLR](./2025/ICLR.md)] (42 篇)
    [[ICASSP](./2025/ICASSP.md)] (5 篇)
    [[ICRA](./2025/ICRA.md)] (16 篇)
  - [[CVPR](./2025/CVPR.md)] (137 篇)
    [[SIGGRAPH](./2025/SIGGRAPH.md)] (8 篇)
    [[ICML](./2025/ICML.md)] (2 篇)
    [[ICME](./2025/ICME.md)] (6 篇)
    [[others](./2025/Accepted.md)] (39 篇)
...
#### [260] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [261] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [262] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [263] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [264] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [265] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [266] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [267] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [268] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [269] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [270] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [271] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [272] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [273] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [274] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [275] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [276] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [277] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [278] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [279] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [280] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [281] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [282] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [283] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [284] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [285] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [286] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [287] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [288] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [289] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [290] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [291] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [292] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [293] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [294] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [295] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [296] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [297] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [298] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [299] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [300] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [301] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [302] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [303] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [304] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [305] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [306] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [307] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [308] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [309] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [310] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [311] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [312] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [313] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [314] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [315] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [316] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [317] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [318] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [319] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [320] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [322] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [323] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [324] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [325] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [326] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [327] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [328] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [329] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [330] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [331] Gaussian Masked Autoencoders
...
#### [332] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [333] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [334] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [335] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [336] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [337] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [338] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [339] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [340] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [341] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [342] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [343] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [344] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [345] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [346] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [347] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [348] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [349] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [350] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [351] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [352] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [353] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [354] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [355] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [356] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [357] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [358] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [359] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [360] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [361] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [362] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [363] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [364] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [365] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [366] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [367] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [368] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [369] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [370] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [371] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [372] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [373] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [374] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [375] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [376] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [377] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [378] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [379] Deformable Radial Kernel Splatting
...
#### [380] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [381] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [382] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [383] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [384] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [385] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [386] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [387] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [388] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [389] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [390] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [391] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [392] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [393] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [394] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [395] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [396] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [397] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [398] Faster and Better 3D Splatting via Group Training
...
#### [399] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [400] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [401] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [402] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [403] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [404] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [405] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [406] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [407] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [408] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [409] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [410] Street Gaussians without 3D Object Tracker
...
#### [411] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [412] Extrapolated Urban View Synthesis Benchmark
...
#### [413] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [414] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [415] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [416] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [417] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [418] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [419] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [420] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [421] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [422] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [423] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [424] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [425] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [426] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [427] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [428] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [429] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [430] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [431] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [432] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [433] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [434] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [435] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [436] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [437] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [438] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [439] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [440] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [441] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [442] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [443] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [444] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [445] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [446] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [447] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [448] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [449] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [450] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [451] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [452] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [453] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [454] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [455] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [456] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [457] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
- **🧑‍🔬 作者**：Lei Liu, Zhenghao Chen, Dong Xu
...
#### [458] Neural Surface Priors for Editable Gaussian Splatting
...
#### [459] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [460] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [461] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [462] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [463] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [464] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [465] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [466] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [467] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [468] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [469] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [470] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [471] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [472] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [473] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [474] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [475] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [476] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [477] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [478] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [479] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [480] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [481] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [482] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [483] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [484] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [485] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [486] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [487] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [488] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [489] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [490] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [491] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [492] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [493] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [494] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [495] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [496] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [497] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [498] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [499] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [500] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [501] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [502] VeGaS: Video Gaussian Splatting
...
#### [503] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [504] Efficient Density Control for 3D Gaussian Splatting
...
#### [505] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [506] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [507] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [508] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [509] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [510] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [511] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [512] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [513] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [514] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [515] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [516] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [517] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [518] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [519] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [520] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [521] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [522] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [523] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [524] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [525] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [526] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [527] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [528] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [529] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [530] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [531] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [532] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [533] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [534] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [535] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [536] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [537] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [538] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [539] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [540] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [541] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [542] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [543] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [544] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [545] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [546] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [547] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [548] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [549] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [550] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [551] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [552] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [553] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [554] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [555] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [556] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [557] Variational Bayes Gaussian Splatting
...
#### [558] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [559] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [560] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [561] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [562] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [563] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [564] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [565] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [566] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [567] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [568] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [569] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [570] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [571] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [572] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [573] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [574] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [576] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [577] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [578] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [579] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [580] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [581] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [582] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [583] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [584] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [585] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [586] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [587] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [588] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [589] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [590] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [591] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [592] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [593] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [594] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [595] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [596] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [597] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [598] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [599] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [600] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [601] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [602] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [603] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [604] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [605] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [606] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [607] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [608] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [609] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [610] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [611] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [612] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [613] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [614] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [615] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [616] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [617] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [618] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [619] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [620] G-Style: Stylized Gaussian Splatting
...
#### [621] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [622] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [623] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [624] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [627] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [628] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [629] Subsurface Scattering for 3D Gaussian Splatting
...
#### [630] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [631] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [632] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [633] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [634] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [635] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [636] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [637] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [638] 3D Gaussian Editing with A Single Image
...
#### [639] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [640] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [641] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [642] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [643] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [644] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [645] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [646] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [647] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [648] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [649] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [650] IG-SLAM: Instant Gaussian SLAM
...
#### [651] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [652] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [653] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [654] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [655] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [656] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [657] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [658] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [659] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [660] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [661] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [662] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [663] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [664] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [665] PICA: Physics-Integrated Clothed Avatar
...
#### [666] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [668] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [669] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [670] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [671] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [672] Lightweight Predictive 3D Gaussian Splats
...
#### [673] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [674] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [675] On Scaling Up 3D Gaussian Splatting Training
...
#### [676] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [677] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [678] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [679] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [680] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [681] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [682] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [683] E2GS: Event Enhanced Gaussian Splatting
...
#### [684] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [685] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [686] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [687] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [688] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [689] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [690] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [691] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [692] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [693] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [694] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [695] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [696] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [697] Gaussian Representation for Deformable Image Registration
...
#### [698] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [699] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [700] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [701] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [702] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [703] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
