...
#### [1] Connecting Consistency Distillation to Score Distillation for Text-to-3D Generation
...
#### [2] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [3] Generalizable Human Gaussians for Sparse View Synthesis
...
#### [4] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [5] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [6] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [7] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [9] iHuman: Instant Animatable Digital Humans From Monocular Videos
...
#### [12] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [13] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [15] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [17] PICA: Physics-Integrated Clothed Avatar
...
#### [19] Gaussian Eigen Models for Human Heads
...
#### [21] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [22] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [23] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [25] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [26] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [27] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [28] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [29] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [30] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [32] Lightweight Predictive 3D Gaussian Splats
...
#### [35] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [36] On Scaling Up 3D Gaussian Splatting Training
...
#### [37] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [38] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [39] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [41] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [42] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [43] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [44] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [45] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [46] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [47] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [48] E2GS: Event Enhanced Gaussian Splatting
...
#### [49] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [51] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [52] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [53] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [54] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [55] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [56] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [58] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [59] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [60] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [61] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [63] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [64] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [65] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [66] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [67] From Chaos to Clarity: 3DGS in the Dark
...
#### [68] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [69] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [70] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [71] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [72] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [73] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [74] Generalizable Human Gaussians from Single-View Image
...
#### [76] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [77] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [78] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [79] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [81] Gaussian Representation for Deformable Image Registration
...
#### [83] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [84] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [85] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [86] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [87] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [88] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [89] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [90] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [91] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [92] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [93] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [95] Tetrahedron Splatting for 3D Generation
...
#### [96] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [97] RaDe-GS: Rasterizing Depth in Gaussian Splatting
