...
#### [1] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [2] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [3] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [5] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [6] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [7] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [8] Variational Bayes Gaussian Splatting
...
#### [9] Flash-Splat: 3D Reflection Removal with Flash Cues and Gaussian Splats
...
#### [10] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [11] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [12] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [14] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [15] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [16] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [17] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [18] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [19] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [20] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [21] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [22] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [23] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [24] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [26] RNG: Relightable Neural Gaussians
...
#### [27] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [28] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [29] Gaussian Heritage: 3D Digitization of Cultural Heritage with Integrated Object Segmentation
...
- **🔗 链接**：[[中英摘要](./abs/22409.19039.md)] [[arXiv:2409.19039](https://arxiv.org/abs/2409.19039)] [[Code](https://github.com/mahtaabdn/GaussianHeritage)]
- **📝 说明**：🏆 Accepted to ECCV 2024

#### [30] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [31] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [32] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [33] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [34] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [35] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [36] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [37] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [38] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [39] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [40] Low Latency Point Cloud Rendering with Learned Splatting
...
#### [41] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
- **🧑‍🔬 作者**：Gennady Sidorov, Malik Mohrat, Ksenia Lebedeva, Ruslan Rakhimov, Sergey Kolyubin
...
#### [42] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [43] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [44] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [45] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [46] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [47] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [48] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [49] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [50] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [51] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [52] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [53] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [54] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [55] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [56] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [57] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [58] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [59] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [60] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [61] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [62] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [63] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [64] SRIF: Semantic Shape Registration Empowered by Diffusion-based Image Morphing and Flow Estimation
...
#### [65] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [66] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [69] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [70] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [71] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [72] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [73] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [74] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [75] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [76] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [77] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [78] AdR-Gaussian: Accelerating Gaussian Splatting with Adaptive Radius
...
#### [79] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [80] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [81] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [82] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [83] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [84] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [85] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [86] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [87] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [88] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [89] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [90] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [91] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [92] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [93] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [94] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [95] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [96] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [97] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [98] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [99] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [100] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [101] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [102] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [103] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [104] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [105] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [106] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [107] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [108] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [109] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [110] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [111] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [112] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [113] OmniRe: Omni Urban Scene Reconstruction
...
#### [114] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [115] G-Style: Stylized Gaussian Splatting
...
#### [116] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [117] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [118] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [119] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [120] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [121] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [122] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [123] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [124] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [125] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [126] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [127] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [128] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [129] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [130] Subsurface Scattering for 3D Gaussian Splatting
...
#### [131] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [132] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [133] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [134] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [135] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [136] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [137] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [138] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [139] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [140] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [141] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [142] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [143] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [144] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [145] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [146] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [147] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [148] 3D Gaussian Editing with A Single Image
...
#### [149] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [150] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [151] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [152] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [153] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [154] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [155] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [156] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [157] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [158] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [159] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [160] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [161] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [162] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [163] IG-SLAM: Instant Gaussian SLAM
...
#### [164] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [165] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [166] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [167] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [168] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [169] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [170] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [171] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [172] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [173] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [174] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [175] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [176] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [177] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [178] Gaussian Splatting Lucas-Kanade
...
#### [179] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [180] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [181] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [182] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [183] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [184] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [185] PICA: Physics-Integrated Clothed Avatar
...
#### [186] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [187] Gaussian Eigen Models for Human Heads
...
#### [189] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [190] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [191] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [192] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [193] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [194] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [195] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [196] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [197] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [198] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [199] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [200] Lightweight Predictive 3D Gaussian Splats
...
#### [201] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [202] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [203] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [204] On Scaling Up 3D Gaussian Splatting Training
...
#### [205] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [206] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [207] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [208] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [209] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [210] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [211] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [212] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [213] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [214] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [215] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [216] E2GS: Event Enhanced Gaussian Splatting
...
#### [217] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [218] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [219] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [220] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [221] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [222] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [223] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [224] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [225] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [226] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [227] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [228] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [229] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [230] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [231] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [232] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [233] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [234] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [235] From Chaos to Clarity: 3DGS in the Dark
...
#### [236] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [237] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [238] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [239] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [240] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [241] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [242] Generalizable Human Gaussians from Single-View Image
...
#### [243] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [244] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [245] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [246] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [247] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [248] Localized Gaussian Point Management
...
#### [249] Gaussian Representation for Deformable Image Registration
...
#### [250] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [251] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [252] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [253] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [254] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [255] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [256] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [257] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [258] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [259] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [260] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [261] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [262] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [263] Tetrahedron Splatting for 3D Generation
...
#### [264] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [265] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [266] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [267] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
