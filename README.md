...
#### [1] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
- **🔗 链接**：[[中英摘要](./abs/2411.18625.md)] [[arXiv:2411.18625](https://arxiv.org/abs/2411.18625)] [[Code](https://textured-gaussians.github.io/)]
- **📝 说明**：
...
- **🔗 链接**：[[中英摘要](./abs/2411.18548.md)] [[arXiv:2411.18548](https://arxiv.org/abs/2411.18548)] [[Code](https://wolfball.github.io/phycage/)]
- **📝 说明**：

#### [3] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [4] Neural Surface Priors for Editable Gaussian Splatting
...
#### [5] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [6] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [7] GLS: Geometry-aware 3D Language Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2411.17982.md)] [[arXiv:2411.17982](https://arxiv.org/abs/2411.17982)] [[Code](https://hi-slam2.github.io/)]
- **📝 说明**：

#### [9] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [10] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [11] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [12] Geometry Field Splatting with Gaussian Surfels
...
#### [14] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [15] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [16] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [17] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [18] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [19] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [20] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [21] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
- **🧑‍🔬 作者**：Hyojun Go, Byeongjun Park, Jiho Jang, Jin-Young Kim, Soonwoo Kwon, Changick Kim
- **🏫 单位**：Twelve Labs ⟐ KAIST
- **🔗 链接**：[[中英摘要](./abs/2411.16443.md)] [[arXiv:2411.16443](https://arxiv.org/abs/2411.16443)] [[Code](https://gohyojun15.github.io/SplatFlow/)]
- **📝 说明**：

#### [22] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
- **🔗 链接**：[[中英摘要](./abs/2411.16392.md)] [[arXiv:2411.16392](https://arxiv.org/abs/2411.16392)] [[Code](https://quadraticgs.github.io/QGS/)]
- **📝 说明**：

#### [23] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [24] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [25] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [26] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [27] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [28] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [29] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [30] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [31] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [32] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [33] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
- **🔗 链接**：[[中英摘要](./abs/2411.15468.md)] [[arXiv:2411.15468](https://arxiv.org/abs/2411.15468)] [[Code](https://blarklee.github.io/splatsdf/)]
- **📝 说明**：

#### [34] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [35] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [36] Neural 4D Evolution under Large Topological Changes from 2D Images
- **🧑‍🔬 作者**：AmirHossein Naghi Razlighi, Tiago Novello, Asen Nachkov, Thomas Probst, Danda Paudel
- **🏫 单位**：INSAIT, Sofia University ⟐ IMPA
- **🔗 链接**：[[中英摘要](./abs/2411.15018.md)] [[arXiv:2411.15018](https://arxiv.org/abs/2411.15018)] [[Code](https://github.com/insait-institute/N4DE)]
- **📝 说明**：

#### [37] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [38] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [39] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [40] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [41] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [42] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [43] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [44] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [45] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [46] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [47] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [48] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [49] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [50] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [51] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [52] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [53] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [54] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [55] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [56] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [57] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [58] VeGaS: Video Gaussian Splatting
...
#### [59] Direct and Explicit 3D Generation from a Single Image
...
#### [60] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [61] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [62] Efficient Density Control for 3D Gaussian Splatting
...
#### [63] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
...
#### [64] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [65] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [66] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [67] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [68] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [69] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [70] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [71] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [72] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [73] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [74] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [75] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [76] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [77] Object and Contact Point Tracking in Demonstrations Using 3D Gaussian Splatting
...
#### [78] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [79] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [80] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [81] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [82] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [83] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [84] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [85] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [86] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [87] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [88] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [89] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [90] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [91] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
...
#### [92] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [93] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [94] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [95] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [96] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [97] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [98] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [99] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [100] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [101] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [102] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [103] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [104] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [105] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [106] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [107] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [108] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [109] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [110] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [111] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [112] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [113] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [114] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [115] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [116] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [117] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [118] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [119] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [120] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [121] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [122] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [123] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [124] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [125] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [126] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [127] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [128] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [129] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [130] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [131] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [132] 3D Vision-Language Gaussian Splatting
...
#### [133] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [134] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [135] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [136] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [137] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [138] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [139] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [140] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [141] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [142] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [143] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [144] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [145] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [146] Variational Bayes Gaussian Splatting
...
#### [147] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [148] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [149] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [150] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [151] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [152] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [153] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [154] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [155] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [156] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [157] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [158] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [159] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [160] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [161] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [162] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [163] RNG: Relightable Neural Gaussians
...
#### [164] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [165] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [166] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [167] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [168] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [169] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [170] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [171] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [172] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [173] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [174] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [175] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [176] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [177] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [178] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [179] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [180] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [181] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [182] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [183] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [184] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [185] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [186] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [187] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [188] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [189] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [190] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [191] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [192] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [193] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [194] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [195] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [196] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [197] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [198] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [199] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [200] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [201] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [202] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [203] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [204] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [205] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [206] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [207] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [208] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [209] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [210] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [211] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [212] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [213] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [214] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [215] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [216] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [217] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [218] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [219] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [220] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [221] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [222] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [223] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [224] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [225] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [226] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [227] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [228] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [229] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [230] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [231] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [232] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [233] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [234] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [235] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [236] OmniRe: Omni Urban Scene Reconstruction
...
#### [237] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [238] G-Style: Stylized Gaussian Splatting
...
#### [239] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [240] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [241] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [242] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [243] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [244] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [245] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [246] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [247] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [248] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [249] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [250] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [251] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [252] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [253] Subsurface Scattering for 3D Gaussian Splatting
...
#### [254] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [255] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [256] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [257] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [258] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [259] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [260] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [261] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [262] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [263] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [264] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [265] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [266] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [267] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [268] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [269] 3D Gaussian Editing with A Single Image
...
#### [270] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [271] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [272] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [273] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [274] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [275] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [276] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [277] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [278] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [279] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [280] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [281] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [282] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [283] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [284] IG-SLAM: Instant Gaussian SLAM
...
#### [285] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [286] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [287] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [288] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [289] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [290] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [291] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [292] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [293] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [294] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [295] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [296] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [297] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [298] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [299] Gaussian Splatting Lucas-Kanade
...
#### [300] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [301] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [302] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [303] PICA: Physics-Integrated Clothed Avatar
...
#### [304] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [305] Gaussian Eigen Models for Human Heads
...
#### [307] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [308] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [309] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [310] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [311] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [312] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [313] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [314] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [315] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [316] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [317] Lightweight Predictive 3D Gaussian Splats
...
#### [318] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [319] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [320] On Scaling Up 3D Gaussian Splatting Training
...
#### [321] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [322] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [323] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [324] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [325] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [326] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [327] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [328] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [329] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [330] E2GS: Event Enhanced Gaussian Splatting
...
#### [331] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [332] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [333] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [334] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [335] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [336] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [337] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [338] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [339] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [340] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [341] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [342] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [343] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [344] From Chaos to Clarity: 3DGS in the Dark
...
#### [345] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [346] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [347] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [348] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [349] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [350] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [351] Generalizable Human Gaussians from Single-View Image
...
#### [352] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [353] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [354] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [355] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [356] Localized Gaussian Point Management
...
#### [357] Gaussian Representation for Deformable Image Registration
...
#### [358] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [359] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [360] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [361] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [362] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [363] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [364] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [365] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [366] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [367] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [368] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [369] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
