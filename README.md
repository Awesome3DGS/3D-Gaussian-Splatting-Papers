...
#### [2] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [3] SemanticSplat: Feed-Forward 3D Scene Understanding with Language-Aware Gaussian Fields
...
#### [4] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
#### [5] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [6] TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
#### [7] ODG: Occupancy Prediction Using Dual Gaussians
...
#### [9] STREAMINGGS: Voxel-Based Streaming 3D Gaussian Splatting with Memory Optimization and Architectural Support
...
#### [10] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [11] Gaussian2Scene: 3D Scene Representation Learning via Self-supervised Learning with 3D Gaussian Splatting
...
#### [12] SceneSplat++: A Large Dataset and Comprehensive Benchmark for Language Gaussian Splatting
...
#### [13] TraGraph-GS: Trajectory Graph-based Gaussian Splatting for Arbitrary Large-Scale Scene Rendering
...
#### [14] Complex-Valued Holographic Radiance Fields
...
#### [15] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
...
#### [16] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **🧑‍🔬 作者**：Shuja Khalid, Mohamed Ibrahim, Yang Liu
- **🏫 单位**：Huawei Canada
- **🔗 链接**：[[中英摘要](./abs/2506.07897.md)] [[arXiv:2506.07897](https://arxiv.org/abs/2506.07897)] [Code]
- **📝 说明**:

#### [17] FreeGave: 3D Physics Learning from Dynamic Videos by Gaussian Velocity
...
#### [18] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [19] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [20] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [21] PIG: Physically-based Multi-Material Interaction with 3D Gaussians
...
#### [22] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [23] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [24] Hybrid Mesh-Gaussian Representation for Efficient Indoor Scene Reconstruction
...
#### [25] Gaussian Mapping for Evolving Scenes
...
#### [26] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [27] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [28] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [29] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [30] Splat and Replace: 3D Reconstruction with Repetitive Elements
...
#### [31] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [32] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [33] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [34] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [35] VoxelSplat: Dynamic Gaussian Splatting as an Effective Loss for Occupancy and Flow Prediction
...
#### [36] On-the-fly Reconstruction for Large-Scale Novel View Synthesis from Unposed Images
...
#### [37] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [38] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [39] Gen4D: Synthesizing Humans and Scenes in the Wild
...
#### [40] FreeTimeGS: Free Gaussian Primitives at Anytime and Anywhere for Dynamic Scene Reconstruction
...
#### [41] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [42] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [43] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [44] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [45] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [46] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [47] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [48] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [49] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [50] FlexGS: Train Once, Deploy Everywhere with Many-in-One Flexible 3D Gaussian Splatting
...
#### [51] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [52] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
...
#### [53] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [54] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [55] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [56] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [57] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [58] RobustSplat: Decoupling Densification and Dynamics for Transient-Free 3DGS
...
#### [59] VTGaussian-SLAM: RGBD SLAM for Large Scale Scenes with Splatting View-Tied 3D Gaussians
...
#### [60] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [61] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [62] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [63] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [64] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [65] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [66] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [67] 3D Gaussian Splat Vulnerabilities
...
#### [68] Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
#### [69] Understanding while Exploring: Semantics-driven Active Mapping
...
#### [70] AdaHuman: Animatable Detailed 3D Human Generation with Compositional Multiview Diffusion
...
#### [71] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [72] Tackling View-Dependent Semantics in 3D Language Gaussian Splatting
...
#### [73] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [74] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [75] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [76] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
...
#### [77] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [78] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [79] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [80] Pose-free 3D Gaussian splatting via shape-ray estimation
...
#### [81] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [82] 4DTAM: Non-Rigid Tracking and Mapping via Dynamic Surface Gaussians
...
#### [83] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [84] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [85] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [86] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [87] Hyperspectral Gaussian Splatting
...
#### [88] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [89] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [90] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [91] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [92] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [93] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [94] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [95] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [96] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [97] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [98] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
...
#### [101] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [102] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [103] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [104] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [105] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [106] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [108] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [109] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [110] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [111] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [112] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [113] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [114] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [115] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [116] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [117] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [118] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [119] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [120] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [121] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [122] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [123] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [124] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [125] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [126] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [127] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [128] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [129] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [130] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [131] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [132] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [133] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [134] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [135] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [136] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [137] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [138] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [139] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [140] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [141] Large-Scale Gaussian Splatting SLAM
...
#### [142] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [143] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [146] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [147] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [148] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [149] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [150] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [151] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [152] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [153] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [154] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [155] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [156] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [157] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [158] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [159] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [160] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [161] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [162] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [163] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [164] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [165] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [166] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [167] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [168] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [169] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [170] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [171] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [172] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [173] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [174] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [175] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [176] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [177] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [178] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [179] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [180] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [181] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [182] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [183] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [184] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [185] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [186] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [187] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [188] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [189] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [190] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [191] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [192] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [193] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [194] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [195] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [196] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [197] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [198] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [199] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [200] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [201] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [202] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [203] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [204] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [205] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [206] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [207] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [208] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [209] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [210] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [211] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [212] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [213] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [214] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [215] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [216] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [217] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [218] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [219] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [220] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [221] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [222] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [223] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [224] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [225] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [226] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [227] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [228] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [229] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [230] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [231] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [232] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [233] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [234] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [235] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [236] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [237] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [238] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [239] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [240] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [241] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [242] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [243] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [244] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [245] Digital-twin imaging based on descattering Gaussian splatting
...
#### [246] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [247] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [248] BOGausS: Better Optimized Gaussian Splatting
...
#### [249] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [250] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [251] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [252] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [253] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [254] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [255] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [256] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
