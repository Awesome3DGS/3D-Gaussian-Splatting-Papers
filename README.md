...
#### [1] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [2] Learning 3D Gaussians for Extremely Sparse-View Cone-Beam CT Reconstruction
...
#### [4] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [5] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [6] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [7] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [8] Lightweight Predictive 3D Gaussian Splats
...
#### [9] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [10] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [11] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [12] On Scaling Up 3D Gaussian Splatting Training
...
#### [13] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [14] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [15] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [16] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [17] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [18] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [19] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [20] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [21] LGS: A Light-weight 4D Gaussian Splatting for Efficient Surgical Scene Reconstruction
...
#### [22] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [23] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [24] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [25] E2GS: Event Enhanced Gaussian Splatting
...
#### [26] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [27] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [28] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [29] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [30] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [31] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [32] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [33] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [34] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [35] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [36] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [37] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [38] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [39] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [42] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [43] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [44] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [45] From Chaos to Clarity: 3DGS in the Dark
...
#### [46] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [47] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [48] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [49] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [50] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [51] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [52] Generalizable Human Gaussians from Single-View Image
...
#### [53] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [54] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [55] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [56] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [57] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [58] Localized Gaussian Point Management
...
#### [59] Gaussian Representation for Deformable Image Registration
...
#### [60] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [61] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [62] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [63] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [64] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [65] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [66] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [67] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [68] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [69] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [70] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [71] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [72] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [73] Tetrahedron Splatting for 3D Generation
...
#### [74] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [75] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [76] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [77] SuperGaussian: Repurposing Video Models for 3D Super Resolution
...
#### [78] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [79] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
