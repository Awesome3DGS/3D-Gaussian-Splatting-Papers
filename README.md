...
#### [2] DriveGen3D: Boosting Feed-Forward Driving Scene Generation with Efficient Video Diffusion
...
#### [3] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [4] Terra: Explorable Native 3D World Model with Point Latents
...
#### [6] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [7] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [8] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [9] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [10] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [12] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [13] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [14] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [15] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [16] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [17] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [18] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [19] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [20] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [21] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [22] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [23] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [24] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [25] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [26] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [27] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [28] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [29] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [30] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [31] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [32] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [35] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [36] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [37] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [38] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [39] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [40] ReSplat: Learning Recurrent Gaussian Splats
...
#### [41] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [42] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [43] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [44] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [45] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [46] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [47] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [48] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [49] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [50] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [52] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [53] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [54] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [55] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [57] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [58] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [59] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [60] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [61] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [62] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [63] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [64] HART: Human Aligned Reconstruction Transformer
...
#### [65] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [66] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [67] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [68] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [69] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [70] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [71] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [72] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [73] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [74] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [75] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [76] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [77] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [78] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [79] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [80] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [81] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [82] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [83] Learning Unified Representation of 3D Gaussian Splatting
...
#### [84] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [85] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [86] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [87] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [88] Large Material Gaussian Model for Relightable 3D Generation
...
#### [89] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [90] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [91] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [92] 4D Driving Scene Generation With Stereo Forcing
...
#### [93] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [94] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [95] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [96] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
...
#### [97] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [98] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [99] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [100] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [101] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [103] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [104] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [105] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [106] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [107] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [108] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [109] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [110] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [111] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [112] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [113] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [114] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [115] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [116] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [117] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [118] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [119] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [120] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [121] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [122] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [123] Camera Splatting for Continuous View Optimization
...
#### [124] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [125] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [126] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [127] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [128] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [129] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [130] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [131] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [132] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [133] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [134] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [135] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [136] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [138] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [139] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [140] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [141] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [142] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [143] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [144] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [145] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [146] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [147] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [148] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [149] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [150] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [151] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [152] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [153] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [154] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [155] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [156] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [157] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [158] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [159] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [160] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [161] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [162] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [163] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [164] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [165] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [166] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [167] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [168] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [169] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [170] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [171] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [172] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [173] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [174] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [175] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [176] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [177] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [178] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [179] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [180] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [181] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [182] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [183] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [184] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [185] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [186] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [187] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [188] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [189] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [190] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [191] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [192] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [193] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [194] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [195] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [196] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [197] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [198] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [199] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [200] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [201] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [202] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [203] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [204] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [205] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [206] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [207] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [208] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [209] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [210] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [211] SAGOnline: Segment Any Gaussians Online
...
#### [212] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [213] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [214] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [215] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [216] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [217] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [218] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [219] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [220] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [221] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [222] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [223] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [224] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [225] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [226] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [227] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [228] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [229] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [230] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [231] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [232] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [233] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [234] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [235] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [236] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [237] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [238] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [239] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [240] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [241] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [242] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [243] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [244] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [245] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [246] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [247] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [248] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [249] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [250] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [251] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [252] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [253] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [254] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [255] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [256] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [257] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [258] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [259] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [260] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [261] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [262] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [263] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [264] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [265] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [266] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [267] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [268] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [269] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [270] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [271] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [272] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [273] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [274] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [275] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [276] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [277] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [278] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [279] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [280] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [281] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [282] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [283] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [284] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [285] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [286] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [287] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [288] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [289] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [290] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [291] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [292] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [293] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [294] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [295] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [296] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [297] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [298] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [299] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [300] Masks make discriminative models great again!
...
#### [301] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [302] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [303] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
