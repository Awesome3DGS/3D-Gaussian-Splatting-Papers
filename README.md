...
**⚡ 快捷链接**: [[10](#10-periodic-vibration-gaussian-dynamic-urban-scene-reconstruction-and-real-time-rendering)]
                 [[30](#30-4dgen-grounded-4d-content-generation-with-spatial-temporal-consistency)]
                 [[50](#50-rig3dgs-creating-controllable-portraits-from-casual-monocular-videos)]
                 [[70](#70-texture-gs-disentangling-the-geometry-and-texture-for-3d-gaussian-splatting-editing)]
                 [[90](#90-radsplat-radiance-field-informed-gaussian-splatting-for-robust-real-time-rendering-with-900-fps)]
                 [[100](#100-octree-gs-towards-consistent-real-time-rendering-with-lod-structured-3d-gaussians)]
                 [[120](#120-z-splat-z-axis-gaussian-splatting-for-camera-sonar-fusion)]
                 [[140](#140-deblurgs-gaussian-splatting-for-camera-motion-blur)]
                 [[160](#160-efficient-data-driven-scene-simulation-using-robotic-surgery-videos-via-physics-embedded-3d-gaussians)]
                 [[180](#180-moss-motion-based-3d-clothed-human-synthesis-from-monocular-video)]
                 [[200](#200-memorize-what-matters-emergent-scene-decomposition-from-multitraverse)]
                 [[220](#220-tambridge-bridging-frame-centered-tracking-and-3d-gaussian-splatting-for-enhanced-slam)]（最新）
...
- [[SIGGRAPH2024](./SIGGRAPH2024.md)] (8 篇)
  [[IJCAI2024](./IJCAI2024.md)] (1 篇)
  [[ECCV2024](./ECCV2024.md)](44 篇)
  [[MICCAI2024](./MICCAI2024.md)](2 篇)
  [[ACMMM2024](./ACMMM2024.md)](1 篇)
...
#### [7] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [8] LightGaussian: Unbounded 3D Gaussian Compression with 15x Reduction and 200+ FPS
...
#### [9] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [10] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [11] SparseGS: Real-Time 360° Sparse View Synthesis using Gaussian Splatting
...
#### [12] MD-Splatting: Learning Metric Deformation from 4D Gaussians in Highly Deformable Scenes
...
#### [13] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [15] GaussianHead: Impressive 3D Gaussian-based Head Avatars with Dynamic Hybrid Neural Field
...
#### [16] MonoGaussianAvatar: Monocular Gaussian Point-based Head Avatar
...
#### [17] EAGLES: Efficient Accelerated 3D Gaussians with Lightweight EncodingS
...
#### [18] GIR: 3D Gaussian Inverse Rendering for Relightable Scene Factorization
...
#### [19] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [20] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [21] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [22] GauFRe: Gaussian Deformation Fields for Real-time Dynamic Novel View Synthesis
...
#### [23] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [24] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [25] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [26] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [27] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [28] 2D-Guided 3D Gaussian Segmentation
...
#### [29] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [30] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [31] FMGS: Foundation Model Embedded 3D Gaussian Splatting for Holistic 3D Scene Understanding
...
#### [32] PEGASUS: Physically Enhanced Gaussian Splatting Simulation System for 6DOF Object Pose Dataset Generation
...
#### [33] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
...
#### [34] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [35] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [36] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [37] TRIPS: Trilinear Point Splatting for Real-Time Radiance Field Rendering
...
#### [38] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [39] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [40] EndoGaussian: Gaussian Splatting for Deformable Surgical Scene Reconstruction
...
#### [41] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [42] LIV-GaussMap: LiDAR-Inertial-Visual Fusion for Real-time 3D Radiance Field Map Rendering
...
#### [43] Gaussian Splashing: Dynamic Fluid Synthesis with Gaussian Splatting
...
#### [44] Endo-4DGS: Distilling Depth Ranking for Endoscopic Monocular Scene Reconstruction with 4D Gaussian Splatting
...
#### [45] Segment Anything in 3D Gaussians
...
#### [46] On the Error Analysis of 3D Gaussian Splatting and an Optimal Projection Strategy
...
#### [47] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [48] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [49] SGS-SLAM: Semantic Gaussian Splatting For Neural Dense SLAM
...
#### [50] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [51] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [52] GaussianObject: Just Taking Four Images to Get A High-Quality 3D Object with Gaussian Splatting
...
#### [53] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [54] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
- **🧑‍🔬 作者**：Joongho Jo, Hyeongwon Kim, Jongsun Park
- **🏫 单位**：Korea University
- **🔗 链接**：[[中英摘要](./abs/2402.13827.md)] [[arXiv:2402.13827](https://arxiv.org/abs/2402.13827)] [Code]
- **📝 说明**：✏️

#### [55] Spec-Gaussian: Anisotropic View-Dependent Appearance for 3D Gaussian Splatting
...
#### [56] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [57] 3D Gaussian Model for Animation and Texturing
...
#### [58] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [59] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [60] SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM
...
#### [61] StyleGaussian: Instant 3D Style Transfer with Gaussian Splatting
...
#### [62] ManiGaussian: Dynamic Gaussian Splatting for Multi-task Robotic Manipulation
...
#### [63] Gaussian Splatting in Style
...
#### [64] A New Split Algorithm for 3D Gaussian Splatting
...
#### [65] Hyper-3DG: Text-to-3D Gaussian Generation via Hypergraph
...
#### [66] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [67] GaussianGrasper: 3D Language Gaussian Splatting for Open-vocabulary Robotic Grasping
...
#### [68] Touch-GS: Visual-Tactile Supervised 3D Gaussian Splatting
...
#### [69] Controllable Text-to-3D Generation via Surface-Aligned Gaussian Splatting
...
#### [70] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [71] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [72] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [73] GS-Pose: Cascaded Framework for Generalizable Segmentation-based 6D Object Pose Estimation
...
#### [74] DarkGS: Learning Neural Illumination and 3D Gaussians Relighting for Robotic Exploration in the Dark
...
#### [76] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [77] 3DGS-ReLoc: 3D Gaussian Splatting for Map Representation and Visual ReLocalization
...
#### [78] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [79] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [80] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [81] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [82] 3DGS-Calib: 3D Gaussian Splatting for Multimodal SpatioTemporal Calibration
...
#### [83] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [84] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [85] NEDS-SLAM: A Novel Neural Explicit Dense Semantic SLAM Framework using 3D Gaussian Splatting
...
#### [86] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [87] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [88] High-Fidelity SLAM Using Gaussian Splatting with Rendering-Guided Densification and Regularized Optimization
...
#### [90] RadSplat: Radiance Field-Informed Gaussian Splatting for Robust Real-Time Rendering with 900+ FPS
...
#### [92] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [93] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [94] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [95] Gaussian in the Wild: 3D Gaussian Splatting for Unconstrained Image Collections
...
#### [96] GSDF: 3DGS Meets SDF for Improved Rendering and Reconstruction
...
#### [97] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [98] DN-Splatter: Depth and Normal Priors for Gaussian Splatting and Meshing
...
#### [99] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [100] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [101] Modeling uncertainty for Gaussian Splatting
...
#### [102] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [103] Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction
...
#### [104] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [105] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [106] GaussianCube: Structuring Gaussian Splatting using Optimal Transport for 3D Generative Modeling
...
#### [107] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [108] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [109] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [112] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [113] MM3DGS SLAM: Multi-modal 3D Gaussian Splatting for SLAM Using Vision, Depth, and Inertial Measurements
...
#### [114] Mirror-3DGS: Incorporating Mirror Reflections into 3D Gaussian Splatting
...
#### [115] Feature Splatting: Language-Driven Physics-Based Scene Synthesis and Editing
...
#### [116] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [117] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [118] OmniGS: Omnidirectional Gaussian Splatting for Fast Radiance Field Reconstruction using Omnidirectional Images
...
#### [120] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [121] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [122] Dual-Camera Smooth Zoom on Mobile Phones
...
#### [123] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [124] Revising Densification in Gaussian Splatting
...
#### [125] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [126] Gaussian-LIC: Photo-realistic LiDAR-Inertial-Camera SLAM with 3D Gaussian Splatting
...
#### [127] RealmDreamer: Text-Driven 3D Scene Generation with Inpainting and Depth Diffusion
...
#### [128] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [129] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [130] LoopGaussian: Creating 3D Cinemagraph with Multi-view Images via Eulerian Motion Field
...
#### [131] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [132] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [133] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [134] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [135] 3D Gaussian Splatting as Markov Chain Monte Carlo
...
#### [136] LetsGo: Large-Scale Garage Modeling and Rendering via LiDAR-Assisted Gaussian Primitives
...
#### [137] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [138] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [139] Gaussian Opacity Fields: Efficient and Compact Surface Reconstruction in Unbounded Scenes
...
#### [140] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [141] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [142] Dynamic Gaussians Mesh: Consistent Mesh Reconstruction from Monocular Videos
...
#### [143] Does Gaussian Splatting need SFM Initialization?
...
#### [144] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [145] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [146] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [147] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [148] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [149] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [150] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [151] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [152] 3D Gaussian Splatting with Deferred Reflection
...
#### [153] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [154] MeGA: Hybrid Mesh-Gaussian Head Avatar for High-Fidelity Rendering and Head Editing
...
#### [155] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [156] SAGS: Structure-Aware 3D Gaussian Splatting
...
#### [157] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [158] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [159] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [160] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [161] HoloGS: Instant Depth-based 3D Gaussian Splatting with Microsoft HoloLens 2
...
#### [162] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [163] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [164] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2405.05446.md)] [[arXiv:2405.05446](https://arxiv.org/abs/2405.05446)] [Code]
- **📝 说明**：✏️

#### [165] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [166] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [167] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [168] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06547.md)] [[arXiv:2405.06547](https://arxiv.org/abs/2405.06547)] [[Code](https://github.com/lin-jinwei/OneTo3D)]
- **📝 说明**：✏️

#### [169] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [170] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [171] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [172] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [173] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [174] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [175] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [176] AtomGS: Atomizing Gaussian Splatting for High-Fidelity Radiance Field
...
#### [177] GarmentDreamer: 3DGS Guided Garment Synthesis with Diverse Geometry and Texture Details
...
#### [178] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [179] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [180] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [181] Gaussian Time Machine: A Real-Time Rendering Methodology for Time-Variant Appearances
...
#### [182] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [183] DoGaussian: Distributed-Oriented Gaussian Splatting for Large-Scale 3D Reconstruction Via Gaussian Consensus
...
#### [184] NeuroGauss4D-PCI: 4D Neural Fields and Gaussian Deformation Fields for Point Cloud Interpolation
...
#### [185] D-MiSo: Editing Dynamic 3D Scenes using Multi-Gaussians Soup
...
#### [186] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [187] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [188] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [189] GS-Hider: Hiding Messages into 3D Gaussian Splatting
...
#### [190] HDR-GS: Efficient High Dynamic Range Novel View Synthesis at 1000x Speed via Gaussian Splatting
...
#### [191] DisC-GS: Discontinuity-aware Gaussian Splatting
...
#### [192] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [193] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [194] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [195] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [196] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [197] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [198] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [199] F-3DGS: Factorized Coordinates and Representations for 3D Gaussian Splatting
...
#### [200] Memorize What Matters: Emergent Scene Decomposition from Multitraverse
...
#### [201] DOF-GS: Adjustable Depth-of-Field 3D Gaussian Splatting for Refocusing,Defocus Rendering and Blur Removal
...
#### [202] GOI: Find 3D Gaussians of Interest with an Optimizable Open-vocabulary Semantic-space Hyperplane
...
#### [203] DC-Gaussian: Improving 3D Gaussian Splatting for Reflective Dash Cam Videos
...
#### [204] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
...
#### [205] Mani-GS: Gaussian Splatting Manipulation with Triangular Mesh
...
#### [206] HFGS: 4D Gaussian Splatting with Emphasis on Spatial and Temporal High-Frequency Components for Endoscopic Scene Reconstruction
...
#### [207] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [208] FreeSplat: Generalizable 3D Gaussian Splatting Towards Free-View Synthesis of Indoor Scenes
...
#### [209] RT-GS2: Real-Time Generalizable Semantic Segmentation for 3D Gaussian Representations of Radiance Fields
...
#### [210] EG4D: Explicit Generation of 4D Object without Score Distillation
...
#### [211] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [212] NegGS: Negative Gaussian Splatting
...
#### [213] 3D StreetUnveiler with Semantic-Aware 2DGS
...
#### [214] 3DitScene: Editing Any Scene via Language-guided Disentangled Gaussian Splatting
...
#### [215] GFlow: Recovering 4D World from Monocular Video
...
#### [216] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [217] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [218] DGD: Dynamic 3D Gaussians Distillation
...
#### [219] NPGA: Neural Parametric Gaussian Avatars
...
#### [220] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [221] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [222] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [223] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [224] Object-centric Reconstruction and Tracking of Dynamic Unknown Objects using 3D Gaussian Splatting
...
#### [225] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [226] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [227] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [228] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [229] R2-Gaussian: Rectifying Radiative Gaussian Splatting for Tomographic Reconstruction
...
#### [230] ContextGS: Compact 3D Gaussian Splatting with Anchor Level Context Model
...
#### [231] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
