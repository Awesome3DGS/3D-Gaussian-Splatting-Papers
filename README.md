...
#### [2] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [3] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [4] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [5] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [6] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [7] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [9] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [10] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [11] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [12] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [13] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [14] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [15] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [16] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [17] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [18] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [19] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [20] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [21] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [22] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [23] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [24] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [25] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [26] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [27] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [28] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [29] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [30] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [31] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [32] OmniRe: Omni Urban Scene Reconstruction
...
#### [33] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [34] G-Style: Stylized Gaussian Splatting
...
#### [35] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [36] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [37] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [38] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [39] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [40] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [41] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [42] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [43] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [44] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [45] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [46] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [47] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [48] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [49] Subsurface Scattering for 3D Gaussian Splatting
...
#### [50] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [51] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [52] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [53] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [54] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [55] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [56] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [57] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [58] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [59] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [60] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [61] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [62] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [63] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [64] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [65] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [66] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [71] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [72] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [73] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [74] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [75] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [81] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [88] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [89] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [91] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [92] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [93] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [94] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [95] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [96] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [97] Gaussian Splatting Lucas-Kanade
...
#### [98] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [99] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [100] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [101] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [102] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [103] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [104] PICA: Physics-Integrated Clothed Avatar
...
#### [105] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [106] Gaussian Eigen Models for Human Heads
...
#### [108] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [109] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [110] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [111] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [112] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [113] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [114] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [115] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [116] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [117] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [118] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [119] Lightweight Predictive 3D Gaussian Splats
...
#### [120] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [121] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [122] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [123] On Scaling Up 3D Gaussian Splatting Training
...
#### [124] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [125] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [126] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [127] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [128] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [129] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [130] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [131] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [132] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [133] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [134] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [135] E2GS: Event Enhanced Gaussian Splatting
...
#### [136] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [137] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [138] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [139] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [140] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [141] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [142] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [143] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [144] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [145] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [146] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [147] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [148] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [149] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [150] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [151] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [152] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [153] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [154] From Chaos to Clarity: 3DGS in the Dark
...
#### [155] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [156] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [157] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [158] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [159] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [160] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [161] Generalizable Human Gaussians from Single-View Image
...
#### [162] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [163] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [164] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [165] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [166] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [167] Localized Gaussian Point Management
...
#### [168] Gaussian Representation for Deformable Image Registration
...
#### [169] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [170] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [171] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [172] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [173] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [174] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [175] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [176] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [177] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [178] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [179] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [180] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [181] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [182] Tetrahedron Splatting for 3D Generation
...
#### [183] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [184] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [185] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [186] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
