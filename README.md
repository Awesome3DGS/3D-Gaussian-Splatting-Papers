...
#### [3] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [4] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [5] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [6] IG-SLAM: Instant Gaussian SLAM
...
#### [7] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [8] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [9] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [10] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [11] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [12] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [13] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [14] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [15] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [16] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [17] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [18] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [19] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [20] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [21] Gaussian Splatting Lucas-Kanade
...
#### [22] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [23] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [24] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [25] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [26] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [27] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [28] PICA: Physics-Integrated Clothed Avatar
...
#### [29] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [30] Gaussian Eigen Models for Human Heads
...
#### [32] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [33] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [34] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [35] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [36] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [37] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [38] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [39] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [40] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [41] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [42] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [43] Lightweight Predictive 3D Gaussian Splats
...
#### [44] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [45] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [46] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [47] On Scaling Up 3D Gaussian Splatting Training
...
#### [48] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [49] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [50] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [51] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [52] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [53] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [54] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [55] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [56] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [57] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [58] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [59] E2GS: Event Enhanced Gaussian Splatting
...
#### [60] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [61] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [62] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [63] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [64] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [65] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [66] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [67] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [68] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [69] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [70] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [71] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [72] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [73] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [74] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [75] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [76] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [77] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [78] From Chaos to Clarity: 3DGS in the Dark
...
#### [79] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [80] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [81] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [82] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [83] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [84] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [85] Generalizable Human Gaussians from Single-View Image
...
#### [86] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [87] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [88] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [89] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [90] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [91] Localized Gaussian Point Management
...
#### [92] Gaussian Representation for Deformable Image Registration
...
#### [93] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [94] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [95] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [96] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [97] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [98] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [99] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [100] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [101] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [102] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [103] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [104] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [105] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [106] Tetrahedron Splatting for 3D Generation
...
#### [107] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [108] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [109] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [110] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
