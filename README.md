...
#### [1] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [2] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [3] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [4] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [5] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [7] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [8] Template-free Articulated Gaussian Splatting for Real-time Reposable Dynamic View Synthesis
...
#### [9] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
- **🧑‍🔬 作者**：Wenqing Wang, Yun Fu
- **🏫 单位**：Northeastern University, USA ⟐  360 Huntington Ave, Boston, MA 02115
- **🔗 链接**：[[中英摘要](./abs/2412.05560.md)] [[arXiv:2412.05560](https://arxiv.org/abs/2412.05560)] [Code]
- **📝 说明**：

#### [10] Street Gaussians without 3D Object Tracker
...
#### [11] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [12] Extrapolated Urban View Synthesis Benchmark
...
#### [13] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [14] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [15] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [16] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [17] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [18] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [19] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [20] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [21] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [22] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [23] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [24] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [25] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [26] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [27] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [28] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [29] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [30] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [31] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [32] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [33] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [34] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [35] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [36] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [37] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [64] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [65] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [66] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [67] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [68] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [69] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [70] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [71] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [72] Neural Surface Priors for Editable Gaussian Splatting
...
#### [73] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [74] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [75] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [76] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [77] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [78] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [79] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [80] Geometry Field Splatting with Gaussian Surfels
...
#### [81] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [82] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [83] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [84] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [85] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [86] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [87] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [88] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [89] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [90] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [91] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [92] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [93] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [94] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [95] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [96] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [97] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [98] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [99] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [100] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [101] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [102] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [103] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [104] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [105] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [106] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [107] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [108] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [109] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [110] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [111] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [112] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [113] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [114] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [115] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [116] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [117] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [118] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [119] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [120] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [121] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [122] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [123] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [124] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [125] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [126] VeGaS: Video Gaussian Splatting
...
#### [127] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [128] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [129] Efficient Density Control for 3D Gaussian Splatting
...
#### [130] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [131] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [132] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [133] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [134] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [135] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [136] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [137] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [138] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [139] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [140] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [141] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [142] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [143] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [144] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [145] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [146] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [147] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [148] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [149] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [150] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [151] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [152] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [153] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [154] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [155] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [156] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [157] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [158] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [159] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [160] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [161] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [162] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [163] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [168] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [169] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [170] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [173] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [174] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [175] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [176] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [177] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [178] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [179] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [180] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [181] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [182] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [183] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [184] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [185] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [186] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [187] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [188] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [189] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [190] 3D Vision-Language Gaussian Splatting
...
#### [191] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [192] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [193] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [194] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [195] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [196] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [197] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [198] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [199] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [200] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [201] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [202] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [203] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [204] Variational Bayes Gaussian Splatting
...
#### [205] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [206] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [207] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [208] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [209] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [236] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [237] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [238] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [239] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [240] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [241] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [242] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [243] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [244] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [245] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [246] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [247] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [248] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [249] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [250] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [251] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [252] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [253] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [254] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [255] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [256] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [257] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [258] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [259] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [260] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [261] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [262] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [263] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [264] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [266] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [267] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [268] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [269] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [270] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [271] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [272] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [273] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [274] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [275] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [276] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [277] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [278] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [279] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [280] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [281] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [282] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [283] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [284] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [285] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [286] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [287] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [288] OmniRe: Omni Urban Scene Reconstruction
...
#### [289] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [290] G-Style: Stylized Gaussian Splatting
...
#### [291] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [292] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [293] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [294] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [295] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [296] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [297] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [298] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [299] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [300] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [301] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [302] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [303] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [304] Subsurface Scattering for 3D Gaussian Splatting
...
#### [305] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [306] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [307] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [308] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [309] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [310] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [311] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [312] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [313] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [314] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [315] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [316] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [317] 3D Gaussian Editing with A Single Image
...
#### [318] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [319] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [320] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [321] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [322] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [323] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [324] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [325] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [326] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [327] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [328] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [329] IG-SLAM: Instant Gaussian SLAM
...
#### [330] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [331] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [332] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [333] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [334] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [335] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [336] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [337] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [338] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [339] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [340] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [341] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [342] Gaussian Splatting Lucas-Kanade
...
#### [343] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [344] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [345] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [346] PICA: Physics-Integrated Clothed Avatar
...
#### [347] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [348] Gaussian Eigen Models for Human Heads
...
#### [350] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [351] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [352] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [353] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [354] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [355] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [356] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [357] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [358] Lightweight Predictive 3D Gaussian Splats
...
#### [359] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [360] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [361] On Scaling Up 3D Gaussian Splatting Training
...
#### [362] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [363] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [364] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [365] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [366] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [367] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [368] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [369] E2GS: Event Enhanced Gaussian Splatting
...
#### [370] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [371] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [372] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [373] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [374] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [375] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [376] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [377] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [378] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [379] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [380] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [381] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [382] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [383] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [384] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [385] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [386] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [387] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [388] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [389] Generalizable Human Gaussians from Single-View Image
...
#### [390] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [391] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [392] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [393] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [394] Localized Gaussian Point Management
...
#### [395] Gaussian Representation for Deformable Image Registration
...
#### [396] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [397] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [398] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [399] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [400] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [401] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [402] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [403] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [404] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [405] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [406] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
