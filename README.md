...
#### [3] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [4] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [5] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [6] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [7] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [8] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [9] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [11] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [14] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [15] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [16] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [17] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [18] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [19] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [20] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [21] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [22] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [23] Reflective Gaussian Splatting
...
#### [24] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [25] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [26] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [27] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [28] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [29] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [30] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [31] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [32] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [33] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [34] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [35] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [36] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [37] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [38] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [39] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [40] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [41] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [42] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [43] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [44] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [45] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [46] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [47] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [48] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [49] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [50] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [51] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [52] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [53] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [54] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [55] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [56] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [57] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [58] EOGS: Gaussian Splatting for Earth Observation
...
#### [59] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [60] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [61] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [62] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [63] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [64] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [65] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [66] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [67] Deformable Radial Kernel Splatting
...
#### [68] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [69] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [70] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [71] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [72] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [73] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [74] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [75] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [76] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [77] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [78] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [79] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [80] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [81] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [82] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [83] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [84] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [85] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [86] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [87] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [88] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [89] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [90] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [91] GASP: Gaussian Avatars with Synthetic Priors
...
#### [92] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [93] Faster and Better 3D Splatting via Group Training
...
#### [94] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [95] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [96] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [97] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [98] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [99] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [100] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [101] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [102] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [103] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [104] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [105] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [106] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [107] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [108] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [109] Street Gaussians without 3D Object Tracker
...
#### [110] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [111] Extrapolated Urban View Synthesis Benchmark
...
#### [112] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [113] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [114] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [115] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [116] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [117] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [118] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [119] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [120] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [121] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [122] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [123] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [124] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [125] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [126] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [127] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [128] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [129] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [130] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [131] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [132] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [133] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [134] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [135] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [136] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [137] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [138] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [139] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [140] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [141] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [142] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [143] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [144] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [145] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [146] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [147] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [148] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [149] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [150] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [151] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [152] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [153] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [154] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [155] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [156] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [157] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [158] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [159] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [160] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [161] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [162] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [163] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [164] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [165] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [166] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [167] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [168] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [169] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [170] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [171] Neural Surface Priors for Editable Gaussian Splatting
...
#### [172] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [173] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [174] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [175] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [176] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [177] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [178] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [179] Geometry Field Splatting with Gaussian Surfels
...
#### [180] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [181] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [182] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [183] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [184] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [185] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [186] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [187] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [188] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [189] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [190] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [191] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [192] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [193] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [194] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [195] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [196] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [197] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [198] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [199] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [200] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [201] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [202] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [203] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [204] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [205] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [206] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [207] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [208] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [209] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [210] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [211] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [212] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [213] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [214] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [215] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [216] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [217] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [218] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [219] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [220] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [221] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [222] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [223] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [224] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [225] VeGaS: Video Gaussian Splatting
...
#### [226] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [227] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [228] Efficient Density Control for 3D Gaussian Splatting
...
#### [229] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [230] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [231] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [232] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [233] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [234] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [235] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [236] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [237] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [238] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [239] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [240] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [241] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [242] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [243] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [244] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [245] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [246] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [247] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [248] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [249] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [250] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [251] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [252] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [253] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [254] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [255] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [256] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [257] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [258] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [259] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [261] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [262] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [263] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [264] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [265] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [266] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [267] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [268] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [269] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [270] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [271] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [272] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [273] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [274] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [275] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [276] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [277] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [278] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [279] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [280] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [281] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [282] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [283] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [284] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [285] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [286] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [287] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [288] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [289] 3D Vision-Language Gaussian Splatting
...
#### [290] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [291] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [292] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [293] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [294] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [295] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [296] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [297] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [298] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [299] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [300] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [301] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [302] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [303] Variational Bayes Gaussian Splatting
...
#### [304] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [305] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [306] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [307] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [308] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [309] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [310] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [311] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [312] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [313] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [314] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [315] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [316] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [317] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [318] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [319] RNG: Relightable Neural Gaussians
...
#### [320] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [321] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [322] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [323] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [324] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [325] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [326] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [327] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [328] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [329] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [330] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [331] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [332] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [333] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [334] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [335] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [336] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [337] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [338] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [339] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [340] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [341] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [342] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [343] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [344] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [345] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [346] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [347] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [348] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [349] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [350] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [351] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [352] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [353] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [354] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [355] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [356] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [357] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [358] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [359] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [360] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [361] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [362] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [363] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [364] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [365] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [366] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [367] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [368] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [369] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [370] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [371] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [372] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [373] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [374] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [375] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [376] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [377] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [378] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [379] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [380] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [381] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [382] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [383] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [384] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [385] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [386] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [387] OmniRe: Omni Urban Scene Reconstruction
...
#### [388] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [389] G-Style: Stylized Gaussian Splatting
...
#### [390] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [391] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [392] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [393] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [394] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [395] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [396] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [397] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [398] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [399] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [400] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [401] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [402] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [403] Subsurface Scattering for 3D Gaussian Splatting
...
#### [404] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [405] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [406] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [407] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [408] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [409] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [410] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [411] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [412] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [413] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [414] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [415] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [416] 3D Gaussian Editing with A Single Image
...
#### [417] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [418] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [419] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [420] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [421] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [422] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [423] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [424] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [425] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [426] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [427] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [428] IG-SLAM: Instant Gaussian SLAM
...
#### [429] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [430] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [431] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [432] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [433] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [434] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [435] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [436] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [437] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [438] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [439] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [440] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [441] Gaussian Splatting Lucas-Kanade
...
#### [442] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [443] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [444] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [445] PICA: Physics-Integrated Clothed Avatar
...
#### [446] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [447] Gaussian Eigen Models for Human Heads
...
#### [449] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [450] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [451] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [452] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [453] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [454] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [455] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [456] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [457] Lightweight Predictive 3D Gaussian Splats
...
#### [458] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [459] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [460] On Scaling Up 3D Gaussian Splatting Training
...
#### [461] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [462] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [463] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [464] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [465] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [466] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [467] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [468] E2GS: Event Enhanced Gaussian Splatting
...
#### [469] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [470] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [471] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [472] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [473] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [474] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [475] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [476] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [477] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [478] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [479] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [480] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [481] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [482] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [483] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [484] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [485] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [486] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [487] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [488] Generalizable Human Gaussians from Single-View Image
...
#### [489] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [490] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [491] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [492] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [493] Localized Gaussian Point Management
...
#### [494] Gaussian Representation for Deformable Image Registration
...
#### [495] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [496] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [497] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [498] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [499] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [500] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [501] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [502] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [503] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [504] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
