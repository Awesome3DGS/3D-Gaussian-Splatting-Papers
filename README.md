...
- [[SIGGRAPH2024](./SIGGRAPH2024.md)] (14 篇)
  [[IJCAI2024](./IJCAI2024.md)] (1 篇)
  [[ECCV2024](./ECCV2024.md)] (71 篇)
...
#### [1] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [2] Neural Signed Distance Function Inference through Splatting 3D Gaussians Pulled on Zero-Level Set
- **🧑‍🔬 作者**：Wenyuan Zhang, Yu-Shen Liu, Zhizhong Han
- **🏫 单位**：Tsinghua University ⟐ Wayne State University
- **🔗 链接**：[[中英摘要](./abs/2410.14189.md)] [[arXiv:2410.14189](https://arxiv.org/abs/2410.14189)] [Code]
- **📝 说明**：🏆 Accepted to NeurIPS 2024

#### [3] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [5] DN-4DGS: Denoised Deformable Network with Temporal-Spatial Aggregation for Dynamic Scene Rendering
...
#### [6] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [8] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [9] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [10] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [11] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [12] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [13] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [14] GS^3: Efficient Relighting with Triple Gaussian Splatting
...
#### [15] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [16] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [17] Scalable Indoor Novel-View Synthesis using Drone-Captured 360 Imagery with 3D Gaussian Splatting
...
#### [18] Few-shot Novel View Synthesis using Depth Aware 3D Gaussian Splatting
...
#### [20] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [21] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [22] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [23] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [25] Learning Interaction-aware 3D Gaussian Splatting for One-shot Hand Avatars
...
- **🔗 链接**：[[中英摘要](./abs/2410.08840.md)] [[arXiv:2410.08840](https://arxiv.org/abs/2410.08840)] [[Code](https://github.com/XuanHuang0/GuassianHan)]
- **📝 说明**：🏆 Accepted to NeurIPS 2024

#### [26] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [27] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [28] Neural Material Adaptor for Visual Grounding of Intrinsic Dynamics
...
#### [29] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [30] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [31] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [32] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [33] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [34] Generalizable and Animatable Gaussian Head Avatar
...
#### [35] MotionGS: Exploring Explicit Motion Guidance for Deformable 3D Gaussian Splatting
...
#### [36] 3D Vision-Language Gaussian Splatting
...
#### [37] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [39] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [40] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [41] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [42] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [43] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [44] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [45] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [46] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [47] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [48] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [49] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [50] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [51] Variational Bayes Gaussian Splatting
...
#### [52] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [53] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [54] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [55] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [56] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [57] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [58] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [59] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [60] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [61] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [62] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [63] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [64] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [65] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [66] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [67] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [68] RNG: Relightable Neural Gaussians
...
#### [69] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [70] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [71] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [72] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [73] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [74] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [75] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [76] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [77] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [78] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [79] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [80] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [81] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [82] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [83] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [84] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [85] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [86] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [87] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [88] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [89] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [90] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [91] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [92] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [93] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [94] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [95] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [96] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [97] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [98] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [99] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [100] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [101] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [102] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [103] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [104] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [105] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [106] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [107] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [108] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [109] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [110] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [111] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [112] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [113] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [114] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [115] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [116] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [117] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [118] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [119] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [120] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [121] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [122] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [123] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [124] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [125] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [126] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [127] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [128] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [129] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [130] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [131] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [132] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [133] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [134] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [135] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [136] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [137] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [138] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [139] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [140] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [141] OmniRe: Omni Urban Scene Reconstruction
...
#### [142] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [143] G-Style: Stylized Gaussian Splatting
...
#### [144] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [145] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [146] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [147] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [148] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [149] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [150] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [151] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [152] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [153] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [154] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [155] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [156] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [157] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [158] Subsurface Scattering for 3D Gaussian Splatting
...
#### [159] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [160] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [161] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [162] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [163] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [164] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [165] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [166] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [167] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [168] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [169] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [170] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [171] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [172] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [173] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [174] 3D Gaussian Editing with A Single Image
...
#### [175] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [176] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [177] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [178] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [179] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [180] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [181] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
...
#### [182] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [183] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [184] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [185] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [186] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [187] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [188] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [189] IG-SLAM: Instant Gaussian SLAM
...
#### [190] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [191] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [192] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [193] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [194] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [195] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [196] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [197] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [198] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [199] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [200] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [201] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [202] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [203] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [204] Gaussian Splatting Lucas-Kanade
...
#### [205] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [206] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [207] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [208] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [209] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [210] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [211] PICA: Physics-Integrated Clothed Avatar
...
#### [212] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [213] Gaussian Eigen Models for Human Heads
...
#### [215] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [216] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [217] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [218] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [219] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [220] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [221] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [222] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [223] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [224] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [225] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [226] Lightweight Predictive 3D Gaussian Splats
...
#### [227] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [228] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [229] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [230] On Scaling Up 3D Gaussian Splatting Training
...
#### [231] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [232] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [233] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [234] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [235] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [236] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [237] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [238] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [239] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [240] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [241] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [242] E2GS: Event Enhanced Gaussian Splatting
...
#### [243] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [244] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [245] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [246] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [247] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [248] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [249] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [250] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [251] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [252] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [253] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [254] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [255] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [256] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [257] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [258] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [259] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [260] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [261] From Chaos to Clarity: 3DGS in the Dark
...
#### [262] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [263] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [264] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [265] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [266] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [267] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [268] Generalizable Human Gaussians from Single-View Image
...
#### [269] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [270] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [271] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [272] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [273] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [274] Localized Gaussian Point Management
...
#### [275] Gaussian Representation for Deformable Image Registration
...
#### [276] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [277] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [278] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [279] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [280] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [281] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [282] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [283] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [284] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [285] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [286] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [287] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [288] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [289] Tetrahedron Splatting for 3D Generation
...
#### [290] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [291] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [292] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [293] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
