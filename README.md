...
#### [1] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [2] Variational Bayes Gaussian Splatting
...
#### [3] Flash-Splat: 3D Reflection Removal with Flash Cues and Gaussian Splats
...
#### [4] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [5] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [6] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [7] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [8] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [9] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [10] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [12] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [13] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [14] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
...
#### [16] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [17] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [18] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [19] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [20] RNG: Relightable Neural Gaussians
...
#### [21] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [22] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [23] Gaussian Heritage: 3D Digitization of Cultural Heritage with Integrated Object Segmentation
...
#### [24] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [25] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [26] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [27] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [28] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [29] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [30] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [31] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [32] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [33] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [34] Low Latency Point Cloud Rendering with Learned Splatting
...
#### [35] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
- **🧑‍🔬 作者**：Gennady Sidorov, Malik Mohrat, Ksenia Lebedeva, Ruslan Rakhimov, Sergey Kolyubin
...
#### [36] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [37] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [38] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [39] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [40] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [41] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [42] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [43] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [44] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [45] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [46] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [47] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [48] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [49] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [50] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [51] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [52] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [53] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [54] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [55] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [56] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [57] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [58] SRIF: Semantic Shape Registration Empowered by Diffusion-based Image Morphing and Flow Estimation
...
#### [59] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [60] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [61] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [62] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [63] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [64] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [65] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [66] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [67] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [68] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [69] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [70] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [71] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [72] AdR-Gaussian: Accelerating Gaussian Splatting with Adaptive Radius
...
#### [73] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [74] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [75] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [76] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [77] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [78] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [79] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [80] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [81] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [82] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [83] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [84] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [85] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [86] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [87] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [88] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [89] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [90] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [91] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [92] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [93] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [94] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [95] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [96] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [97] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [98] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [99] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [100] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [101] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [102] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [103] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [104] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [105] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [106] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [108] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [109] G-Style: Stylized Gaussian Splatting
...
#### [110] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [111] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [112] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [113] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [114] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [115] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [116] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [117] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [118] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [119] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [120] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [121] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [122] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [123] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [124] Subsurface Scattering for 3D Gaussian Splatting
...
#### [125] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [126] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [127] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [128] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [129] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [130] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [131] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [132] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [133] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [134] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [135] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [136] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [137] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [138] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [139] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [140] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [141] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [142] 3D Gaussian Editing with A Single Image
...
#### [143] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [144] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [145] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [146] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [147] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [148] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [149] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [150] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [151] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [152] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [153] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [154] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [155] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [156] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [157] IG-SLAM: Instant Gaussian SLAM
...
#### [158] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [159] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [160] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [161] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [162] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [163] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [164] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [165] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [166] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [167] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [168] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [169] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [170] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [171] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [172] Gaussian Splatting Lucas-Kanade
...
#### [173] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [174] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [175] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [176] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [177] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [178] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [179] PICA: Physics-Integrated Clothed Avatar
...
#### [180] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [181] Gaussian Eigen Models for Human Heads
...
#### [183] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [184] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [185] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [186] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [187] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [188] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [189] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [190] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [191] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [192] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [193] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [194] Lightweight Predictive 3D Gaussian Splats
...
#### [195] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [196] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [197] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [198] On Scaling Up 3D Gaussian Splatting Training
...
#### [199] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [200] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [201] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [202] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [203] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [204] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [205] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [206] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [207] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [208] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [209] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [210] E2GS: Event Enhanced Gaussian Splatting
...
#### [211] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [212] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [213] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [214] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [215] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [216] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [217] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [218] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [219] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [220] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [221] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [222] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [223] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [224] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [225] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [226] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [227] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [228] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [229] From Chaos to Clarity: 3DGS in the Dark
...
#### [230] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [231] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [232] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [233] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [234] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [235] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [236] Generalizable Human Gaussians from Single-View Image
...
#### [237] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [238] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [239] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [240] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [241] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [242] Localized Gaussian Point Management
...
#### [243] Gaussian Representation for Deformable Image Registration
...
#### [244] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [245] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [246] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [247] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [248] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [249] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [250] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [251] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [252] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [253] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [254] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [255] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [256] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [257] Tetrahedron Splatting for 3D Generation
...
#### [258] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [259] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [260] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [261] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
