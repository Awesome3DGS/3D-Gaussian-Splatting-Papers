...
#### [1] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [4] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [5] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [7] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [9] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [10] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [11] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [12] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [13] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [14] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [15] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [17] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [18] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [19] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [20] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [21] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [22] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [23] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [24] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [25] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [26] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [27] Large-Scale Gaussian Splatting SLAM
...
#### [28] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [29] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [30] Neural Video Compression using 2D Gaussian Splatting
...
#### [31] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [32] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [33] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [34] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [35] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [36] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [37] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [38] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [39] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [40] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [42] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [43] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [44] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [45] SignSplat: Rendering Sign Language via Gaussian Splatting
...
#### [46] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [47] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [49] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [51] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [52] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [53] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [54] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [55] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [56] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [57] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [58] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [59] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [60] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [61] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [62] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [63] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [64] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [65] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [66] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [67] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [68] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [69] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [70] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [71] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [72] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [73] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [74] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [75] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [76] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [77] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [78] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [79] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [80] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [81] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [82] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [83] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [84] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [85] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [86] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [87] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [88] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [89] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [90] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [91] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [92] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [93] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [94] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [95] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [96] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [97] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [98] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [99] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [100] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [101] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [102] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [103] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [104] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [105] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [106] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [107] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [108] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [109] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [110] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [111] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [112] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [113] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [114] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [115] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [116] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [117] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [118] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [119] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [120] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [121] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [122] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [123] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [124] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [125] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [126] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [127] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [128] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [129] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [130] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [131] Digital-twin imaging based on descattering Gaussian splatting
...
#### [132] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [133] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [134] BOGausS: Better Optimized Gaussian Splatting
...
#### [135] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [136] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [137] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [138] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [140] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [141] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [142] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
