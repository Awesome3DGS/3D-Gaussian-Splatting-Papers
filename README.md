...
#### [1] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
...
#### [2] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [3] Lifting by Gaussians: A Simple, Fast and Flexible Method for 3D Instance Segmentation
...
#### [5] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [6] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [7] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [8] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [10] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [11] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [12] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [13] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [14] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [15] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [16] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [17] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [18] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [19] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [20] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [21] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [22] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [23] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [24] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [25] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [26] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [27] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [28] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [29] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [30] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [31] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [32] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [33] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [35] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [36] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [37] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [38] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [39] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [40] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [41] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [42] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [43] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [44] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [45] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [46] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [47] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [48] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [49] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [50] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [51] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [52] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [53] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [54] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [55] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [56] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [57] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [58] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [60] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [61] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [62] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [63] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [64] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [65] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [66] Gaussian Masked Autoencoders
...
#### [67] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [68] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [69] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [70] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [71] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [72] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [73] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [74] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [75] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [76] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [77] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [78] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [79] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [80] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [81] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [82] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [83] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [84] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [85] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [86] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [87] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [88] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [89] Reflective Gaussian Splatting
...
#### [90] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [91] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [92] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [93] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [94] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [95] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [96] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [97] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [98] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [99] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [100] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [101] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [102] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [103] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [104] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [105] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [106] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [107] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [108] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [109] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [110] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [111] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [112] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [113] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [114] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [115] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [116] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [117] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [118] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [119] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [120] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [121] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [122] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [123] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [124] EOGS: Gaussian Splatting for Earth Observation
...
#### [125] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [126] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [127] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [128] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [129] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [130] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [131] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [132] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [133] Deformable Radial Kernel Splatting
...
#### [134] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [135] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [136] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [137] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [138] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [139] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [140] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [141] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [142] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [143] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [144] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [145] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [146] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [147] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [148] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [149] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [150] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [151] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [152] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [153] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [154] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [155] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [156] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [157] GASP: Gaussian Avatars with Synthetic Priors
...
#### [158] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [159] Faster and Better 3D Splatting via Group Training
...
#### [160] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [161] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [162] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [163] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [164] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [165] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [166] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [167] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [168] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [169] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [170] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [171] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [172] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [173] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [174] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [175] Street Gaussians without 3D Object Tracker
...
#### [176] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [177] Extrapolated Urban View Synthesis Benchmark
...
#### [178] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [179] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [180] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [181] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [182] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [183] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [184] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [185] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [186] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [187] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [188] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [189] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [190] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [191] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [192] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [193] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [194] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [195] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [196] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [197] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [198] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [199] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [200] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [201] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [202] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [203] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [204] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [205] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [206] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [207] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [208] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [209] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [210] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [211] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [212] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [213] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [214] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [215] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [216] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [217] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [218] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [219] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [220] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [221] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [222] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [223] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [224] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [225] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [226] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [227] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [228] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [229] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [230] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [231] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [232] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [233] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [234] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [235] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [236] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [237] Neural Surface Priors for Editable Gaussian Splatting
...
#### [238] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [239] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [240] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [241] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [242] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [243] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [244] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [245] Geometry Field Splatting with Gaussian Surfels
...
#### [246] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [247] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [248] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [249] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [250] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [251] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [252] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [253] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [254] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [255] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [256] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [257] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [258] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [259] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [260] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [261] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [262] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [263] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [264] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [265] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [266] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [267] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [268] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [269] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [270] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [271] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [272] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [273] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [274] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [275] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [276] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [277] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [278] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [279] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [280] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [281] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [282] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [283] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [284] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [285] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [286] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [287] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [288] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [289] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [290] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [291] VeGaS: Video Gaussian Splatting
...
#### [292] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [293] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [294] Efficient Density Control for 3D Gaussian Splatting
...
#### [295] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [296] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [297] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [298] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [299] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [300] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [301] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [302] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [303] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [304] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [305] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [306] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [307] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [308] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [309] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [310] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [311] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [312] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [313] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [314] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [315] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [316] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [317] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [318] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [319] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [320] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [321] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [322] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [323] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [324] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [325] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [326] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [327] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [328] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [329] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [330] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [331] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [332] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [333] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [334] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [335] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [336] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [337] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [338] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [339] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [340] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [341] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [342] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [343] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [344] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [345] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [346] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [347] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [348] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [349] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [350] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [351] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [352] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [353] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [354] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [355] 3D Vision-Language Gaussian Splatting
...
#### [356] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [357] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [358] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [359] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [360] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [361] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [362] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [363] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [364] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [365] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [366] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [367] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [368] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [369] Variational Bayes Gaussian Splatting
...
#### [370] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [371] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [372] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [373] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [374] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [375] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [376] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [377] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [378] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [379] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [380] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [381] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [382] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [383] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [384] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [385] RNG: Relightable Neural Gaussians
...
#### [386] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [387] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [388] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [389] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [390] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [391] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [392] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [393] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [394] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [395] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [396] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [397] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [398] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [399] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [400] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [401] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [402] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [403] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [404] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [405] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [406] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [407] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [408] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [409] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [410] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [411] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [412] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [413] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [414] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [415] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [416] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [417] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [418] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [419] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [420] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [421] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [422] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [423] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [424] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [425] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [426] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [427] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [428] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [429] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [430] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [431] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [432] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [433] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [434] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [435] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [436] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [437] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [438] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [439] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [440] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [441] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [442] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [443] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [444] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [445] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [446] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [447] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [448] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [449] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [450] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [451] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [452] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [453] OmniRe: Omni Urban Scene Reconstruction
...
#### [454] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [455] G-Style: Stylized Gaussian Splatting
...
#### [456] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [457] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [458] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [459] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [460] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [461] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [462] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [463] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [464] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [465] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [466] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [467] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [468] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [469] Subsurface Scattering for 3D Gaussian Splatting
...
#### [470] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [471] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [474] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [475] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [476] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [477] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [478] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [479] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [480] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [481] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [482] 3D Gaussian Editing with A Single Image
...
#### [483] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [484] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [485] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [486] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [487] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [488] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [489] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [490] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [491] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [492] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [493] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [494] IG-SLAM: Instant Gaussian SLAM
...
#### [495] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [496] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [497] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [498] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [499] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [500] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [501] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [502] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [503] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [504] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [505] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [506] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [507] Gaussian Splatting Lucas-Kanade
...
#### [508] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [509] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [510] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [511] PICA: Physics-Integrated Clothed Avatar
...
#### [512] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [513] Gaussian Eigen Models for Human Heads
...
#### [515] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [516] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [517] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [518] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [519] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [520] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [521] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [522] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [523] Lightweight Predictive 3D Gaussian Splats
...
#### [524] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [525] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [526] On Scaling Up 3D Gaussian Splatting Training
...
#### [527] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [528] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [529] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [530] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [531] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [532] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [533] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [534] E2GS: Event Enhanced Gaussian Splatting
...
#### [535] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [536] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [537] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [538] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [539] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [540] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [541] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [542] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [543] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [544] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [545] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [546] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [547] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [548] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [549] Generalizable Human Gaussians from Single-View Image
...
#### [550] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [551] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [552] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [553] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [554] Localized Gaussian Point Management
...
#### [555] Gaussian Representation for Deformable Image Registration
...
#### [556] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [557] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [558] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [559] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [560] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [561] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [562] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [563] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [564] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
