...
#### [1] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
#### [2] OnlineSplatter: Pose-Free Online 3D Reconstruction for Free-Moving Objects
...
#### [4] Extreme Views: 3DGS Filter for Novel View Synthesis from Out-of-Distribution Camera Poses
...
#### [5] Re-Activating Frozen Primitives for 3D Gaussian Splatting
...
#### [6] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [7] GRASPLAT: Enabling dexterous grasping through novel view synthesis
...
#### [8] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [9] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [10] From Volume Rendering to 3D Gaussian Splatting: Theory and Applications
...
#### [11] HouseTour: A Virtual Real Estate A(I)gent
...
#### [12] InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation
...
#### [13] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
...
#### [14] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [15] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [17] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [18] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [19] HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars
...
#### [20] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [21] Fix False Transparency by Noise Guided Splatting
...
#### [22] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [23] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [25] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [26] Terra: Explorable Native 3D World Model with Point Latents
...
#### [27] Leveraging Learned Image Prior for 3D Gaussian Compression
...
#### [28] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [29] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [30] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [31] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [32] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [33] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [34] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [35] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [36] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [37] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [38] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [39] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [40] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [41] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [42] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [43] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [44] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [45] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [46] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [47] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [48] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [49] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [50] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [51] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [52] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [53] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [54] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [55] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [56] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [57] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [58] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [59] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [60] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [61] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [62] ReSplat: Learning Recurrent Gaussian Splats
...
#### [63] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [64] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [65] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [66] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [67] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [68] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [69] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [70] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [71] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [72] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [73] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [74] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [75] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [76] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [77] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [79] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [80] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [81] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [82] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [83] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [84] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [85] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [86] HART: Human Aligned Reconstruction Transformer
...
#### [87] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [88] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [89] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [90] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [91] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [92] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [93] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [94] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [95] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [96] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [97] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [98] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [99] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [100] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [101] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [102] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [103] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [104] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [105] Learning Unified Representation of 3D Gaussian Splatting
...
#### [106] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [107] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [108] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [109] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [110] Large Material Gaussian Model for Relightable 3D Generation
...
#### [111] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [112] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [113] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [114] 4D Driving Scene Generation With Stereo Forcing
...
#### [115] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [116] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [117] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [118] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [119] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [120] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [122] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [123] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [124] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [125] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [126] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [127] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [128] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [129] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [130] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [131] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [132] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [133] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [134] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [135] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [136] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [137] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [138] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [139] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [140] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [141] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [142] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [143] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [144] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [145] Camera Splatting for Continuous View Optimization
...
#### [146] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [147] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [148] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [149] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [150] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [151] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [152] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [153] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [154] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [155] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [156] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [157] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [158] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [159] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [160] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [161] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [162] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [163] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [164] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [165] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [166] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [167] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [168] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [169] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [170] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [171] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [172] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [173] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [174] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [175] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [176] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [177] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [178] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [179] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [180] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [181] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [182] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [183] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [184] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [185] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [186] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [188] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [189] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [190] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [192] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [193] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [194] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [195] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [196] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [197] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [198] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [199] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [200] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [201] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [202] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [203] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [204] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [205] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [206] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [207] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [208] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [209] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [210] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [211] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [212] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [213] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [214] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [215] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [216] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [217] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [218] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [219] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [220] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [221] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [222] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [223] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [224] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [225] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [226] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [227] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [228] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [229] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [230] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [231] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [232] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [233] SAGOnline: Segment Any Gaussians Online
...
#### [234] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [235] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [236] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [237] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [238] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [239] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [240] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [241] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [242] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [243] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [244] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [245] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [246] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [247] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [248] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [249] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [250] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [251] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [252] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [253] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [254] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [255] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [256] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [257] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [258] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [259] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [260] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [261] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [262] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [263] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [264] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [265] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [266] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [267] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [268] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [269] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [270] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [271] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [272] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [273] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [274] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [275] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [276] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [277] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [278] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [279] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [280] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [281] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [282] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [283] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [284] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [285] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [286] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [287] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [288] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [289] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [290] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [291] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [292] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [293] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [294] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [295] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [296] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [297] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [298] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [299] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [300] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [301] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [302] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [303] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [304] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [305] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [306] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [307] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [308] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [309] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [310] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [311] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [312] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [313] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [314] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [315] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [316] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [317] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [318] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [319] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [320] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [321] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [322] Masks make discriminative models great again!
...
#### [323] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [324] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [325] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
