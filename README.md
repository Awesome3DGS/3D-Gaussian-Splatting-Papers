...
#### [1] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [2] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [3] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [4] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
...
#### [6] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [7] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [8] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [9] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [10] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [11] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [12] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [13] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [14] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [15] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [16] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [17] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [18] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [19] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**: Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [20] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [21] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [22] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [23] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [24] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [25] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [26] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [27] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [28] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [29] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [30] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [31] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [32] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**: The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [33] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [34] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [35] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [36] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [37] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [38] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [39] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [40] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [41] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [42] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [43] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [44] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [45] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [46] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [47] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [48] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [49] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [50] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [51] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [52] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [53] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [54] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [55] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [56] Gaussian Masked Autoencoders
...
#### [57] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [58] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [59] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [60] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [61] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [62] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [63] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [64] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [65] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [66] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [67] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [68] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [69] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [70] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [71] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [72] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [73] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [74] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [75] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [76] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [77] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [78] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [79] Reflective Gaussian Splatting
...
#### [80] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [81] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [82] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [83] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [84] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [85] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [86] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [87] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [88] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [89] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [90] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [91] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [92] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [93] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [94] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [95] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [96] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [97] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [98] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [99] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [100] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [101] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [102] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [103] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [104] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [105] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [106] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [107] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [108] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [109] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [110] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [111] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [112] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [113] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [114] EOGS: Gaussian Splatting for Earth Observation
...
#### [115] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [116] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [117] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [118] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [119] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [120] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [121] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [122] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [123] Deformable Radial Kernel Splatting
...
#### [124] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [125] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [126] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [127] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [128] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [129] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [130] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [131] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [132] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [133] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [134] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [135] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [136] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [137] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [138] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [139] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [140] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [141] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [142] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [143] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [144] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [145] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [146] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [147] GASP: Gaussian Avatars with Synthetic Priors
...
#### [148] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [149] Faster and Better 3D Splatting via Group Training
...
#### [150] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [151] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [152] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [153] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [154] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [155] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [156] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [157] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [158] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [159] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [160] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [161] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [162] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [163] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [164] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [165] Street Gaussians without 3D Object Tracker
...
#### [166] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [167] Extrapolated Urban View Synthesis Benchmark
...
#### [168] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [169] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [170] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [171] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [172] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [173] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [174] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [175] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [176] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [177] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [178] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [179] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [180] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [181] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [182] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [183] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [184] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [185] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [186] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [187] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [188] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [189] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [190] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [191] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [192] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [193] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [194] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [195] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [196] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [197] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [198] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [199] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [200] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [201] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [202] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [203] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [204] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [205] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [206] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [207] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [208] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [209] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [210] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [211] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [212] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [213] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [214] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [215] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [216] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [217] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [218] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [219] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [220] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [221] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [222] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [223] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [224] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [225] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [226] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [227] Neural Surface Priors for Editable Gaussian Splatting
...
#### [228] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [229] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [230] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [231] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [232] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [233] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [234] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [235] Geometry Field Splatting with Gaussian Surfels
...
#### [236] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [237] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [238] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [239] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [240] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [241] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [242] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [243] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [244] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [245] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [246] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [247] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [248] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [249] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [250] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [251] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [252] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [253] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [254] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [255] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [256] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [257] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [258] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [259] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [260] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [261] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [262] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [263] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [264] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [265] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [266] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [267] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [268] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [269] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [270] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [271] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [272] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [273] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [274] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [275] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [276] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [277] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [278] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [279] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [280] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [281] VeGaS: Video Gaussian Splatting
...
#### [282] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [283] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [284] Efficient Density Control for 3D Gaussian Splatting
...
#### [285] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [286] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [287] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [288] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [289] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [290] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [291] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [292] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [293] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [294] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [295] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [296] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [297] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [298] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [299] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [300] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [301] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [302] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [303] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [304] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [305] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [306] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [307] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [308] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [309] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [310] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [311] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [312] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [313] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [314] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [315] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [316] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [317] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [318] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [319] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [320] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [321] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [322] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [323] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [324] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [325] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [326] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [327] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [328] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [329] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [330] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [331] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [332] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [333] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [334] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [335] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [336] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [337] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [338] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [339] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [340] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [341] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [342] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [343] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [344] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [345] 3D Vision-Language Gaussian Splatting
...
#### [346] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [347] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [348] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [349] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [350] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [351] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [352] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [353] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [354] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [355] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [356] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [357] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [358] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [359] Variational Bayes Gaussian Splatting
...
#### [360] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [361] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [362] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [363] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [364] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [365] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [366] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [367] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [368] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [369] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [370] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [371] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [372] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [373] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [374] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [375] RNG: Relightable Neural Gaussians
...
#### [376] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [377] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [378] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [379] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [380] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [381] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [382] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [383] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [384] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [385] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [386] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [387] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [388] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [389] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [390] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [391] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [392] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [393] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [394] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [395] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [396] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [397] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [398] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [399] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [400] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [401] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [402] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [403] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [404] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [405] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [406] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [407] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [408] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [409] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [410] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [411] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [412] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [413] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [414] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [415] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [416] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [417] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [418] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [419] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [420] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [421] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [422] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [423] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [424] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [425] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [426] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [427] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [428] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [429] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [430] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [431] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [432] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [433] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [434] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [435] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [436] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [437] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [438] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [439] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [440] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [441] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [442] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [443] OmniRe: Omni Urban Scene Reconstruction
...
#### [444] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [445] G-Style: Stylized Gaussian Splatting
...
#### [446] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [447] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [448] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [449] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [450] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [451] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [452] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [453] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [454] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [455] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [456] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [457] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [458] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [459] Subsurface Scattering for 3D Gaussian Splatting
...
#### [460] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [461] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [462] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [463] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [464] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [465] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [466] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [467] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [468] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [469] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [470] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [471] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [472] 3D Gaussian Editing with A Single Image
...
#### [473] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [474] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [475] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [476] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [477] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [478] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [479] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [480] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [481] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [482] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [483] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [484] IG-SLAM: Instant Gaussian SLAM
...
#### [485] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [486] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [487] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [488] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [489] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [490] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [491] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [492] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [493] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [494] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [495] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [496] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [497] Gaussian Splatting Lucas-Kanade
...
#### [498] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [499] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [500] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [501] PICA: Physics-Integrated Clothed Avatar
...
#### [502] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [503] Gaussian Eigen Models for Human Heads
...
#### [505] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [506] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [507] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [508] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [509] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [510] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [511] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [512] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [513] Lightweight Predictive 3D Gaussian Splats
...
#### [514] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [515] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [516] On Scaling Up 3D Gaussian Splatting Training
...
#### [517] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [518] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [519] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [520] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [521] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [522] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [523] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [524] E2GS: Event Enhanced Gaussian Splatting
...
#### [525] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [526] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [527] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [528] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [529] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [530] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [531] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [532] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [533] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [534] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [535] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [536] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [537] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [538] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [539] Generalizable Human Gaussians from Single-View Image
...
#### [540] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [541] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [542] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [543] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [544] Localized Gaussian Point Management
...
#### [545] Gaussian Representation for Deformable Image Registration
...
#### [546] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [547] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [548] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [549] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [550] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [551] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [552] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [553] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [554] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
