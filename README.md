...
**📂 归档论文**: [[Before 2024/06/01](https://github.com/Awesome3DGS/3D-Gaussian-Splatting-Papers/tree/archive/202406)] (285 篇)
...
#### [1] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [2] VEGS: View Extrapolation of Urban Scenes in 3D Gaussian Splatting using Learned Priors
...
#### [3] Free-SurGS: SfM-Free 3D Gaussian Splatting for Surgical Scene Reconstruction
...
#### [4] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [5] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [6] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [7] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [8] Learning 3D Gaussians for Extremely Sparse-View Cone-Beam CT Reconstruction
...
#### [9] EndoSparse: Real-Time Sparse View Synthesis of Endoscopic Scenes using Gaussian Splatting
...
#### [10] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [11] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [12] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [13] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [14] Lightweight Predictive 3D Gaussian Splats
...
#### [15] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [16] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [17] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [18] On Scaling Up 3D Gaussian Splatting Training
...
#### [19] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [20] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [21] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [22] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [23] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [24] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [25] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [26] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [27] LGS: A Light-weight 4D Gaussian Splatting for Efficient Surgical Scene Reconstruction
...
#### [28] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [29] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [30] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [31] E2GS: Event Enhanced Gaussian Splatting
...
#### [33] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [34] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [35] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [36] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [37] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [38] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [39] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [40] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [41] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [42] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [43] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [44] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [45] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [46] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [47] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [48] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [49] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [50] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [52] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [53] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [54] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [55] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [56] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [57] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [58] Generalizable Human Gaussians from Single-View Image
...
#### [59] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [60] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [61] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [62] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [63] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [64] Localized Gaussian Point Management
...
#### [65] Gaussian Representation for Deformable Image Registration
...
#### [66] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [67] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [68] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [69] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [70] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [71] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [72] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [73] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [74] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [75] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [76] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [77] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [78] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [79] Tetrahedron Splatting for 3D Generation
...
#### [80] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [81] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [82] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [83] SuperGaussian: Repurposing Video Models for 3D Super Resolution
...
#### [84] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [85] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
