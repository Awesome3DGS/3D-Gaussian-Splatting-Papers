...
#### [2] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [3] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [4] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [5] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [6] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [8] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [9] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [11] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [12] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [13] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [14] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [15] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [16] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [17] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [18] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [20] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [21] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [22] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [23] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [24] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [25] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [26] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [27] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [28] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [29] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [30] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [31] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [32] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [33] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [34] IG-SLAM: Instant Gaussian SLAM
...
#### [35] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [36] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [37] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [38] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [39] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [40] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [41] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [42] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [43] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [44] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [45] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [46] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [47] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [48] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [49] Gaussian Splatting Lucas-Kanade
...
#### [50] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [51] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [52] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [53] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [54] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [55] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [56] PICA: Physics-Integrated Clothed Avatar
...
#### [57] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [58] Gaussian Eigen Models for Human Heads
...
#### [60] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [61] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [62] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [63] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [64] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [65] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [66] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [67] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [68] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [69] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [70] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [71] Lightweight Predictive 3D Gaussian Splats
...
#### [72] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [73] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [74] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [75] On Scaling Up 3D Gaussian Splatting Training
...
#### [76] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [77] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [78] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [79] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [80] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [81] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [82] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [83] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [84] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [85] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [86] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [87] E2GS: Event Enhanced Gaussian Splatting
...
#### [88] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [89] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [90] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [91] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [92] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [93] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [94] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [95] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [96] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [97] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [98] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [99] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [100] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [101] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [102] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [103] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [104] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [105] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [106] From Chaos to Clarity: 3DGS in the Dark
...
#### [107] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [108] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [109] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [110] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [111] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [112] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [113] Generalizable Human Gaussians from Single-View Image
...
#### [114] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [115] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [116] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [117] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [118] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [119] Localized Gaussian Point Management
...
#### [120] Gaussian Representation for Deformable Image Registration
...
#### [121] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [122] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [123] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [124] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [125] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [126] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [127] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [128] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [129] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [130] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [131] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [132] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [133] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [134] Tetrahedron Splatting for 3D Generation
...
#### [135] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [136] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [137] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [138] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
