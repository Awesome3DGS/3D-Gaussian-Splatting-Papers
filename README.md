...
#### [1] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [3] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [4] GaussianPainter: Painting Point Cloud into 3D Gaussians with Normal Guidance
...
#### [5] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [6] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [7] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [9] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [10] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [11] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [12] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [13] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [14] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [15] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [16] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [17] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [18] EGSRAL: An Enhanced 3D Gaussian Splatting based Renderer with Automated Labeling for Large-Scale Driving Scene
...
#### [19] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [20] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [21] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [22] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [23] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [24] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [25] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [26] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [27] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [28] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [29] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [30] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [31] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [32] EOGS: Gaussian Splatting for Earth Observation
...
#### [33] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [34] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [35] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [36] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [37] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [38] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [39] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [40] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [41] Deformable Radial Kernel Splatting
...
#### [42] 3D2-Actor: Learning Pose-Conditioned 3D-Aware Denoiser for Realistic Gaussian Avatar Modeling
...
#### [43] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [44] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [45] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [46] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [47] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [48] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [49] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [50] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [51] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [52] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [54] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [55] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [56] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [57] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [58] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [59] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [60] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [61] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [62] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [63] PointTalk: Audio-Driven Dynamic Lip Point Cloud for 3D Gaussian-based Talking Head Synthesis
...
#### [64] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [65] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [66] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [67] GASP: Gaussian Avatars with Synthetic Priors
...
#### [68] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [69] Faster and Better 3D Splatting via Group Training
...
#### [70] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [71] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [72] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [73] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [74] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [75] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [76] 4D Gaussian Splatting with Scale-aware Residual Field and Adaptive Optimization for Real-time Rendering of Temporally Complex Dynamic Scenes
...
#### [77] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [78] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [79] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [80] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [81] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [82] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [83] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [84] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [85] Template-free Articulated Gaussian Splatting for Real-time Reposable Dynamic View Synthesis
...
#### [86] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [87] Street Gaussians without 3D Object Tracker
...
#### [88] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [89] Extrapolated Urban View Synthesis Benchmark
...
#### [90] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [91] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [92] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [93] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [94] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [95] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [96] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [97] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [98] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [99] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [100] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [101] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [102] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [103] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [104] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [105] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [106] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [107] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [108] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [109] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [110] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [111] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [112] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [113] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [114] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [115] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [116] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [117] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [118] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [119] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [120] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [121] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [122] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [123] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [124] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [125] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [126] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [127] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [128] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [129] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [130] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [131] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [132] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [133] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [134] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [135] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [136] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [137] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [138] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [139] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [140] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [141] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [142] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [143] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [144] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [145] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [146] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [147] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [148] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [149] Neural Surface Priors for Editable Gaussian Splatting
...
#### [150] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [151] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [152] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [153] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [154] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [155] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [156] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [157] Geometry Field Splatting with Gaussian Surfels
...
#### [158] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [159] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [160] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [161] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [162] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [163] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [164] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [165] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [166] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [167] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [168] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [169] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [170] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [171] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [172] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [173] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [174] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [175] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [176] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [177] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [178] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [179] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [180] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [181] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [182] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [183] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [184] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [185] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [186] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [187] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [188] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [189] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [190] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [191] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [192] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [193] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [194] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [195] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [196] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [197] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [198] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [199] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [200] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [201] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [202] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [203] VeGaS: Video Gaussian Splatting
...
#### [204] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [205] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [206] Efficient Density Control for 3D Gaussian Splatting
...
#### [207] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [208] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [209] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [210] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [211] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [212] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [213] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [214] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [215] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [216] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [217] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [218] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [219] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [220] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [221] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [222] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [223] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [224] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [225] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [226] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [227] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [228] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [229] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [230] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [231] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [232] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [233] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [234] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [235] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [236] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [237] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [238] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [239] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [240] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [241] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [242] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [243] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [244] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [245] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [246] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [247] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [248] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [249] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [250] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [251] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [252] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [253] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [254] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [255] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [256] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [257] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [258] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [259] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [260] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [261] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [262] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [263] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [264] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [265] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [266] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [267] 3D Vision-Language Gaussian Splatting
...
#### [268] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [269] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [270] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [271] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [272] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [273] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [274] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [275] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [276] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [277] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [278] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [279] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [280] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [281] Variational Bayes Gaussian Splatting
...
#### [282] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [283] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [284] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [285] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [286] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [287] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [288] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [289] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [290] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [291] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [292] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [293] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [294] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [295] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [296] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [297] RNG: Relightable Neural Gaussians
...
#### [298] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [299] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [300] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [301] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [302] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [303] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [304] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [305] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [306] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [307] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [308] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [309] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [310] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [311] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [312] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [313] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [314] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [315] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [316] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [317] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [318] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [319] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [320] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [321] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [322] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [323] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [324] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [325] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [326] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [327] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [328] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [329] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [330] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [331] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [332] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [333] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [334] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [335] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [336] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [337] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [338] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [339] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [340] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [341] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [342] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [343] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [344] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [345] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [346] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [347] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [348] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [349] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [350] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [351] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [352] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [353] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [354] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [355] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [356] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [357] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [358] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [359] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [360] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [361] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [362] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [363] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [364] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [365] OmniRe: Omni Urban Scene Reconstruction
...
#### [366] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [367] G-Style: Stylized Gaussian Splatting
...
#### [368] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [369] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [370] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [371] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [372] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [373] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [374] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [375] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [376] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [377] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [378] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [379] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [380] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [381] Subsurface Scattering for 3D Gaussian Splatting
...
#### [382] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [383] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [384] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [385] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [386] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [387] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [388] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [389] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [390] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [391] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [392] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [393] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [394] 3D Gaussian Editing with A Single Image
...
#### [395] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [396] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [397] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [398] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [399] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [400] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [401] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [402] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [403] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [404] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [405] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [406] IG-SLAM: Instant Gaussian SLAM
...
#### [407] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [408] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [409] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [410] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [411] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [412] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [413] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [414] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [415] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [416] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [417] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [418] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [419] Gaussian Splatting Lucas-Kanade
...
#### [420] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [421] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [422] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [423] PICA: Physics-Integrated Clothed Avatar
...
#### [424] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [425] Gaussian Eigen Models for Human Heads
...
#### [427] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [428] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [429] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [430] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [431] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [432] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [433] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [434] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [435] Lightweight Predictive 3D Gaussian Splats
...
#### [436] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [437] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [438] On Scaling Up 3D Gaussian Splatting Training
...
#### [439] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [440] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [441] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [442] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [443] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [444] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [445] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [446] E2GS: Event Enhanced Gaussian Splatting
...
#### [447] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [448] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [449] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [450] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [451] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [452] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [453] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [454] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [455] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [456] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [457] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [458] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [459] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [460] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [461] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [462] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [463] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [464] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [465] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [466] Generalizable Human Gaussians from Single-View Image
...
#### [467] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [468] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [469] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [470] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [471] Localized Gaussian Point Management
...
#### [472] Gaussian Representation for Deformable Image Registration
...
#### [473] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [474] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [475] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [476] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [477] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [478] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [479] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [480] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [481] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [482] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [483] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
