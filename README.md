...
#### [5] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [6] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [7] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [8] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [9] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [10] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [11] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [12] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [13] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [14] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [15] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [16] Gaussian Splatting Under Attack: Investigating Adversarial Noise in 3D Objects
...
#### [17] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [18] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [19] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [20] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [21] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [22] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [23] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [25] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [26] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [27] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [28] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [29] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
...
#### [30] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [31] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [32] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [33] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [34] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [35] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [36] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [37] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [38] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [39] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [40] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [41] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [42] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [43] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [44] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [45] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [46] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [47] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [48] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [49] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [50] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [51] AGS-Mesh: Adaptive Gaussian Splatting and Meshing with Geometric Priors for Indoor Room Reconstruction Using Smartphones
...
#### [52] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [53] Gaussians-to-Life: Text-Driven Animation of 3D Gaussian Splatting Scenes
...
#### [54] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [55] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [56] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [57] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [58] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [59] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [60] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [61] Neural Surface Priors for Editable Gaussian Splatting
...
#### [62] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [63] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [64] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [65] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [66] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [67] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [68] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [69] Geometry Field Splatting with Gaussian Surfels
...
#### [70] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [71] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [72] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [73] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [74] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [75] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [76] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [77] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [78] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [79] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [80] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [81] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [82] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [83] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [84] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [85] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [86] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [87] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [88] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [89] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [90] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [91] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [92] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [93] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [94] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [95] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [96] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [97] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [98] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [99] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [100] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [101] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [102] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [103] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [104] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [105] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [106] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [107] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [108] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [109] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [110] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [111] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [112] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [113] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [114] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [115] VeGaS: Video Gaussian Splatting
...
#### [116] Direct and Explicit 3D Generation from a Single Image
...
#### [117] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [118] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [119] Efficient Density Control for 3D Gaussian Splatting
...
#### [120] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
...
#### [121] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [122] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [123] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [124] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [125] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [126] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [127] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [128] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [129] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [130] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [131] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [132] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [133] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [134] Object and Contact Point Tracking in Demonstrations Using 3D Gaussian Splatting
...
#### [135] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [136] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [137] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [138] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [139] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [140] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [141] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [142] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [143] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [144] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [145] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [146] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [147] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [148] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
...
#### [149] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [150] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [151] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [152] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [153] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [154] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [155] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [156] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [157] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [158] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [159] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [160] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [161] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [162] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [163] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [164] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [165] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [166] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [167] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [168] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [170] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [171] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [172] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [175] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [176] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [177] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [178] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [179] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [180] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [181] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [182] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [183] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [184] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [185] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [186] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [187] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [188] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [189] 3D Vision-Language Gaussian Splatting
...
#### [190] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [191] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [192] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [193] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [194] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [195] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [196] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [197] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [198] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [199] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [200] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [201] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [202] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [203] Variational Bayes Gaussian Splatting
...
#### [204] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [205] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [206] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [207] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [208] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [209] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [210] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [211] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [212] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [213] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [214] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [215] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [216] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [217] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [218] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [219] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [220] RNG: Relightable Neural Gaussians
...
#### [221] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [222] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [223] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [224] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [225] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [226] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [227] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [228] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [229] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [230] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [231] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [232] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [233] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [234] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [235] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [236] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [237] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [238] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [239] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [240] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [241] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [242] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [243] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [244] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [245] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [246] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [247] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [248] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [249] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [250] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [251] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [252] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [253] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [254] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [255] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [256] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [257] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [258] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [259] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [260] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [261] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [262] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [263] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [264] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [265] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [266] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [267] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [268] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [269] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [270] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [271] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [272] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [273] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [274] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [275] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [276] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [277] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [278] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [279] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [280] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [281] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [282] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [283] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [284] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [285] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [286] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [287] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [288] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [289] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [290] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [291] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [292] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [293] OmniRe: Omni Urban Scene Reconstruction
...
#### [294] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [295] G-Style: Stylized Gaussian Splatting
...
#### [296] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [297] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [298] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [299] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [300] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [301] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [302] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [303] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [304] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [305] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [306] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [307] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [308] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [309] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [310] Subsurface Scattering for 3D Gaussian Splatting
...
#### [311] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [312] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [313] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [314] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [315] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [316] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [317] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [318] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [319] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [320] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [321] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [322] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [323] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [324] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [325] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [326] 3D Gaussian Editing with A Single Image
...
#### [327] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [328] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [329] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [330] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [331] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [332] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [333] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [334] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [335] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [336] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [337] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [338] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [339] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [340] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [341] IG-SLAM: Instant Gaussian SLAM
...
#### [342] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [343] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [344] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [345] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [346] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [347] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [348] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [349] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [350] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [351] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [352] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [353] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [354] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [355] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [356] Gaussian Splatting Lucas-Kanade
...
#### [357] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [358] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [359] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [360] PICA: Physics-Integrated Clothed Avatar
...
#### [361] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [362] Gaussian Eigen Models for Human Heads
...
#### [364] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [365] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [366] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [367] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [368] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [369] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [370] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [371] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [372] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [373] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [374] Lightweight Predictive 3D Gaussian Splats
...
#### [375] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [376] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [377] On Scaling Up 3D Gaussian Splatting Training
...
#### [378] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [379] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [380] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [381] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [382] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [383] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [384] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [385] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [386] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [387] E2GS: Event Enhanced Gaussian Splatting
...
#### [388] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [389] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [390] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [391] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [392] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [393] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [394] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [395] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [396] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [397] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [398] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [399] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [400] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [401] From Chaos to Clarity: 3DGS in the Dark
...
#### [402] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [403] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [404] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [405] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [406] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [407] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [408] Generalizable Human Gaussians from Single-View Image
...
#### [409] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [410] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [411] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [412] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [413] Localized Gaussian Point Management
...
#### [414] Gaussian Representation for Deformable Image Registration
...
#### [415] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [416] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [417] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [418] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [419] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [420] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [421] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [422] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [423] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [424] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [425] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [426] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
