...
#### [1] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [2] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [3] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [4] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [5] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [6] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [7] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
...
#### [8] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [10] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [11] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [12] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [14] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [15] Camera Splatting for Continuous View Optimization
...
#### [16] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
...
#### [17] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [18] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [19] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [20] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [21] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [22] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [23] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [24] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
...
#### [25] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [26] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [27] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [28] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [29] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [30] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [31] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [32] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [33] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [34] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [35] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [36] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [37] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [38] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [39] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [40] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [41] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [42] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [43] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [44] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [45] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [47] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [48] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [49] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [50] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [51] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [52] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [53] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [54] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [55] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [56] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [57] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [58] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [59] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [60] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [61] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [62] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [63] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [64] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [65] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [66] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [67] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [68] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [69] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [70] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [71] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [72] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [73] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [74] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [75] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [76] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [77] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [79] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [80] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [81] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [82] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [83] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [84] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [85] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [86] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [88] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [89] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [90] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [91] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [92] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [93] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [94] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [95] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [96] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [97] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [98] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [99] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [100] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [101] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [102] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [103] SAGOnline: Segment Any Gaussians Online
...
#### [104] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [105] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [106] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [107] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [108] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [109] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [110] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [111] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [112] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [113] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [114] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [115] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [116] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [117] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [118] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [119] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
...
#### [120] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [121] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [122] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [123] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [124] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [125] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [126] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [127] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [128] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [129] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [130] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [131] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [132] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [133] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [134] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [135] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [136] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [137] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [138] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [139] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [140] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [141] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [142] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [143] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [144] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [145] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [146] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [147] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [148] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [149] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [150] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [151] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [152] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [153] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [154] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [155] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [156] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [157] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [158] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [159] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [160] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [161] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [162] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [163] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [164] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [165] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [166] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [167] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [168] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [169] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [170] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [171] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [172] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [173] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [174] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [175] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [176] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [177] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [178] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [179] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [180] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [181] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [182] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [183] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [184] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [185] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [186] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [187] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [188] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [189] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [190] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [191] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [192] Masks make discriminative models great again!
...
#### [193] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [194] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [195] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
