...
#### [10] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [11] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [12] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [14] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [16] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [17] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [18] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
#### [20] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [21] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [22] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [23] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [24] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [25] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [26] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [27] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [29] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [30] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [31] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [32] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [33] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [34] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [35] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [36] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [37] LiDAR-enhanced 3D Gaussian Splatting Mapping
- **🧑‍🔬 作者**：Jian Shen, Huai Yu, Ji Wu, Wen Yang, Gui-Song Xia
...
#### [38] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [39] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [40] STGA: Selective-Training Gaussian Head Avatars
...
#### [41] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [42] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [43] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [44] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [45] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [46] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [47] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [48] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [49] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [50] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [51] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [52] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [53] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [54] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [55] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [56] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [57] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [58] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [59] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [60] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [61] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [62] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [63] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [64] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [65] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [66] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [67] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [68] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [69] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [70] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [71] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [72] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [73] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [74] Seeing A 3D World in A Grain of Sand
...
#### [75] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [76] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [77] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [78] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [79] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [80] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [81] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [82] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [83] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [84] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [85] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [86] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [87] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [88] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [89] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [90] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [91] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [92] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [93] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [94] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [95] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [96] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [97] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [98] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [99] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [100] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [101] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [102] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [103] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [104] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [105] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [106] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [107] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [108] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [109] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [110] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [111] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [112] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [113] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [114] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [115] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [116] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [117] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [118] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [119] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [120] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [121] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [122] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [123] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [124] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [125] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [126] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [127] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [128] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [129] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [130] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [131] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [132] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [133] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [135] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [136] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [137] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [138] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [139] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [140] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [141] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [142] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [143] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [144] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [145] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [146] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [147] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [148] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [149] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [150] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [151] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [152] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [153] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [154] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [155] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [156] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [157] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [158] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [159] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [160] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [161] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [162] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [163] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [164] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [165] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [166] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [167] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [168] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [169] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [170] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [171] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [172] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [173] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [174] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [175] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [176] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [177] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [178] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [179] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [180] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [181] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [182] Gaussian Masked Autoencoders
...
#### [183] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [184] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [185] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [186] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [187] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [188] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [189] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [190] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [191] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [192] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [193] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [194] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [195] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [196] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [197] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [198] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [199] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [200] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [201] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [202] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [203] Reflective Gaussian Splatting
...
#### [204] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [205] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [206] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [207] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [208] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [209] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [210] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [211] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [212] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [213] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [214] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [215] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [216] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [217] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [218] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [219] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [220] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [221] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [222] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [223] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [224] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [225] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [226] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [227] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [228] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [229] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [230] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [231] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [232] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [233] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [234] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [235] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [236] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [237] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [238] EOGS: Gaussian Splatting for Earth Observation
...
#### [239] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [240] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [241] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [242] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [243] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [244] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [245] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [246] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [247] Deformable Radial Kernel Splatting
...
#### [248] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [249] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [250] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [251] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [252] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [253] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [254] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [255] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [256] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [257] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [258] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [259] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [260] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [261] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [262] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [263] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [264] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [265] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [266] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [267] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [268] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [269] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [270] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [271] GASP: Gaussian Avatars with Synthetic Priors
...
#### [272] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [273] Faster and Better 3D Splatting via Group Training
...
#### [274] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [275] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [276] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [277] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [278] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [279] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [280] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [281] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [282] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [283] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [284] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [285] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [286] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [287] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [288] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [289] Street Gaussians without 3D Object Tracker
...
#### [290] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [291] Extrapolated Urban View Synthesis Benchmark
...
#### [292] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [293] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [294] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [295] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [296] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [297] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [298] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [299] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [300] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [301] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [302] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [303] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [304] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [305] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [306] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [307] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [308] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [309] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [310] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [311] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [312] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [313] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [314] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [315] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [316] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [317] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [318] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [319] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [320] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [321] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [322] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [323] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [324] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [325] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [326] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [327] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [328] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [329] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [330] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [331] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [332] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [333] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [334] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [335] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [336] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [337] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [338] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [339] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [340] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [341] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [342] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [343] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [344] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [345] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [346] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [347] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [348] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [349] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [350] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [351] Neural Surface Priors for Editable Gaussian Splatting
...
#### [352] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [353] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [354] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [355] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [356] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [357] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [358] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [359] Geometry Field Splatting with Gaussian Surfels
...
#### [360] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [361] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [362] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [363] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [364] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [365] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [366] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [367] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [368] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [369] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [370] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [371] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [372] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [373] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [374] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [375] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [376] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [377] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [378] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [379] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [380] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [381] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [382] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [383] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [384] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [385] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [386] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [387] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [388] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [389] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [390] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [391] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [392] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [393] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [394] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [395] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [396] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [397] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [398] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [399] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [400] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [401] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [402] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [403] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [404] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [405] VeGaS: Video Gaussian Splatting
...
#### [406] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [407] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [408] Efficient Density Control for 3D Gaussian Splatting
...
#### [409] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [410] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [411] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [412] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [413] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [414] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [415] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [416] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [417] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [418] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [419] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [420] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [421] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [422] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [423] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [424] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [425] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [426] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [427] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [428] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [429] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [430] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [431] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [432] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [433] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [434] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [435] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [436] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [437] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [439] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [440] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [441] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [442] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [443] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [444] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [445] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [446] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [447] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [448] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [449] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [450] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [451] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [452] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [453] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [454] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [455] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [456] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [457] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [458] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [459] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [460] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [461] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [462] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [463] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [464] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [465] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [466] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [467] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [468] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [469] 3D Vision-Language Gaussian Splatting
...
#### [470] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [471] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [472] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [473] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [474] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [475] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [476] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [477] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [478] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [479] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
- **🧑‍🔬 作者**：Zhongpai Gao, Benjamin Planche, Meng Zheng, Anwesa Choudhuri, Terrence Chen, Ziyan Wu
- **🏫 单位**：United Imaging Intelligence, Boston MA, USA
- **🔗 链接**：[[中英摘要](./abs/2410.04974.md)] [[arXiv:2410.04974](https://arxiv.org/abs/2410.04974)] [Code]
- **📝 说明**：

#### [480] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [481] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [482] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [483] Variational Bayes Gaussian Splatting
...
#### [484] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [485] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [486] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [487] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [488] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [489] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [490] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [491] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [492] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [493] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [494] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [495] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [496] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [497] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [498] RNG: Relightable Neural Gaussians
...
#### [499] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [500] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [501] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [502] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [503] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [504] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [505] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [506] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [507] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [508] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [509] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [510] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [511] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [512] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [513] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [514] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [515] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [516] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [517] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [518] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [519] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [520] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [521] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [522] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [523] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [524] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [525] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [526] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [527] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [528] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [529] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [530] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [531] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [532] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [533] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [534] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [535] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [536] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [537] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [538] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [539] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [540] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [541] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [542] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [543] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [544] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [545] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [546] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [547] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [548] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [549] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [550] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [551] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [552] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [553] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [554] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [555] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [556] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [557] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [558] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [559] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [560] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [561] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [562] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [563] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [564] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [565] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [566] OmniRe: Omni Urban Scene Reconstruction
...
#### [567] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [568] G-Style: Stylized Gaussian Splatting
...
#### [569] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [570] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [571] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [572] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [573] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [574] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [575] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [576] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [577] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [578] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [579] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [580] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [581] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [582] Subsurface Scattering for 3D Gaussian Splatting
...
#### [583] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [584] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [585] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [586] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [587] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [588] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [589] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [590] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [591] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [592] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [593] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [594] 3D Gaussian Editing with A Single Image
...
#### [595] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [596] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [597] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [598] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [599] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [600] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [601] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [602] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [603] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [604] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [605] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [606] IG-SLAM: Instant Gaussian SLAM
...
#### [607] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [608] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [609] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [610] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [611] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [612] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [613] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [614] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [615] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [616] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [617] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [618] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [619] Gaussian Splatting Lucas-Kanade
...
#### [620] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [621] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [622] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [623] PICA: Physics-Integrated Clothed Avatar
...
#### [624] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [625] Gaussian Eigen Models for Human Heads
...
#### [627] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [628] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [629] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [630] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [631] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [632] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [633] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [634] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [635] Lightweight Predictive 3D Gaussian Splats
...
#### [636] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [637] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [638] On Scaling Up 3D Gaussian Splatting Training
...
#### [639] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [640] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [641] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [642] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [643] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [644] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [645] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [646] E2GS: Event Enhanced Gaussian Splatting
...
#### [647] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [648] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [649] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [650] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [651] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [652] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [653] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [654] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [655] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [656] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [657] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [658] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [659] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [660] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [661] Generalizable Human Gaussians from Single-View Image
...
#### [662] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [663] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [664] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [665] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [666] Localized Gaussian Point Management
...
#### [667] Gaussian Representation for Deformable Image Registration
...
#### [668] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [669] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [670] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [671] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [672] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [673] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [674] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [675] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [676] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
