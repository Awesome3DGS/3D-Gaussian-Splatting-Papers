...
#### [1] Novel Demonstration Generation with Gaussian Splatting Enables Robust One-Shot Manipulation
...
#### [2] ODHSR: Online Dense 3D Reconstruction of Humans and Scenes from Monocular Videos
...
#### [5] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [6] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [7] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [8] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [9] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [10] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [11] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [12] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [13] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [14] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [15] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [16] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [17] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [18] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [19] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [20] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [21] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [22] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [23] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [24] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [25] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [26] DropoutGS: Dropping Out Gaussians for Better Sparse-view Rendering
...
#### [27] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [28] BIGS: Bimanual Category-agnostic Interaction Reconstruction from Monocular Videos via 3D Gaussian Splatting
...
#### [29] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [30] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [31] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [32] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [33] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [34] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [35] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [36] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [37] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [38] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [39] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [40] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [41] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [42] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [43] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [44] HiMoR: Monocular Deformable Gaussian Reconstruction with Hierarchical Motion Representation
...
#### [46] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [47] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [48] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [49] Optimizing 4D Gaussians for Dynamic Scene Video from Single Landscape Images
...
#### [50] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [51] PanoDreamer: Consistent Text to 360-Degree Scene Generation
...
#### [52] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
- **🧑‍🔬 作者**：Isha Sharma, Dieter Schmalstieg
- **🏫 单位**：University of Stuttgart
- **🔗 链接**：[[中英摘要](./abs/2504.04857.md)] [[arXiv:2504.04857](https://arxiv.org/abs/2504.04857)] [Code]
- **📝 说明**：

#### [53] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [54] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [55] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [56] Video4DGen: Enhancing Video and 4D Generation through Mutual Optimization
...
#### [57] WildGS-SLAM: Monocular Gaussian Splatting SLAM in Dynamic Environments
...
#### [58] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [59] Compressing 3D Gaussian Splatting by Noise-Substituted Vector Quantization
...
#### [60] Scene Splatter: Momentum 3D Scene Generation from Single Image with Video Diffusion Model
...
#### [61] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [62] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [63] Digital-twin imaging based on descattering Gaussian splatting
...
#### [64] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [65] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [66] Diffusion-Guided Gaussian Splatting for Large-Scale Unconstrained 3D Reconstruction and Novel View Synthesis
...
#### [67] Toward Real-world BEV Perception: Depth Uncertainty Estimation via Gaussian Splatting
...
#### [68] BOGausS: Better Optimized Gaussian Splatting
...
#### [69] FIORD: A Fisheye Indoor-Outdoor Dataset with LIDAR Ground Truth for 3D Scene Reconstruction and Benchmarking
...
#### [70] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [71] 3DBonsai: Structure-Aware Bonsai Modeling Using Conditioned 3D Gaussian Splatting
...
#### [72] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [73] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [74] Luminance-GS: Adapting 3D Gaussian Splatting to Challenging Lighting Conditions with View-Adaptive Curve Adjustment
...
#### [75] 3D Gaussian Inverse Rendering with Approximated Global Illumination
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [76] DropGaussian: Structural Regularization for Sparse-view Gaussian Splatting
- **🧑‍🔬 作者**：Hyunwoo Park, Gun Ryu, Wonjun Kim
...
#### [77] UnIRe: Unsupervised Instance Decomposition for Dynamic Urban Scene Reconstruction
...
#### [78] Monocular and Generalizable Gaussian Talking Head Animation
...
#### [79] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [80] Robust LiDAR-Camera Calibration with 2D Gaussian Splatting
...
#### [81] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [82] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [83] Scene4U: Hierarchical Layered 3D Scene Reconstruction from Single Panoramic Image for Your Immerse Exploration
...
#### [84] LITA-GS: Illumination-Agnostic Novel View Synthesis via Reference-Free 3D Gaussian Splatting and Physical Priors
...
#### [85] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
...
#### [86] Free360: Layered Gaussian Splatting for Unbounded 360-Degree View Synthesis from Extremely Sparse and Unposed Views
...
#### [87] StochasticSplats: Stochastic Rasterization for Sorting-Free 3D Gaussian Splatting
...
#### [89] DiET-GS: Diffusion Prior and Event Stream-Assisted Motion Deblurring 3D Gaussian Splatting
...
#### [90] Learning 3D-Gaussian Simulators from RGB Videos
...
#### [91] ExScene: Free-View 3D Scene Reconstruction with Gaussian Splatting from a Single Image
...
#### [92] Gaussian Blending Unit: An Edge GPU Plug-in for Real-Time Gaussian-Based Rendering in AR/VR
...
#### [93] Enhancing 3D Gaussian Splatting Compression via Spatial Condition-based Prediction
...
#### [94] ReasonGrounder: LVLM-Guided Hierarchical Feature Splatting for Open-Vocabulary 3D Visual Grounding and Reasoning
- **🧑‍🔬 作者**：Zhenyang Liu, Yikai Wang, Sixiao Zheng, Tongying Pan, Longfei Liang, Yanwei Fu, Xiangyang Xue
- **🏫 单位**：Fudan University ⟐ Nanyang Technological University ⟐ Shanghai Innovation Institute ⟐ NeuHelium Co., Ltd
- **🔗 链接**：[[中英摘要](./abs/2503.23297.md)] [[arXiv:2503.23297](https://arxiv.org/abs/2503.23297)] [Code]
- **📝 说明**：🏆 Accepted to CVPR 2025

#### [95] NeuralGS: Bridging Neural Fields and 3D Gaussian Splatting for Compact 3D Representations
...
#### [96] CityGS-X: A Scalable Architecture for Efficient and Geometrically Accurate Large-Scale Scene Reconstruction
...
#### [97] FreeSplat++: Generalizable 3D Gaussian Splatting for Efficient Indoor Scene Reconstruction
...
#### [98] VizFlyt: Perception-centric Pedagogical Framework For Autonomous Aerial Robots
...
#### [99] TranSplat: Lighting-Consistent Cross-Scene Object Transfer with 3D Gaussian Splatting
...
#### [101] EndoLRMGS: Complete Endoscopic Scene Reconstruction combining Large Reconstruction Modelling and Gaussian Splatting
...
#### [102] AH-GS: Augmented 3D Gaussian Splatting for High-Frequency Detail Representation
...
#### [103] Follow Your Motion: A Generic Temporal Consistency Portrait Editing Framework with Trajectory Guidance
...
#### [104] ABC-GS: Alignment-Based Controllable Style Transfer for 3D Gaussian Splatting
- **🧑‍🔬 作者**：Wenjie Liu, Zhongliang Liu, Xiaoyan Yang, Man Sha, Yang Li
- **🏫 单位**：School of Computer Science and Technology, East China Normal University, Shanghai, China ⟐ School of Software Engineering, East China Normal University, Shanghai, China ⟐ Shanghai Chinafortune Co Ltd, Shanghai, China
- **🔗 链接**：[[中英摘要](./abs/2503.22218.md)] [[arXiv:2503.22218](https://arxiv.org/abs/2503.22218)] [[Code](https://github.com/vpx-ecnu/ABC-GS)]
- **📝 说明**：🏆 Accepted to ICME 2025

#### [105] Segment then Splat: A Unified Approach for 3D Open-Vocabulary Segmentation based on Gaussian Splatting
...
#### [106] Disentangled 4D Gaussian Splatting: Towards Faster and More Efficient Dynamic Scene Rendering
...
#### [107] EVPGS: Enhanced View Prior Guidance for Splatting-based Extrapolated View Synthesis
...
#### [108] X^2-Gaussian: 4D Radiative Gaussian Splatting for Continuous-time Tomographic Reconstruction
...
#### [109] Semantic Consistent Language Gaussian Splatting for Point-Level Open-vocabulary Querying
...
#### [110] STAMICS: Splat, Track And Map with Integrated Consistency and Semantics for Dense RGB-D SLAM
...
#### [111] Frequency-Aware Gaussian Splatting Decomposition
...
#### [112] TC-GS: Tri-plane based compression for 3D Gaussian Splatting
...
#### [113] High-Quality Spatial Reconstruction and Orthoimage Generation Using Efficient 2D Gaussian Splatting
...
#### [114] SparseGS-W: Sparse-View 3D Gaussian Splatting in the Wild with Generative Priors
...
#### [115] Divide-and-Conquer: Dual-Hierarchical Optimization for Semantic 4D Gaussian Spatting
...
#### [116] MATT-GS: Masked Attention-based 3DGS for Robot Perception and Object Detection
...
#### [117] GS-Marker: Generalizable and Robust Watermarking for 3D Gaussian Splatting
...
#### [118] LLGS: Unsupervised Gaussian Splatting for Image Enhancement and Reconstruction in Pure Dark Environment
...
#### [119] StableGS: A Floater-Free Framework for 3D Gaussian Splatting
...
#### [120] ReconDreamer++: Harmonizing Generative and Reconstructive Models for Driving Scene Representation
...
#### [121] GI-SLAM: Gaussian-Inertial SLAM
...
#### [122] Unraveling the Effects of Synthetic Data on End-to-End Autonomous Driving
...
#### [123] PanopticSplatting: End-to-End Panoptic Gaussian Splatting
...
#### [124] SceneSplat: Gaussian Splatting-based Scene Understanding with Vision-Language Pretraining
...
#### [125] Real-time Global Illumination for Dynamic 3D Gaussian Scenes
...
#### [126] GaussianFocus: Constrained Attention Focus for 3D Gaussian Splatting
...
#### [127] GS-LTS: 3D Gaussian Splatting-Based Adaptive Modeling for Long-Term Service Robots
...
#### [128] Is there anything left? Measuring semantic residuals of objects removed from 3D Gaussian Splatting
...
#### [129] Splat-LOAM: Gaussian Splatting LiDAR Odometry and Mapping
...
#### [130] ProtoGS: Efficient and High-Quality Rendering with 3D Gaussian Prototypes
...
#### [131] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [132] Optimized Minimal 3D Gaussian Splatting
...
#### [133] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [134] 4D Gaussian Splatting SLAM
...
#### [135] GauRast: Enhancing GPU Triangle Rasterizers to Accelerate 3D Gaussian Splatting
...
#### [136] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [137] OccluGaussian: Occlusion-Aware Gaussian Splatting for Large Scene Reconstruction and Rendering
...
#### [138] Repurposing 2D Diffusion Models with Gaussian Atlas for 3D Generation
...
#### [139] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [140] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [141] Uncertainty-Aware Diffusion Guided Refinement of 3D Scenes
...
#### [142] CHROME: Clothed Human Reconstruction with Occlusion-Resilience and Multiview-Consistency from a Single Image
...
#### [143] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [144] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [145] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [146] SplatVoxel: History-Aware Novel View Streaming without Temporal Training
...
#### [147] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [148] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [149] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [150] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [151] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [152] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [153] DeGauss: Dynamic-Static Decomposition with Gaussian Splatting for Distractor-free 3D Reconstruction
...
#### [154] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [155] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [156] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [157] Deblur Gaussian Splatting SLAM
...
#### [158] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [159] MTGS: Multi-Traversal Gaussian Splatting
...
#### [160] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [161] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [162] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [163] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [164] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [165] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [166] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [167] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [168] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [169] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [170] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [171] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [172] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [173] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [174] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [175] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
...
#### [176] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [177] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [178] 3D Student Splatting and Scooping
...
#### [179] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [180] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [181] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [182] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [184] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [186] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [187] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [188] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [189] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [190] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [191] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [192] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [193] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [194] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [195] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [196] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [197] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [198] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [199] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [200] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [201] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [202] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [203] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [204] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [205] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [206] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zexu Huang, Min Xu, Stuart Perry
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2503.06462.md)] [[arXiv:2503.06462](https://arxiv.org/abs/2503.06462)] [Code]
- **📝 说明**：

#### [207] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [208] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [209] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [210] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [211] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [212] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [213] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [214] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [215] Self-Modeling Robots by Photographing
...
#### [216] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [217] STGA: Selective-Training Gaussian Head Avatars
...
#### [218] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [219] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [220] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [221] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [222] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [223] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [224] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [225] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [226] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [227] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [228] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [229] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [230] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [231] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [232] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [233] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [234] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [235] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [236] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [237] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [238] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [239] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [240] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [241] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [242] Seeing A 3D World in A Grain of Sand
...
#### [243] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [244] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [245] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [246] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [247] LUCAS: Layered Universal Codec Avatars
...
#### [248] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [249] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [250] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [251] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [252] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [253] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [254] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [255] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [256] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [257] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [258] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [259] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [260] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [261] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [262] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [263] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [264] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [265] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [266] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [267] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [268] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [269] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [270] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [271] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [272] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [273] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [274] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [275] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [276] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [277] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [278] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [279] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [280] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [281] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [282] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [283] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [284] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [285] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [286] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [287] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [288] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [290] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [291] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [292] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [293] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [294] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [295] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [296] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [297] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [298] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [299] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [300] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [301] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [302] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [303] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [304] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [305] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [306] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [307] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [308] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [309] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [310] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [311] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [312] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [313] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [314] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [315] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [316] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [317] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [318] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [319] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [320] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [321] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [322] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [323] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [324] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [325] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [326] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [327] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [328] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [329] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [330] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [331] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [332] Gaussian Masked Autoencoders
...
#### [333] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [334] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [335] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [336] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [337] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [338] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [339] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [340] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [341] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [342] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [343] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [344] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [345] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [346] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [347] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [348] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [349] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [350] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [351] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [352] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [353] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [354] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [355] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [356] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [357] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [358] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [359] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [360] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [361] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [362] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [363] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [364] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [365] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [366] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [367] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [368] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [369] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [370] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [371] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [372] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [373] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [374] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [375] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [376] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [377] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [378] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [379] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [380] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [381] EOGS: Gaussian Splatting for Earth Observation
...
#### [382] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [383] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [384] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [385] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [386] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [387] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [388] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [389] Deformable Radial Kernel Splatting
...
#### [390] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [391] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [392] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [393] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [394] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [395] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [396] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [397] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [398] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [399] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [400] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [401] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [402] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [403] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [404] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [405] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [406] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [407] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [408] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [409] Faster and Better 3D Splatting via Group Training
...
#### [410] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [411] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [412] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [413] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [414] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [415] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [416] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [417] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [418] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [419] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [420] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [421] Street Gaussians without 3D Object Tracker
...
#### [422] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [423] Extrapolated Urban View Synthesis Benchmark
...
#### [424] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [425] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [426] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [427] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [428] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [429] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [430] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [431] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [432] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [433] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [434] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [435] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [436] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [437] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [438] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [439] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [440] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [441] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [442] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [443] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [444] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [445] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [446] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [447] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [448] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [449] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [450] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [451] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [452] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [453] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [454] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [455] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [456] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [457] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [458] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [459] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [460] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [461] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [462] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [463] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [464] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [465] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [466] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [467] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [468] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [469] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [470] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [471] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [472] Neural Surface Priors for Editable Gaussian Splatting
...
#### [473] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [474] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [475] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [476] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [477] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [478] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [479] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [480] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [481] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [482] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [483] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [484] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [485] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [486] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [487] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [488] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [489] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [490] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [491] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [492] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [493] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [494] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [495] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [496] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [497] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [498] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [499] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [500] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [501] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [502] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [503] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [504] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [505] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [506] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [507] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [508] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [509] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [510] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [511] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [512] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [513] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [514] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [515] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [516] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [517] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [518] VeGaS: Video Gaussian Splatting
...
#### [519] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [520] Efficient Density Control for 3D Gaussian Splatting
...
#### [521] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [522] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [523] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [524] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [525] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [526] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [527] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [528] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [529] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [530] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [531] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [532] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [533] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [534] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [535] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [536] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [537] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [538] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [539] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [540] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [541] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [542] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [543] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [544] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [545] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [546] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [547] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [548] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [549] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [551] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [552] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [553] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [554] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [555] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [556] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [557] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [558] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [559] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [560] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [561] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [562] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [563] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [564] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [565] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [566] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [567] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [568] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [569] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [570] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [571] 3D Vision-Language Gaussian Splatting
...
#### [572] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [573] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [574] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [575] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [576] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [577] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [578] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [579] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [580] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [581] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [582] Variational Bayes Gaussian Splatting
...
#### [583] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [584] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [585] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [586] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [587] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [588] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [589] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [590] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [591] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [592] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [593] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [594] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [595] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [596] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [597] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [598] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [599] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [600] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [601] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [602] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [603] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [604] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [605] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [606] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [607] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [608] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [609] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [610] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [611] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [612] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [613] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [614] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [615] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [616] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [617] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [618] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [619] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [620] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [621] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [622] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [623] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [624] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [625] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [626] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [627] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [628] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [629] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [630] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [631] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [632] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [633] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [634] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [635] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [636] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [637] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [638] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [639] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [640] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [641] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [642] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [643] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [644] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [645] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [646] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [647] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [648] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [649] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [650] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [651] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [652] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [653] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [654] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [655] G-Style: Stylized Gaussian Splatting
...
#### [656] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [657] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [658] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [659] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [660] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [661] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [662] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [663] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [664] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [665] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [666] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [667] Subsurface Scattering for 3D Gaussian Splatting
...
#### [668] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [669] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [670] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [671] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [672] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [673] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [674] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [675] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [676] 3D Gaussian Editing with A Single Image
...
#### [677] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [678] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [679] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [680] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [681] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [682] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [683] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [684] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [685] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [686] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [687] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [688] IG-SLAM: Instant Gaussian SLAM
...
#### [689] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [690] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [691] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [692] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [693] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [694] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [695] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [696] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [697] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [698] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [699] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [700] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [701] Gaussian Splatting Lucas-Kanade
...
#### [702] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [703] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [704] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [705] PICA: Physics-Integrated Clothed Avatar
...
#### [706] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [708] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [709] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [710] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [711] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [712] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [713] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [714] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [715] Lightweight Predictive 3D Gaussian Splats
...
#### [716] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [717] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [718] On Scaling Up 3D Gaussian Splatting Training
...
#### [719] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [720] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [721] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [722] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [723] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [724] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [725] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [726] E2GS: Event Enhanced Gaussian Splatting
...
#### [727] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [728] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [729] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [730] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [731] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [732] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [733] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [734] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [735] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [736] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [737] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [738] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [739] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [740] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [741] Localized Gaussian Point Management
...
#### [742] Gaussian Representation for Deformable Image Registration
...
#### [743] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [744] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [745] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [746] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [747] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [748] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [749] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
