...
#### [1] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [2] MVPGS: Excavating Multi-view Priors for Gaussian Splatting from Sparse Input Views
...
#### [4] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [5] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [8] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [9] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [10] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [11] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [12] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [13] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [14] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [15] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [16] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [17] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [18] SRIF: Semantic Shape Registration Empowered by Diffusion-based Image Morphing and Flow Estimation
...
#### [19] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [20] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [21] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [22] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [23] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [24] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [25] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [26] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [27] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [28] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [29] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [31] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [32] AdR-Gaussian: Accelerating Gaussian Splatting with Adaptive Radius
...
#### [35] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [36] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [37] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [38] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [39] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [40] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [41] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [42] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [43] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [44] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [45] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [46] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [47] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [48] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [49] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [50] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [51] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [52] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [53] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [54] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [55] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [56] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [57] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [58] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [59] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [60] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [61] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [62] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [63] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [64] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [65] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [66] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [67] OmniRe: Omni Urban Scene Reconstruction
...
#### [68] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [69] G-Style: Stylized Gaussian Splatting
...
#### [70] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [71] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [72] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [73] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [74] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [75] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [76] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [77] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [78] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [79] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [80] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [81] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [82] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [83] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [84] Subsurface Scattering for 3D Gaussian Splatting
...
#### [85] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [86] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [87] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [88] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [89] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [90] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [91] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [92] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [93] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [94] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [95] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [96] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [97] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [98] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [99] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [100] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [101] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [102] 3D Gaussian Editing with A Single Image
...
#### [103] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [104] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [105] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [106] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [107] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [108] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [109] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [110] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [111] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [112] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [113] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [114] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [115] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [116] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [117] IG-SLAM: Instant Gaussian SLAM
...
#### [118] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [119] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [120] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [121] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [122] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [123] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [124] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [125] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [126] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [127] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [128] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [129] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [130] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [131] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [132] Gaussian Splatting Lucas-Kanade
...
#### [133] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [134] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [135] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [136] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [137] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [138] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [139] PICA: Physics-Integrated Clothed Avatar
...
#### [140] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [141] Gaussian Eigen Models for Human Heads
...
#### [143] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [144] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [145] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [146] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [147] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [148] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [149] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [150] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [151] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [152] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [153] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [154] Lightweight Predictive 3D Gaussian Splats
...
#### [155] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [156] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [157] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [158] On Scaling Up 3D Gaussian Splatting Training
...
#### [159] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [160] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [161] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [162] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [163] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [164] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [165] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [166] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [167] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [168] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [169] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [170] E2GS: Event Enhanced Gaussian Splatting
...
#### [171] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [172] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [173] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [174] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [175] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [176] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [177] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [178] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [179] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [180] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [181] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [182] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [183] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [184] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [185] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [186] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [187] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [188] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [189] From Chaos to Clarity: 3DGS in the Dark
...
#### [190] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [191] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [192] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [193] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [194] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [195] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [196] Generalizable Human Gaussians from Single-View Image
...
#### [197] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [198] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [199] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [200] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [201] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [202] Localized Gaussian Point Management
...
#### [203] Gaussian Representation for Deformable Image Registration
...
#### [204] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [205] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [206] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [207] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [208] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [209] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [210] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [211] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [212] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [213] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [214] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [215] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [216] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [217] Tetrahedron Splatting for 3D Generation
...
#### [218] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [219] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [220] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [221] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
