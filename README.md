...
#### [1] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [2] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [3] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [4] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [5] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [6] NeRF and Gaussian Splatting SLAM in the Wild
- **🧑‍🔬 作者**：Fabian Schmidt, Markus Enzweiler, Abhinav Valada
- **🏫 单位**：Esslingen University of Applied Sciences ⟐ University of Freiburg
- **🔗 链接**：[[中英摘要](./abs/2412.03263.md)] [[arXiv:2412.03263](https://arxiv.org/abs/2412.03263)] [Code]
- **📝 说明**：

#### [7] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
- **🏫 单位**：POSTECH
- **🔗 链接**：[[中英摘要](./abs/2412.03077.md)] [[arXiv:2412.03077](https://arxiv.org/abs/2412.03077)] [Code]
- **📝 说明**：

#### [9] Gaussian Splatting Under Attack: Investigating Adversarial Noise in 3D Objects
...
#### [10] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [11] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
- **🔗 链接**：[[中英摘要](./abs/2412.02493.md)] [[arXiv:2412.02493](https://arxiv.org/abs/2412.02493)] [Code]
- **📝 说明**：

#### [12] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [13] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [14] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [16] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [18] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
- **🏫 单位**：University of Pennsylvania ⟐ Archimedes, Athena RC
- **🔗 链接**：[[中英摘要](./abs/2412.01823.md)] [[arXiv:2412.01823](https://arxiv.org/abs/2412.01823)] [Code]
- **📝 说明**：

#### [19] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
- **🏫 单位**：Johns Hopkins University ⟐ INSAIT, Sofia University
- **🔗 链接**：[[中英摘要](./abs/2412.01807.md)] [[arXiv:2412.01807](https://arxiv.org/abs/2412.01807)] [Code]
- **📝 说明**：
...
#### [21] Diffusion Models with Anisotropic Gaussian Splatting for Image Inpainting
- **🧑‍🔬 作者**：Jacob Fein-Ashley, Benjamin Fein-Ashley
- **🏫 单位**：University of Southern California
- **🔗 链接**：[[中英摘要](./abs/2412.01682.md)] [[arXiv:2412.01682](https://arxiv.org/abs/2412.01682)] [Code]
- **📝 说明**：

#### [22] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2412.01583.md)] [[arXiv:2412.01583](https://arxiv.org/abs/2412.01583)] [Code]
- **📝 说明**：

#### [23] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.01553.md)] [[arXiv:2412.01553](https://arxiv.org/abs/2412.01553)] [Code]
- **📝 说明**：

#### [24] GFreeDet: Exploiting Gaussian Splatting and Foundation Models for Model-free Unseen Object Detection in the BOP Challenge 2024
- **🧑‍🔬 作者**：Xingyu Liu, Yingyue Li, Chengxi Li, Gu Wang, Chenyangguang Zhang, Ziqin Huang, Xiangyang Ji
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2412.01552.md)] [[arXiv:2412.01552](https://arxiv.org/abs/2412.01552)] [Code]
- **📝 说明**：

#### [25] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [26] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [27] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [28] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [29] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [30] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [31] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [32] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [33] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [34] Instant3dit: Multiview Inpainting for Fast Editing of 3D Objects
- **🧑‍🔬 作者**：Amir Barda, Matheus Gadelha, Vladimir G. Kim, Noam Aigerman, Amit H. Bermano, Thibault Groueix
- **🏫 单位**：Tel Aviv University, Israel ⟐ Adobe Research, USA ⟐ Universite de Montreal, Canada
- **🔗 链接**：[[中英摘要](./abs/2412.00518.md)] [[arXiv:2412.00518](https://arxiv.org/abs/2412.00518)] [Code]
- **📝 说明**：

#### [35] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [36] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [37] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [38] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [39] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [40] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [41] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [43] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [44] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [45] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [46] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [47] AGS-Mesh: Adaptive Gaussian Splatting and Meshing with Geometric Priors for Indoor Room Reconstruction Using Smartphones
...
#### [48] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [49] Gaussians-to-Life: Text-Driven Animation of 3D Gaussian Splatting Scenes
...
#### [50] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [51] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [52] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [53] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [54] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [55] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [56] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [57] Neural Surface Priors for Editable Gaussian Splatting
...
#### [58] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [59] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [60] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [61] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [62] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [63] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [64] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [65] Geometry Field Splatting with Gaussian Surfels
...
#### [66] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [67] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [68] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [69] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [70] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [71] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [72] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [73] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [74] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [75] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [76] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [77] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [78] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [79] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [80] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [81] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [82] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [83] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [84] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [85] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [86] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [87] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [88] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [89] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [90] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [91] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [92] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [93] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [94] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [95] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [96] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [97] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [98] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [99] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [100] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [101] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [102] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [103] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [104] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [105] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [106] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [107] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [108] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [109] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [110] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [111] VeGaS: Video Gaussian Splatting
...
#### [112] Direct and Explicit 3D Generation from a Single Image
...
#### [113] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [114] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [115] Efficient Density Control for 3D Gaussian Splatting
...
#### [116] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
...
#### [117] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [118] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [119] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [120] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [121] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [122] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [123] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [124] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [125] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [126] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [127] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [128] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [129] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [130] Object and Contact Point Tracking in Demonstrations Using 3D Gaussian Splatting
...
#### [131] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [132] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [133] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [134] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [135] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [136] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [137] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [138] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [139] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [140] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [141] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [142] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [143] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [144] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
...
#### [145] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [146] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [147] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [148] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [149] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [150] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [151] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [152] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [153] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [154] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [155] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [156] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [157] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [158] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [159] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [160] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [161] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [162] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [163] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [164] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [165] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [166] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [167] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [168] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [169] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [170] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [171] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [172] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [173] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [174] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [175] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [176] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [177] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [178] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [180] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [182] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [183] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [184] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [185] 3D Vision-Language Gaussian Splatting
...
#### [186] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [187] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [188] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [189] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [190] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [191] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [192] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [193] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [194] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [195] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [196] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [197] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [198] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [199] Variational Bayes Gaussian Splatting
...
#### [200] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [201] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [203] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [204] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [205] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [206] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [207] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [208] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [209] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [210] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [211] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [212] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [213] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [214] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [215] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [216] RNG: Relightable Neural Gaussians
...
#### [217] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [218] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [219] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [220] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [221] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [222] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [223] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [224] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [225] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [226] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [227] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [228] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [229] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [230] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [231] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [232] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [233] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [234] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [235] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [236] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [237] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [238] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [239] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [240] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [241] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [242] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [243] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [244] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [245] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [246] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [247] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [248] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [249] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [250] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [251] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [252] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [253] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [254] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [255] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [256] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [257] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [258] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [259] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [260] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [261] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [262] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [263] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [264] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [265] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [266] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [267] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [268] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [269] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [270] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [271] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [272] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [273] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [274] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [275] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [276] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [277] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [278] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [279] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [280] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [281] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [282] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [283] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [284] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [285] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [286] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [287] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [288] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [289] OmniRe: Omni Urban Scene Reconstruction
...
#### [290] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [291] G-Style: Stylized Gaussian Splatting
...
#### [292] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [293] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [294] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [295] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [296] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [297] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [298] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [299] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [300] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [301] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [302] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [303] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [304] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [305] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [306] Subsurface Scattering for 3D Gaussian Splatting
...
#### [307] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [308] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [309] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [310] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [311] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [312] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [313] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [314] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [315] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [316] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [317] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [318] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [319] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [320] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [321] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [322] 3D Gaussian Editing with A Single Image
...
#### [323] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [324] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [325] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [326] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [327] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [328] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [329] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [330] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [331] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [332] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [333] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [334] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [335] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [336] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [337] IG-SLAM: Instant Gaussian SLAM
...
#### [338] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [339] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [340] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [341] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [342] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [343] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [344] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [345] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [346] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [347] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [348] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [349] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [350] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [351] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [352] Gaussian Splatting Lucas-Kanade
...
#### [353] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [354] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [355] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [356] PICA: Physics-Integrated Clothed Avatar
...
#### [357] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [358] Gaussian Eigen Models for Human Heads
...
#### [360] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [361] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [362] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [363] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [364] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [365] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [366] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [367] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [368] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [369] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [370] Lightweight Predictive 3D Gaussian Splats
...
#### [371] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [372] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [373] On Scaling Up 3D Gaussian Splatting Training
...
#### [374] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [375] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [376] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [377] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [378] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [379] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [380] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [381] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [382] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [383] E2GS: Event Enhanced Gaussian Splatting
...
#### [384] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [385] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [386] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [387] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [388] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [389] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [390] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [391] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [392] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [393] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [394] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [395] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [396] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [397] From Chaos to Clarity: 3DGS in the Dark
...
#### [398] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [399] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [400] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [401] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [402] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [403] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [404] Generalizable Human Gaussians from Single-View Image
...
#### [405] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [406] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [407] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [408] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [409] Localized Gaussian Point Management
...
#### [410] Gaussian Representation for Deformable Image Registration
...
#### [411] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [412] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [413] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [414] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [415] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [416] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [417] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [418] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [419] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [420] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [421] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [422] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
