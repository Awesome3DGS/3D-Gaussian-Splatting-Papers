...
#### [1] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [2] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [3] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [4] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [5] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [6] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [7] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [8] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
...
#### [11] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [12] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [13] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [14] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [15] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [17] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [18] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [19] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [20] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [21] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [22] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [23] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [24] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [25] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [26] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [27] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [28] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [29] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [30] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [31] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [32] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [33] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [34] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [35] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [36] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [37] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [38] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [39] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [40] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [41] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [42] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [43] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [44] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [45] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [46] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [47] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [48] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [49] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [50] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [51] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [52] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [53] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [54] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [55] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [56] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [57] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [58] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [59] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [60] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [61] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [62] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [63] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [64] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [65] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [66] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [67] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [68] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [69] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [70] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [71] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [72] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [73] Gaussian Masked Autoencoders
...
#### [74] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [75] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [76] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [77] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [78] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [79] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [80] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [81] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [82] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [83] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [84] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [85] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [86] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [87] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [88] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [89] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [90] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [91] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [92] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [93] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [94] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [95] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [96] Reflective Gaussian Splatting
...
#### [97] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [98] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [99] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [100] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [101] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [102] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [103] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [104] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [105] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [106] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [107] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [108] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [109] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [110] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [111] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [112] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [113] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [114] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [115] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [116] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [117] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [118] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [119] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [120] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [121] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [122] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [123] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [124] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [125] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [126] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [127] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [128] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [129] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [130] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [131] EOGS: Gaussian Splatting for Earth Observation
...
#### [132] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [133] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [134] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [135] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [136] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [137] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [138] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [139] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [140] Deformable Radial Kernel Splatting
...
#### [141] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [142] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [143] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [144] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [145] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [146] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [147] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [148] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [149] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [150] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [151] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [152] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [153] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [154] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [155] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [156] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [157] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [158] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [159] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [160] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [161] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [162] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [163] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [164] GASP: Gaussian Avatars with Synthetic Priors
...
#### [165] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [166] Faster and Better 3D Splatting via Group Training
...
#### [167] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [168] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [169] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [170] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [171] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [172] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [173] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [174] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [175] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [176] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [177] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [178] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [179] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [180] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [181] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [182] Street Gaussians without 3D Object Tracker
...
#### [183] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [184] Extrapolated Urban View Synthesis Benchmark
...
#### [185] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [186] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [187] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [188] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [189] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [190] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [191] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [192] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [193] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [194] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [195] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [196] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [197] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [198] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [199] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [200] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [201] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [202] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [203] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [204] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [205] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [206] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [207] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [208] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [209] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [210] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [211] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [212] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [213] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [214] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [215] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [216] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [217] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [218] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [219] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [220] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [221] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [222] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [223] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [224] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [225] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [226] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [227] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [228] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [229] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [230] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [231] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [232] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [233] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [234] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [235] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [236] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [237] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [238] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [239] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [240] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [241] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [243] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [244] Neural Surface Priors for Editable Gaussian Splatting
...
#### [245] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [246] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [247] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [248] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [249] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [250] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [251] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [252] Geometry Field Splatting with Gaussian Surfels
...
#### [253] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [254] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [255] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [256] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [257] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [258] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [259] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [260] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [261] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [262] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [263] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [264] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [265] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [266] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [267] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [268] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [269] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [270] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [271] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [272] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [273] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [274] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [275] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [276] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [277] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [278] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [279] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [280] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [281] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [282] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [283] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [284] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [285] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [286] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [287] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [288] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [289] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [290] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [291] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [292] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [293] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [294] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [295] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [296] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [297] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [298] VeGaS: Video Gaussian Splatting
...
#### [299] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [300] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [301] Efficient Density Control for 3D Gaussian Splatting
...
#### [302] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [303] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [304] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [305] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [306] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [307] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [308] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [309] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [310] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [311] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [312] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [313] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [314] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [315] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [316] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [317] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [318] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [319] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [320] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [321] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [322] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [323] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [324] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [325] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [326] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [327] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [328] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [329] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [330] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [331] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [332] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [333] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [334] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [335] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [336] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [337] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [338] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [339] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [340] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [341] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [342] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [343] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [344] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [345] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [346] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [347] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [348] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [349] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [350] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [351] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [352] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [353] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [354] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [355] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [356] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [357] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [358] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [359] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [360] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [361] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [362] 3D Vision-Language Gaussian Splatting
...
#### [363] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [364] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [365] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [366] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [367] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [368] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [369] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [370] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [371] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [372] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [373] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [374] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [375] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [376] Variational Bayes Gaussian Splatting
...
#### [377] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [378] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [379] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [380] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [381] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [382] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [383] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [384] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [385] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [386] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [387] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [388] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [389] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [390] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [391] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [392] RNG: Relightable Neural Gaussians
...
#### [393] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [394] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [395] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [396] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [397] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [398] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [399] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [400] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [401] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [402] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [403] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [404] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [405] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [406] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [407] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [408] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [409] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [410] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [411] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [412] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [413] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [414] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [415] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [416] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [417] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [418] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [419] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [420] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [421] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [422] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [423] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [424] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [425] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [426] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [427] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [428] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [429] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [430] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [431] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [432] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [433] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [434] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [435] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [436] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [437] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [438] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [439] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [440] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [441] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [442] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [443] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [444] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [445] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [446] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [447] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [448] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [449] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [450] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [451] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [452] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [453] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [454] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [455] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [456] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [457] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [458] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [459] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [460] OmniRe: Omni Urban Scene Reconstruction
...
#### [461] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [462] G-Style: Stylized Gaussian Splatting
...
#### [463] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [464] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [465] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [466] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [467] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [468] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [469] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [470] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [471] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [472] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [473] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [474] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [475] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [476] Subsurface Scattering for 3D Gaussian Splatting
...
#### [477] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [478] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [479] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [480] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [481] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [482] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [483] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [484] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [485] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [486] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [487] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [488] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [489] 3D Gaussian Editing with A Single Image
...
#### [490] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [491] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [492] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [493] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [494] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [495] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [496] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [497] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [498] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [499] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [500] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [501] IG-SLAM: Instant Gaussian SLAM
...
#### [502] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [503] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [504] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [505] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [506] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [507] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [508] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [509] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [510] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [511] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [512] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [513] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [514] Gaussian Splatting Lucas-Kanade
...
#### [515] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [516] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [517] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [518] PICA: Physics-Integrated Clothed Avatar
...
#### [519] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [520] Gaussian Eigen Models for Human Heads
...
#### [522] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [523] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [524] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [525] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [526] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [527] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [528] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [529] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [530] Lightweight Predictive 3D Gaussian Splats
...
#### [531] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [532] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [533] On Scaling Up 3D Gaussian Splatting Training
...
#### [534] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [535] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [536] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [537] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [538] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [539] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [540] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [541] E2GS: Event Enhanced Gaussian Splatting
...
#### [542] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [543] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [544] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [545] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [546] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [547] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [548] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [549] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [550] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [551] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [552] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [553] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [554] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [555] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [556] Generalizable Human Gaussians from Single-View Image
...
#### [557] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [558] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [559] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [560] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [561] Localized Gaussian Point Management
...
#### [562] Gaussian Representation for Deformable Image Registration
...
#### [563] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [564] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [565] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [566] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [567] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [568] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [569] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [570] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [571] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
