...
由于论文数量激增，页面变得过长。为方便查阅，我们将2024年6月之前的论文暂时[📁 归档](https://github.com/Awesome3DGS/3D-Gaussian-Splatting-Papers/tree/archive/202406)（后续进一步整理），并把最新论文调整为按时间倒序排列。

Due to the rapid increase in the number of papers, the page has become too long.
To facilitate the review, we have temporarily
[📁 archived](https://github.com/Awesome3DGS/3D-Gaussian-Splatting-Papers/tree/archive/202406) papers
before Jan 2024 (which will be further organized) and rearranged latest papers
...
- [[ICLR2024](./ICLR2024.md)] (2 篇)
  ...
  [[CVPR2024](./CVPR2024.md)] (67 篇)
  [[WACV2024](./WACV2024.md)] (1 篇)
  [[ICML2024](./ICML2024.md)] (4 篇)
- [[SIGGRAPH2024](./SIGGRAPH2024.md)] (19 篇)
  [[IJCAI2024](./IJCAI2024.md)] (1 篇)
  [[ECCV2024](./ECCV2024.md)] (74 篇)
  [[MICCAI2024](./MICCAI2024.md)] (7 篇)
  [[ACMMM2024](./ACMMM2024.md)] (6 篇)
- [[NeurIPS2024](./NeurIPS2024.md)] (58 篇)

**📂 归档论文**: [[Before 2024/06/01](https://github.com/Awesome3DGS/3D-Gaussian-Splatting-Papers/tree/archive/202406)] (221 篇)
...
#### [1] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [2] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [3] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [4] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [5] Template-free Articulated Gaussian Splatting for Real-time Reposable Dynamic View Synthesis
...
#### [6] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [7] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
- **🧑‍🔬 作者**：Haosong Peng, Tianyu Qi, Yufeng Zhan, Hao Li, Yalun Dai, Yuanqing Xia
- **🏫 单位**：School of Automation, Beijing Institute of Technology, Beijing, China ⟐ School of Cyber Science and Technology, Sun Yat-sen University, Shenzhen, China ⟐ Brain and Artificial Intelligence Lab, Northwestern Polytechnical University, Xi’an, China ⟐ Nanyang Technological University, Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.05546.md)] [[arXiv:2412.05546](https://arxiv.org/abs/2412.05546)] [Code]
- **📝 说明**：

#### [8] Extrapolated Urban View Synthesis Benchmark
...
#### [9] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [11] WRF-GS: Wireless Radiation Field Reconstruction with 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chaozheng Wen, Jingwen Tong, Yingdong Hu, Zehong Lin, Jun Zhang
- **🏫 单位**：Hong Kong Research Grants Council ⟐ Department of Electronic and Computer Engineering, Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2412.04832.md)] [[arXiv:2412.04832](https://arxiv.org/abs/2412.04832)] [Code]
- **📝 说明**：🏆 Accepted to INFOCOM 2025

#### [12] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [14] QUEEN: QUantized Efficient ENcoding of Dynamic Gaussians for Streaming Free-viewpoint Videos
...
#### [15] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [16] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [18] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [19] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [20] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [21] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [22] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [23] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [24] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [25] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [26] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [27] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [28] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [29] Gaussian Splatting Under Attack: Investigating Adversarial Noise in 3D Objects
...
#### [30] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [31] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [32] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [33] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [34] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [35] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [36] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [38] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [39] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [40] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [41] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [42] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
...
#### [43] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [44] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [45] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [46] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [47] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [48] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [49] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [50] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [51] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [52] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [53] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [54] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [55] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [56] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [57] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [58] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [59] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [60] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [61] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [62] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [63] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [64] AGS-Mesh: Adaptive Gaussian Splatting and Meshing with Geometric Priors for Indoor Room Reconstruction Using Smartphones
...
#### [65] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [66] Gaussians-to-Life: Text-Driven Animation of 3D Gaussian Splatting Scenes
...
#### [67] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [68] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [69] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [70] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [71] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [72] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [73] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [74] Neural Surface Priors for Editable Gaussian Splatting
...
#### [75] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [76] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [77] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [78] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [79] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [80] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [81] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [82] Geometry Field Splatting with Gaussian Surfels
...
#### [83] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [84] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [85] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [86] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [87] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [88] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [89] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [90] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [91] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [92] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [93] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [94] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [95] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [96] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [97] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [98] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [99] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [100] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [101] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [102] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [103] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [104] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [105] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [106] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [107] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [108] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [109] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [110] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [111] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [112] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [113] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [114] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [115] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [116] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [117] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [118] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [119] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [120] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [121] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [122] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [123] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [124] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [125] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [126] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [127] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [128] VeGaS: Video Gaussian Splatting
...
#### [129] Direct and Explicit 3D Generation from a Single Image
...
#### [130] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [131] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [132] Efficient Density Control for 3D Gaussian Splatting
...
#### [133] GSEditPro: 3D Gaussian Splatting Editing with Attention-based Progressive Localization
...
#### [134] GGAvatar: Reconstructing Garment-Separated 3D Gaussian Splatting Avatars from Monocular Video
- **🧑‍🔬 作者**：Jingxuan Chen
...
#### [135] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [136] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [137] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [138] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [139] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [140] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [141] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [142] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [143] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [144] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [145] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [146] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [147] Object and Contact Point Tracking in Demonstrations Using 3D Gaussian Splatting
...
#### [148] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [149] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [150] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [151] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [152] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [153] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [154] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [155] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [156] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [157] ELMGS: Enhancing memory and computation scaLability through coMpression for 3D Gaussian Splatting
...
#### [158] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [160] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [161] ArCSEM: Artistic Colorization of SEM Images via Gaussian Splatting
...
#### [162] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [163] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [164] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [165] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [166] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [167] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [168] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [169] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [170] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [171] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [172] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [173] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [174] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [175] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [176] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [177] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [178] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [179] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [180] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [181] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [182] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [183] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [184] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [185] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [186] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [187] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [188] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [189] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [190] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [191] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [192] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [193] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [194] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [195] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [196] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [197] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [198] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [199] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [200] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [201] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [202] 3D Vision-Language Gaussian Splatting
...
#### [203] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [204] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [205] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [206] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [207] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [208] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [209] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [210] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [211] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [212] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [213] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [214] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [215] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [216] Variational Bayes Gaussian Splatting
...
#### [217] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [218] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [219] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [220] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [221] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [222] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [223] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [224] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [225] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [226] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [227] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [228] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [229] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [230] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [231] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [232] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [233] RNG: Relightable Neural Gaussians
...
#### [234] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [235] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [236] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [237] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [238] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [239] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [240] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [241] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [242] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [243] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [244] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [245] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [246] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [247] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [248] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [249] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [250] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [251] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [252] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [253] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [254] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [255] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [256] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [257] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [258] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [259] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [260] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [261] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [262] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [263] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [264] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [265] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [266] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [267] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [268] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [269] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [270] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [271] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [272] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [273] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [274] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [275] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [276] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [277] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [278] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [279] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [280] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [281] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [282] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [283] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [284] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [285] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [286] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [287] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [288] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [289] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [290] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [291] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [292] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [293] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [294] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [295] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [296] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [297] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [298] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [299] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [300] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [301] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [302] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [303] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [304] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [305] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [306] OmniRe: Omni Urban Scene Reconstruction
...
#### [307] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [308] G-Style: Stylized Gaussian Splatting
...
#### [309] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [310] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [311] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [312] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [313] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [314] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [315] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [316] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [317] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [318] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [319] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [320] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [321] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [322] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [323] Subsurface Scattering for 3D Gaussian Splatting
...
#### [324] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [325] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [326] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [327] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [329] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [330] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [331] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [332] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [333] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [334] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [335] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [336] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [337] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [338] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [339] 3D Gaussian Editing with A Single Image
...
#### [340] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [341] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [342] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [343] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [344] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [345] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [346] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [347] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [348] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [349] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [350] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [351] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [352] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [353] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [354] IG-SLAM: Instant Gaussian SLAM
...
#### [355] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [356] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [357] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [358] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [359] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [360] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [361] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [362] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [363] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [364] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [365] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [366] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [367] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [368] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [369] Gaussian Splatting Lucas-Kanade
...
#### [370] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [371] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [372] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [373] PICA: Physics-Integrated Clothed Avatar
...
#### [374] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [375] Gaussian Eigen Models for Human Heads
...
#### [377] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [378] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [379] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [380] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [381] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [382] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [383] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [384] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [385] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [386] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [387] Lightweight Predictive 3D Gaussian Splats
...
#### [388] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [389] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [390] On Scaling Up 3D Gaussian Splatting Training
...
#### [391] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [392] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [393] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [394] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [395] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [396] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [397] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [398] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [399] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [400] E2GS: Event Enhanced Gaussian Splatting
...
#### [401] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [402] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [403] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [404] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [405] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [406] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [407] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [408] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [409] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [410] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [411] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [412] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [413] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [414] From Chaos to Clarity: 3DGS in the Dark
...
#### [415] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [416] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [417] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [418] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [419] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [420] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [421] Generalizable Human Gaussians from Single-View Image
...
#### [422] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [423] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [424] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [425] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [426] Localized Gaussian Point Management
...
#### [427] Gaussian Representation for Deformable Image Registration
...
#### [428] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [429] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [430] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [431] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [432] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [433] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [434] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [435] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [436] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [437] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [438] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [439] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
