...
#### [14] SparseGS: Real-Time 360° Sparse View Synthesis using Gaussian Splatting
...
#### [16] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [20] MonoGaussianAvatar: Monocular Gaussian Point-based Head Avatar
...
#### [21] EAGLES: Efficient Accelerated 3D Gaussians with Lightweight EncodingS
...
#### [22] GIR: 3D Gaussian Inverse Rendering for Relightable Scene Factorization
...
#### [23] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [24] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [25] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [27] Repaint123: Fast and High-quality One Image to 3D Generation with Progressive Controllable 2D Repainting
...
#### [29] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [30] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [32] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [33] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [34] 2D-Guided 3D Gaussian Segmentation
...
#### [37] FMGS: Foundation Model Embedded 3D Gaussian Splatting for Holistic 3D Scene Understanding
...
#### [38] PEGASUS: Physically Enhanced Gaussian Splatting Simulation System for 6DOF Object Pose Dataset Generation
...
#### [39] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
...
#### [40] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [41] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [42] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [43] TRIPS: Trilinear Point Splatting for Real-Time Radiance Field Rendering
...
#### [45] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [48] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [49] LIV-GaussMap: LiDAR-Inertial-Visual Fusion for Real-time 3D Radiance Field Map Rendering
...
#### [53] Segment Anything in 3D Gaussians
...
#### [54] On the Error Analysis of 3D Gaussian Splatting and an Optimal Projection Strategy
...
#### [55] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [56] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [57] SGS-SLAM: Semantic Gaussian Splatting For Neural Dense SLAM
...
#### [61] LGM: Large Multi-View Gaussian Model for High-Resolution 3D Content Creation
...
#### [63] GALA3D: Towards Text-to-3D Complex Scene Generation via Layout-guided Generative Gaussian Splatting
...
#### [64] GaussianObject: Just Taking Four Images to Get A High-Quality 3D Object with Gaussian Splatting
...
#### [65] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [66] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
- **🧑‍🔬 作者**：Joongho Jo, Hyeongwon Kim, Jongsun Park
- **🏫 单位**：Korea University
- **🔗 链接**：[[中英摘要](./abs/2402.13827.md)] [[arXiv:2402.13827](https://arxiv.org/abs/2402.13827)] [Code]
- **📝 说明**：✏️

#### [67] Spec-Gaussian: Anisotropic View-Dependent Appearance for 3D Gaussian Splatting
...
#### [68] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [70] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [71] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [72] SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM
...
#### [73] StyleGaussian: Instant 3D Style Transfer with Gaussian Splatting
...
#### [75] Gaussian Splatting in Style
...
#### [76] GaussCtrl: Multi-View Consistent Text-Driven 3D Gaussian Splatting Editing
...
#### [77] A New Split Algorithm for 3D Gaussian Splatting
...
#### [78] Hyper-3DG: Text-to-3D Gaussian Generation via Hypergraph
...
#### [79] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [80] GaussianGrasper: 3D Language Gaussian Splatting for Open-vocabulary Robotic Grasping
...
#### [81] Touch-GS: Visual-Tactile Supervised 3D Gaussian Splatting
...
#### [82] Controllable Text-to-3D Generation via Surface-Aligned Gaussian Splatting
...
#### [83] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [84] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [85] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [86] GS-Pose: Cascaded Framework for Generalizable Segmentation-based 6D Object Pose Estimation
...
#### [87] DarkGS: Learning Neural Illumination and 3D Gaussians Relighting for Robotic Exploration in the Dark
...
#### [88] Analytic-Splatting: Anti-Aliased 3D Gaussian Splatting via Analytic Integration
...
#### [90] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [91] GeoGaussian: Geometry-aware Gaussian Splatting for Scene Rendering
...
#### [92] 3DGS-ReLoc: 3D Gaussian Splatting for Map Representation and Visual ReLocalization
...
#### [95] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [96] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [97] 3DGS-Calib: 3D Gaussian Splatting for Multimodal SpatioTemporal Calibration
...
#### [98] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [99] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [100] NEDS-SLAM: A Novel Neural Explicit Dense Semantic SLAM Framework using 3D Gaussian Splatting
...
#### [101] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [103] High-Fidelity SLAM Using Gaussian Splatting with Rendering-Guided Densification and Regularized Optimization
...
#### [105] GVGEN: Text-to-3D Generation with Volumetric Representation
...
#### [106] Gaussian Splatting on the Move: Blur and Rolling Shutter Compensation for Natural Camera Motion
...
#### [107] RadSplat: Radiance Field-Informed Gaussian Splatting for Robust Real-Time Rendering with 900+ FPS
...
#### [108] Isotropic Gaussian Splatting for Real-Time Radiance Field Rendering
...
#### [109] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [110] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [111] Pixel-GS: Density Control with Pixel-aware Gradient for 3D Gaussian Splatting
...
#### [112] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [113] Gaussian in the Wild: 3D Gaussian Splatting for Unconstrained Image Collections
...
#### [114] latentSplat: Autoencoding Variational Gaussians for Fast Generalizable 3D Reconstruction
...
#### [115] GSDF: 3DGS Meets SDF for Improved Rendering and Reconstruction
...
#### [116] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [117] DN-Splatter: Depth and Normal Priors for Gaussian Splatting and Meshing
...
#### [118] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [119] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [121] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [122] Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction
...
#### [123] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [124] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [125] GaussianCube: Structuring Gaussian Splatting using Optimal Transport for 3D Generative Modeling
...
#### [126] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [127] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [128] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [129] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [130] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [131] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [132] MM3DGS SLAM: Multi-modal 3D Gaussian Splatting for SLAM Using Vision, Depth, and Inertial Measurements
...
#### [133] Mirror-3DGS: Incorporating Mirror Reflections into 3D Gaussian Splatting
...
#### [134] Feature Splatting: Language-Driven Physics-Based Scene Synthesis and Editing
...
#### [135] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [136] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [137] OmniGS: Omnidirectional Gaussian Splatting for Fast Radiance Field Reconstruction using Omnidirectional Images
...
#### [139] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [140] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [141] Dual-Camera Smooth Zoom on Mobile Phones
...
#### [142] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [143] Revising Densification in Gaussian Splatting
...
#### [144] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [145] Gaussian-LIC: Photo-realistic LiDAR-Inertial-Camera SLAM with 3D Gaussian Splatting
...
#### [146] RealmDreamer: Text-Driven 3D Scene Generation with Inpainting and Depth Diffusion
...
#### [147] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [148] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [149] LoopGaussian: Creating 3D Cinemagraph with Multi-view Images via Eulerian Motion Field
...
#### [150] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [151] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [152] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [153] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [154] 3D Gaussian Splatting as Markov Chain Monte Carlo
...
#### [155] LetsGo: Large-Scale Garage Modeling and Rendering via LiDAR-Assisted Gaussian Primitives
...
#### [156] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [157] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [158] Gaussian Opacity Fields: Efficient and Compact Surface Reconstruction in Unbounded Scenes
...
#### [159] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [160] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [162] Does Gaussian Splatting need SFM Initialization?
...
#### [163] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [164] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [166] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [167] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [169] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [170] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [171] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [172] 3D Gaussian Splatting with Deferred Reflection
...
#### [173] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [174] DGE: Direct Gaussian 3D Editing by Consistent Multi-view Editing
...
#### [175] MeGA: Hybrid Mesh-Gaussian Head Avatar for High-Fidelity Rendering and Head Editing
...
#### [177] SAGS: Structure-Aware 3D Gaussian Splatting
...
#### [178] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [179] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [180] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [181] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [182] HoloGS: Instant Depth-based 3D Gaussian Splatting with Microsoft HoloLens 2
...
#### [184] A Construct-Optimize Approach to Sparse View Synthesis without Camera Pose
...
#### [185] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [186] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2405.05446.md)] [[arXiv:2405.05446](https://arxiv.org/abs/2405.05446)] [Code]
- **📝 说明**：✏️

#### [187] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [188] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [189] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [190] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06547.md)] [[arXiv:2405.06547](https://arxiv.org/abs/2405.06547)] [[Code](https://github.com/lin-jinwei/OneTo3D)]
- **📝 说明**：✏️

#### [191] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [192] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [193] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [194] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [195] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [196] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [197] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [198] AtomGS: Atomizing Gaussian Splatting for High-Fidelity Radiance Field
...
#### [199] GarmentDreamer: 3DGS Guided Garment Synthesis with Diverse Geometry and Texture Details
...
#### [200] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [201] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [202] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [204] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [205] DoGaussian: Distributed-Oriented Gaussian Splatting for Large-Scale 3D Reconstruction Via Gaussian Consensus
...
#### [208] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [209] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [210] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [211] GS-Hider: Hiding Messages into 3D Gaussian Splatting
...
#### [212] HDR-GS: Efficient High Dynamic Range Novel View Synthesis at 1000x Speed via Gaussian Splatting
...
#### [213] DisC-GS: Discontinuity-aware Gaussian Splatting
...
#### [215] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [216] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [217] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [218] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
...
#### [220] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [221] F-3DGS: Factorized Coordinates and Representations for 3D Gaussian Splatting
...
#### [222] Memorize What Matters: Emergent Scene Decomposition from Multitraverse
...
#### [223] DOF-GS: Adjustable Depth-of-Field 3D Gaussian Splatting for Refocusing,Defocus Rendering and Blur Removal
...
#### [224] GOI: Find 3D Gaussians of Interest with an Optimizable Open-vocabulary Semantic-space Hyperplane
...
#### [225] DC-Gaussian: Improving 3D Gaussian Splatting for Reflective Dash Cam Videos
...
#### [226] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
...
#### [227] Mani-GS: Gaussian Splatting Manipulation with Triangular Mesh
...
#### [228] Deform3DGS: Flexible Deformation for Fast Surgical Scene Reconstruction with Gaussian Splatting
...
#### [231] FreeSplat: Generalizable 3D Gaussian Splatting Towards Free-View Synthesis of Indoor Scenes
...
#### [232] RT-GS2: Real-Time Generalizable Semantic Segmentation for 3D Gaussian Representations of Radiance Fields
...
#### [234] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [235] NegGS: Negative Gaussian Splatting
...
#### [236] 3D StreetUnveiler with Semantic-Aware 2DGS
...
#### [237] 3DitScene: Editing Any Scene via Language-guided Disentangled Gaussian Splatting
...
#### [239] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [240] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [242] NPGA: Neural Parametric Gaussian Avatars
...
#### [243] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [244] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [245] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [248] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [249] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [250] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [251] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [252] R2-Gaussian: Rectifying Radiative Gaussian Splatting for Tomographic Reconstruction
...
#### [253] ContextGS: Compact 3D Gaussian Splatting with Anchor Level Context Model
...
#### [254] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
