...
#### [1] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [2] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [3] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
...
#### [4] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [5] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [6] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [9] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [10] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [11] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [12] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [13] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [14] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [15] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [16] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [17] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [18] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [19] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [21] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [22] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [23] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [24] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [25] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [26] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [27] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [28] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [29] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [30] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [31] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [32] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [33] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [34] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [35] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [36] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [37] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [38] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [39] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [40] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [42] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [43] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [44] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [45] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [46] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [47] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [48] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [49] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [50] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [51] Large-Scale Gaussian Splatting SLAM
...
#### [52] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [53] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [54] Neural Video Compression using 2D Gaussian Splatting
...
#### [55] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [56] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [57] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [58] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [59] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [60] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [61] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [62] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [63] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [64] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [65] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [66] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [67] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [68] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [69] SignSplat: Rendering Sign Language via Gaussian Splatting
...
#### [70] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [71] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [72] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [73] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [74] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [75] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [76] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [77] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [78] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [79] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [80] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [81] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [82] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [83] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [84] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [85] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [86] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [87] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [88] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [89] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [90] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [91] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [92] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [93] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [94] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [95] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [96] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [97] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [98] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [99] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [100] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [101] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [102] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [103] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [104] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [105] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [106] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [107] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [108] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [109] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [110] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [111] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [112] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [113] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [114] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [115] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [116] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [117] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [118] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [119] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [120] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [122] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [123] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [124] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [125] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [126] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [127] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [128] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [129] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [130] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [131] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [132] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [133] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [134] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [135] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [136] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [137] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [138] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [139] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [140] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [141] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [142] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [143] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [144] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [145] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [146] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [147] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [148] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [149] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [150] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [151] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [152] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [153] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [154] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [155] Digital-twin imaging based on descattering Gaussian splatting
...
#### [156] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [157] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [158] BOGausS: Better Optimized Gaussian Splatting
...
#### [159] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [160] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [161] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [162] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [163] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [164] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [165] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [166] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
