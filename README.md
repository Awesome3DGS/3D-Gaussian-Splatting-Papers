...
- **2024**
  ...
  - [[ICLR](./2024/ICLR.md)] (2 篇)
    ...
    [[SIGGRAPH](./2024/SIGGRAPH.md)] (23 篇)
  - [[NeurIPS](./2024/NeurIPS.md)] (66 篇)
    [[ICML](./2024/ICML.md)] (4 篇)
    [[BMVC](./2024/BMVC.md)] (8 篇)
    [[CoRL](./2024/CoRL.md)] (4 篇)
    [[IROS](./2024/IROS.md)] (7 篇)
    [[others](./2024/Accepted.md)] (23 篇)

- **2025**

  - [[3DV](./2025/3DV.md)] (7 篇)
    [[WACV](./2025/WACV.md)] (7 篇)
    [[AAAI](./2025/AAAI.md)] (5 篇)
...
#### [1] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [5] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [8] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [9] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [10] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [11] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [13] Gaussian Masked Autoencoders
...
#### [15] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [16] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [17] Cloth-Splatting: 3D Cloth State Estimation from RGB Supervision
...
#### [18] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [19] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [20] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [21] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [22] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [23] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [24] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [25] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [26] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [27] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [28] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [29] KeyGS: A Keyframe-Centric Gaussian Splatting Method for Monocular Image Sequences
...
#### [30] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [32] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [33] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [34] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [35] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [36] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [37] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [38] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [39] Reflective Gaussian Splatting
...
#### [40] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [41] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [42] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [43] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [44] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [45] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [46] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [47] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [48] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [49] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [50] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [51] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [52] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [53] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [54] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [55] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [56] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [57] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [58] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [59] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [60] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [61] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [62] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [63] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [64] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [65] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [66] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [67] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [68] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [69] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [70] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [71] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [72] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [73] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [74] EOGS: Gaussian Splatting for Earth Observation
...
#### [75] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [76] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [77] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [78] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [79] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [80] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [81] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [82] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [83] Deformable Radial Kernel Splatting
...
#### [84] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [85] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [86] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [87] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [88] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [89] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [90] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [91] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [92] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [93] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [94] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [95] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [96] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [97] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [98] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [99] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [100] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [101] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [102] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [103] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [104] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [105] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [106] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [107] GASP: Gaussian Avatars with Synthetic Priors
...
#### [108] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [109] Faster and Better 3D Splatting via Group Training
...
#### [110] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [111] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [112] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [113] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [114] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [115] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [116] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [117] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [118] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [119] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [120] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [121] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [122] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [123] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [124] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [125] Street Gaussians without 3D Object Tracker
...
#### [126] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [127] Extrapolated Urban View Synthesis Benchmark
...
#### [128] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [129] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [130] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [131] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [132] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [133] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [134] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [135] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [136] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [137] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [138] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [139] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [140] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [141] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [142] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [143] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [144] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [145] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [146] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [147] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [148] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [149] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [150] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [151] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [152] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [153] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [154] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [155] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [156] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [157] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [158] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [159] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [160] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [161] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [162] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [163] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [164] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [165] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [166] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [167] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [168] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [169] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [170] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [171] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [172] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [173] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [174] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [175] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [176] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [177] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [178] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [179] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [180] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [181] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [182] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [183] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [184] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [185] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [186] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [187] Neural Surface Priors for Editable Gaussian Splatting
...
#### [188] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [189] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [190] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [191] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [192] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [193] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [194] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [195] Geometry Field Splatting with Gaussian Surfels
...
#### [196] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [197] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [198] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [199] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [200] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [201] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [202] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [203] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [204] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [205] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [206] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [207] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [208] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [209] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [210] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [211] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [212] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [213] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [214] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [215] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [216] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [217] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [218] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [219] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [220] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [221] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [222] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [223] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [224] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [225] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [226] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [227] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [228] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [229] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [230] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [231] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [232] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [233] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [234] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [235] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [236] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [237] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [238] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [239] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [240] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [241] VeGaS: Video Gaussian Splatting
...
#### [242] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [243] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [244] Efficient Density Control for 3D Gaussian Splatting
...
#### [245] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [246] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [247] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [248] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [249] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [250] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [251] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [252] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [253] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [254] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [255] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [256] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [257] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [258] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [259] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [260] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [261] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [262] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [263] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [264] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [265] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [266] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [267] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [268] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [269] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [270] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [271] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [272] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [273] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [274] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [275] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [276] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [277] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [278] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [279] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [280] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [281] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [282] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [283] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [284] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [285] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [286] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [287] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [288] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [289] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [290] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [291] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [292] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [293] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [294] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [295] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [296] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [297] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [298] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [299] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [300] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [301] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [302] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [303] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [304] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [305] 3D Vision-Language Gaussian Splatting
...
#### [306] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [307] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [308] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [309] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [310] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [311] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [312] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [313] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [314] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [315] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [316] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2410.04680.md)] [[arXiv:2410.04680](https://arxiv.org/abs/2410.04680)] [Code]
- **📝 说明**：

#### [317] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [318] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [319] Variational Bayes Gaussian Splatting
...
#### [320] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [321] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
- **🧑‍🔬 作者**：Shiyun Xie, Zhiru Wang, Yinghao Zhu, Chengwei Pan
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2410.02571.md)] [[arXiv:2410.02571](https://arxiv.org/abs/2410.02571)] [Code]
- **📝 说明**：

#### [322] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [323] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [324] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [325] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [326] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [327] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [328] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [329] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [330] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [331] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [332] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [333] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [334] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [335] RNG: Relightable Neural Gaussians
...
#### [336] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [337] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [338] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [339] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [340] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [341] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [342] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [343] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [344] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [345] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [346] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [347] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [348] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [349] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [350] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [351] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [352] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [353] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [354] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [355] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [356] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [357] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [358] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [359] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [360] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [361] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [362] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [363] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [364] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [365] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [366] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [367] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [368] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [369] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [370] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [371] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [372] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [373] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [374] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [375] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [376] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [377] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [378] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [379] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [380] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [381] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [382] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [383] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [384] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [385] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [386] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [387] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [388] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [389] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [390] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [391] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [392] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [393] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [394] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [395] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [396] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [397] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [398] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [399] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [400] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [401] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [402] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [403] OmniRe: Omni Urban Scene Reconstruction
...
#### [404] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [405] G-Style: Stylized Gaussian Splatting
...
#### [406] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [407] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [408] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [409] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [410] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [411] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [412] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [413] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [414] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [415] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [416] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [417] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [418] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [419] Subsurface Scattering for 3D Gaussian Splatting
...
#### [420] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [421] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [422] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [423] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [424] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [425] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [426] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [427] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [428] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [429] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [430] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [431] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [432] 3D Gaussian Editing with A Single Image
...
#### [433] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [434] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [435] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [436] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [437] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [438] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [439] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [440] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [441] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [442] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [443] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [444] IG-SLAM: Instant Gaussian SLAM
...
#### [445] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [446] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [447] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [448] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [449] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [450] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [451] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [452] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [453] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [454] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [455] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [456] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [457] Gaussian Splatting Lucas-Kanade
...
#### [458] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [459] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [460] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [461] PICA: Physics-Integrated Clothed Avatar
...
#### [462] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [463] Gaussian Eigen Models for Human Heads
...
#### [465] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [466] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [467] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [468] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [469] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [470] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [471] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [472] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [473] Lightweight Predictive 3D Gaussian Splats
...
#### [474] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [475] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [476] On Scaling Up 3D Gaussian Splatting Training
...
#### [477] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [478] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [479] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [480] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [481] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [482] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [483] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [484] E2GS: Event Enhanced Gaussian Splatting
...
#### [485] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [486] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [487] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [488] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [489] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [490] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [491] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [492] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [493] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [494] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [495] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [496] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [497] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [498] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [499] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [500] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [501] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [502] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [503] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [504] Generalizable Human Gaussians from Single-View Image
...
#### [505] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [506] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [507] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [508] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [509] Localized Gaussian Point Management
...
#### [510] Gaussian Representation for Deformable Image Registration
...
#### [511] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [512] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [513] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [514] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [515] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [516] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [517] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [518] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [519] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [520] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
