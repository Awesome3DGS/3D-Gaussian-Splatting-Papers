...
#### [1] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [2] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
...
#### [4] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [5] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [7] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [8] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [9] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [10] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [11] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [12] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [13] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [14] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**: Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [15] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [16] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [17] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [18] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [19] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [20] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [21] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [22] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [23] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [24] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [25] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [26] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**: The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [27] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [28] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [29] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [30] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [31] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [32] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [33] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [34] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [35] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [36] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [37] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [38] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [39] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [40] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [41] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [42] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [43] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [44] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [45] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [46] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [47] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [48] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [49] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [50] Gaussian Masked Autoencoders
...
#### [51] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [52] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [53] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [54] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [55] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [56] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [57] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [58] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [59] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [60] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [61] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [62] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [63] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [64] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [66] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [67] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [68] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [69] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [70] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [71] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [72] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [73] Reflective Gaussian Splatting
...
#### [74] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [75] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [76] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [77] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [78] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [79] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [80] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [81] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [82] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [83] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [84] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [85] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [86] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [87] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [88] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [89] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [90] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [91] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [92] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [93] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [94] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [95] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [96] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [97] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [98] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [99] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [100] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [101] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [102] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [103] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [104] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [105] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [106] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [107] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [108] EOGS: Gaussian Splatting for Earth Observation
...
#### [109] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [110] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [111] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [112] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [113] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [114] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [115] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [116] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [117] Deformable Radial Kernel Splatting
...
#### [118] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [119] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [120] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [121] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [122] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [123] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [124] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [125] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [126] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [127] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [128] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [129] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [130] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [131] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [132] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [133] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [134] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [135] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [136] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [137] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [138] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [139] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [140] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [141] GASP: Gaussian Avatars with Synthetic Priors
...
#### [142] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [143] Faster and Better 3D Splatting via Group Training
...
#### [144] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [145] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [146] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [147] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [148] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [149] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [150] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [151] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [152] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [153] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [154] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [155] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [156] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [157] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [158] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [159] Street Gaussians without 3D Object Tracker
...
#### [160] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [161] Extrapolated Urban View Synthesis Benchmark
...
#### [162] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [163] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [164] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [165] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [166] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [167] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [168] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [169] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [170] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [171] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [172] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [173] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [174] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [175] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [176] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [177] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [178] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [179] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [180] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [181] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [182] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [183] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [184] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [185] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [186] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [187] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [188] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [189] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [190] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [191] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [192] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [193] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [194] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [195] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [196] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [197] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [198] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [199] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [200] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [201] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [202] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [203] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [204] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [205] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [206] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [207] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [208] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [209] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [210] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [211] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [212] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [213] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [214] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [215] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [216] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [217] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [218] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [219] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [220] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [221] Neural Surface Priors for Editable Gaussian Splatting
...
#### [222] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [223] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [224] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [225] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [226] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [227] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [228] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [229] Geometry Field Splatting with Gaussian Surfels
...
#### [230] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [231] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [232] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [233] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [234] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [235] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [236] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [237] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [238] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [239] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [240] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [241] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [242] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [243] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [244] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [245] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [246] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [247] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [248] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [249] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [250] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [251] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [252] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [253] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [254] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [255] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [256] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [257] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [258] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [259] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [260] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [261] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [262] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [263] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [264] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [265] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [266] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [267] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [268] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [269] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [270] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [271] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [272] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [273] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [274] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [275] VeGaS: Video Gaussian Splatting
...
#### [276] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [277] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [278] Efficient Density Control for 3D Gaussian Splatting
...
#### [279] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [280] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [281] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [282] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [283] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [284] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [285] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [286] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [287] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [288] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [289] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [290] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [291] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [292] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [293] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [294] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [295] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [296] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [297] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [298] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [299] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [300] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [301] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [302] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [303] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [304] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [305] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [306] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [307] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [308] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [309] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [310] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [311] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [312] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [313] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [314] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [315] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [316] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [317] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [318] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [319] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [320] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [321] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [322] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [323] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [324] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [325] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [326] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [327] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [328] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [329] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [330] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [331] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [332] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [333] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [334] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [335] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [336] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [337] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [338] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [339] 3D Vision-Language Gaussian Splatting
...
#### [340] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [341] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [342] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [343] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [344] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [345] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [346] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [347] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [348] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [349] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [350] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [351] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [352] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [353] Variational Bayes Gaussian Splatting
...
#### [354] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [355] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [356] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [357] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [358] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [359] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [360] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [361] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [362] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [363] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [364] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [365] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [366] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [367] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [368] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [369] RNG: Relightable Neural Gaussians
...
#### [370] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [371] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [372] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [373] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [374] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [375] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [376] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [377] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [378] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [379] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [380] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [381] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [382] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [383] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [384] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [385] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [386] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [387] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [388] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [389] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [390] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [391] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [392] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [393] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [394] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [395] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [396] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [397] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [398] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [399] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [400] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [401] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [402] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [403] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [404] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [405] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [406] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [407] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [408] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [409] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [410] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [411] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [412] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [413] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [414] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [415] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [416] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [417] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [418] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [419] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [420] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [421] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [422] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [423] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [424] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [425] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [426] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [427] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [428] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [429] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [430] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [431] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [432] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [433] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [434] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [435] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [436] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [437] OmniRe: Omni Urban Scene Reconstruction
...
#### [438] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [439] G-Style: Stylized Gaussian Splatting
...
#### [440] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [441] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [442] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [443] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [444] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [445] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [446] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [447] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [448] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [449] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [450] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [451] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [452] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [453] Subsurface Scattering for 3D Gaussian Splatting
...
#### [454] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [455] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [456] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [457] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [458] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [459] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [460] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [461] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [462] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [463] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [464] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [465] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [466] 3D Gaussian Editing with A Single Image
...
#### [467] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [468] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [469] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [470] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [471] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [472] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [473] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [474] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [475] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [476] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [477] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [478] IG-SLAM: Instant Gaussian SLAM
...
#### [479] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [480] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [481] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [482] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [483] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [484] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [485] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [486] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [487] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [488] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [489] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [490] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [491] Gaussian Splatting Lucas-Kanade
...
#### [492] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [493] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [494] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [495] PICA: Physics-Integrated Clothed Avatar
...
#### [496] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [497] Gaussian Eigen Models for Human Heads
...
#### [499] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [500] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [501] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [502] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [503] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [504] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [505] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [506] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [507] Lightweight Predictive 3D Gaussian Splats
...
#### [508] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [509] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [510] On Scaling Up 3D Gaussian Splatting Training
...
#### [511] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [512] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [513] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [514] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [515] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [516] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [517] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [518] E2GS: Event Enhanced Gaussian Splatting
...
#### [519] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [520] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [521] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [522] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [523] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [524] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [525] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [526] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [527] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [528] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [529] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [530] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [531] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [532] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [533] Generalizable Human Gaussians from Single-View Image
...
#### [534] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [535] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [536] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [537] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [538] Localized Gaussian Point Management
...
#### [539] Gaussian Representation for Deformable Image Registration
...
#### [540] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [541] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [542] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [543] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [544] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [545] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [546] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [547] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [548] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
