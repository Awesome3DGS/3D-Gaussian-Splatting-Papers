...
#### [1] EmoTalk3D: High-Fidelity Free-View Synthesis of Emotional 3D Talking Head
...
#### [2] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [3] Localized Gaussian Splatting Editing with Contextual Awareness
...
- **🏫 单位**：University of Amsterdam ⟐ Robert Bosch GmbH
- **🔗 链接**：[[中英摘要](./abs/2407.20727.md)] [[arXiv:2407.20727](https://arxiv.org/abs/2407.20727)] [Code]
- **📝 说明**：ECCV'24 camera-ready version

#### [6] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [7] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [8] GaussianSR: High Fidelity 2D Gaussian Splatting for Arbitrary-Scale Image Super-Resolution
- **🧑‍🔬 作者**：Jintong Hu, Bin Xia, Bin Chen, Wenming Yang, Lei Zhang
- **🏫 单位**：Tsinghua University ⟐ The Chinese University of Hong ⟐ Kong Peking University ⟐ The Hong Kong Polytechnic University ⟐ OPPO Research Institute
- **🔗 链接**：[[中英摘要](./abs/2407.18046.md)] [[arXiv:2407.18046](https://arxiv.org/abs/2407.18046)] [Code]
- **📝 说明**：

#### [9] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [10] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [11] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [12] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [13] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [14] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [15] PlacidDreamer: Advancing Harmony in Text-to-3D Generation
...
#### [16] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [17] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [18] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [19] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [20] Gaussian Splatting Lucas-Kanade
...
#### [21] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [22] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [23] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [24] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [25] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [26] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [27] PICA: Physics-Integrated Clothed Avatar
...
#### [28] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [29] Gaussian Eigen Models for Human Heads
...
#### [31] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [32] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [33] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [34] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [35] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [36] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [37] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [38] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [39] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [40] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [41] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [43] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [45] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [46] On Scaling Up 3D Gaussian Splatting Training
...
#### [47] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [48] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [49] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [50] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [51] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [52] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [53] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [54] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [55] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [56] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [57] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [58] E2GS: Event Enhanced Gaussian Splatting
...
#### [59] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [60] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [61] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [62] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [63] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [64] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [65] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [66] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [67] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [68] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [69] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [70] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [71] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [72] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [73] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [74] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [75] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [76] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [78] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [79] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [80] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [81] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [82] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [83] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [84] Generalizable Human Gaussians from Single-View Image
...
#### [85] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [86] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [87] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [88] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [89] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [90] Localized Gaussian Point Management
...
#### [91] Gaussian Representation for Deformable Image Registration
...
#### [92] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [93] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [94] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [95] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [96] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [97] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [98] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [99] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [100] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [101] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [102] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [103] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [104] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [105] Tetrahedron Splatting for 3D Generation
...
#### [106] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [107] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [108] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [109] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
