...
#### [1] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [2] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [3] Flow Distillation Sampling: Regularizing 3D Gaussians with Pre-trained Matching Priors
...
#### [5] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [6] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [8] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [9] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [10] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [11] SC-OmniGS: Self-Calibrating Omnidirectional Gaussian Splatting
...
- **🔗 链接**：[[中英摘要](./abs/2502.04734.md)] [[arXiv:2502.04734](https://arxiv.org/abs/2502.04734)] [[Code](https://www.chenyingshu.com/sc-omnigs/#)]
- **📝 说明**：

#### [12] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [14] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [15] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [16] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [17] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [18] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
- **🔗 链接**：[[中英摘要](./abs/2502.01536.md)] [[arXiv:2502.01536](https://arxiv.org/abs/2502.01536)] [[Code](https://vr-robo.github.io/)]
- **📝 说明**：

#### [19] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [20] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [21] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [22] Lifting by Gaussians: A Simple, Fast and Flexible Method for 3D Instance Segmentation
...
#### [23] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [24] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [25] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [26] OmniPhysGS: 3D Constitutive Gaussians for General Physics-Based Dynamics Generation
...
#### [27] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [29] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [30] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [31] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [32] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [33] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [34] DiffSplat: Repurposing Image Diffusion Models for Scalable Gaussian Splat Generation
...
#### [35] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [36] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [37] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [38] Trick-GS: A Balanced Bag of Tricks for Efficient Gaussian Splatting
...
#### [39] Scalable Benchmarking and Robust Learning for Noise-Free Ego-Motion and 3D Reconstruction from Noisy Video
...
#### [40] Micro-macro Wavelet-based Gaussian Splatting for 3D Reconstruction from Unconstrained Images
...
#### [41] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [42] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [43] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [44] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [45] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [46] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [47] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [48] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [49] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [50] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [51] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [52] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [53] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [54] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [55] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [56] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [57] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [58] BloomScene: Lightweight Structured 3D Gaussian Splatting for Crossmodal Scene Generation
...
#### [59] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [60] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [61] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [62] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [63] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [64] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [65] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [66] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [67] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [68] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [69] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [70] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [71] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [72] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [73] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [74] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [75] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [76] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [77] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [78] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [79] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [80] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [81] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [82] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [83] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [84] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [85] Gaussian Masked Autoencoders
...
#### [86] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [87] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [88] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [89] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [90] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [91] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [92] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [93] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [94] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [95] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [96] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [97] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [98] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [99] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [100] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [101] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [102] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [103] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [104] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [105] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [106] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [107] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [108] Reflective Gaussian Splatting
...
#### [109] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [110] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [111] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [112] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [113] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [114] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [115] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [116] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [117] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [118] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [119] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [120] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [121] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [122] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [123] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [124] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [125] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [126] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [127] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [128] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [129] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [130] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [131] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [132] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [133] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [134] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [135] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [136] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [137] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [138] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [139] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [140] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [141] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [142] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [143] EOGS: Gaussian Splatting for Earth Observation
...
#### [144] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [145] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [146] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [147] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [148] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [149] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [150] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [151] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [152] Deformable Radial Kernel Splatting
...
#### [153] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [154] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [155] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [156] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [157] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [158] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [159] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [160] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [161] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [162] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [163] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [164] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [165] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [166] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [167] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [168] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [169] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [170] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [171] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [172] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [173] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [174] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [175] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [176] GASP: Gaussian Avatars with Synthetic Priors
...
#### [177] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [178] Faster and Better 3D Splatting via Group Training
...
#### [179] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [180] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [181] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [182] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [183] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [184] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [185] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [186] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [187] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [188] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [189] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [190] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [191] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [192] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [193] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [194] Street Gaussians without 3D Object Tracker
...
#### [195] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [196] Extrapolated Urban View Synthesis Benchmark
...
#### [197] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [198] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [199] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [200] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [201] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [202] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [203] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [204] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [205] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [206] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [207] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [208] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [209] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [210] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [211] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [212] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [213] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [214] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [215] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [216] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [217] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [218] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [219] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [220] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [221] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [222] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [223] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [224] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [225] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [226] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [227] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [228] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [229] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [230] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [231] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [232] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [233] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [234] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [235] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [236] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [237] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [238] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [239] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [240] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [241] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [242] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [243] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [244] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [245] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [246] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [247] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [248] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [249] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [250] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [251] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [252] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [253] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [254] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [255] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [256] Neural Surface Priors for Editable Gaussian Splatting
...
#### [257] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [258] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [259] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [260] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [261] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [262] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [263] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [264] Geometry Field Splatting with Gaussian Surfels
...
#### [265] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [266] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [267] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [268] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [269] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [270] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [271] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [272] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [273] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [274] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [275] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [276] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [277] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [278] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [279] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [280] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [281] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [282] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [283] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [284] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [285] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [286] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [287] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [288] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [289] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [290] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [291] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [292] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [293] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [294] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [295] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [296] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [297] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [298] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [299] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [300] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [301] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [302] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [303] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [304] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [305] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [306] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [307] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [308] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [309] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [310] VeGaS: Video Gaussian Splatting
...
#### [311] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [312] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [313] Efficient Density Control for 3D Gaussian Splatting
...
#### [314] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [315] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [316] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [317] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [318] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [319] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [320] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [321] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [322] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [323] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [324] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [325] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [326] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [327] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [328] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [329] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [330] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [331] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [332] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [333] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [334] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [335] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [336] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [337] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [338] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [339] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [340] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [341] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [342] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [343] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [344] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [345] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [346] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [347] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [348] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [349] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [350] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [351] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [352] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [353] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [354] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [355] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [356] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [357] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [358] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [359] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [360] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [361] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [362] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [363] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [364] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [365] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [366] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [367] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [368] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [369] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [370] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [371] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [372] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [373] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [374] 3D Vision-Language Gaussian Splatting
...
#### [375] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [376] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [377] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [378] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [379] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [380] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [381] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [382] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [383] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [384] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [385] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [386] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [387] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [388] Variational Bayes Gaussian Splatting
...
#### [389] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [390] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [391] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [392] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [393] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [394] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [395] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [396] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [397] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [398] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [399] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [400] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [401] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [402] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [403] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [404] RNG: Relightable Neural Gaussians
...
#### [405] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [406] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [407] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [408] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [409] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [410] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [411] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [412] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [413] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [414] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [415] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [416] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [417] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [418] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [419] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [420] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [421] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [422] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [423] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [424] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [425] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [426] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [427] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [428] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [429] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [430] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [431] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [432] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [433] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [434] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [435] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [436] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [437] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [438] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [439] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [440] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [441] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [442] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [443] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [444] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [445] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [446] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [447] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [448] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [449] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [450] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [451] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [452] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [453] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [454] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [455] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [456] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [457] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [458] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [459] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [460] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [461] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [462] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [463] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [464] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [465] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [466] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [467] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [468] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [469] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [470] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [471] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [472] OmniRe: Omni Urban Scene Reconstruction
...
#### [473] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [474] G-Style: Stylized Gaussian Splatting
...
#### [475] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [476] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [477] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [478] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [479] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [480] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [481] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [482] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [483] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [484] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [485] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [486] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [487] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [488] Subsurface Scattering for 3D Gaussian Splatting
...
#### [489] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [490] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [491] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [492] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [493] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [494] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [495] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [496] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [497] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [498] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [499] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [500] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [501] 3D Gaussian Editing with A Single Image
...
#### [502] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [503] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [504] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [505] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [506] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [507] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [508] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [509] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [510] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [511] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [512] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [513] IG-SLAM: Instant Gaussian SLAM
...
#### [514] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [515] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [516] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [517] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [518] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [519] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [520] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [521] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [522] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [523] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [524] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [525] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [526] Gaussian Splatting Lucas-Kanade
...
#### [527] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [528] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [529] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [530] PICA: Physics-Integrated Clothed Avatar
...
#### [531] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [532] Gaussian Eigen Models for Human Heads
...
#### [534] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [535] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [536] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [537] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [538] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [539] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [540] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [541] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [542] Lightweight Predictive 3D Gaussian Splats
...
#### [543] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [544] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [545] On Scaling Up 3D Gaussian Splatting Training
...
#### [546] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [547] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [548] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [549] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [550] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [551] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [552] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [553] E2GS: Event Enhanced Gaussian Splatting
...
#### [554] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [555] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [556] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [557] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [558] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [559] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [560] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [561] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [562] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [563] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [564] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [565] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [566] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [567] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [568] Generalizable Human Gaussians from Single-View Image
...
#### [569] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [570] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [571] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [572] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [573] Localized Gaussian Point Management
...
#### [574] Gaussian Representation for Deformable Image Registration
...
#### [575] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [576] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [577] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [578] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [579] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [580] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [581] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [582] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [583] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
