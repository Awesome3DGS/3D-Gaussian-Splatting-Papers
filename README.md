...
#### [1] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [2] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [3] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [5] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [6] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [7] Decoupling Appearance Variations with 3D Consistent Features in Gaussian Splatting
...
#### [9] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [10] GaussianAvatar-Editor: Photorealistic Animatable Gaussian Head Avatar Editor
...
#### [11] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**: The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [12] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [13] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [14] 3D Gaussian Splatting with Normal Information for Mesh Extraction and Improved Rendering
...
#### [15] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [16] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [17] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [18] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [19] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [20] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [21] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [22] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [23] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [24] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [26] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [27] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [28] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [29] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [30] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [31] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [32] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [33] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
#### [34] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [35] Gaussian Masked Autoencoders
...
#### [36] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [37] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [38] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [39] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [40] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [41] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [42] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [43] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [44] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [45] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [46] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [47] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [48] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [49] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [50] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [51] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [52] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [53] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [54] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [55] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [56] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [57] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [58] Reflective Gaussian Splatting
...
#### [59] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [60] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [61] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [62] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [63] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [64] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [65] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [66] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [67] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [68] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [69] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [70] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [71] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [72] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [73] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [74] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [75] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [76] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [77] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [78] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [79] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [80] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [81] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [82] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [83] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [84] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [85] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [86] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [87] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [88] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [89] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [90] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [91] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [92] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [93] EOGS: Gaussian Splatting for Earth Observation
...
#### [94] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [95] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [96] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [97] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [98] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [99] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [100] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [101] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [102] Deformable Radial Kernel Splatting
...
#### [103] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [104] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [105] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [106] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [107] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [108] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [109] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [110] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [111] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [112] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [113] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [114] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [115] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [116] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [117] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [118] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [119] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [120] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [121] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [122] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [123] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [124] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [125] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [126] GASP: Gaussian Avatars with Synthetic Priors
...
#### [127] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [128] Faster and Better 3D Splatting via Group Training
...
#### [129] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [130] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [131] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [132] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [133] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [134] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [135] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [136] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [137] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [138] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [139] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [140] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [141] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [142] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [143] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [144] Street Gaussians without 3D Object Tracker
...
#### [145] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [146] Extrapolated Urban View Synthesis Benchmark
...
#### [147] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [148] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [149] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [150] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [151] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [152] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [153] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [154] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [155] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [156] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [157] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [158] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [159] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [160] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [161] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [162] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [163] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [164] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [165] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [166] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [167] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [168] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [169] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [170] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [171] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [172] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [173] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [174] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [175] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [176] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [177] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [178] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [179] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [180] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [181] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [182] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [183] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [184] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [185] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [186] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [187] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [188] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [189] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [190] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [191] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [192] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [193] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [194] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [195] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [196] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [197] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [198] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [199] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [200] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [201] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [202] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [203] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [204] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [205] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [206] Neural Surface Priors for Editable Gaussian Splatting
...
#### [207] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [208] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [209] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [210] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [211] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [212] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [213] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [214] Geometry Field Splatting with Gaussian Surfels
...
#### [215] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [216] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [217] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [218] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [219] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [220] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [221] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [222] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [223] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [224] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [225] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [226] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [227] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [228] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [229] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [230] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [231] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [232] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [233] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [234] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [235] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [236] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [237] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [238] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [239] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [240] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [241] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [242] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [243] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [244] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [245] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [246] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [247] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [248] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [249] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [250] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [251] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [252] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [253] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [254] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [255] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [256] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [257] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [258] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [259] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [260] VeGaS: Video Gaussian Splatting
...
#### [261] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [262] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [263] Efficient Density Control for 3D Gaussian Splatting
...
#### [264] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [265] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [266] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [267] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [268] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [269] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [270] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [271] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [272] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [273] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [274] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [275] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [276] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [277] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [278] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [279] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [280] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [281] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [282] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [283] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [284] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [285] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [286] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [287] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [288] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [289] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [290] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [291] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [292] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [293] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [294] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [295] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [296] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [297] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [298] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [299] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [300] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [301] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [302] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [303] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [304] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [305] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [306] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [307] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [308] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [309] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [310] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [311] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [312] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [313] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [314] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [315] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [316] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [317] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [318] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [319] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [320] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [321] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [322] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [323] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [324] 3D Vision-Language Gaussian Splatting
...
#### [325] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [326] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [327] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [328] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [329] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [330] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [331] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [332] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [333] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [334] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [335] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [336] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [337] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [338] Variational Bayes Gaussian Splatting
...
#### [339] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [340] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [341] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [342] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [343] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [344] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [345] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [346] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [347] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [348] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [349] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [350] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [351] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [352] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [353] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [354] RNG: Relightable Neural Gaussians
...
#### [355] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [356] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [357] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [358] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [359] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [360] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [361] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [362] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [363] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [364] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [365] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [366] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [367] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [368] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [369] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [370] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [371] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [372] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [373] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [374] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [375] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [376] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [377] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [378] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [379] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [380] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [381] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [382] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [383] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [384] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [385] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [386] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [387] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [388] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [389] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [390] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [391] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [392] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [393] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [394] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [395] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [396] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [397] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [398] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [399] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [400] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [401] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [402] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [403] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [404] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [405] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [406] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [407] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [408] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [409] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [410] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [411] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [412] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [413] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [414] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [415] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [416] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [417] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [418] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [419] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [420] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [421] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [422] OmniRe: Omni Urban Scene Reconstruction
...
#### [423] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [424] G-Style: Stylized Gaussian Splatting
...
#### [425] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [426] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [427] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [428] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [429] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [430] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [431] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [432] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [433] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [434] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [435] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [436] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [437] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [438] Subsurface Scattering for 3D Gaussian Splatting
...
#### [439] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [440] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [441] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [442] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [443] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [444] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [445] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [446] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [447] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [448] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [449] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [450] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [451] 3D Gaussian Editing with A Single Image
...
#### [452] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [453] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [454] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [455] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [456] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [457] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [458] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [459] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [460] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [461] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [462] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [463] IG-SLAM: Instant Gaussian SLAM
...
#### [464] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [465] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [466] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [467] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [468] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [469] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [470] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [471] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [472] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [473] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [474] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [475] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [476] Gaussian Splatting Lucas-Kanade
...
#### [477] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [478] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [479] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [480] PICA: Physics-Integrated Clothed Avatar
...
#### [481] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [482] Gaussian Eigen Models for Human Heads
...
#### [484] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [485] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [486] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [487] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [488] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [489] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [490] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [491] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [492] Lightweight Predictive 3D Gaussian Splats
...
#### [493] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [494] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [495] On Scaling Up 3D Gaussian Splatting Training
...
#### [496] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [497] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [498] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [499] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [500] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [501] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [502] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [503] E2GS: Event Enhanced Gaussian Splatting
...
#### [504] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [505] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [506] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [507] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [508] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [509] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [510] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [511] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [512] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [513] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [514] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [515] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [516] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [517] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [518] Generalizable Human Gaussians from Single-View Image
...
#### [519] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [520] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [521] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [522] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [523] Localized Gaussian Point Management
...
#### [524] Gaussian Representation for Deformable Image Registration
...
#### [525] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [526] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [527] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [528] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [529] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [530] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [531] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [532] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [533] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
