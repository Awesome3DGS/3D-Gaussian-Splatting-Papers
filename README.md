...
#### [1] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [2] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [3] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [4] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [5] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [6] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [7] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [8] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [9] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [10] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [11] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [12] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [13] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [15] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [16] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [17] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
- **📝 说明**：🏆 Accepted by ICRA 2025

#### [19] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [20] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [21] STGA: Selective-Training Gaussian Head Avatars
...
#### [22] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [23] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [24] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [25] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [26] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [27] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [28] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [29] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [30] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [31] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [32] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [33] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [34] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [35] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [36] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [37] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [38] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [39] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [40] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [41] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [42] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [43] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [44] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [45] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [46] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [47] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [48] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
- **🧑‍🔬 作者**：BoCheng Li, WenJuan Zhang, Bing Zhang, YiLing Yao, YaNing Wang
- **🏫 单位**: Aerospace Information Research Institute
- **🔗 链接**：[[中英摘要](./abs/2503.00848.md)] [[arXiv:2503.00848](https://arxiv.org/abs/2503.00848)] [Code]
- **📝 说明**：

#### [49] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [50] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [51] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [52] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [53] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [54] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [55] Seeing A 3D World in A Grain of Sand
...
#### [56] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [57] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [58] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [59] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [60] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [61] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [62] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [63] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [64] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [65] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [66] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [67] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [68] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [69] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [70] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [71] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [72] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [73] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [74] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [75] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [76] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [77] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [78] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [79] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [80] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [81] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [82] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [83] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [84] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [85] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [86] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [87] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [88] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [89] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [90] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [91] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [92] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [93] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [94] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [95] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [96] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [97] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [98] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [99] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [100] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [101] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [102] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [103] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [104] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [105] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [106] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [107] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [108] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [109] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [110] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [111] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [112] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [113] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [114] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [116] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [117] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [118] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [119] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [120] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [121] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [122] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [123] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [124] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [125] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [126] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [127] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [129] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [130] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [131] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [132] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [133] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [134] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [135] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [136] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [137] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [138] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [139] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [140] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [141] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [142] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [143] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [144] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [145] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [146] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [147] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [148] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [149] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [150] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [151] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [152] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [153] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [154] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [155] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [156] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [157] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [158] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [159] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [160] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [161] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [162] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [163] Gaussian Masked Autoencoders
...
#### [164] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [165] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [166] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [167] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [168] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [169] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [170] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [171] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [172] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [173] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [174] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [175] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [176] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [177] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [178] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [179] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [180] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [181] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [182] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [183] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [184] Reflective Gaussian Splatting
...
#### [185] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [186] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [187] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [188] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [189] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [190] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [191] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [192] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [193] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [194] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [195] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [196] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [197] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [198] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [199] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [200] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [201] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [202] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [203] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [204] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [205] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [206] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [207] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [208] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [209] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [210] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [211] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [212] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [213] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [214] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [215] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [216] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [217] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [218] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [219] EOGS: Gaussian Splatting for Earth Observation
...
#### [220] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [221] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [222] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [223] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [224] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [225] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [226] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [227] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [228] Deformable Radial Kernel Splatting
...
#### [229] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [230] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [231] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [232] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [233] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [234] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [235] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [236] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [237] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [238] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [239] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [240] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [241] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [242] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [243] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [244] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [245] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [246] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [247] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [248] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [249] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [250] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [251] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [252] GASP: Gaussian Avatars with Synthetic Priors
...
#### [253] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [254] Faster and Better 3D Splatting via Group Training
...
#### [255] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [256] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [257] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [258] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [259] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [260] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [261] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [262] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [263] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [264] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [265] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [266] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [267] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [268] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [269] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [270] Street Gaussians without 3D Object Tracker
...
#### [271] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [272] Extrapolated Urban View Synthesis Benchmark
...
#### [273] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [274] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [275] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [276] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [277] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [278] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [279] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [280] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [281] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [282] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [283] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [284] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [285] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [286] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [287] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [288] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [289] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [290] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [291] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [292] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [293] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [294] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [295] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [296] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [297] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [298] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [299] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [300] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [301] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [302] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [303] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [304] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [305] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [306] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [307] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [308] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [309] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [310] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [311] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [312] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [313] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [314] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [315] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [316] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [317] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [318] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [319] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [320] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [321] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [322] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [323] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [324] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [325] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [326] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [327] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [328] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [329] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [330] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [331] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [332] Neural Surface Priors for Editable Gaussian Splatting
...
#### [333] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [334] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [335] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [336] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [337] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [338] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [339] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [340] Geometry Field Splatting with Gaussian Surfels
...
#### [341] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [342] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [343] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [344] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [345] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [346] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [347] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [348] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [349] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [350] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [351] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [352] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [353] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [354] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [355] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [356] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [357] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [358] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [359] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [360] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [361] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [362] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [363] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [364] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [365] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [366] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [367] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [368] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [369] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [370] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [371] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [372] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [373] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [374] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [375] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [376] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [377] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [378] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [379] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [380] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [381] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [382] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [383] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [384] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [385] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [386] VeGaS: Video Gaussian Splatting
...
#### [387] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [388] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [389] Efficient Density Control for 3D Gaussian Splatting
...
#### [390] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [391] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [392] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [393] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [394] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [395] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [396] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [397] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [398] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [399] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [400] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [401] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [402] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [403] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [404] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [405] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [406] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [407] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [408] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [409] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [410] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [411] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [412] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [413] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [414] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [415] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [416] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [417] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [418] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [419] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [420] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [421] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [422] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [423] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [424] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [425] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [426] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [427] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [428] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [429] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [430] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [431] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [432] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [433] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [434] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [435] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [436] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [437] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [438] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [439] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [440] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [441] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [442] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [443] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [444] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [445] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [446] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [447] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [448] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [449] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [450] 3D Vision-Language Gaussian Splatting
...
#### [451] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [452] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [453] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [454] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [455] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [456] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [457] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [458] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [459] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [460] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [461] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [462] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [463] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [464] Variational Bayes Gaussian Splatting
...
#### [465] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [466] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [467] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [468] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [469] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [470] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [471] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [472] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [473] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [474] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [475] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [476] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [477] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [478] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [479] RNG: Relightable Neural Gaussians
...
#### [480] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [481] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [482] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [483] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [484] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [485] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [486] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [487] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [488] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [489] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [490] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [491] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [492] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [493] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [494] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [495] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [496] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [497] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [498] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [499] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [500] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [501] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [502] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [503] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [504] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [505] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [506] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [507] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [508] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [509] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [510] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [511] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [512] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [513] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [514] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [515] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [516] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [517] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [518] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [519] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [520] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [521] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [522] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [523] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [524] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [525] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [526] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [527] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [528] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [529] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [530] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [531] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [532] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [533] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [534] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [535] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [536] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [537] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [538] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [539] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [540] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [541] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [542] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [543] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [544] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [545] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [546] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [547] OmniRe: Omni Urban Scene Reconstruction
...
#### [548] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [549] G-Style: Stylized Gaussian Splatting
...
#### [550] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [551] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [552] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [553] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [554] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [555] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [556] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [557] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [558] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [559] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [560] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [561] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [562] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [563] Subsurface Scattering for 3D Gaussian Splatting
...
#### [564] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [565] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [566] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [567] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [568] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [569] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [570] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [571] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [572] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [573] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [574] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [575] 3D Gaussian Editing with A Single Image
...
#### [576] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [577] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [578] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [579] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [580] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [581] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [582] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [583] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [584] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [585] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [586] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [587] IG-SLAM: Instant Gaussian SLAM
...
#### [588] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [589] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [590] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [591] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [592] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [593] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [594] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [595] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [596] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [597] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [598] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [599] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [600] Gaussian Splatting Lucas-Kanade
...
#### [601] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [602] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [603] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [604] PICA: Physics-Integrated Clothed Avatar
...
#### [605] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [606] Gaussian Eigen Models for Human Heads
...
#### [608] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [609] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [610] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [611] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [612] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [613] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [614] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [615] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [616] Lightweight Predictive 3D Gaussian Splats
...
#### [617] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [618] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [619] On Scaling Up 3D Gaussian Splatting Training
...
#### [620] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [621] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [622] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [623] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [624] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [625] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [626] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [627] E2GS: Event Enhanced Gaussian Splatting
...
#### [628] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [629] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [630] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [631] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [632] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [633] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [634] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [635] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [636] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [637] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [638] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [639] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [640] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [641] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [642] Generalizable Human Gaussians from Single-View Image
...
#### [643] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [644] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [645] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [646] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [647] Localized Gaussian Point Management
...
#### [648] Gaussian Representation for Deformable Image Registration
...
#### [649] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [650] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [651] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [652] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [653] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [654] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [655] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [656] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [657] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
