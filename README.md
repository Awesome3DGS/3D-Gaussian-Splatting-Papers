...
#### [1] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [2] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [3] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [4] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [5] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [6] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [7] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [8] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [9] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [10] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [11] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [12] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [13] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [14] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [15] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [16] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [17] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [18] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [19] Learning Unified Representation of 3D Gaussian Splatting
...
#### [20] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [21] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [22] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [23] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [24] Large Material Gaussian Model for Relightable 3D Generation
...
#### [25] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [26] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [27] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [28] 4D Driving Scene Generation With Stereo Forcing
...
#### [29] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [30] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [31] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [32] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
...
#### [33] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [34] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [35] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [36] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [37] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [38] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [39] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [40] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [41] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [42] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [43] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [44] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [45] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [46] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [47] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [48] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [49] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [50] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [51] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
...
#### [52] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [53] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [54] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [55] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [56] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [57] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [58] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [59] Camera Splatting for Continuous View Optimization
...
#### [60] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [61] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [62] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [63] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [64] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [65] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [66] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [67] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [68] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
...
#### [69] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [70] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [71] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [72] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [74] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [75] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [76] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [77] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [78] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [79] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [80] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [81] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [83] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [84] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [85] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [86] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [87] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [88] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [89] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [90] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [91] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [92] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [93] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [94] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [95] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [96] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [97] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [98] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [99] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [100] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [101] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [102] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [103] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [104] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [105] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [106] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [107] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [108] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [109] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [110] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [111] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [112] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [113] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [114] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [115] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [116] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [117] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [118] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [119] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [120] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [121] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [122] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [123] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [124] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [125] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [126] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [127] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [128] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [129] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [130] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [131] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [132] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [133] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [134] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [135] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [136] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [137] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [138] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [139] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [140] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [141] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [142] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [143] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [144] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [145] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [146] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [147] SAGOnline: Segment Any Gaussians Online
...
#### [148] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [149] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [150] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [151] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [152] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [153] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [154] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [155] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [156] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [157] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [158] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [159] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [160] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [161] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [162] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [163] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [164] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [165] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [166] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [167] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [168] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [169] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [170] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [171] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [172] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [173] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [174] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [175] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [176] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [177] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [178] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [179] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [180] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [181] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [182] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [183] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [184] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [185] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [186] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [187] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [188] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [189] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [190] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [191] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [192] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [193] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [194] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [195] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [196] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [197] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [198] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [199] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [200] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [201] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [202] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [203] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [204] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [205] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [206] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [207] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [208] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [209] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [210] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [211] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [212] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [213] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [214] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [215] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [216] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [217] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [218] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [219] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [220] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [221] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [222] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [223] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [224] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [225] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [226] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [227] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [228] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [229] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [230] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [231] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [232] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [233] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [234] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [235] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [236] Masks make discriminative models great again!
...
#### [237] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [238] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [239] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
