...
#### [1] FreeGave: 3D Physics Learning from Dynamic Videos by Gaussian Velocity
...
#### [2] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [3] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [4] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [6] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [7] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [9] Gaussian Mapping for Evolving Scenes
...
#### [10] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [11] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [12] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [13] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [14] Splat and Replace: 3D Reconstruction with Repetitive Elements
...
#### [15] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [16] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [17] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [18] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [19] VoxelSplat: Dynamic Gaussian Splatting as an Effective Loss for Occupancy and Flow Prediction
...
#### [20] On-the-fly Reconstruction for Large-Scale Novel View Synthesis from Unposed Images
...
#### [21] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [22] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [23] Gen4D: Synthesizing Humans and Scenes in the Wild
...
#### [24] FreeTimeGS: Free Gaussian Primitives at Anytime and Anywhere for Dynamic Scene Reconstruction
...
#### [25] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [26] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [27] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [28] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [29] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [30] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [31] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [32] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [33] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [34] FlexGS: Train Once, Deploy Everywhere with Many-in-One Flexible 3D Gaussian Splatting
...
#### [35] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [36] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
...
#### [37] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [38] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [39] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [40] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [41] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [43] VTGaussian-SLAM: RGBD SLAM for Large Scale Scenes with Splatting View-Tied 3D Gaussians
...
#### [44] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [45] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [46] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [47] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [48] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [49] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [50] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [51] 3D Gaussian Splat Vulnerabilities
...
#### [52] Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
#### [53] Understanding while Exploring: Semantics-driven Active Mapping
...
#### [54] AdaHuman: Animatable Detailed 3D Human Generation with Compositional Multiview Diffusion
...
#### [55] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [56] Tackling View-Dependent Semantics in 3D Language Gaussian Splatting
...
#### [57] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [58] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [59] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [61] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [62] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [63] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [64] Pose-free 3D Gaussian splatting via shape-ray estimation
...
#### [65] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [66] 4DTAM: Non-Rigid Tracking and Mapping via Dynamic Surface Gaussians
...
#### [67] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [68] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [69] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [70] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [71] Hyperspectral Gaussian Splatting
...
#### [72] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [73] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [74] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [75] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [76] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [77] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [78] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [79] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [80] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [81] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [82] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
...
#### [83] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [84] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [85] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [86] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [87] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [88] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [89] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [90] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [91] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [92] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [93] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [94] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [95] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [96] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [97] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [98] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [99] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [100] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [101] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [102] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [103] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [104] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [105] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [106] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [107] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [108] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [109] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [110] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [111] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [112] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [113] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [114] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [115] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [123] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [124] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [125] Large-Scale Gaussian Splatting SLAM
...
#### [126] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [127] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [128] Neural Video Compression using 2D Gaussian Splatting
...
#### [129] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [130] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [131] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [132] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [133] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [134] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [135] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [136] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [139] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [140] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [141] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [142] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [143] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [144] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [145] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [146] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [147] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [148] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [149] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [150] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [151] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [152] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [153] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
...
#### [154] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [155] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [156] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [157] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [158] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [159] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [160] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [161] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [162] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [163] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [164] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [165] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [166] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [167] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [168] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [169] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [170] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [171] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [172] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [173] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [174] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [175] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [176] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [177] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [178] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [179] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [180] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [181] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [182] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [183] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [184] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [185] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [186] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [187] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [188] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [189] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [190] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [191] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [192] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [193] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [194] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [195] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [196] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [197] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [198] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [199] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [200] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [201] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [202] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [203] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [204] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [205] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [206] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [207] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [208] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [209] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [210] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [211] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [212] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [213] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [214] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [215] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [216] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [217] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [218] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [219] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [220] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [221] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [222] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [223] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [224] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [225] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [226] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [227] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [228] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [229] Digital-twin imaging based on descattering Gaussian splatting
...
#### [230] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [231] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [232] BOGausS: Better Optimized Gaussian Splatting
...
#### [233] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [234] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [235] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [236] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [237] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [238] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [239] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [240] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
