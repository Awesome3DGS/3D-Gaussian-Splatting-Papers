...
#### [2] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [5] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [6] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [7] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [10] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [11] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [13] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [14] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [15] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [16] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [17] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [18] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [19] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [20] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [21] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [22] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [23] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [24] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [25] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [26] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [27] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [28] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [29] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [30] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [31] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [32] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [33] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [34] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [35] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [36] OmniRe: Omni Urban Scene Reconstruction
...
#### [37] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [38] G-Style: Stylized Gaussian Splatting
...
#### [39] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [40] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [41] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [42] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [43] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [44] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [45] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [46] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [47] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [48] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [49] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [50] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [51] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [52] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [53] Subsurface Scattering for 3D Gaussian Splatting
...
#### [54] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [55] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [56] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [57] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [58] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [59] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [60] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [61] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [62] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [63] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [64] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [65] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [66] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [69] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [70] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [71] 3D Gaussian Editing with A Single Image
...
#### [72] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [73] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [75] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [76] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [77] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [78] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [79] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [81] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [85] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [86] IG-SLAM: Instant Gaussian SLAM
...
#### [87] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [88] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [89] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [90] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [91] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [92] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [93] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [94] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [95] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [96] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [97] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [98] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [99] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [100] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [101] Gaussian Splatting Lucas-Kanade
...
#### [102] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [103] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [104] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [105] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [106] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [107] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [108] PICA: Physics-Integrated Clothed Avatar
...
#### [109] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [110] Gaussian Eigen Models for Human Heads
...
#### [112] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [113] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [114] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [115] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [116] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [117] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [118] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [119] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [120] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [121] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [122] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [123] Lightweight Predictive 3D Gaussian Splats
...
#### [124] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [125] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [126] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [127] On Scaling Up 3D Gaussian Splatting Training
...
#### [128] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [129] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [130] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [131] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [132] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [133] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [134] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [135] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [136] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [137] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [138] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [139] E2GS: Event Enhanced Gaussian Splatting
...
#### [140] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [141] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [142] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [143] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [144] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [145] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [146] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [147] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [148] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [149] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [150] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [151] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [152] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [153] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [154] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [155] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [156] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [157] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [158] From Chaos to Clarity: 3DGS in the Dark
...
#### [159] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [160] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [161] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [162] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [163] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [164] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [165] Generalizable Human Gaussians from Single-View Image
...
#### [166] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [167] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [168] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [169] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [170] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [171] Localized Gaussian Point Management
...
#### [172] Gaussian Representation for Deformable Image Registration
...
#### [173] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [174] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [175] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [176] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [177] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [178] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [179] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [180] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [181] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [182] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [183] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [184] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [185] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [186] Tetrahedron Splatting for 3D Generation
...
#### [187] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [188] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [189] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [190] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
