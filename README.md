...
#### [1] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [2] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [3] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [4] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [5] Reflective Gaussian Splatting
...
#### [6] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [7] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [8] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [9] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [10] GSAVS: Gaussian Splatting-based Autonomous Vehicle Simulator
- **🧑‍🔬 作者**：Rami Wilson
- **🏫 单位**: UCSanta Cruz
- **🔗 链接**：[[中英摘要](./abs/2412.18816.md)] [[arXiv:2412.18816](https://arxiv.org/abs/2412.18816)] [Code]
- **📝 说明**：

#### [11] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [12] Resolution-Robust 3D MRI Reconstruction with 2D Diffusion Priors: Diverse-Resolution Training Outperforms Interpolation
...
#### [13] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [14] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [15] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [16] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [17] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [18] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [19] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [20] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [21] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [22] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [23] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [24] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [25] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [26] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [27] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [28] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [29] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [30] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [31] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [32] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [33] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [34] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [35] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [36] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [37] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [38] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [39] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [40] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [41] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [42] EOGS: Gaussian Splatting for Earth Observation
...
#### [43] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [44] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [45] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [46] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [47] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [48] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [49] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [50] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [51] Deformable Radial Kernel Splatting
...
#### [52] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [53] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [54] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [56] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [57] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [58] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [59] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [60] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [61] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [62] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [63] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [64] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [65] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [66] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [67] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [68] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [69] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [70] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [71] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [72] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [73] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [74] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [75] GASP: Gaussian Avatars with Synthetic Priors
...
#### [76] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [77] Faster and Better 3D Splatting via Group Training
...
#### [78] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [79] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [80] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [81] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [82] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [83] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [84] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [85] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [86] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [87] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [88] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [89] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [90] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [91] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [92] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [93] Street Gaussians without 3D Object Tracker
...
#### [94] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [95] Extrapolated Urban View Synthesis Benchmark
...
#### [96] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [97] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [98] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [99] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [100] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [101] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [102] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [103] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [104] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [105] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [106] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [107] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [108] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [109] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [110] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [111] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [112] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [113] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [114] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [115] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [116] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [117] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [118] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [119] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [120] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [121] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [122] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [123] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [124] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [125] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [126] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [127] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [128] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [129] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [130] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [131] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [132] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [133] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [134] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [135] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [136] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [137] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [138] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [139] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [140] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [141] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [142] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [143] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [144] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [145] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [146] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [147] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [148] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [149] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [150] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [151] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [152] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [153] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [154] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [155] Neural Surface Priors for Editable Gaussian Splatting
...
#### [156] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [157] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [158] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [159] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [160] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [161] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [162] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [163] Geometry Field Splatting with Gaussian Surfels
...
#### [164] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [165] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [166] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [167] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [168] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [169] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [170] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [171] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [172] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [173] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [174] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [175] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [176] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [177] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [178] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [179] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [180] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [181] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [182] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [183] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [184] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [185] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [186] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [187] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [188] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [189] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [190] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [191] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [192] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [193] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [194] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [195] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [196] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [197] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [198] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [199] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [200] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [201] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [202] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [203] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [204] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [205] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [206] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [207] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [208] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [209] VeGaS: Video Gaussian Splatting
...
#### [210] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [211] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [212] Efficient Density Control for 3D Gaussian Splatting
...
#### [213] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [214] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [215] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [216] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [217] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [218] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [219] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [220] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [221] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [222] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [223] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [224] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [225] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [226] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [227] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [228] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [229] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [230] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [231] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [232] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [233] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [234] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [235] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [236] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [237] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [238] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [239] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [240] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [241] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [242] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [243] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [244] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [245] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [246] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [247] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [248] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [249] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [250] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [251] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [252] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [253] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [254] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [255] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [256] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [257] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [258] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [259] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [260] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [261] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [262] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [263] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [264] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [265] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [266] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [267] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [268] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [269] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [270] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [271] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [272] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [273] 3D Vision-Language Gaussian Splatting
...
#### [274] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [275] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [276] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [277] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [278] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [279] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [280] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [281] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [282] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [283] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [284] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [285] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [286] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [287] Variational Bayes Gaussian Splatting
...
#### [288] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [289] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [290] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [291] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [292] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [293] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [294] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [295] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [296] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [297] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [298] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [299] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [300] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [301] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [302] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [303] RNG: Relightable Neural Gaussians
...
#### [304] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [305] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [306] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [307] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [308] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [309] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [310] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [311] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [312] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [313] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [314] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [315] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [316] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [317] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [318] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [319] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [320] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [321] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [322] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [323] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [324] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [325] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [326] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [327] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [328] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [329] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [330] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [331] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [332] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [333] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [334] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [335] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [336] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [337] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [338] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [339] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [340] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [341] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [342] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [343] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [344] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [345] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [346] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [347] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [348] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [349] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [350] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [351] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [352] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [353] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [354] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [355] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [356] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [357] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [358] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [359] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [360] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [361] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [362] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [363] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [364] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [365] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [366] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [367] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [368] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [369] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [370] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [371] OmniRe: Omni Urban Scene Reconstruction
...
#### [372] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [373] G-Style: Stylized Gaussian Splatting
...
#### [374] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [375] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [376] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [377] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [378] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [379] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [380] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [381] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [382] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [383] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [384] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [385] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [386] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [387] Subsurface Scattering for 3D Gaussian Splatting
...
#### [388] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [389] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [390] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [391] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [392] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [393] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [394] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [395] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [396] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [397] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [398] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [399] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [400] 3D Gaussian Editing with A Single Image
...
#### [401] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [402] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [403] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [404] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [405] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [406] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [407] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [408] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [409] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [410] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [411] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [412] IG-SLAM: Instant Gaussian SLAM
...
#### [413] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [414] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [415] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [416] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [417] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [418] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [419] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [420] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [421] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [422] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [423] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [424] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [425] Gaussian Splatting Lucas-Kanade
...
#### [426] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [427] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [428] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [429] PICA: Physics-Integrated Clothed Avatar
...
#### [430] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [431] Gaussian Eigen Models for Human Heads
...
#### [433] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [434] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [435] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [436] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [437] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [438] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [439] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [440] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [441] Lightweight Predictive 3D Gaussian Splats
...
#### [442] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [443] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [444] On Scaling Up 3D Gaussian Splatting Training
...
#### [445] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [446] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [447] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [448] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [449] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [450] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [451] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [452] E2GS: Event Enhanced Gaussian Splatting
...
#### [453] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [454] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [455] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [456] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [457] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [458] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [459] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [460] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [461] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [462] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [463] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [464] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [465] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [466] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [467] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [468] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [469] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [470] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [471] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [472] Generalizable Human Gaussians from Single-View Image
...
#### [473] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [474] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [475] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [476] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [477] Localized Gaussian Point Management
...
#### [478] Gaussian Representation for Deformable Image Registration
...
#### [479] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [480] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [481] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [482] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [483] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [484] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [485] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [486] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [487] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [488] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
