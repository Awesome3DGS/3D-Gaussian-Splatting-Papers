...
#### [1] RegGS: Unposed Sparse Views Gaussian Splatting with 3DGS Registration
...
#### [2] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [3] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [4] Seg-Wild: Interactive Segmentation based on 3D Gaussian Splatting for Unconstrained Image Collections
...
#### [6] FlexGaussian: Flexible and Cost-Effective Training-Free Compression for 3D Gaussian Splatting
...
#### [7] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [8] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [9] VisualSpeaker: Visually-Guided 3D Avatar Lip Synthesis
...
#### [10] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [11] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [12] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [13] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [14] A3FR: Agile 3D Gaussian Splatting with Incremental Gaze Tracked Foveated Rendering in Virtual Reality
...
#### [15] Gaussian-LIC2: LiDAR-Inertial-Camera Gaussian Splatting SLAM
...
#### [16] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [17] Outdoor Monocular SLAM with Global Scale-Consistent 3D Gaussian Pointmaps
...
#### [18] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [19] ArtGS:3D Gaussian Splatting for Interactive Visual-Physical Modeling and Manipulation of Articulated Objects
...
#### [20] Reconstructing Close Human Interaction with Appearance and Proxemics Reasoning
...
#### [21] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [22] LocalDyGS: Multi-view Global Dynamic Scene Modeling via Adaptive Local Implicit Feature Decoupling
...
#### [23] Gbake: Baking 3D Gaussian Splats into Reflection Probes
...
#### [24] 3D Gaussian Splatting Driven Multi-View Robust Physical Adversarial Camouflage Generation
...
#### [25] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [26] Masks make discriminative models great again!
...
#### [27] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [28] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [29] Learning Dense Feature Matching via Lifting Single 2D Image to 3D Space
...
#### [30] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
- **🧑‍🔬 作者**：Xingjun Wang, Lianlei Shan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2507.00363.md)] [[arXiv:2507.00363](https://arxiv.org/abs/2507.00363)] [Code]
- **📝 说明**:

#### [31] MILo: Mesh-In-the-Loop Gaussian Splatting for Detailed and Efficient Surface Reconstruction
...
#### [32] GaVS: 3D-Grounded Video Stabilization via Temporally-Consistent Local Reconstruction and Rendering
...
#### [33] AttentionGS: Towards Initialization-Free 3D Gaussian Splatting via Structural Attention
...
#### [34] SurgTPGS: Semantic 3D Surgical Scene Understanding with Text Promptable Gaussian Splatting
...
#### [35] Endo-4DGX: Robust Endoscopic Scene Reconstruction and Illumination Correction with Gaussian Splatting
...
#### [36] TVG-SLAM: Robust Gaussian Splatting SLAM with Tri-view Geometric Constraints
...
#### [37] From Coarse to Fine: Learnable Discrete Wavelet Transforms for Efficient 3D Gaussian Splatting
...
#### [38] Confident Splatting: Confidence-Based Compression of 3D Gaussian Splatting via Learnable Beta Distributions
...
#### [39] RGE-GS: Reward-Guided Expansive Driving Scene Reconstruction via Diffusion Priors
...
#### [40] VoteSplat: Hough Voting Gaussian Splatting for 3D Scene Understanding
...
#### [41] RoboPearls: Editable Video Simulation for Robot Manipulation
...
#### [42] Part Segmentation and Motion Estimation for Articulated Objects with Dynamic 3D Gaussians
...
#### [43] DIGS: Dynamic CBCT Reconstruction using Deformation-Informed 4D Gaussian Splatting and a Low-Rank Free-Form Deformation Model
...
#### [44] Few-Shot Identity Adaptation for 3D Talking Heads via Global Gaussian Field
...
#### [45] SAR-GS: 3D Gaussian Splatting for Synthetic Aperture Radar Target Reconstruction
...
#### [46] ICP-3DGS: SfM-free 3D Gaussian Splatting for Large-scale Unbounded Scenes
...
#### [47] MADrive: Memory-Augmented Driving Scene Modeling
...
#### [49] EndoFlow-SLAM: Real-Time Endoscopic SLAM with Flow-Constrained Gaussian Splatting
...
#### [50] Curve-Aware Gaussian Splatting for 3D Parametric Curve Reconstruction
...
#### [51] Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image
...
#### [52] CL-Splats: Continual Learning of Gaussian Splatting with Local Optimization
...
#### [53] DBMovi-GS: Dynamic View Synthesis from Blurry Monocular Video via Sparse-Controlled Gaussian Splatting
...
#### [54] 3DGH: 3D Head Generation with Composable Hair and Face
...
#### [55] Virtual Memory for 3D Gaussian Splatting
...
#### [56] SOF: Sorted Opacity Fields for Fast Unbounded Surface Reconstruction
...
#### [57] GRAND-SLAM: Local Optimization for Globally Consistent Large-Scale Multi-Agent Gaussian SLAM
...
#### [58] 4Real-Video-V2: Fused View-Time Attention and Feedforward Reconstruction for 4D Scene Generation
...
#### [59] BulletGen: Improving 4D Reconstruction with Bullet-Time Generation
...
#### [60] 2D Triangle Splatting for Direct Differentiable Mesh Training
...
#### [61] 3D Gaussian Splatting for Fine-Detailed Surface Reconstruction in Large-Scale Scene
...
#### [62] Part2GS: Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [63] GraphGSOcc: Semantic-Geometric Graph Transformer with Dynamic-Static Decoupling for 3D Gaussian Splatting-based Occupancy Prediction
...
#### [64] SyncTalk++: High-Fidelity and Efficient Synchronized Talking Heads Synthesis Using Gaussian Splatting
...
#### [65] 3DGS-IEval-15K: A Large-scale Image Quality Evaluation Database for 3D Gaussian-Splatting
...
#### [66] HRGS: Hierarchical Gaussian Splatting for Memory-Efficient High-Resolution 3D Reconstruction
...
#### [67] GAF: Gaussian Action Field as a Dynamic World Model for Robotic Manipulation
...
#### [68] GRaD-Nav++: Vision-Language Model Enabled Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [69] PF-LHM: 3D Animatable Avatar Reconstruction from Pose-free Articulated Human Images
...
#### [70] Micro-macro Gaussian Splatting with Enhanced Scalability for Unconstrained Scene Reconstruction
...
#### [71] Multiview Geometric Regularization of Gaussian Splatting for Accurate Radiance Fields
...
#### [72] GS-2DGS: Geometrically Supervised 2DGS for Reflective Object Reconstruction
...
#### [73] Metropolis-Hastings Sampling for 3D Gaussian Reconstruction
...
#### [74] SMPL Normal Map Is All You Need for Single-view Textured Human Reconstruction
...
#### [75] Efficient multi-view training for 3D Gaussian Splatting
...
#### [76] Generative 4D Scene Gaussian Splatting with Object View-Synthesis Priors
...
#### [77] Perceptual-GS: Scene-adaptive Perceptual Densification for Gaussian Splatting
...
#### [78] PointGS: Point Attention-Aware Sparse View Synthesis with Gaussian Splatting
...
#### [79] DGS-LRM: Real-Time Deformable 3D Gaussian Reconstruction From Monocular Videos
...
#### [80] UniPre3D: Unified Pre-training of 3D Point Cloud Models with Cross-Modal Gaussian Splatting
...
#### [81] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [82] SemanticSplat: Feed-Forward 3D Scene Understanding with Language-Aware Gaussian Fields
...
#### [83] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
#### [84] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [85] TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
#### [86] ODG: Occupancy Prediction Using Dual Gaussians
...
#### [87] UniForward: Unified 3D Scene and Semantic Field Reconstruction via Feed-Forward Gaussian Splatting from Only Sparse-View Images
...
#### [88] STREAMINGGS: Voxel-Based Streaming 3D Gaussian Splatting with Memory Optimization and Architectural Support
...
#### [89] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [91] SceneSplat++: A Large Dataset and Comprehensive Benchmark for Language Gaussian Splatting
...
#### [92] TraGraph-GS: Trajectory Graph-based Gaussian Splatting for Arbitrary Large-Scale Scene Rendering
...
#### [93] Complex-Valued Holographic Radiance Fields
...
#### [94] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
...
#### [95] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **🧑‍🔬 作者**：Shuja Khalid, Mohamed Ibrahim, Yang Liu
- **🏫 单位**：Huawei Canada
- **🔗 链接**：[[中英摘要](./abs/2506.07897.md)] [[arXiv:2506.07897](https://arxiv.org/abs/2506.07897)] [Code]
- **📝 说明**:

#### [96] FreeGave: 3D Physics Learning from Dynamic Videos by Gaussian Velocity
...
#### [97] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [98] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [99] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [100] PIG: Physically-based Multi-Material Interaction with 3D Gaussians
...
#### [101] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [102] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [103] Hybrid Mesh-Gaussian Representation for Efficient Indoor Scene Reconstruction
...
#### [104] Gaussian Mapping for Evolving Scenes
...
#### [105] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [106] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [107] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [108] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [109] Splat and Replace: 3D Reconstruction with Repetitive Elements
...
#### [111] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [112] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [113] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [114] VoxelSplat: Dynamic Gaussian Splatting as an Effective Loss for Occupancy and Flow Prediction
...
#### [115] On-the-fly Reconstruction for Large-Scale Novel View Synthesis from Unposed Images
...
#### [116] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [117] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [118] Gen4D: Synthesizing Humans and Scenes in the Wild
...
#### [119] FreeTimeGS: Free Gaussian Primitives at Anytime and Anywhere for Dynamic Scene Reconstruction
...
#### [120] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [121] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [122] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [123] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [124] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [125] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [126] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [127] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [128] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [129] FlexGS: Train Once, Deploy Everywhere with Many-in-One Flexible 3D Gaussian Splatting
...
#### [130] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [131] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
...
#### [132] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [133] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [134] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [135] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [136] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [137] RobustSplat: Decoupling Densification and Dynamics for Transient-Free 3DGS
...
#### [138] VTGaussian-SLAM: RGBD SLAM for Large Scale Scenes with Splatting View-Tied 3D Gaussians
...
#### [139] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [140] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [141] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [142] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [143] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [144] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [145] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [147] Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
#### [148] Understanding while Exploring: Semantics-driven Active Mapping
...
#### [149] AdaHuman: Animatable Detailed 3D Human Generation with Compositional Multiview Diffusion
...
#### [150] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [151] Tackling View-Dependent Semantics in 3D Language Gaussian Splatting
...
#### [152] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [153] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [154] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [155] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
...
#### [156] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [157] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [158] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [159] Pose-free 3D Gaussian splatting via shape-ray estimation
...
#### [160] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [161] 4DTAM: Non-Rigid Tracking and Mapping via Dynamic Surface Gaussians
...
#### [162] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [163] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [164] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [165] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [166] Hyperspectral Gaussian Splatting
...
#### [167] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [168] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [169] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [170] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [171] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [172] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [173] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [174] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [175] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [176] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [177] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
...
#### [178] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [179] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [180] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [181] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [182] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [183] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [184] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [185] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [186] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [187] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [188] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [189] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [190] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [191] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [192] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [193] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [194] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [195] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [196] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [197] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [198] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [199] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [200] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [201] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [202] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [203] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [204] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [205] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [206] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [207] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [208] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [209] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [210] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [211] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [212] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [213] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [214] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [215] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [216] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [217] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [218] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [219] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [220] Large-Scale Gaussian Splatting SLAM
...
#### [221] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [222] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [223] Neural Video Compression using 2D Gaussian Splatting
...
#### [224] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [225] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [226] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [227] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [228] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [229] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [230] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [231] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [232] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [233] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [234] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [235] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [236] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [237] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [238] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [239] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [240] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [241] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [242] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [243] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [244] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [245] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [246] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [247] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [248] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jongwon Lee, Timothy Bretl
- **🏫 单位**：University of Illinois Urbana-Champaign
- **🔗 链接**：[[中英摘要](./abs/2504.20379.md)] [[arXiv:2504.20379](https://arxiv.org/abs/2504.20379)] [Code]
- **📝 说明**:

#### [249] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [250] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [251] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [252] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [253] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [254] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [255] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [256] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [257] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [258] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [259] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [260] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [261] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [262] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [263] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [264] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [265] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [266] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [267] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [268] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [269] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [270] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [271] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [272] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [273] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [274] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [275] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [276] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [277] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [278] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [279] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [280] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [281] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [282] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [283] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [284] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [285] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [286] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [287] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [288] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [289] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [290] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [291] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [292] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [293] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [294] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [295] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [296] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [297] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [298] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [299] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [300] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [301] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [302] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [303] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [304] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [305] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [306] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [307] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [308] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [309] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [310] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [311] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [312] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [313] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [314] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [315] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [316] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [317] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [318] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [319] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [320] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [321] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [322] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [323] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [324] Digital-twin imaging based on descattering Gaussian splatting
...
#### [325] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [326] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [327] BOGausS: Better Optimized Gaussian Splatting
...
#### [328] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [329] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [330] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [331] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [332] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [333] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [334] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [335] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
