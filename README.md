...
- [[SIGGRAPH2024](./SIGGRAPH2024.md)] (7 篇)
  ...
  [[ECCV2024](./ECCV2024.md)] (38 篇)
  [[MICCAI2024](./MICCAI2024.md)] (5 篇)
...
#### [1] 6DGS: 6D Pose Estimation from a Single Image and a 3D Gaussian Splatting Model
...
#### [2] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [3] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [4] 3D Gaussian Parametric Head Model
...
#### [5] Realistic Surgical Image Dataset Generation Based On 3D Gaussian Splatting
...
#### [6] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [7] PlacidDreamer: Advancing Harmony in Text-to-3D Generation
...
#### [8] Connecting Consistency Distillation to Score Distillation for Text-to-3D Generation
...
#### [9] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [10] Generalizable Human Gaussians for Sparse View Synthesis
...
#### [11] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [12] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [13] Click-Gaussian: Interactive Segmentation to Any 3D Gaussians
...
#### [14] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [15] Gaussian Splatting Lucas-Kanade
...
#### [16] iHuman: Instant Animatable Digital Humans From Monocular Videos
...
#### [17] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [19] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [20] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [21] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [22] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [23] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [24] PICA: Physics-Integrated Clothed Avatar
...
#### [25] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [26] Gaussian Eigen Models for Human Heads
...
#### [28] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [29] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [30] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [31] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [32] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [33] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [34] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [35] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [36] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [37] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [38] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [39] Lightweight Predictive 3D Gaussian Splats
...
#### [40] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [41] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [42] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [44] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [45] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [46] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [47] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [48] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [49] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [50] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [51] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [52] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [53] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [54] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [55] E2GS: Event Enhanced Gaussian Splatting
...
#### [56] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [57] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [58] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [59] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [60] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [61] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [62] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [63] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [64] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [65] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [66] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [67] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [68] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [69] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [70] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [71] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [72] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [73] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [74] From Chaos to Clarity: 3DGS in the Dark
...
#### [75] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [76] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [77] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [78] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [79] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [80] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [81] Generalizable Human Gaussians from Single-View Image
...
#### [82] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [84] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [85] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [86] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [87] Localized Gaussian Point Management
...
#### [88] Gaussian Representation for Deformable Image Registration
...
#### [89] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [90] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [91] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [92] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [93] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [94] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [95] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [96] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [97] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [98] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [99] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [100] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [101] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [102] Tetrahedron Splatting for 3D Generation
...
#### [103] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [104] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [105] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [106] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
