...
#### [1] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [3] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [4] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [5] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [6] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [7] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [9] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [12] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [13] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [15] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [16] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [17] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [18] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [19] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [20] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [21] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [22] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [23] Lightweight Predictive 3D Gaussian Splats
...
#### [24] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [25] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [26] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [27] On Scaling Up 3D Gaussian Splatting Training
...
#### [28] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [29] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [30] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [31] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [32] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [33] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [34] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [35] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [36] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [37] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [38] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [39] E2GS: Event Enhanced Gaussian Splatting
...
#### [40] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [41] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [42] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [43] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [44] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [45] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [47] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [48] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [49] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [50] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [51] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [52] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [53] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [54] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [55] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [56] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [57] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [58] From Chaos to Clarity: 3DGS in the Dark
...
#### [59] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [60] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [61] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [62] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [63] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [64] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [65] Generalizable Human Gaussians from Single-View Image
...
#### [66] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [67] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [69] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [70] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [71] Localized Gaussian Point Management
...
#### [72] Gaussian Representation for Deformable Image Registration
...
#### [73] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [74] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [75] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [76] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [77] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [78] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [79] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [80] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [81] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [82] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [83] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [84] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [85] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [86] Tetrahedron Splatting for 3D Generation
...
#### [87] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [88] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [89] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [90] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
