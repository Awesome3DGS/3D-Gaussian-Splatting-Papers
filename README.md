...
#### [1] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [2] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [4] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [6] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [7] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [8] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [9] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [10] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [11] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [12] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [13] MapGS: Generalizable Pretraining and Data Augmentation for Online Mapping via Novel View Synthesis
- **🧑‍🔬 作者**：Hengyuan Zhang, David Paz, Yuliang Guo, Xinyu Huang, Henrik I. Christensen, Liu Ren
- **🏫 单位**: UC San Diego ⟐ Bosch North America
- **🔗 链接**：[[中英摘要](./abs/2501.06660.md)] [[arXiv:2501.06660](https://arxiv.org/abs/2501.06660)] [Code]
- **📝 说明**：

#### [14] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [15] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
- **🧑‍🔬 作者**：Xuyi Meng, Chen Wang, Jiahui Lei, Kostas Daniilidis, Jiatao Gu, Lingjie Liu
- **🏫 单位**: University of Pennsylvania ⟐ Apple
- **🔗 链接**：[[中英摘要](./abs/2501.05427.md)] [[arXiv:2501.05427](https://arxiv.org/abs/2501.05427)] [[Code](https://mengxuyigit.github.io/projects/zero-1-to-G/)]
- **📝 说明**：

#### [16] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [17] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [18] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [19] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [20] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [21] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [22] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [23] ConcealGS: Concealing Invisible Copyright Information in 3D Gaussian Splatting
...
- **📝 说明**：🏆 Accepted by ICASSP 2025

#### [24] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [25] Gaussian Masked Autoencoders
...
#### [26] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [27] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [28] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [29] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [30] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [31] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [32] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [33] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [34] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [35] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [36] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [37] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [38] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [39] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [40] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [41] DEGSTalk: Decomposed Per-Embedding Gaussian Fields for Hair-Preserving Talking Face Synthesis
...
#### [42] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [43] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [44] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [45] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [46] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [47] BeSplat -- Gaussian Splatting from a Single Blurry Image and Event Stream
...
#### [48] Reflective Gaussian Splatting
...
#### [49] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [50] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [51] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [52] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [53] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [54] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [55] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [56] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [57] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [58] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [59] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [60] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [61] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [62] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [63] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [65] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [66] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [67] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [68] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [69] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [70] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [71] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [72] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [73] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [74] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [75] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [76] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [77] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [78] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [79] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [80] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [81] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [82] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [83] EOGS: Gaussian Splatting for Earth Observation
...
#### [84] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [85] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [86] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [87] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [88] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [89] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [90] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [91] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [92] Deformable Radial Kernel Splatting
...
#### [93] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [94] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [95] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [96] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [97] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [98] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [99] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [100] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [101] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [102] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [103] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [104] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [105] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [106] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [107] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [108] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [109] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [110] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [111] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [112] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [113] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [114] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [115] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [116] GASP: Gaussian Avatars with Synthetic Priors
...
#### [117] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [118] Faster and Better 3D Splatting via Group Training
...
#### [119] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [120] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [121] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [122] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [123] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [124] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [125] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [126] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [127] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [128] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [129] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [130] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [131] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [132] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [133] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [134] Street Gaussians without 3D Object Tracker
...
#### [135] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [136] Extrapolated Urban View Synthesis Benchmark
...
#### [137] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [138] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [139] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [140] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [141] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [142] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [143] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [144] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [145] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [146] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [147] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [148] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [149] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [150] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [151] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [152] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [153] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [154] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [155] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [156] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [157] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [158] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [159] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [160] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [161] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [162] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [163] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [164] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [165] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [166] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [167] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [168] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [169] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [170] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [171] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [172] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [173] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [174] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [175] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [176] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [177] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [178] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [179] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [180] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [181] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [182] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [183] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [184] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [185] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [186] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [187] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [188] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [189] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [190] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [191] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [192] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [193] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [194] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [195] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [196] Neural Surface Priors for Editable Gaussian Splatting
...
#### [197] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [198] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [199] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [200] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [201] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [202] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [203] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [204] Geometry Field Splatting with Gaussian Surfels
...
#### [205] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [206] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [207] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [208] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [209] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [210] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [211] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [212] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [213] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [214] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [215] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [216] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [217] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [218] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [219] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [220] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [221] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [222] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [223] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [224] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [225] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [226] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [227] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [228] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [229] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [230] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [231] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [232] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [233] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [234] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [235] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [236] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [237] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [238] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [239] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [240] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [241] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [242] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [243] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [244] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [245] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [246] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [247] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [248] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [249] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [250] VeGaS: Video Gaussian Splatting
...
#### [251] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [252] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [253] Efficient Density Control for 3D Gaussian Splatting
...
#### [254] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [255] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [256] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [257] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [258] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [259] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [260] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [261] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [262] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [263] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [264] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [265] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [266] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [267] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [268] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [269] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [270] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [271] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [272] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [273] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [274] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [275] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [276] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [277] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [278] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [279] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [280] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [281] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [282] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [283] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [284] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [285] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [286] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [287] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [288] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [289] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [290] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [291] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [292] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [293] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [294] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [295] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [296] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [297] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [298] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [299] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [300] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [301] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [302] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [303] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [304] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [305] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [306] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [307] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [308] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [309] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [310] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [311] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [312] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [313] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [314] 3D Vision-Language Gaussian Splatting
...
#### [315] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [316] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [317] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [318] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [319] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [320] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [321] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [322] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [323] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [324] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [325] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [326] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [327] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [328] Variational Bayes Gaussian Splatting
...
#### [329] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [330] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [331] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [332] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [333] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [334] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [335] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [336] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [337] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [338] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [339] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [340] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [341] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [342] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [343] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [344] RNG: Relightable Neural Gaussians
...
#### [345] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [346] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [347] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [348] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [349] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [350] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [351] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [352] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [353] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [354] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [355] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [356] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [357] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [358] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [359] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [360] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [361] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [362] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [363] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [364] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [365] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [366] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [367] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [368] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [369] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [370] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [371] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [372] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [373] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [374] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [375] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [376] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [377] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [378] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [379] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [380] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [381] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [382] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [383] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [384] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [385] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [386] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [387] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [388] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [389] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [390] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [391] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [392] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [393] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [394] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [395] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [396] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [397] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [398] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [399] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [400] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [401] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [402] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [403] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [404] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [405] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [406] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [407] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [408] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [409] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [410] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [411] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [412] OmniRe: Omni Urban Scene Reconstruction
...
#### [413] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [414] G-Style: Stylized Gaussian Splatting
...
#### [415] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [416] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [417] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [418] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [419] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [420] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [421] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [422] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [423] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [424] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [425] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [426] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [427] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [428] Subsurface Scattering for 3D Gaussian Splatting
...
#### [429] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [430] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [431] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [432] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [433] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [434] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [435] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [436] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [437] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [438] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [439] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [440] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [441] 3D Gaussian Editing with A Single Image
...
#### [442] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [443] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [444] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [445] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [446] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [447] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [448] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [449] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [450] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [451] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [452] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [453] IG-SLAM: Instant Gaussian SLAM
...
#### [454] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [455] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [456] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [457] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [458] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [459] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [460] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [461] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [462] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [463] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [464] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [465] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [466] Gaussian Splatting Lucas-Kanade
...
#### [467] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [468] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [469] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [470] PICA: Physics-Integrated Clothed Avatar
...
#### [471] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [472] Gaussian Eigen Models for Human Heads
...
#### [474] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [475] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [476] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [477] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [478] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [479] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [480] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [481] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [482] Lightweight Predictive 3D Gaussian Splats
...
#### [483] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [484] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [485] On Scaling Up 3D Gaussian Splatting Training
...
#### [486] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [487] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [488] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [489] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [490] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [491] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [492] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [493] E2GS: Event Enhanced Gaussian Splatting
...
#### [494] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [495] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [496] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [497] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [498] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [499] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [500] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [501] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [502] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [503] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [504] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [505] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [506] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [507] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [508] Generalizable Human Gaussians from Single-View Image
...
#### [509] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [510] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [511] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [512] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [513] Localized Gaussian Point Management
...
#### [514] Gaussian Representation for Deformable Image Registration
...
#### [515] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [516] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [517] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [518] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [519] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [520] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [521] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [522] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [523] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
