...
#### [2] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [3] Lightweight Predictive 3D Gaussian Splats
...
#### [4] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [5] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [7] On Scaling Up 3D Gaussian Splatting Training
...
#### [8] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [9] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [10] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [11] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [12] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [13] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [14] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [15] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [16] LGS: A Light-weight 4D Gaussian Splatting for Efficient Surgical Scene Reconstruction
...
#### [17] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [18] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [19] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [20] E2GS: Event Enhanced Gaussian Splatting
...
#### [21] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [22] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [23] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [25] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [26] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [27] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [28] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [29] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [30] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [31] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [33] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [34] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [35] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [36] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [37] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [38] ICE-G: Image Conditional Editing of 3D Gaussian Splats
...
#### [39] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [40] From Chaos to Clarity: 3DGS in the Dark
...
#### [41] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [42] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [43] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [44] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [45] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [46] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [47] Generalizable Human Gaussians from Single-View Image
...
#### [48] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [49] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [50] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [51] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [52] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [53] Localized Gaussian Point Management
...
#### [54] Gaussian Representation for Deformable Image Registration
...
#### [55] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [56] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [57] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [59] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [60] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [61] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [62] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [63] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [64] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [65] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [66] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [67] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [68] Tetrahedron Splatting for 3D Generation
...
#### [69] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [70] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [71] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [72] SuperGaussian: Repurposing Video Models for 3D Super Resolution
...
#### [73] Topo4D: Topology-Preserving Gaussian Splatting for High-Fidelity 4D Head Capture
...
#### [74] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
