...
#### [2] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [3] LiDAR-enhanced 3D Gaussian Splatting Mapping
- **🧑‍🔬 作者**：Jian Shen, Huai Yu, Ji Wu, Wen Yang, Gui-Song Xia
...
#### [4] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [5] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [6] STGA: Selective-Training Gaussian Head Avatars
...
#### [7] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [8] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [9] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [10] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [12] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [13] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [14] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [16] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [17] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [18] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [19] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [20] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [21] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [22] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [23] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [24] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [25] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [26] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [27] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [29] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [30] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [31] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [32] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [33] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
- **🧑‍🔬 作者**：BoCheng Li, WenJuan Zhang, Bing Zhang, YiLing Yao, YaNing Wang
- **🏫 单位**: Aerospace Information Research Institute
- **🔗 链接**：[[中英摘要](./abs/2503.00848.md)] [[arXiv:2503.00848](https://arxiv.org/abs/2503.00848)] [Code]
- **📝 说明**：

#### [34] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [35] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [36] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [37] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [39] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [40] Seeing A 3D World in A Grain of Sand
...
#### [41] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [42] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [43] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [44] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [45] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [46] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [47] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [48] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [49] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [50] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [51] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [52] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [53] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [54] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [55] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [56] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [57] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [58] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [59] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [60] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [61] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [62] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [63] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [64] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [65] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [66] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [67] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [68] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [69] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [70] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [71] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [72] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [73] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [74] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [75] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [76] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [77] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [78] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [79] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [80] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [81] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [82] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [83] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [84] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [85] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [86] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [87] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [88] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [89] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [90] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [91] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [92] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [93] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [94] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [95] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [96] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [97] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [98] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [99] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [101] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [102] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [103] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [104] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [105] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [106] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [107] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [108] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [109] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [110] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [111] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [112] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [113] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [114] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [115] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [116] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [117] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [118] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [119] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [120] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [121] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [122] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [123] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [124] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [125] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [126] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [127] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [128] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [129] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [130] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [131] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [132] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [133] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [134] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [135] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [136] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [137] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [138] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [139] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [140] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [141] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [142] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [143] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [144] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [145] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [146] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [147] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [148] Gaussian Masked Autoencoders
...
#### [149] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [150] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [151] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [152] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [153] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [154] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [155] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [156] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [157] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [158] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [159] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [160] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [161] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [162] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [163] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [164] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [165] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [166] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [167] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [168] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [169] Reflective Gaussian Splatting
...
#### [170] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [171] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [172] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [173] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [174] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [175] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [176] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [177] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [178] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [179] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [180] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [181] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [182] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [183] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [184] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [185] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [186] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [187] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [188] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [189] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [190] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [191] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [192] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [193] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [194] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [195] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [196] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [197] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [198] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [199] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [200] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [201] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [202] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [203] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [204] EOGS: Gaussian Splatting for Earth Observation
...
#### [205] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [206] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [207] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [208] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [209] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [210] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [211] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [212] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [213] Deformable Radial Kernel Splatting
...
#### [214] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [215] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [216] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [217] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [218] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [219] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [220] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [221] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [222] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [223] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [224] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [225] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [226] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [227] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [228] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [229] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [230] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [231] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [232] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [233] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [234] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [235] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [236] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [237] GASP: Gaussian Avatars with Synthetic Priors
...
#### [238] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [239] Faster and Better 3D Splatting via Group Training
...
#### [240] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [241] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [242] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [243] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [244] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [245] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [246] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [247] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [248] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [249] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [250] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [251] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [252] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [253] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [254] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [255] Street Gaussians without 3D Object Tracker
...
#### [256] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [257] Extrapolated Urban View Synthesis Benchmark
...
#### [258] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [259] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [260] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [261] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [262] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [263] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [264] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [265] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [266] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [267] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [268] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [269] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [270] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [271] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [272] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [273] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [274] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [275] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [276] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [277] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [278] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [279] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [280] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [281] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [282] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [283] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [284] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [285] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [286] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [287] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [288] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [289] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [290] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [291] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [292] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [293] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [294] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [295] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [296] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [297] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [298] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [299] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [300] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [301] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [302] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [303] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [304] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [305] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [306] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [307] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [308] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [309] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [310] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [311] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [312] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [313] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [314] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [315] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [316] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [317] Neural Surface Priors for Editable Gaussian Splatting
...
#### [318] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [319] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [320] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [321] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [322] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [323] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [324] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [325] Geometry Field Splatting with Gaussian Surfels
...
#### [326] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [327] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [328] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [329] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [330] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [331] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [332] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [333] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [334] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [335] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [336] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [337] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [338] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [339] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [340] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [341] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [342] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [343] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [344] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [345] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [346] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [347] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [348] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [349] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [350] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [351] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [352] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [353] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [354] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [355] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [356] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [357] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [358] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [359] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [360] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [361] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [362] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [363] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [364] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [365] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [366] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [367] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [368] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [369] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [370] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [371] VeGaS: Video Gaussian Splatting
...
#### [372] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [373] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [374] Efficient Density Control for 3D Gaussian Splatting
...
#### [375] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [376] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [377] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [378] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [379] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [380] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [381] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [382] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [383] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [384] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [385] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [386] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [387] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [388] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [389] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [390] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [391] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [392] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [393] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [394] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [395] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [396] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [397] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [398] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [399] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [400] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [401] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [402] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [403] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [404] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [405] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [406] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [407] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [408] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [409] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [410] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [411] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [412] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [413] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [414] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [415] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [416] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [417] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [418] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [419] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [420] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [421] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [422] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [423] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [424] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [425] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [426] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [427] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [428] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [429] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [430] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [431] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [432] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [433] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [434] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [435] 3D Vision-Language Gaussian Splatting
...
#### [436] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [437] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [438] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [439] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [440] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [441] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [442] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [443] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [444] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [445] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [446] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [447] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [448] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [449] Variational Bayes Gaussian Splatting
...
#### [450] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [451] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [452] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [453] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [454] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [455] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [456] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [457] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [458] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [459] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [460] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [461] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [462] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [463] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [464] RNG: Relightable Neural Gaussians
...
#### [465] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [466] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [467] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [468] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [469] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [470] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [471] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [472] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [473] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [474] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [475] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [476] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [477] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [478] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [479] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [480] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [481] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [482] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [483] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [484] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [485] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [486] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [487] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [488] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [489] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [490] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [491] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [492] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [493] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [494] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [495] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [496] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [497] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [498] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [499] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [500] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [501] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [502] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [503] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [504] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [505] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [506] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [507] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [508] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [509] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [510] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [511] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [512] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [513] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [514] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [515] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [516] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [517] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [518] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [519] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [520] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [521] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [522] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [523] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [524] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [525] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [526] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [527] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [528] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [529] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [530] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [531] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [532] OmniRe: Omni Urban Scene Reconstruction
...
#### [533] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [534] G-Style: Stylized Gaussian Splatting
...
#### [535] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [536] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [537] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [538] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [539] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [540] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [541] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [542] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [543] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [544] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [545] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [546] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [547] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [548] Subsurface Scattering for 3D Gaussian Splatting
...
#### [549] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [550] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [551] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [552] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [553] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [554] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [555] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [556] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [557] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [558] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [559] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [560] 3D Gaussian Editing with A Single Image
...
#### [561] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [562] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [563] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [564] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [565] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [566] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [567] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [568] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [569] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [570] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [571] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [572] IG-SLAM: Instant Gaussian SLAM
...
#### [573] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [574] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [575] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [576] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [577] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [578] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [579] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [580] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [581] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [582] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [583] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [584] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [585] Gaussian Splatting Lucas-Kanade
...
#### [586] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [587] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [588] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [589] PICA: Physics-Integrated Clothed Avatar
...
#### [590] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [591] Gaussian Eigen Models for Human Heads
...
#### [593] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [594] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [595] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [596] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [597] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [598] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [599] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [600] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [601] Lightweight Predictive 3D Gaussian Splats
...
#### [602] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [603] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [604] On Scaling Up 3D Gaussian Splatting Training
...
#### [605] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [606] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [607] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [608] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [609] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [610] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [611] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [612] E2GS: Event Enhanced Gaussian Splatting
...
#### [613] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [614] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [615] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [616] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [617] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [618] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [619] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [620] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [621] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [622] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [623] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [624] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [625] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [626] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [627] Generalizable Human Gaussians from Single-View Image
...
#### [628] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [629] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [630] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [631] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [632] Localized Gaussian Point Management
...
#### [633] Gaussian Representation for Deformable Image Registration
...
#### [634] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [635] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [636] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [637] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [638] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [639] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [640] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [641] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [642] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
