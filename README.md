...
#### [1] Efficient representation of 3D spatial data for defense-related applications
...
#### [2] CLM: Removing the GPU Memory Barrier for 3D Gaussian Splatting
...
#### [4] Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions
...
#### [5] UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction
...
#### [6] FastGS: Training 3D Gaussian Splatting in 100 Seconds
...
#### [8] Improving Multi-View Reconstruction via Texture-Guided Gaussian-Mesh Joint Optimization
...
#### [9] DentalSplat: Dental Occlusion Novel View Synthesis from Sparse Intra-Oral Photographs
...
#### [10] PercHead: Perceptual Head Model for Single-Image 3D Head Reconstruction & Editing
...
#### [11] Object-Centric 3D Gaussian Splatting for Strawberry Plant Reconstruction and Phenotyping
...
#### [12] 3D Gaussian Radiation Field Modeling for Integrated RIS-FAS Systems: Analysis and Optimization
...
#### [13] GauDP: Reinventing Multi-Agent Collaboration through Gaussian-Image Synergy in Diffusion Policies
...
#### [14] 4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Guassian Splatting
...
#### [16] Object-Aware 4D Human Motion Generation
...
#### [17] SAGS: Self-Adaptive Alias-Free Gaussian Splatting for Dynamic Surgical Endoscopic Reconstruction
...
#### [18] DC4GS: Directional Consistency-Driven Adaptive Density Control for 3D Gaussian Splatting
...
#### [19] HEIR: Learning Graph-Based Motion Hierarchies
...
#### [21] 6D Channel Knowledge Map Construction via Bidirectional Wireless Gaussian Splatting
...
#### [22] JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting
...
#### [23] Learning Disentangled Speech- and Expression-Driven Blendshapes for 3D Talking Face Animation
...
#### [24] EA3D: Online Open-World 3D Object Extraction from Streaming Videos
...
#### [25] AtlasGS: Atlanta-world Guided Surface Reconstruction with Implicit Structured Gaussians
...
#### [26] DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes
...
#### [27] NVSim: Novel View Synthesis Simulator for Large Scale Indoor Navigation
...
#### [28] LagMemo: Language 3D Gaussian Splatting Memory for Multi-modal Open-vocabulary Multi-goal Visual Navigation
...
#### [29] PlanarGS: High-Fidelity Indoor 3D Gaussian Splatting Guided by Vision-Language Planar Priors
...
#### [30] Explicit Memory through Online 3D Gaussian Splatting Improves Class-Agnostic Video Segmentation
...
#### [31] VR-Drive: Viewpoint-Robust End-to-End Driving with Feed-Forward 3D Gaussian Splatting
...
#### [32] EndoWave: Rational-Wavelet 4D Gaussian Splatting for Endoscopic Reconstruction
...
#### [33] Gen-LangSplat: Generalized Language Gaussian Splatting with Pre-Trained Feature Compression
- **🧑‍🔬 作者**：Pranav Saxena
...
#### [34] Region-Adaptive Learned Hierarchical Encoding for 3D Gaussian Splatting Data
...
#### [35] LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering
...
#### [36] RoGER-SLAM: A Robust Gaussian Splatting SLAM System for Noisy and Low-light Environment Resilience
...
#### [37] DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss
...
#### [39] STG-Avatar: Animatable Human Avatars via Spacetime Gaussian
...
#### [40] Towards Physically Executable 3D Gaussian for Embodied Navigation
...
#### [42] OnlineSplatter: Pose-Free Online 3D Reconstruction for Free-Moving Objects
...
#### [43] COS3D: Collaborative Open-Vocabulary 3D Segmentation
...
#### [44] Extreme Views: 3DGS Filter for Novel View Synthesis from Out-of-Distribution Camera Poses
...
#### [45] Re-Activating Frozen Primitives for 3D Gaussian Splatting
...
#### [46] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [47] GRASPLAT: Enabling dexterous grasping through novel view synthesis
...
#### [48] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [49] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [51] HouseTour: A Virtual Real Estate A(I)gent
...
#### [52] InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation
...
#### [53] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
...
#### [54] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [55] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [56] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [57] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [58] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [59] HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars
...
#### [60] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [61] Fix False Transparency by Noise Guided Splatting
...
#### [62] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [63] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [64] DriveGen3D: Boosting Feed-Forward Driving Scene Generation with Efficient Video Diffusion
...
#### [65] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [66] Terra: Explorable Native 3D World Model with Point Latents
...
#### [67] Leveraging Learned Image Prior for 3D Gaussian Compression
...
#### [68] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [69] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [70] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [71] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [72] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [73] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [74] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [75] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [76] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [77] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [78] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [79] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [80] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [81] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [82] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [83] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [84] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [85] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [86] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [87] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [88] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [89] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [90] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [91] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [92] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [93] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [94] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [95] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [96] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [97] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [98] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [99] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [100] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [101] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [102] ReSplat: Learning Recurrent Gaussian Splats
...
#### [103] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [104] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [105] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [106] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [107] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [108] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [109] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [110] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [111] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [112] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [113] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [114] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [115] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [116] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [117] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [119] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [120] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [121] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [122] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [123] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [124] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [125] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [126] HART: Human Aligned Reconstruction Transformer
...
#### [127] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [128] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [129] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [130] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [131] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [132] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [133] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [134] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [135] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [136] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [137] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [138] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [139] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [140] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [141] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [142] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [143] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [144] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [145] Learning Unified Representation of 3D Gaussian Splatting
...
#### [146] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [147] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [148] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [149] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [150] Large Material Gaussian Model for Relightable 3D Generation
...
#### [151] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [152] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [153] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [154] 4D Driving Scene Generation With Stereo Forcing
...
#### [155] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [156] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [157] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [158] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [159] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [160] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [161] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [162] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [163] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [164] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [165] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [166] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [167] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [168] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [169] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [170] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [171] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [172] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [173] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [174] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [175] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [176] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [177] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [178] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [179] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [180] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [181] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [182] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [183] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [184] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [185] Camera Splatting for Continuous View Optimization
...
#### [186] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [187] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [188] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [189] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [190] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [191] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [192] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [193] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [194] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [195] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [196] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [197] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [198] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [199] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [200] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [201] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [202] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [203] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [204] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [205] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [206] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [207] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [208] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [209] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [210] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [211] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [212] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [213] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [214] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [215] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [216] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [217] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [218] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [219] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [220] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [221] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [222] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [223] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [224] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [225] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [226] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [227] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [228] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [229] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [230] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [231] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [232] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [233] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [234] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [235] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [236] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [237] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [238] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [239] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [240] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [241] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [242] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [243] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [244] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [245] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [246] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [247] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [248] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [249] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [250] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [251] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [252] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [253] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [254] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [255] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [256] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [257] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [258] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [259] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [260] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [261] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [262] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [263] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [264] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [265] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [266] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [267] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [268] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [269] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [270] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [271] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [272] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [273] SAGOnline: Segment Any Gaussians Online
...
#### [274] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [275] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [276] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [277] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [278] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [279] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [280] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [281] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [282] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [283] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [284] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [285] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [286] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [287] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [288] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [289] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [290] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [291] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [292] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [293] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [294] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [295] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [296] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [297] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [298] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [299] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [300] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [301] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [302] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [303] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [304] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [305] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [306] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [307] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [308] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [309] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [310] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [311] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [312] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [313] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [314] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [315] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [316] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [317] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [318] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [319] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [320] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [321] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [322] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [323] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [324] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [325] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [326] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [327] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [328] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [329] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [330] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [331] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [332] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [333] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [334] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [335] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [336] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [337] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [338] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [339] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [340] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [341] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [342] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [343] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [344] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [345] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [346] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [347] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [348] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [349] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [350] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [351] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [352] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [353] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [354] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [355] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [356] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [357] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [358] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [359] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [360] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [361] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [362] Masks make discriminative models great again!
...
#### [363] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [364] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [365] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
