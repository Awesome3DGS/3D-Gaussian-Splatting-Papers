...
#### [1] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [2] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [5] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [6] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [7] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [8] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [9] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [10] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [11] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [12] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [13] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [14] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [15] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [16] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [17] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [18] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [19] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [20] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [21] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [22] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [23] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [24] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [25] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [26] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
...
#### [27] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [28] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [29] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [31] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [32] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [33] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [34] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [35] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [36] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [37] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [38] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [39] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [40] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [41] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [42] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [43] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [45] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [46] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [47] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [49] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [50] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [51] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [52] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [53] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [54] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [55] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [56] Neural Surface Priors for Editable Gaussian Splatting
...
#### [57] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [58] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [59] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [60] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [61] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [62] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [63] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [64] Geometry Field Splatting with Gaussian Surfels
...
#### [65] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [66] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [67] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [68] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [69] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [70] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [71] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [72] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [73] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [74] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [75] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [76] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [77] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [78] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [79] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [80] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [81] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [83] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [84] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [85] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [86] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [87] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [88] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [89] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [90] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [91] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [92] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [93] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [94] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
...
#### [95] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [96] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [97] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [98] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [99] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [100] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [101] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [102] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [103] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [104] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [105] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [106] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [107] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [108] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [109] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [110] VeGaS: Video Gaussian Splatting
...
#### [111] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [112] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [113] Efficient Density Control for 3D Gaussian Splatting
...
#### [114] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [115] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [116] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [117] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [118] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [119] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [120] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [121] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [122] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [123] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [124] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [125] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [126] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [127] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [128] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [129] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [130] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [131] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [132] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [134] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [135] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [136] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [137] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [138] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [139] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [140] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [141] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [142] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [143] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [144] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [145] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [146] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [147] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [148] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [149] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [150] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [151] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [152] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [153] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [154] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [155] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [156] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [157] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [158] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [159] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [160] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [161] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [162] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [163] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [164] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [165] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [166] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [167] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [168] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [169] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [170] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [171] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [172] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [173] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [174] 3D Vision-Language Gaussian Splatting
...
#### [175] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [176] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [177] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [178] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [179] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [180] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [181] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [182] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [183] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [184] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [185] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [189] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [190] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [191] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [192] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [193] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [194] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [195] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [196] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [197] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [198] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [199] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [200] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [201] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [202] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [203] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [204] RNG: Relightable Neural Gaussians
...
#### [205] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [206] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [207] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [208] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [209] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [210] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [211] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [212] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [213] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [214] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [215] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [216] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [217] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [218] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [219] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [220] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [221] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [222] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [223] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [224] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [225] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [226] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [227] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [228] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [229] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [230] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [231] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [232] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [233] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [234] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [235] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [236] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [237] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [238] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [239] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [240] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [241] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [242] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [243] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [244] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [245] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [246] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [247] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [248] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [249] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [250] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [251] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [252] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [253] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [254] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [255] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [256] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [257] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [258] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [259] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [260] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [261] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [262] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [263] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [264] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [265] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [266] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [267] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [268] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [269] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [270] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [271] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [272] OmniRe: Omni Urban Scene Reconstruction
...
#### [273] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [274] G-Style: Stylized Gaussian Splatting
...
#### [275] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [276] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [277] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [278] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [279] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [280] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [281] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [282] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [283] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [284] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [285] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [286] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [287] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [288] Subsurface Scattering for 3D Gaussian Splatting
...
#### [289] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [290] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [291] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [292] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [293] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [294] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [295] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [296] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [297] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [298] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [299] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [300] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [301] 3D Gaussian Editing with A Single Image
...
#### [302] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [303] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [304] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [305] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [306] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [307] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [308] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [309] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [310] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [311] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [312] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [313] IG-SLAM: Instant Gaussian SLAM
...
#### [314] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [315] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [316] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [317] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [318] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [319] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [320] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [321] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [322] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [323] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [324] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [325] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [326] Gaussian Splatting Lucas-Kanade
...
#### [327] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [328] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [329] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [330] PICA: Physics-Integrated Clothed Avatar
...
#### [331] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [332] Gaussian Eigen Models for Human Heads
...
#### [334] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [335] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [336] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [337] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [338] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [339] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [340] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [341] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [342] Lightweight Predictive 3D Gaussian Splats
...
#### [343] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [344] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [345] On Scaling Up 3D Gaussian Splatting Training
...
#### [346] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [347] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [348] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [349] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [350] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [351] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [352] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [353] E2GS: Event Enhanced Gaussian Splatting
...
#### [354] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [355] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [356] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [357] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [358] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [359] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [360] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [361] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [362] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [363] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [364] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [365] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [366] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [367] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [368] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [369] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [370] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [371] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [372] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [373] Generalizable Human Gaussians from Single-View Image
...
#### [374] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [375] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [376] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [377] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [378] Localized Gaussian Point Management
...
#### [379] Gaussian Representation for Deformable Image Registration
...
#### [380] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [381] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [382] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [383] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [384] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [385] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [386] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [387] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [388] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [389] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [390] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
