...
#### [3] GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise
...
#### [5] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [6] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [7] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [8] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [11] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [12] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [13] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [15] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [16] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [17] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [18] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [19] 2D-Guided 3D Gaussian Segmentation
...
#### [20] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [21] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [22] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
...
#### [23] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [24] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [25] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [26] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [27] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [28] EndoGaussian: Gaussian Splatting for Deformable Surgical Scene Reconstruction
...
#### [29] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [30] LIV-GaussMap: LiDAR-Inertial-Visual Fusion for Real-time 3D Radiance Field Map Rendering
...
#### [31] Endo-4DGS: Distilling Depth Ranking for Endoscopic Monocular Scene Reconstruction with 4D Gaussian Splatting
...
#### [32] Segment Anything in 3D Gaussians
...
#### [33] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [34] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [35] SGS-SLAM: Semantic Gaussian Splatting For Neural Dense SLAM
...
#### [36] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [37] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [38] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [40] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [41] 3D Gaussian Model for Animation and Texturing
...
#### [42] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [43] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [44] SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM
...
#### [45] A New Split Algorithm for 3D Gaussian Splatting
...
#### [46] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [47] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [48] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [49] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [50] DarkGS: Learning Neural Illumination and 3D Gaussians Relighting for Robotic Exploration in the Dark
...
#### [51] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [52] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [53] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [54] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [55] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [56] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [57] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [58] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [59] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [60] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [62] Isotropic Gaussian Splatting for Real-Time Radiance Field Rendering
...
#### [63] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [64] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [65] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [66] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [67] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [68] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [69] Modeling uncertainty for Gaussian Splatting
...
#### [70] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [71] Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction
...
#### [72] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [73] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [74] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [75] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [76] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [77] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [78] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [79] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [80] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [81] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [83] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [84] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [85] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [86] Revising Densification in Gaussian Splatting
...
#### [87] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [88] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [89] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [90] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [91] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [92] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [93] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [95] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [96] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [97] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [98] Does Gaussian Splatting need SFM Initialization?
...
#### [99] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [100] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [101] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [102] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [103] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [104] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [105] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [106] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [107] 3D Gaussian Splatting with Deferred Reflection
...
#### [108] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [109] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [110] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [111] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [112] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [113] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [114] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [115] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [116] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2405.05446.md)] [[arXiv:2405.05446](https://arxiv.org/abs/2405.05446)] [Code]
- **📝 说明**：✏️

#### [117] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [118] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [119] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [120] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06547.md)] [[arXiv:2405.06547](https://arxiv.org/abs/2405.06547)] [[Code](https://github.com/lin-jinwei/OneTo3D)]
- **📝 说明**：✏️

#### [121] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [122] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [123] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [124] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [125] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [126] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [127] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [128] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [129] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [130] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [131] Gaussian Time Machine: A Real-Time Rendering Methodology for Time-Variant Appearances
...
#### [132] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [133] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [134] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [135] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [136] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [137] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [138] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [139] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [140] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [141] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [142] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [143] GOI: Find 3D Gaussians of Interest with an Optimizable Open-vocabulary Semantic-space Hyperplane
...
#### [144] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
...
#### [145] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [146] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [147] NegGS: Negative Gaussian Splatting
...
#### [148] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [149] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [150] NPGA: Neural Parametric Gaussian Avatars
...
#### [151] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [152] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [153] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [154] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [155] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [156] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [157] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [158] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [159] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
