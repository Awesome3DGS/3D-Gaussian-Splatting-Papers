...
- **2025**
  ...
  - [[3DV](./2025/3DV.md)] (9 篇)
    ...
    [[AAAI](./2025/AAAI.md)] (16 篇)
    [[ICLR](./2025/ICLR.md)] (15 篇)
    [[ICASSP](./2025/ICASSP.md)] (4 篇)
    [[ICRA](./2025/ICRA.md)] (6 篇)
  - [[CVPR](./2025/CVPR.md)] (13 篇)
...
#### [1] TaoAvatar: Real-Time Lifelike Full-Body Talking Avatars for Augmented Reality via 3D Gaussian Splatting
...
#### [3] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [4] Optimized Minimal 3D Gaussian Splatting
...
#### [5] RigGS: Rigging of 3D Gaussians for Modeling Articulated Objects in Videos
...
#### [6] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [8] GauRast: Enhancing GPU Triangle Rasterizers to Accelerate 3D Gaussian Splatting
...
#### [9] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [10] M3: 3D-Spatial MultiModal Memory
...
#### [11] Gaussian Graph Network: Learning Efficient and Generalizable Gaussian Representations from Multi-view Images
...
#### [12] OccluGaussian: Occlusion-Aware Gaussian Splatting for Large Scene Reconstruction and Rendering
...
#### [13] Enhancing Close-up Novel View Synthesis via Pseudo-labeling
...
#### [14] Repurposing 2D Diffusion Models with Gaussian Atlas for 3D Generation
...
#### [15] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [16] BARD-GS: Blur-Aware Reconstruction of Dynamic Scenes via Gaussian Splatting
...
#### [17] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [18] Uncertainty-Aware Diffusion Guided Refinement of 3D Scenes
...
#### [19] CHROME: Clothed Human Reconstruction with Occlusion-Resilience and Multiview-Consistency from a Single Image
...
#### [20] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [21] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [22] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [23] SplatVoxel: History-Aware Novel View Streaming without Temporal Training
...
#### [24] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [25] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [26] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [27] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [28] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [29] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [31] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [32] RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars
...
#### [33] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [34] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [35] Deblur Gaussian Splatting SLAM
...
#### [36] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [37] MTGS: Multi-Traversal Gaussian Splatting
...
#### [38] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [39] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [40] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [41] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [42] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [43] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [44] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [45] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [46] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [47] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [48] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [49] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [50] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [51] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [52] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [53] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
...
#### [54] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [55] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [56] 3D Student Splatting and Scooping
...
#### [57] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [58] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [59] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [60] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [62] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
- **🧑‍🔬 作者**：Jiatong Xia, Lingqiao Liu
- **🏫 单位**: Australian Institute for Machine Learning, The University of Adelaide
- **🔗 链接**：[[中英摘要](./abs/2503.09396.md)] [[arXiv:2503.09396](https://arxiv.org/abs/2503.09396)] [Code]
- **📝 说明**：

#### [63] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [64] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [65] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [66] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [67] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [68] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [69] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [70] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [71] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [72] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [73] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [74] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [75] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [76] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [77] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [78] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [79] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [80] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [81] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [82] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [83] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [84] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [85] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [86] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [87] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [88] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [89] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [90] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [91] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [92] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [93] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [94] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [95] Self-Modeling Robots by Photographing
...
#### [96] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [97] STGA: Selective-Training Gaussian Head Avatars
...
#### [98] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [99] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [100] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [101] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [102] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [103] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [104] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [105] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [106] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [107] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [108] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [109] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [110] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [111] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [112] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [113] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [114] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [115] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [116] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [117] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [118] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [119] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [120] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [121] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [123] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [124] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [125] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [126] Seeing A 3D World in A Grain of Sand
...
#### [127] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [128] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [129] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [130] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [131] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [132] LUCAS: Layered Universal Codec Avatars
...
#### [133] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [134] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [136] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [137] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [138] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [139] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [140] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [141] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [142] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [143] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [144] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [145] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [146] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [147] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [148] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [149] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [150] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [155] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [156] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [157] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [158] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [159] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [160] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [161] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [162] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [163] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [164] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [165] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [166] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [167] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [168] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [169] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [170] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [171] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [172] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [173] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [174] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [175] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [176] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [177] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [179] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [180] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [181] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [182] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [183] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [184] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [185] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [186] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [187] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [188] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [189] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [190] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [191] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [192] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [193] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [194] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [195] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [196] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [197] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [198] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [199] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [200] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [201] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [202] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [203] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [204] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [205] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [206] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [207] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [208] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [209] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [210] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [211] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [212] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [213] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [214] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [215] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [216] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [218] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [219] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [220] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [221] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [222] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [223] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [224] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [225] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [226] Gaussian Masked Autoencoders
...
#### [227] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [228] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [229] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [230] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [231] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [232] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [233] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [234] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [235] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [236] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [237] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [238] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [239] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [240] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [241] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [242] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [243] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [244] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [245] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [246] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [247] Reflective Gaussian Splatting
...
#### [248] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [249] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [250] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [251] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [252] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [253] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [254] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [255] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [256] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [257] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [258] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [259] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [260] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [261] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [262] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [263] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [264] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [265] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [266] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [267] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [268] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [269] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [270] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [271] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [272] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [273] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [274] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [275] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [276] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [277] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [278] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [279] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [280] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [281] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [282] EOGS: Gaussian Splatting for Earth Observation
...
#### [283] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [284] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [285] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [286] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [287] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [288] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [289] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [290] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [291] Deformable Radial Kernel Splatting
...
#### [292] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [293] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [294] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [295] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [296] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [297] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [298] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [299] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [300] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [301] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [302] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [303] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [304] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [305] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [306] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [307] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [308] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [309] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [310] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [311] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [312] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [313] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [314] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [315] GASP: Gaussian Avatars with Synthetic Priors
...
#### [316] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [317] Faster and Better 3D Splatting via Group Training
...
#### [318] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [319] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [320] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [321] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [322] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [323] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [324] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [325] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [326] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [327] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [328] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [329] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [330] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [331] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [332] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [333] Street Gaussians without 3D Object Tracker
...
#### [334] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [335] Extrapolated Urban View Synthesis Benchmark
...
#### [336] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [337] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [338] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [339] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [340] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [341] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [342] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [343] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [344] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [345] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [346] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [347] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [348] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [349] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [350] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [351] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [352] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [353] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [354] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [355] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [356] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [357] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [358] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [359] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [360] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [361] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [362] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [363] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [364] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [365] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [366] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [367] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [368] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [369] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [370] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [371] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [372] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [373] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [374] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [375] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [376] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [377] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [378] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [379] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [380] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [381] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [382] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [383] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [384] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [385] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [386] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [387] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [388] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [389] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [390] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [391] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [392] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [393] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [394] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [395] Neural Surface Priors for Editable Gaussian Splatting
...
#### [396] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [397] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [398] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [399] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [400] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [401] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [402] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [403] Geometry Field Splatting with Gaussian Surfels
...
#### [404] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [405] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [406] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [407] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [408] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [409] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [410] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [411] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [412] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [413] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [414] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [415] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [416] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [417] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [418] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [419] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [420] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [421] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [422] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [423] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [424] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [425] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [426] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [427] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [428] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [429] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [430] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [431] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [432] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [433] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [434] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [435] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [436] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [437] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [438] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [439] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [440] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [441] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [442] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [443] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [444] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [445] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [446] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [447] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [448] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [449] VeGaS: Video Gaussian Splatting
...
#### [450] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [451] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [452] Efficient Density Control for 3D Gaussian Splatting
...
#### [453] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [454] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [455] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [456] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [457] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [458] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [459] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [460] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [461] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [462] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [463] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [464] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [465] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [466] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [467] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [468] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [469] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [470] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [471] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [472] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [473] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [474] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [475] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [476] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [477] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [478] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [479] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [480] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [481] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [482] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [483] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [484] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [485] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [486] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [487] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [488] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [489] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [490] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [491] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [492] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [493] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [494] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [495] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [496] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [497] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [498] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [499] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [500] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [501] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [502] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [503] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [504] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [505] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [506] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [507] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [508] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [509] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [510] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [511] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [512] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [513] 3D Vision-Language Gaussian Splatting
...
#### [514] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [515] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [516] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [517] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [518] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [519] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [520] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [521] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [522] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [523] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
- **🧑‍🔬 作者**：Zhongpai Gao, Benjamin Planche, Meng Zheng, Anwesa Choudhuri, Terrence Chen, Ziyan Wu
- **🏫 单位**：United Imaging Intelligence, Boston MA, USA
- **🔗 链接**：[[中英摘要](./abs/2410.04974.md)] [[arXiv:2410.04974](https://arxiv.org/abs/2410.04974)] [Code]
- **📝 说明**：

#### [524] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [525] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [526] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [527] Variational Bayes Gaussian Splatting
...
#### [528] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [529] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [530] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [531] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [532] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [533] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [534] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [535] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [536] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [537] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [538] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [539] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [540] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [541] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [542] RNG: Relightable Neural Gaussians
...
#### [543] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [544] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [545] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [546] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [547] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [548] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [549] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [550] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [551] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [552] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [553] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [554] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [555] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [556] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [557] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [558] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [559] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [560] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [561] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [562] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [563] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [564] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [565] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [566] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [567] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [568] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [569] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [570] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [571] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [572] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [573] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [574] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [575] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [576] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [577] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [578] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [579] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [580] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [581] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [582] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [583] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [584] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [585] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [586] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [587] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [588] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [589] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [590] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [591] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [592] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [593] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [594] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [595] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [596] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [597] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [598] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [599] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [600] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [601] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [602] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [603] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [604] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [605] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [606] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [607] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [608] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [609] OmniRe: Omni Urban Scene Reconstruction
...
#### [610] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [611] G-Style: Stylized Gaussian Splatting
...
#### [612] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [613] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [614] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [615] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [616] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [617] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [618] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [619] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [620] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [621] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [622] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [623] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [624] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [625] Subsurface Scattering for 3D Gaussian Splatting
...
#### [626] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [627] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [628] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [629] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [630] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [631] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [632] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [633] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [634] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [635] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [636] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [637] 3D Gaussian Editing with A Single Image
...
#### [638] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [639] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [640] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [641] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [642] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [643] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [644] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [645] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [646] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [647] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [648] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [649] IG-SLAM: Instant Gaussian SLAM
...
#### [650] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [651] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [652] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [653] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [654] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [655] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [656] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [657] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [658] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [659] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [660] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [661] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [662] Gaussian Splatting Lucas-Kanade
...
#### [663] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [664] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [665] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [666] PICA: Physics-Integrated Clothed Avatar
...
#### [667] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [668] Gaussian Eigen Models for Human Heads
...
#### [670] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [671] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [672] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [673] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [674] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [675] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [676] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [677] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [678] Lightweight Predictive 3D Gaussian Splats
...
#### [679] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [680] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [681] On Scaling Up 3D Gaussian Splatting Training
...
#### [682] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [683] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [684] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [685] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [686] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [687] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [688] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [689] E2GS: Event Enhanced Gaussian Splatting
...
#### [690] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [691] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [692] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [693] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [694] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [695] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [696] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [697] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [698] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [699] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [700] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [701] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [702] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [703] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [704] Generalizable Human Gaussians from Single-View Image
...
#### [705] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [706] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [707] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [708] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [709] Localized Gaussian Point Management
...
#### [710] Gaussian Representation for Deformable Image Registration
...
#### [711] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [712] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [713] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [714] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [715] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [716] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [717] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [718] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [719] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
