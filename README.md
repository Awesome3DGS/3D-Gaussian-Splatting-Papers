...
#### [4] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [5] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [6] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [7] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [8] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
- **🧑‍🔬 作者**：Xingrui Wang, Cuiling Lan, Hanxin Zhu, Zhibo Chen, Yan Lu
...
#### [9] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [10] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [11] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [12] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [13] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [14] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [16] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [17] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [18] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [19] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [20] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [21] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [22] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [23] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [24] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [28] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [29] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [30] EOGS: Gaussian Splatting for Earth Observation
...
#### [31] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [32] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [33] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [34] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [35] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [36] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [37] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [38] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [39] Deformable Radial Kernel Splatting
...
#### [40] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [41] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [42] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [43] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [44] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [45] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [46] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [47] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [48] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [49] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [50] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [51] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [53] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [54] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [55] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [56] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [57] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [58] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [59] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [60] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [61] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [62] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [63] GASP: Gaussian Avatars with Synthetic Priors
...
#### [64] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [65] Faster and Better 3D Splatting via Group Training
...
#### [66] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [67] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [68] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [69] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [70] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [71] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [72] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [73] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [74] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [75] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [76] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [77] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [78] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [79] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [80] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [81] Street Gaussians without 3D Object Tracker
...
#### [82] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [83] Extrapolated Urban View Synthesis Benchmark
...
#### [84] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [85] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [86] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [87] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [88] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [89] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [90] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [91] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [92] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [93] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [94] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [95] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [96] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [97] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [98] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [99] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [100] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [101] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [102] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [103] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [104] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [105] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [106] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [107] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [108] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [109] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [110] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [111] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [112] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [113] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [114] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [115] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [116] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [117] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [118] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [119] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [120] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [121] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [122] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [123] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [124] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [125] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [126] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [127] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [128] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [129] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [130] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [131] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [132] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [133] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [134] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [135] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [136] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [137] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [138] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [139] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [140] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [141] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [142] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [143] Neural Surface Priors for Editable Gaussian Splatting
...
#### [144] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [145] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [146] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [147] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [148] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [149] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [150] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [151] Geometry Field Splatting with Gaussian Surfels
...
#### [152] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [153] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [154] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [155] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [156] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [157] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [158] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [159] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [160] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [161] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [162] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [163] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [164] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [165] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [166] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [167] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [168] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [169] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [170] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [171] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [172] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [173] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [174] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [175] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [176] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [177] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [178] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [179] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [180] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [181] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [182] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [183] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [184] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [185] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [186] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [187] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [188] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [189] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [190] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [191] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [192] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [193] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [194] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [195] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [196] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [197] VeGaS: Video Gaussian Splatting
...
#### [198] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [199] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [200] Efficient Density Control for 3D Gaussian Splatting
...
#### [201] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [202] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [203] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [204] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [205] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [206] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [207] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [208] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [209] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [210] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [211] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [212] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [213] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [214] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [215] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [216] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [217] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [218] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [219] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [220] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [221] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [222] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [223] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [224] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [225] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [226] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [227] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [228] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [229] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [230] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [231] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [232] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [233] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [234] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [235] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [236] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [237] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [238] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [239] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [240] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [241] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [242] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [243] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [244] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [245] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [246] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [247] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [248] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [249] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [250] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [251] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [252] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [253] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [254] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [255] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [256] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [257] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [258] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [259] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [260] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [261] 3D Vision-Language Gaussian Splatting
...
#### [262] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [263] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [264] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [265] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [266] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [267] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [268] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [269] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [270] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [271] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [272] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [273] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [274] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [275] Variational Bayes Gaussian Splatting
...
#### [276] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [277] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [278] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [279] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [280] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [281] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [282] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [283] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [284] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [285] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [286] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [287] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [288] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [289] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [290] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [291] RNG: Relightable Neural Gaussians
...
#### [292] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [293] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [294] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [295] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [296] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [297] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [298] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [299] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [300] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [301] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [302] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [303] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [304] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [305] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [306] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [307] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [308] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [309] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [310] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [311] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [312] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [313] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [314] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [315] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [316] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [317] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [318] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [319] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [320] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [321] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [322] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [323] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [324] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [325] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [326] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [327] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [328] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [329] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [330] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [331] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [332] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [333] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [334] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [335] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [336] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [337] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [338] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [339] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [340] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [341] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [342] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [343] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [344] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [345] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [346] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [347] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [348] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [349] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [350] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [351] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [352] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [353] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [354] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [355] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [356] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [357] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [358] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [359] OmniRe: Omni Urban Scene Reconstruction
...
#### [360] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [361] G-Style: Stylized Gaussian Splatting
...
#### [362] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [363] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [364] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [365] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [366] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [367] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [368] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [369] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [370] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [371] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [372] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [373] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [374] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [375] Subsurface Scattering for 3D Gaussian Splatting
...
#### [376] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [377] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [378] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [379] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [380] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [381] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [382] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [383] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [384] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [385] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [386] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [387] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [388] 3D Gaussian Editing with A Single Image
...
#### [389] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [390] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [391] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [392] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [393] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [394] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [395] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [396] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [397] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [398] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [399] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [400] IG-SLAM: Instant Gaussian SLAM
...
#### [401] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [402] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [403] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [404] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [405] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [406] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [407] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [408] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [409] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [410] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [411] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [412] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [413] Gaussian Splatting Lucas-Kanade
...
#### [414] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [415] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [416] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [417] PICA: Physics-Integrated Clothed Avatar
...
#### [418] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [419] Gaussian Eigen Models for Human Heads
...
#### [421] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [422] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [423] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [424] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [425] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [426] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [427] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [428] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [429] Lightweight Predictive 3D Gaussian Splats
...
#### [430] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [431] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [432] On Scaling Up 3D Gaussian Splatting Training
...
#### [433] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [434] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [435] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [436] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [437] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [438] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [439] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [440] E2GS: Event Enhanced Gaussian Splatting
...
#### [441] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [442] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [443] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [444] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [445] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [446] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [447] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [448] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [449] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [450] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [451] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [452] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [453] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [454] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [455] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [456] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [457] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [458] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [459] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [460] Generalizable Human Gaussians from Single-View Image
...
#### [461] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [462] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [463] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [464] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [465] Localized Gaussian Point Management
...
#### [466] Gaussian Representation for Deformable Image Registration
...
#### [467] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [468] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [469] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [470] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [471] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [472] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [473] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [474] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [475] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [476] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
