...
#### [8] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [9] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [10] SparseGS: Real-Time 360° Sparse View Synthesis using Gaussian Splatting
...
#### [11] MD-Splatting: Learning Metric Deformation from 4D Gaussians in Highly Deformable Scenes
...
#### [12] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [14] GaussianHead: Impressive 3D Gaussian-based Head Avatars with Dynamic Hybrid Neural Field
...
#### [15] MonoGaussianAvatar: Monocular Gaussian Point-based Head Avatar
...
#### [16] EAGLES: Efficient Accelerated 3D Gaussians with Lightweight EncodingS
...
#### [17] GIR: 3D Gaussian Inverse Rendering for Relightable Scene Factorization
...
#### [18] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [19] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [20] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [21] GauFRe: Gaussian Deformation Fields for Real-time Dynamic Novel View Synthesis
...
#### [22] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [23] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [24] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [25] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [26] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [27] 2D-Guided 3D Gaussian Segmentation
...
#### [28] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [29] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [30] FMGS: Foundation Model Embedded 3D Gaussian Splatting for Holistic 3D Scene Understanding
...
#### [31] PEGASUS: Physically Enhanced Gaussian Splatting Simulation System for 6DOF Object Pose Dataset Generation
...
#### [32] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
...
#### [33] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [34] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [35] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [36] TRIPS: Trilinear Point Splatting for Real-Time Radiance Field Rendering
...
#### [37] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [38] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [39] EndoGaussian: Gaussian Splatting for Deformable Surgical Scene Reconstruction
...
#### [40] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [41] LIV-GaussMap: LiDAR-Inertial-Visual Fusion for Real-time 3D Radiance Field Map Rendering
...
#### [42] Gaussian Splashing: Dynamic Fluid Synthesis with Gaussian Splatting
...
#### [43] Endo-4DGS: Distilling Depth Ranking for Endoscopic Monocular Scene Reconstruction with 4D Gaussian Splatting
...
#### [44] Segment Anything in 3D Gaussians
...
#### [45] On the Error Analysis of 3D Gaussian Splatting and an Optimal Projection Strategy
...
#### [46] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [47] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [48] SGS-SLAM: Semantic Gaussian Splatting For Neural Dense SLAM
...
#### [49] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [50] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [51] GaussianObject: Just Taking Four Images to Get A High-Quality 3D Object with Gaussian Splatting
...
#### [52] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [53] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
- **🧑‍🔬 作者**：Joongho Jo, Hyeongwon Kim, Jongsun Park
- **🏫 单位**：Korea University
- **🔗 链接**：[[中英摘要](./abs/2402.13827.md)] [[arXiv:2402.13827](https://arxiv.org/abs/2402.13827)] [Code]
- **📝 说明**：✏️

#### [54] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [55] 3D Gaussian Model for Animation and Texturing
...
#### [56] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [57] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [58] SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM
...
#### [59] StyleGaussian: Instant 3D Style Transfer with Gaussian Splatting
...
#### [60] ManiGaussian: Dynamic Gaussian Splatting for Multi-task Robotic Manipulation
...
#### [61] Gaussian Splatting in Style
...
#### [62] A New Split Algorithm for 3D Gaussian Splatting
...
#### [63] Hyper-3DG: Text-to-3D Gaussian Generation via Hypergraph
...
#### [65] GaussianGrasper: 3D Language Gaussian Splatting for Open-vocabulary Robotic Grasping
...
#### [66] Touch-GS: Visual-Tactile Supervised 3D Gaussian Splatting
...
#### [67] Controllable Text-to-3D Generation via Surface-Aligned Gaussian Splatting
...
#### [68] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [69] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [70] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [71] GS-Pose: Cascaded Framework for Generalizable Segmentation-based 6D Object Pose Estimation
...
#### [72] DarkGS: Learning Neural Illumination and 3D Gaussians Relighting for Robotic Exploration in the Dark
...
#### [73] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [74] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [75] 3DGS-ReLoc: 3D Gaussian Splatting for Map Representation and Visual ReLocalization
...
#### [76] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [77] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [78] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [79] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [80] 3DGS-Calib: 3D Gaussian Splatting for Multimodal SpatioTemporal Calibration
...
#### [81] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [82] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [83] NEDS-SLAM: A Novel Neural Explicit Dense Semantic SLAM Framework using 3D Gaussian Splatting
...
#### [84] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [85] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [86] High-Fidelity SLAM Using Gaussian Splatting with Rendering-Guided Densification and Regularized Optimization
...
#### [88] RadSplat: Radiance Field-Informed Gaussian Splatting for Robust Real-Time Rendering with 900+ FPS
...
#### [89] Isotropic Gaussian Splatting for Real-Time Radiance Field Rendering
...
#### [90] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [91] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [92] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [93] Gaussian in the Wild: 3D Gaussian Splatting for Unconstrained Image Collections
...
#### [94] GSDF: 3DGS Meets SDF for Improved Rendering and Reconstruction
...
#### [95] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [96] DN-Splatter: Depth and Normal Priors for Gaussian Splatting and Meshing
...
#### [97] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [98] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [99] Modeling uncertainty for Gaussian Splatting
...
#### [100] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [101] Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction
...
#### [102] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [103] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [104] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [105] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [106] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [107] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [108] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [109] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [110] MM3DGS SLAM: Multi-modal 3D Gaussian Splatting for SLAM Using Vision, Depth, and Inertial Measurements
...
#### [111] Mirror-3DGS: Incorporating Mirror Reflections into 3D Gaussian Splatting
...
#### [112] Feature Splatting: Language-Driven Physics-Based Scene Synthesis and Editing
...
#### [113] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [114] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [115] OmniGS: Omnidirectional Gaussian Splatting for Fast Radiance Field Reconstruction using Omnidirectional Images
...
#### [117] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [118] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [119] Dual-Camera Smooth Zoom on Mobile Phones
...
#### [120] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [121] Revising Densification in Gaussian Splatting
...
#### [122] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [123] Gaussian-LIC: Photo-realistic LiDAR-Inertial-Camera SLAM with 3D Gaussian Splatting
...
#### [124] RealmDreamer: Text-Driven 3D Scene Generation with Inpainting and Depth Diffusion
...
#### [125] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [126] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [127] LoopGaussian: Creating 3D Cinemagraph with Multi-view Images via Eulerian Motion Field
...
#### [128] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [129] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [130] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [131] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [132] LetsGo: Large-Scale Garage Modeling and Rendering via LiDAR-Assisted Gaussian Primitives
...
#### [133] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [134] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [135] Gaussian Opacity Fields: Efficient and Compact Surface Reconstruction in Unbounded Scenes
...
#### [136] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [137] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [138] Dynamic Gaussians Mesh: Consistent Mesh Reconstruction from Monocular Videos
...
#### [139] Does Gaussian Splatting need SFM Initialization?
...
#### [140] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [141] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [142] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [143] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [144] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [145] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [146] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [147] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [148] 3D Gaussian Splatting with Deferred Reflection
...
#### [149] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [150] MeGA: Hybrid Mesh-Gaussian Head Avatar for High-Fidelity Rendering and Head Editing
...
#### [151] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [152] SAGS: Structure-Aware 3D Gaussian Splatting
...
#### [153] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [154] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [155] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [156] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [157] HoloGS: Instant Depth-based 3D Gaussian Splatting with Microsoft HoloLens 2
...
#### [158] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [159] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [160] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2405.05446.md)] [[arXiv:2405.05446](https://arxiv.org/abs/2405.05446)] [Code]
- **📝 说明**：✏️

#### [161] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [162] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [163] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [164] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06547.md)] [[arXiv:2405.06547](https://arxiv.org/abs/2405.06547)] [[Code](https://github.com/lin-jinwei/OneTo3D)]
- **📝 说明**：✏️

#### [165] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [166] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [167] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [168] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [169] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [170] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [172] AtomGS: Atomizing Gaussian Splatting for High-Fidelity Radiance Field
...
#### [173] GarmentDreamer: 3DGS Guided Garment Synthesis with Diverse Geometry and Texture Details
...
#### [174] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [175] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [176] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [177] Gaussian Time Machine: A Real-Time Rendering Methodology for Time-Variant Appearances
...
#### [178] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [179] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [180] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [181] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [182] HDR-GS: Efficient High Dynamic Range Novel View Synthesis at 1000x Speed via Gaussian Splatting
...
#### [183] DisC-GS: Discontinuity-aware Gaussian Splatting
...
#### [184] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [185] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [186] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [187] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [188] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [189] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [190] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [191] F-3DGS: Factorized Coordinates and Representations for 3D Gaussian Splatting
...
#### [192] Memorize What Matters: Emergent Scene Decomposition from Multitraverse
...
#### [193] DOF-GS: Adjustable Depth-of-Field 3D Gaussian Splatting for Refocusing,Defocus Rendering and Blur Removal
...
#### [194] GOI: Find 3D Gaussians of Interest with an Optimizable Open-vocabulary Semantic-space Hyperplane
...
#### [195] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
...
#### [196] Mani-GS: Gaussian Splatting Manipulation with Triangular Mesh
...
#### [197] HFGS: 4D Gaussian Splatting with Emphasis on Spatial and Temporal High-Frequency Components for Endoscopic Scene Reconstruction
...
#### [198] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [199] FreeSplat: Generalizable 3D Gaussian Splatting Towards Free-View Synthesis of Indoor Scenes
...
#### [200] RT-GS2: Real-Time Generalizable Semantic Segmentation for 3D Gaussian Representations of Radiance Fields
...
#### [201] EG4D: Explicit Generation of 4D Object without Score Distillation
...
#### [202] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [203] NegGS: Negative Gaussian Splatting
...
#### [204] 3D StreetUnveiler with Semantic-Aware 2DGS
...
#### [205] 3DitScene: Editing Any Scene via Language-guided Disentangled Gaussian Splatting
...
#### [206] GFlow: Recovering 4D World from Monocular Video
...
#### [207] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [208] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [209] DGD: Dynamic 3D Gaussians Distillation
...
#### [210] NPGA: Neural Parametric Gaussian Avatars
...
#### [211] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [212] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [213] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [214] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [215] Object-centric Reconstruction and Tracking of Dynamic Unknown Objects using 3D Gaussian Splatting
...
#### [216] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [217] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [218] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [219] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [220] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
