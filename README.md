...
#### [1] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [2] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [3] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [4] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [5] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [6] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [8] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [9] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [10] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [11] Vista3D: Unravel the 3D Darkside of a Single Image
...
#### [12] SRIF: Semantic Shape Registration Empowered by Diffusion-based Image Morphing and Flow Estimation
...
#### [14] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [15] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [16] SplatFields: Neural Gaussian Splats for Sparse 3D and 4D Reconstruction
...
#### [17] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [18] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [19] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [20] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [21] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [22] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [23] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [24] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [25] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [26] AdR-Gaussian: Accelerating Gaussian Splatting with Adaptive Radius
...
#### [27] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [29] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [30] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [31] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [33] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [34] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [35] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [36] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [37] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [38] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [39] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [40] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [41] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [42] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [43] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [44] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [45] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [46] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [47] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [48] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [49] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [50] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [51] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [52] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [53] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [54] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [55] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [56] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [57] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [58] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [60] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [61] OmniRe: Omni Urban Scene Reconstruction
...
#### [62] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [63] G-Style: Stylized Gaussian Splatting
...
#### [64] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [65] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [66] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [67] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [68] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [69] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [70] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [71] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [72] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [73] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [74] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [75] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [76] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [77] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [78] Subsurface Scattering for 3D Gaussian Splatting
...
#### [79] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [80] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [81] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [82] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [83] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [84] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [85] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [86] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [87] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [88] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [89] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [90] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [91] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [92] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [93] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [94] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [95] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [96] 3D Gaussian Editing with A Single Image
...
#### [97] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [98] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [99] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [100] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [101] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [102] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [103] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [104] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [105] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [106] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [107] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [108] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [109] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [110] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [111] IG-SLAM: Instant Gaussian SLAM
...
#### [112] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [113] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [114] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [115] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [116] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [117] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [118] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [119] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [120] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [121] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [122] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [123] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [124] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [125] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [126] Gaussian Splatting Lucas-Kanade
...
#### [127] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [128] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [129] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [130] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [131] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [132] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [133] PICA: Physics-Integrated Clothed Avatar
...
#### [134] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [135] Gaussian Eigen Models for Human Heads
...
#### [137] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [138] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [139] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [140] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [141] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [142] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [143] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [144] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [145] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [146] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [147] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [148] Lightweight Predictive 3D Gaussian Splats
...
#### [149] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [150] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [151] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [152] On Scaling Up 3D Gaussian Splatting Training
...
#### [153] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [154] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [155] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [156] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [157] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [158] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [159] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [160] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [161] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [162] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [163] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [164] E2GS: Event Enhanced Gaussian Splatting
...
#### [165] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [166] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [167] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [168] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [169] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [170] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [171] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [172] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [173] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [174] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [175] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [176] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [177] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [178] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [179] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [180] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [181] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [182] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [183] From Chaos to Clarity: 3DGS in the Dark
...
#### [184] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [185] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [186] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [187] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [188] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [189] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [190] Generalizable Human Gaussians from Single-View Image
...
#### [191] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [192] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [193] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [194] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [195] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [196] Localized Gaussian Point Management
...
#### [197] Gaussian Representation for Deformable Image Registration
...
#### [198] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [199] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [200] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [201] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [202] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [203] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [204] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [205] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [206] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [207] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [208] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [209] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [210] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [211] Tetrahedron Splatting for 3D Generation
...
#### [212] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [213] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [214] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [215] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
