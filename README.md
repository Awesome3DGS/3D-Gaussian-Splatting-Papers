...
#### [1] DC4GS: Directional Consistency-Driven Adaptive Density Control for 3D Gaussian Splatting
...
#### [2] HEIR: Learning Graph-Based Motion Hierarchies
...
#### [3] AgriGS-SLAM: Orchard Mapping Across Seasons via Multi-View Gaussian Splatting SLAM
...
#### [4] 6D Channel Knowledge Map Construction via Bidirectional Wireless Gaussian Splatting
...
#### [6] Learning Disentangled Speech- and Expression-Driven Blendshapes for 3D Talking Face Animation
...
#### [7] EA3D: Online Open-World 3D Object Extraction from Streaming Videos
...
#### [8] AtlasGS: Atlanta-world Guided Surface Reconstruction with Implicit Structured Gaussians
...
#### [9] DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes
...
#### [10] NVSim: Novel View Synthesis Simulator for Large Scale Indoor Navigation
...
#### [11] LagMemo: Language 3D Gaussian Splatting Memory for Multi-modal Open-vocabulary Multi-goal Visual Navigation
...
#### [12] PlanarGS: High-Fidelity Indoor 3D Gaussian Splatting Guided by Vision-Language Planar Priors
...
#### [13] Explicit Memory through Online 3D Gaussian Splatting Improves Class-Agnostic Video Segmentation
...
#### [14] VR-Drive: Viewpoint-Robust End-to-End Driving with Feed-Forward 3D Gaussian Splatting
...
#### [15] EndoWave: Rational-Wavelet 4D Gaussian Splatting for Endoscopic Reconstruction
...
#### [16] Gen-LangSplat: Generalized Language Gaussian Splatting with Pre-Trained Feature Compression
- **🧑‍🔬 作者**：Pranav Saxena
...
#### [17] Region-Adaptive Learned Hierarchical Encoding for 3D Gaussian Splatting Data
...
#### [18] LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering
...
#### [19] RoGER-SLAM: A Robust Gaussian Splatting SLAM System for Noisy and Low-light Environment Resilience
...
#### [20] DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss
...
#### [21] DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum
...
#### [22] STG-Avatar: Animatable Human Avatars via Spacetime Gaussian
...
#### [23] Towards Physically Executable 3D Gaussian for Embodied Navigation
...
#### [24] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
#### [26] COS3D: Collaborative Open-Vocabulary 3D Segmentation
...
#### [27] Extreme Views: 3DGS Filter for Novel View Synthesis from Out-of-Distribution Camera Poses
...
#### [28] Re-Activating Frozen Primitives for 3D Gaussian Splatting
...
#### [29] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [30] GRASPLAT: Enabling dexterous grasping through novel view synthesis
...
#### [31] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [32] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [33] From Volume Rendering to 3D Gaussian Splatting: Theory and Applications
...
#### [34] HouseTour: A Virtual Real Estate A(I)gent
...
#### [35] InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation
...
#### [36] Botany-Bot: Digital Twin Monitoring of Occluded and Underleaf Plant Structures with Gaussian Splats
...
#### [38] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [39] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [40] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [41] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [42] HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars
...
#### [43] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [44] Fix False Transparency by Noise Guided Splatting
...
#### [45] PFGS: Pose-Fused 3D Gaussian Splatting for Complete Multi-Pose Object Reconstruction
...
#### [46] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [48] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [49] Terra: Explorable Native 3D World Model with Point Latents
...
#### [50] Leveraging Learned Image Prior for 3D Gaussian Compression
...
#### [51] BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU
...
#### [52] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [53] Virtually Being: Customizing Camera-Controllable Video Diffusion Models with Multi-View Performance Captures
...
#### [54] Capture, Canonicalize, Splat: Zero-Shot 3D Gaussian Avatars from Unstructured Phone Images
...
#### [55] Instant Skinned Gaussian Avatars for Web, Mobile and VR Applications
...
#### [56] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [57] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [58] Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering
...
#### [59] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [60] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [61] BSGS: Bi-stage 3D Gaussian Splatting for Camera Motion Deblurring
...
#### [62] Hybrid Gaussian Splatting for Novel Urban View Synthesis
...
#### [64] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [65] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [67] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [68] Ev4DGS: Novel-view Rendering of Non-Rigid Objects from Monocular Event Streams
...
#### [69] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [70] VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment
...
#### [71] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [72] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [73] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [74] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [75] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [76] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [77] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [78] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [79] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [80] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [81] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [82] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [83] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [84] EGSTalker: Real-Time Audio-Driven Talking Head Generation with Efficient Gaussian Deformation
...
#### [85] ReSplat: Learning Recurrent Gaussian Splats
...
#### [86] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [87] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [88] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [89] Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting
...
#### [90] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [91] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [92] DEGS: Deformable Event-based 3D Gaussian Splatting from RGB and Event Stream
...
#### [93] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [94] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [95] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [96] SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis
...
#### [97] RTGS: Real-Time 3D Gaussian Splatting SLAM via Multi-Level Redundancy Reduction
...
#### [98] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [99] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [100] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [102] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [103] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [104] StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions
...
#### [105] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [106] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [107] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [108] MPMAvatar: Learning 3D Gaussian Avatars with Accurate and Robust Physics-Based Dynamics
...
#### [109] HART: Human Aligned Reconstruction Transformer
...
#### [110] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [111] GaussEdit: Adaptive 3D Scene Editing with Text and Image Prompts
...
#### [112] PFDepth: Heterogeneous Pinhole-Fisheye Joint Depth Estimation via Distortion-aware Gaussian-Splatted Volumetric Fusion
...
#### [113] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [114] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [115] PAD3R: Pose-Aware Dynamic 3D Reconstruction from Casual Videos
...
#### [116] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [117] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [118] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [119] LVT: Large-Scale Scene Reconstruction via Local View Transformers
...
#### [120] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [121] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [122] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [123] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [124] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [125] Orientation-anchored Hyper-Gaussian for 4D Reconstruction from Casual Videos
...
#### [126] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [127] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [128] Learning Unified Representation of 3D Gaussian Splatting
...
#### [129] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [130] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [131] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [132] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [133] Large Material Gaussian Model for Relightable 3D Generation
...
#### [134] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [135] PowerGS: Display-Rendering Power Co-Optimization for Neural Rendering in Power-Constrained XR Systems
...
#### [136] SeHDR: Single-Exposure HDR Novel View Synthesis via 3D Gaussian Bracketing
...
#### [137] 4D Driving Scene Generation With Stereo Forcing
...
#### [138] PU-Gaussian: Point Cloud Upsampling using 3D Gaussian Representation
...
#### [139] GS-RoadPatching: Inpainting Gaussians via 3D Searching and Placing for Driving Scenes
...
#### [140] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [141] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [142] PolGS: Polarimetric Gaussian Splatting for Fast Reflective Surface Reconstruction
...
#### [143] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [144] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [145] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [146] Seeing Through Reflections: Advancing 3D Scene Reconstruction in Mirror-Containing Environments with Gaussian Splatting
...
#### [147] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [148] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [149] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [150] BridgeSplat: Bidirectionally Coupled CT and Non-Rigid Gaussian Splatting for Deformable Intraoperative Surgical Navigation
...
#### [151] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [152] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [153] EmbodiedSplat: Personalized Real-to-Sim-to-Real Navigation with Gaussian Splats from a Mobile Device
...
#### [154] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [155] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [156] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [157] HyRF: Hybrid Radiance Fields for Memory-efficient and High-quality Novel View Synthesis
...
#### [158] Efficient 3D Scene Reconstruction and Simulation from Sparse Endoscopic Views
- **🧑‍🔬 作者**：Zhenya Yang
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.17027.md)] [[arXiv:2509.17027](https://arxiv.org/abs/2509.17027)] [Code]
- **📝 说明**:

#### [159] SemanticGarment: Semantic-Controlled Generation and Editing of 3D Gaussian Garments
...
#### [160] PGSTalker: Real-Time Audio-Driven Talking Head Generation via 3D Gaussian Splatting with Pixel-Aware Density Control
- **🧑‍🔬 作者**：Tianheng Zhu, Yinfeng Yu, Liejun Wang, Fuchun Sun, Wendong Zheng
- **🏫 单位**：Xinjiang University ⟐ Tsinghua University ⟐ Tianjin University of Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16922.md)] [[arXiv:2509.16922](https://arxiv.org/abs/2509.16922)] [Code]
- **📝 说明**: 🏆 Accepted to ICONIP 2025

#### [161] ConfidentSplat: Confidence-Weighted Depth Fusion for Accurate 3D Gaussian Splatting SLAM
...
#### [162] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [163] SQS: Enhancing Sparse Perception Models via Query-based Splatting in Autonomous Driving
...
#### [164] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
- **🧑‍🔬 作者**：Xiaoyang Yan, Muleilan Pei, Shaojie Shen
- **🏫 单位**：The Hong Kong University of Science and Technology
- **🔗 链接**：[[中英摘要](./abs/2509.16552.md)] [[arXiv:2509.16552](https://arxiv.org/abs/2509.16552)] [Code]
- **📝 说明**:

#### [165] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [166] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [167] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [168] Camera Splatting for Continuous View Optimization
...
#### [169] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [170] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [171] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [172] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [173] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [174] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [175] Perception-Integrated Safety Critical Control via Analytic Collision Cone Barrier Functions on 3D Gaussian Splatting
...
#### [176] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [177] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [178] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [179] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [180] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [181] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [182] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [183] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [184] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [185] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [186] A Controllable 3D Deepfake Generation Framework with Gaussian Splatting
...
#### [187] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [188] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [189] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [190] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [191] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [192] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [193] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [194] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [195] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [196] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [197] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [198] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [199] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [200] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [201] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [202] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [203] FGO-SLAM: Enhancing Gaussian SLAM with Globally Consistent Opacity Radiance Field
...
#### [204] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [205] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [206] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [207] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [208] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [209] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [210] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [211] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [212] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [213] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [214] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [215] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [216] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [217] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
- **🧑‍🔬 作者**：Qun Ji, Peng Li, Mingqiang Wei
- **🏫 单位**：Nanjing University of Aeronautics and Astronautics
- **🔗 链接**：[[中英摘要](./abs/2508.18696.md)] [[arXiv:2508.18696](https://arxiv.org/abs/2508.18696)] [Code]
- **📝 说明**:

#### [218] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [219] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [220] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [221] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [222] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [223] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [224] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [225] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [226] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [227] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [228] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [229] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [230] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [231] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [232] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [233] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [234] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [235] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [236] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [237] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [238] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [239] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [240] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [241] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [242] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [243] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [244] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [245] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [246] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [247] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [248] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [249] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [250] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [251] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [252] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [253] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [254] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [255] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [256] SAGOnline: Segment Any Gaussians Online
...
#### [257] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [258] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [259] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [260] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [261] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [262] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [263] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [264] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [265] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [266] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [267] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [268] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [269] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [270] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [271] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [272] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [273] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [274] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [275] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [276] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [277] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [278] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [279] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [280] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [281] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [282] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [283] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [284] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [285] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [286] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [287] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [288] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [289] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [290] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [291] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [292] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [293] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [294] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [295] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [296] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [297] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [298] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [299] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [300] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [301] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [302] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [303] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [304] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [305] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [306] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [307] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [308] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [309] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [310] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [311] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [312] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [313] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [314] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [315] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [316] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [317] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [318] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [319] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [320] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [321] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [322] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [323] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [324] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [325] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [326] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [327] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [328] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [329] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [330] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [331] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [332] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [333] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [334] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
