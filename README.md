...
#### [1] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [2] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [3] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [4] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [8] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [9] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [10] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [11] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [12] Gaussian Splatting Lucas-Kanade
...
#### [13] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [14] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [15] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [16] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [17] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [19] PICA: Physics-Integrated Clothed Avatar
...
#### [20] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [21] Gaussian Eigen Models for Human Heads
...
#### [23] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [24] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [26] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [27] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [28] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [29] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [30] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [31] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [32] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [33] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [34] Lightweight Predictive 3D Gaussian Splats
...
#### [35] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [36] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [37] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [38] On Scaling Up 3D Gaussian Splatting Training
...
#### [39] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [40] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [41] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [42] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [43] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [44] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [45] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [46] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [47] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [48] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [49] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [50] E2GS: Event Enhanced Gaussian Splatting
...
#### [51] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [52] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [53] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [54] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [55] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [56] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [57] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [58] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [59] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [60] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [61] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [62] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [63] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [64] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [65] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [66] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [67] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [68] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [69] From Chaos to Clarity: 3DGS in the Dark
...
#### [70] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [71] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [72] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [73] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [74] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [75] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [76] Generalizable Human Gaussians from Single-View Image
...
#### [77] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [78] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [79] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [80] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [81] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [82] Localized Gaussian Point Management
...
#### [83] Gaussian Representation for Deformable Image Registration
...
#### [84] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [85] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [86] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [87] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [88] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [89] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [90] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [91] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [92] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [93] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [94] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [95] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [96] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [97] Tetrahedron Splatting for 3D Generation
...
#### [98] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [99] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [100] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [101] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
