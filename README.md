...
- **归档时间**
  ...
  - [[2024/07/01](./archive/202407.md)] (183 篇)
    [[2024/10/01](./archive/202410.md)] (106 篇)
    [[2025/01/01](./archive/202501.md)] (223 篇)
    [[2025/04/01](./archive/202501.md)] (235 篇)
...
#### [2] Roll Your Eyes: Gaze Redirection via Explicit 3D Eyeball Rotation
...
#### [3] ExploreGS: Explorable 3D Scene Reconstruction with Virtual Camera Samplings and Diffusion Priors
...
#### [4] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [5] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [6] GAP: Gaussianize Any Point Clouds with Text Guidance
...
#### [7] 3DGabSplat: 3D Gabor Splatting for Frequency-adaptive Radiance Field Rendering
...
#### [8] CF3: Compact and Fast 3D Feature Fields
...
#### [9] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [10] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [11] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [15] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [16] MuGS: Multi-Baseline Generalizable Gaussian Splatting Reconstruction
...
#### [17] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [18] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [19] Bridging Diffusion Models and 3D Representations: A 3D Consistent Super-Resolution Framework
...
#### [20] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [21] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [22] Trace3D: Consistent Segmentation Lifting via Gaussian Instance Tracing
...
#### [23] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [24] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [25] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [26] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [27] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [28] Low-Frequency First: Eliminating Floating Artifacts in 3D Gaussian Splatting
...
#### [29] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [30] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [31] GaussianCross: Cross-modal Self-supervised 3D Representation Learning via Gaussian Splatting
...
#### [32] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [33] LT-Gaussian: Long-Term Map Update Using 3D Gaussian Splatting for Autonomous Driving
...
#### [34] Can3Tok: Canonical 3D Tokenization and Latent Modeling of Scene-Level 3D Gaussians
...
#### [35] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [36] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [37] No Pose at All: Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [38] OpenGS-Fusion: Open-Vocabulary Dense Mapping with Hybrid 3D Gaussian Splatting for Refined Object-Level Understanding
...
#### [39] IGL-Nav: Incremental 3D Gaussian Localization for Image-goal Navigation
...
#### [40] Omni-Scan: Creating Visually-Accurate Digital Twin Object Models Using a Bimanual Robot with Handover and Gaussian Splat Merging
...
#### [41] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [42] Gaussian Variation Field Diffusion for High-fidelity Video-to-4D Synthesis
...
#### [43] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [44] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [46] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [47] MoGA: 3D Generative Avatar Prior for Monocular Gaussian Avatar Reconstruction
...
#### [48] Gaussian Splatting Feature Fields for Privacy-Preserving Visual Localization
...
#### [49] NeRF Is a Valuable Assistant for 3D Gaussian Splatting
...
#### [50] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [51] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [52] Robust and Efficient 3D Gaussian Splatting for Urban Scene Reconstruction
...
#### [53] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [54] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [55] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [56] GaRe: Relightable 3D Gaussian Splatting for Outdoor Scenes from Unconstrained Photo Collections
...
#### [57] Automated 3D-GS Registration and Fusion via Skeleton Alignment and Gaussian-Adaptive Features
...
#### [58] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [59] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
...
#### [60] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [61] SonicGauss: Position-Aware Physical Sound Synthesis for 3D Gaussian Representations
...
#### [62] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
...
#### [63] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [64] HairCUP: Hair Compositional Universal Prior for 3D Gaussian Avatars
...
#### [65] DASH: 4D Hash Encoding with Self-Supervised Decomposition for Real-Time Dynamic Scene Rendering
...
#### [66] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [67] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [68] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [69] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [70] CRUISE: Cooperative Reconstruction and Editing in V2X Scenarios using Gaussian Splatting
...
#### [71] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [72] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [73] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [74] GeoAvatar: Adaptive Geometrical Gaussian Splatting for 3D Head Avatar
...
#### [75] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [76] Temporal Smoothness-Aware Rate-Distortion Optimized 4D Gaussian Splatting
...
#### [77] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [78] Dyna3DGR: 4D Cardiac Motion Tracking with Dynamic 3D Gaussian Representation
...
#### [79] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [80] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [81] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [82] DWTGS: Rethinking Frequency Regularization for Sparse-view 3D Gaussian Splatting
...
#### [83] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [84] Gaussian Splatting with Discretized SDF for Relightable Assets
...
#### [85] SurfaceSplat: Connecting Surface Reconstruction and Gaussian Splatting
...
#### [86] ObjectGS: Object-aware Scene Reconstruction and Scene Understanding via Gaussian Splatting
...
#### [87] Stereo-GS: Multi-View Stereo Vision Model for Generalizable 3D Gaussian Splatting Reconstruction
...
#### [88] DCHM: Depth-Consistent Human Modeling for Multiview Detection
...
#### [89] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [90] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [91] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
- **📝 说明**: Extended version of ECCV 2024 paper DreamScene

#### [92] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [93] TexGS-VolVis: Expressive Scene Editing for Volume Visualization via Textured Gaussian Splatting
...
#### [94] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [95] NLI4VolVis: Natural Language Interaction for Volume Visualization via LLM Multi-Agents and Editable 3D Gaussian Splatting
...
#### [96] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [97] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [98] SGLoc: Semantic Localization System for Camera Pose Estimation from 3D Gaussian Splatting Representation
...
#### [99] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [101] TRAN-D: 2D Gaussian Splatting-based Sparse-view Transparent Object Depth Reconstruction via Physics Simulation for Scene Update
...
#### [102] Robust 3D-Masked Part-level Editing in 3D Gaussian Splatting with Regularized Score Distillation Sampling
...
#### [103] ScaffoldAvatar: High-Fidelity Gaussian Avatars with Patch Expressions
...
#### [104] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [105] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [106] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [107] Occlusion-Aware Temporally Consistent Amodal Completion for 3D Human-Object Interaction Reconstruction
...
#### [108] RegGS: Unposed Sparse Views Gaussian Splatting with 3DGS Registration
...
#### [109] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [110] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [111] Seg-Wild: Interactive Segmentation based on 3D Gaussian Splatting for Unconstrained Image Collections
...
#### [112] LangSplatV2: High-dimensional 3D Language Gaussian Splatting with 450+ FPS
...
#### [113] FlexGaussian: Flexible and Cost-Effective Training-Free Compression for 3D Gaussian Splatting
...
#### [114] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [115] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [116] VisualSpeaker: Visually-Guided 3D Avatar Lip Synthesis
...
#### [117] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [118] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [119] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [120] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [121] A3FR: Agile 3D Gaussian Splatting with Incremental Gaze Tracked Foveated Rendering in Virtual Reality
...
#### [122] Gaussian-LIC2: LiDAR-Inertial-Camera Gaussian Splatting SLAM
...
#### [123] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [124] Outdoor Monocular SLAM with Global Scale-Consistent 3D Gaussian Pointmaps
...
#### [125] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [126] ArtGS:3D Gaussian Splatting for Interactive Visual-Physical Modeling and Manipulation of Articulated Objects
...
#### [127] Reconstructing Close Human Interaction with Appearance and Proxemics Reasoning
...
#### [128] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [129] LocalDyGS: Multi-view Global Dynamic Scene Modeling via Adaptive Local Implicit Feature Decoupling
...
#### [130] Gbake: Baking 3D Gaussian Splats into Reflection Probes
...
#### [131] 3D Gaussian Splatting Driven Multi-View Robust Physical Adversarial Camouflage Generation
...
#### [132] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [134] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [135] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [136] Learning Dense Feature Matching via Lifting Single 2D Image to 3D Space
...
#### [137] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
- **🧑‍🔬 作者**：Xingjun Wang, Lianlei Shan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2507.00363.md)] [[arXiv:2507.00363](https://arxiv.org/abs/2507.00363)] [Code]
- **📝 说明**:

#### [138] MILo: Mesh-In-the-Loop Gaussian Splatting for Detailed and Efficient Surface Reconstruction
...
#### [139] GaVS: 3D-Grounded Video Stabilization via Temporally-Consistent Local Reconstruction and Rendering
...
#### [140] AttentionGS: Towards Initialization-Free 3D Gaussian Splatting via Structural Attention
...
#### [141] SurgTPGS: Semantic 3D Surgical Scene Understanding with Text Promptable Gaussian Splatting
...
#### [142] Endo-4DGX: Robust Endoscopic Scene Reconstruction and Illumination Correction with Gaussian Splatting
...
#### [143] TVG-SLAM: Robust Gaussian Splatting SLAM with Tri-view Geometric Constraints
...
#### [144] From Coarse to Fine: Learnable Discrete Wavelet Transforms for Efficient 3D Gaussian Splatting
...
#### [145] Confident Splatting: Confidence-Based Compression of 3D Gaussian Splatting via Learnable Beta Distributions
...
#### [146] RGE-GS: Reward-Guided Expansive Driving Scene Reconstruction via Diffusion Priors
...
#### [147] VoteSplat: Hough Voting Gaussian Splatting for 3D Scene Understanding
...
#### [148] RoboPearls: Editable Video Simulation for Robot Manipulation
...
#### [149] Part Segmentation and Motion Estimation for Articulated Objects with Dynamic 3D Gaussians
...
#### [150] DIGS: Dynamic CBCT Reconstruction using Deformation-Informed 4D Gaussian Splatting and a Low-Rank Free-Form Deformation Model
...
#### [151] Few-Shot Identity Adaptation for 3D Talking Heads via Global Gaussian Field
...
#### [152] SAR-GS: 3D Gaussian Splatting for Synthetic Aperture Radar Target Reconstruction
...
#### [153] ICP-3DGS: SfM-free 3D Gaussian Splatting for Large-scale Unbounded Scenes
...
#### [154] MADrive: Memory-Augmented Driving Scene Modeling
...
#### [155] GGTalker: Talking Head Systhesis with Generalizable Gaussian Priors and Identity-Specific Adaptation
...
#### [156] EndoFlow-SLAM: Real-Time Endoscopic SLAM with Flow-Constrained Gaussian Splatting
...
#### [157] Curve-Aware Gaussian Splatting for 3D Parametric Curve Reconstruction
...
#### [158] Geometry and Perception Guided Gaussians for Multiview-consistent 3D Generation from a Single Image
...
#### [159] CL-Splats: Continual Learning of Gaussian Splatting with Local Optimization
...
#### [160] DBMovi-GS: Dynamic View Synthesis from Blurry Monocular Video via Sparse-Controlled Gaussian Splatting
...
#### [161] 3DGH: 3D Head Generation with Composable Hair and Face
...
#### [162] Virtual Memory for 3D Gaussian Splatting
...
#### [163] SOF: Sorted Opacity Fields for Fast Unbounded Surface Reconstruction
...
#### [164] GRAND-SLAM: Local Optimization for Globally Consistent Large-Scale Multi-Agent Gaussian SLAM
...
#### [165] 4Real-Video-V2: Fused View-Time Attention and Feedforward Reconstruction for 4D Scene Generation
...
#### [166] BulletGen: Improving 4D Reconstruction with Bullet-Time Generation
...
#### [167] 2D Triangle Splatting for Direct Differentiable Mesh Training
...
#### [168] 3D Gaussian Splatting for Fine-Detailed Surface Reconstruction in Large-Scale Scene
...
#### [169] Part2GS: Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [170] GraphGSOcc: Semantic-Geometric Graph Transformer with Dynamic-Static Decoupling for 3D Gaussian Splatting-based Occupancy Prediction
...
#### [171] SyncTalk++: High-Fidelity and Efficient Synchronized Talking Heads Synthesis Using Gaussian Splatting
...
#### [172] 3DGS-IEval-15K: A Large-scale Image Quality Evaluation Database for 3D Gaussian-Splatting
...
#### [173] HRGS: Hierarchical Gaussian Splatting for Memory-Efficient High-Resolution 3D Reconstruction
...
#### [174] GAF: Gaussian Action Field as a Dynamic World Model for Robotic Manipulation
...
#### [175] GRaD-Nav++: Vision-Language Model Enabled Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [176] PF-LHM: 3D Animatable Avatar Reconstruction from Pose-free Articulated Human Images
...
#### [177] Micro-macro Gaussian Splatting with Enhanced Scalability for Unconstrained Scene Reconstruction
...
#### [178] Multiview Geometric Regularization of Gaussian Splatting for Accurate Radiance Fields
...
#### [179] GS-2DGS: Geometrically Supervised 2DGS for Reflective Object Reconstruction
...
#### [180] Metropolis-Hastings Sampling for 3D Gaussian Reconstruction
...
#### [181] SMPL Normal Map Is All You Need for Single-view Textured Human Reconstruction
...
#### [182] Efficient multi-view training for 3D Gaussian Splatting
...
#### [183] Generative 4D Scene Gaussian Splatting with Object View-Synthesis Priors
...
#### [184] Perceptual-GS: Scene-adaptive Perceptual Densification for Gaussian Splatting
...
#### [185] PointGS: Point Attention-Aware Sparse View Synthesis with Gaussian Splatting
...
#### [186] DGS-LRM: Real-Time Deformable 3D Gaussian Reconstruction From Monocular Videos
...
#### [187] UniPre3D: Unified Pre-training of 3D Point Cloud Models with Cross-Modal Gaussian Splatting
...
#### [188] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [189] SemanticSplat: Feed-Forward 3D Scene Understanding with Language-Aware Gaussian Fields
...
#### [190] Gaussian Herding across Pens: An Optimal Transport Perspective on Global Gaussian Reduction for 3DGS
...
#### [191] HAIF-GS: Hierarchical and Induced Flow-Guided Gaussian Splatting for Dynamic Scene
...
#### [192] TinySplat: Feedforward Approach for Generating Compact 3D Scene Representation
...
#### [193] ODG: Occupancy Prediction Using Dual Gaussians
...
#### [194] UniForward: Unified 3D Scene and Semantic Field Reconstruction via Feed-Forward Gaussian Splatting from Only Sparse-View Images
...
#### [195] STREAMINGGS: Voxel-Based Streaming 3D Gaussian Splatting with Memory Optimization and Architectural Support
...
#### [196] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [197] Gaussian2Scene: 3D Scene Representation Learning via Self-supervised Learning with 3D Gaussian Splatting
- **🧑‍🔬 作者**：Keyi Liu, Weidong Yang, Ben Fei, Ying He
- **🏫 单位**：Fudan University ⟐ The Chinese University of Hong Kong ⟐ Nanyang Technological University
- **🔗 链接**：[[中英摘要](./abs/2506.08777.md)] [[arXiv:2506.08777](https://arxiv.org/abs/2506.08777)] [Code]
- **📝 说明**:

#### [198] SceneSplat++: A Large Dataset and Comprehensive Benchmark for Language Gaussian Splatting
...
#### [199] TraGraph-GS: Trajectory Graph-based Gaussian Splatting for Arbitrary Large-Scale Scene Rendering
...
#### [200] Complex-Valued Holographic Radiance Fields
...
#### [201] Speedy Deformable 3D Gaussian Splatting: Fast Rendering and Compression of Dynamic Scenes
...
#### [202] GaussianVAE: Adaptive Learning Dynamics of 3D Gaussians for High-Fidelity Super-Resolution
- **🧑‍🔬 作者**：Shuja Khalid, Mohamed Ibrahim, Yang Liu
- **🏫 单位**：Huawei Canada
- **🔗 链接**：[[中英摘要](./abs/2506.07897.md)] [[arXiv:2506.07897](https://arxiv.org/abs/2506.07897)] [Code]
- **📝 说明**:

#### [203] FreeGave: 3D Physics Learning from Dynamic Videos by Gaussian Velocity
...
#### [204] R3D2: Realistic 3D Asset Insertion via Diffusion for Autonomous Driving Simulation
...
#### [205] OpenSplat3D: Open-Vocabulary 3D Instance Segmentation using Gaussian Splatting
...
#### [206] ProSplat: Improved Feed-Forward 3D Gaussian Splatting for Wide-Baseline Sparse Views
...
#### [207] PIG: Physically-based Multi-Material Interaction with 3D Gaussians
...
#### [208] Hierarchical Scoring with 3D Gaussian Splatting for Instance Image-Goal Navigation
...
#### [209] Accelerating 3D Gaussian Splatting with Neural Sorting and Axis-Oriented Rasterization
...
#### [210] Hybrid Mesh-Gaussian Representation for Efficient Indoor Scene Reconstruction
...
#### [211] Gaussian Mapping for Evolving Scenes
...
#### [212] Multi-StyleGS: Stylizing Gaussian Splatting with Multiple Styles
...
#### [213] Hi-LSplat: Hierarchical 3D Language Gaussian Splatting
...
#### [214] Parametric Gaussian Human Model: Generalizable Prior for Efficient and Realistic Human Avatar Modeling
...
#### [215] GS4: Generalizable Sparse Splatting Semantic SLAM
...
#### [216] Splat and Replace: 3D Reconstruction with Repetitive Elements
...
#### [217] BecomingLit: Relightable Gaussian Avatars with Hybrid Neural Shading
...
#### [218] Dy3DGS-SLAM: Monocular 3D Gaussian Splatting SLAM for Dynamic Environments
...
#### [219] SurGSplat: Progressive Geometry-Constrained Gaussian Splatting for Surgical Scene Reconstruction
...
#### [220] Lumina: Real-Time Mobile Neural Rendering by Exploiting Computational Redundancy
...
#### [221] VoxelSplat: Dynamic Gaussian Splatting as an Effective Loss for Occupancy and Flow Prediction
...
#### [222] On-the-fly Reconstruction for Large-Scale Novel View Synthesis from Unposed Images
...
#### [223] ODE-GS: Latent ODEs for Dynamic Scene Extrapolation with 3D Gaussian Splatting
...
#### [224] S2GO: Streaming Sparse Gaussian Occupancy Prediction
...
#### [225] Gen4D: Synthesizing Humans and Scenes in the Wild
...
#### [226] FreeTimeGS: Free Gaussian Primitives at Anytime and Anywhere for Dynamic Scene Reconstruction
...
#### [227] Revisiting Depth Representations for Feed-Forward 3D Gaussian Splatting
...
#### [228] DSG-World: Learning a 3D Gaussian World Model from Dual State Videos
...
#### [229] OGGSplat: Open Gaussian Growing for Generalizable Reconstruction with Expanded Field-of-View
...
#### [230] Synthetic Dataset Generation for Autonomous Mobile Robots Using 3D Gaussian Splatting for Vision Training
...
#### [231] UAV4D: Dynamic Neural Rendering of Human-Centric UAV Imagery using Gaussian Splatting
...
#### [232] Point Cloud Segmentation of Agricultural Vehicles using 3D Gaussian Splatting
...
#### [233] Generating Synthetic Stereo Datasets using 3D Gaussian Splatting and Expert Knowledge Transfer
...
#### [234] Object-X: Learning to Reconstruct Multi-Modal 3D Object Representations
...
#### [235] HuGeDiff: 3D Human Generation via Diffusion with Gaussian Splatting
...
#### [236] FlexGS: Train Once, Deploy Everywhere with Many-in-One Flexible 3D Gaussian Splatting
...
#### [237] Splatting Physical Scenes: End-to-End Real-to-Sim from Imperfect Robot Data
...
#### [238] JointSplat: Probabilistic Joint Flow-Depth Optimization for Sparse-View Gaussian Splatting
- **🧑‍🔬 作者**：Yang Xiao, Guoan Xu, Qiang Wu, Wenjing Jia
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2506.03872.md)] [[arXiv:2506.03872](https://arxiv.org/abs/2506.03872)] [Code]
- **📝 说明**:

#### [239] SplArt: Articulation Estimation and Part-Level Reconstruction with 3D Gaussian Splatting
...
#### [240] Robust Neural Rendering in the Wild with Asymmetric Dual 3D Gaussian Splatting
...
#### [241] Multi-Spectral Gaussian Splatting with Neural Color Representation
...
#### [242] LEG-SLAM: Real-Time Language-Enhanced Gaussian Splatting for SLAM
...
#### [243] Voyager: Real-Time Splatting City-Scale 3D Gaussians on Your Phone
...
#### [244] RobustSplat: Decoupling Densification and Dynamics for Transient-Free 3DGS
...
#### [245] VTGaussian-SLAM: RGBD SLAM for Large Scale Scenes with Splatting View-Tied 3D Gaussians
...
#### [246] EyeNavGS: A 6-DoF Navigation Dataset and Record-n-Replay Software for Real-World 3DGS Scenes in VR
...
#### [247] GSCodec Studio: A Modular Framework for Gaussian Splat Compression
...
#### [248] WorldExplorer: Towards Generating Fully Navigable 3D Scenes
...
#### [249] RadarSplat: Radar Gaussian Splatting for High-Fidelity Data Synthesis and 3D Reconstruction of Autonomous Driving Scenes
...
#### [250] CountingFruit: Real-Time 3D Fruit Counting with Language-Guided Semantic Gaussian Splatting
...
#### [251] PromptVFX: Text-Driven Fields for Open-World 3D Gaussian Animation
...
#### [252] Globally Consistent RGB-D SLAM with 2D Gaussian Splatting
...
#### [253] 3D Gaussian Splat Vulnerabilities
...
#### [254] Adaptive Voxelization for Transform coding of 3D Gaussian splatting data
...
#### [255] Understanding while Exploring: Semantics-driven Active Mapping
...
#### [256] AdaHuman: Animatable Detailed 3D Human Generation with Compositional Multiview Diffusion
...
#### [257] TC-GS: A Faster Gaussian Splatting Module Utilizing Tensor Cores
...
#### [258] Tackling View-Dependent Semantics in 3D Language Gaussian Splatting
...
#### [259] GARLIC: GAussian Representation LearnIng for spaCe partitioning
...
#### [260] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
...
#### [261] ZPressor: Bottleneck-Aware Compression for Scalable Feed-Forward 3DGS
...
#### [262] AnySplat: Feed-forward 3D Gaussian Splatting from Unconstrained Views
...
#### [263] Holistic Large-Scale Scene Reconstruction via Mixed Gaussian Splatting
...
#### [264] LODGE: Level-of-Detail Large-Scale Gaussian Splatting with Efficient Rendering
...
#### [265] SpatialSplat: Efficient Semantic 3D from Sparse Unposed Images
...
#### [266] Pose-free 3D Gaussian splatting via shape-ray estimation
...
#### [267] 3DGS Compression with Sparsity-guided Hierarchical Transform Coding
...
#### [268] 4DTAM: Non-Rigid Tracking and Mapping via Dynamic Surface Gaussians
...
#### [269] CLIPGaussian: Universal and Multimodal Style Transfer Based on Gaussian Splatting
...
#### [270] STDR: Spatio-Temporal Decoupling for Real-Time Dynamic Scene Rendering
...
#### [271] UP-SLAM: Adaptively Structured Gaussian SLAM with Uncertainty Prediction in Dynamic Environments
...
#### [272] Learning Fine-Grained Geometry for Sparse-View Splatting via Cascade Depth Loss
...
#### [273] Hyperspectral Gaussian Splatting
...
#### [274] Generalizable and Relightable Gaussian Splatting for Human Novel View Synthesis
...
#### [275] MV-CoLight: Efficient Object Compositing with Consistent Lighting and Shadow Generation
...
#### [276] Plenodium: UnderWater 3D Scene Reconstruction with Plenoptic Medium Representation
...
#### [277] 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling
...
#### [278] CityGo: Lightweight Urban Modeling and Rendering with Proxy Buildings and Residual Gaussians
...
#### [279] ProBA: Probabilistic Bundle Adjustment with the Bhattacharyya Coefficient
- **🧑‍🔬 作者**：Jason Chui, Daniel Cremers
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.20858.md)] [[arXiv:2505.20858](https://arxiv.org/abs/2505.20858)] [Code]
- **📝 说明**:

#### [280] Intern-GS: Vision Model Guided Sparse-View 3D Gaussian Splatting
...
#### [281] Wideband RF Radiance Field Modeling Using Frequency-embedded 3D Gaussian Splatting
...
#### [282] OmniIndoor3D: Comprehensive Indoor 3D Reconstruction
...
#### [283] WeatherEdit: Controllable Weather Editing with 4D Gaussian Field
...
#### [284] CCL-LGS: Contrastive Codebook Learning for 3D Language Gaussian Splatting
...
#### [285] ParticleGS: Particle-Based Dynamics Modeling of 3D Gaussians for Prior-free Motion Extrapolation
...
#### [286] HaloGS: Loose Coupling of Compact Geometry and Gaussian Splats for 3D Scenes
...
#### [287] ErpGS: Equirectangular Image Rendering enhanced with 3D Gaussian Regularization
...
#### [288] Sparse2DGS: Sparse-View Surface Reconstruction using 2D Gaussian Splatting with Dense Point Cloud
...
#### [289] ADD-SLAM: Adaptive Dynamic Dense SLAM with Gaussian Splatting
...
#### [290] Improving Novel view synthesis of 360∘ Scenes in Extremely Sparse Views by Jointly Training Hemisphere Sampled Synthetic Images
...
#### [291] Triangle Splatting for Real-Time Radiance Field Rendering
...
#### [292] FHGS: Feature-Homogenized Gaussian Splatting
...
#### [293] Veta-GS: View-dependent deformable 3D Gaussian Splatting for thermal infrared Novel-view Synthesis
...
#### [294] VPGS-SLAM: Voxel-based Progressive 3D Gaussian SLAM in Large-Scale Scenes
...
#### [295] Efficient Differentiable Hardware Rasterization for 3D Gaussian Splatting
...
#### [296] SuperGS: Consistent and Detailed 3D Super-Resolution Scene Reconstruction via Gaussian Splatting
...
#### [297] Pose Splatter: A 3D Gaussian Splatting Model for Quantifying Animal Pose and Appearance
...
#### [298] CGS-GAN: 3D Consistent Gaussian Splatting GANs for High Resolution Human Head Synthesis
...
#### [299] From Flight to Insight: Semantic 3D Reconstruction for Aerial Inspection via Gaussian Splatting and Language-Guided Segmentation
...
#### [300] Render-FM: A Foundation Model for Real-time Photorealistic Volumetric Rendering
...
#### [301] Motion Matters: Compact Gaussian Streaming for Free-Viewpoint Video Reconstruction
...
#### [302] RUSplatting: Robust 3D Gaussian Splatting for Sparse-View Underwater Scene Reconstruction
...
#### [303] PlantDreamer: Achieving Realistic 3D Plant Models with Diffusion-Guided Gaussian Splatting
...
#### [304] EVA: Expressive Virtual Avatars from Multi-view Videos
...
#### [305] GS2E: Gaussian Splatting is an Effective Data Generator for Event Stream Generation
...
#### [306] X-GRM: Large Gaussian Reconstruction Model for Sparse-view X-rays to Computed Tomography
...
#### [307] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [308] MonoSplat: Generalizable 3D Gaussian Splatting from Monocular Depth Foundation Models
...
#### [309] Scan, Materialize, Simulate: A Generalizable Framework for Physically Grounded Robot Planning
...
#### [310] Personalize Your Gaussian: Consistent 3D Scene Personalization from a Single Image
...
#### [311] MGStream: Motion-aware 3D Gaussian for Streamable Dynamic Scene Reconstruction
...
#### [312] Recollection from Pensieve: Novel View Synthesis via Learning from Uncalibrated Videos
...
#### [313] Hybrid 3D-4D Gaussian Splatting for Fast Dynamic Scene Representation
...
#### [314] 3D Gaussian Adaptive Reconstruction for Fourier Light-Field Microscopy
...
#### [315] TACOcc:Target-Adaptive Cross-Modal Fusion with Volume Rendering for 3D Semantic Occupancy
...
#### [316] SpatialCrafter: Unleashing the Imagination of Video Diffusion Models for Scene Reconstruction from Limited Observations
...
#### [317] iSegMan: Interactive Segment-and-Manipulate 3D Gaussians
...
#### [318] GTR: Gaussian Splatting Tracking and Reconstruction of Unknown Objects Based on Appearance and Geometric Complexity
...
#### [319] MonoMobility: Zero-Shot 3D Mobility Analysis from Monocular Videos
...
#### [320] GrowSplat: Constructing Temporal Digital Twins of Plants with Gaussian Splats
...
#### [321] EA-3DGS: Efficient and Adaptive 3D Gaussians with Highly Enhanced Quality for outdoor scenes
- **🧑‍🔬 作者**：Jianlin Guo, Haihong Xiao, Wenxiong Kang
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2505.10787.md)] [[arXiv:2505.10787](https://arxiv.org/abs/2505.10787)] [Code]
- **📝 说明**:

#### [322] GaussianFormer3D: Multi-Modal Gaussian-based Semantic Occupancy Prediction with 3D Deformable Attention
...
#### [323] ExploreGS: a vision-based low overhead framework for 3D scene reconstruction
...
#### [324] Consistent Quantity-Quality Control across Scenes for Deployment-Aware Gaussian Splatting
...
#### [325] VRSplat: Fast and Robust Gaussian Splatting for Virtual Reality
...
#### [326] ToonifyGB: StyleGAN-based Gaussian Blendshapes for 3D Stylized Head Avatars
...
#### [327] Large-Scale Gaussian Splatting SLAM
...
- **🔗 链接**：[[中英摘要](./abs/2505.09915.md)] [[arXiv:2505.09915](https://arxiv.org/abs/2505.09915)] [Code]
- **📝 说明**: 🏆 Accepted to ICRA 2025

#### [328] Real2Render2Real: Scaling Robot Data Without Dynamics Simulation or Robot Hardware
...
#### [329] Sparse Point Cloud Patches Rendering via Splitting 2D Gaussians
...
#### [330] Neural Video Compression using 2D Gaussian Splatting
...
#### [331] TUGS: Physics-based Compact Representation of Underwater Scenes by Tensorized Gaussian
...
#### [332] DLO-Splatting: Tracking Deformable Linear Objects Using 3D Gaussian Splatting
...
#### [333] FOCI: Trajectory Optimization on Gaussian Splats
...
#### [334] SLAG: Scalable Language-Augmented Gaussian Splatting
...
#### [335] Monocular Online Reconstruction with Enhanced Detail Preservation
...
#### [336] UltraGauss: Ultrafast Gaussian Reconstruction of 3D Ultrasound Volumes
...
#### [337] QuickSplat: Fast 3D Surface Reconstruction via Learned Gaussian Initialization
- **🧑‍🔬 作者**：Yueh-Cheng Liu, Lukas Höllein, Matthias Nießner, Angela Dai
- **🏫 单位**：Technical University of Munich
- **🔗 链接**：[[中英摘要](./abs/2505.05591.md)] [[arXiv:2505.05591](https://arxiv.org/abs/2505.05591)] [Code]
- **📝 说明**:

#### [338] Apply Hierarchical-Chain-of-Generation to Complex Attributes Text-to-3D Generation
...
#### [339] MoRe-3DGSMR: Motion-resolved reconstruction framework for free-breathing pulmonary MRI based on 3D Gaussian representation
...
#### [340] GSsplat: Generalizable Semantic Gaussian Splatting for Novel-view Synthesis in 3D Scenes
...
#### [341] Bridging Geometry-Coherent Text-to-3D Generation with Multi-View Diffusion Priors and Gaussian Splatting
...
#### [342] GUAVA: Generalizable Upper Body 3D Gaussian Avatar
...
#### [343] 3D Gaussian Splatting Data Compression with Mixture of Priors
...
#### [344] Sparfels: Fast Reconstruction from Sparse Unposed Imagery
...
#### [345] SignSplat: Rendering Sign Language via Gaussian Splatting
- **🧑‍🔬 作者**：Maksym Ivashechkin, Oscar Mendez, Richard Bowden
...
#### [346] GenSync: A Generalized Talking Head Framework for Audio-driven Multi-Subject Lip-Sync using 3D Gaussian Splatting
...
#### [347] AquaGS: Fast Underwater Scene Reconstruction with SfM-Free Gaussian Splatting
...
#### [348] FreeInsert: Disentangled Text-Guided Object Insertion in 3D Gaussian Scene without Spatial Priors
...
#### [349] Real-Time Animatable 2DGS-Avatars with Detail Enhancement from Monocular Videos
...
#### [350] HoloTime: Taming Video Diffusion Models for Panoramic 4D Scene Generation
...
#### [351] GauSS-MI: Gaussian Splatting Shannon Mutual Information for Active 3D Reconstruction
...
#### [352] GaussTrap: Stealthy Poisoning Attacks on 3D Gaussian Splatting for Targeted Scene Confusion
...
#### [353] EfficientHuman: Efficient Training and Reconstruction of Moving Human using Articulated 2D Gaussian
...
#### [354] Creating Your Editable 3D Photorealistic Avatar with Tetrahedron-constrained Gaussian Splatting
...
#### [355] GSFeatLoc: Visual Localization Using Feature Correspondence on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Jongwon Lee, Timothy Bretl
- **🏫 单位**：University of Illinois Urbana-Champaign
- **🔗 链接**：[[中英摘要](./abs/2504.20379.md)] [[arXiv:2504.20379](https://arxiv.org/abs/2504.20379)] [Code]
- **📝 说明**:

#### [356] GSFF-SLAM: 3D Semantic Gaussian Splatting SLAM via Feature Field
...
#### [357] Rendering Anywhere You See: Renderability Field-guided Gaussian Splatting
...
#### [358] 4DGS-CC: A Contextual Coding Framework for 4D Gaussian Splatting Data Compression
...
#### [359] RGS-DR: Reflective Gaussian Surfels with Deferred Rendering for Shiny Objects
...
#### [360] STP4D: Spatio-Temporal-Prompt Consistent Modeling for Text-to-4D Gaussian Splatting
...
#### [361] PerfCam: Digital Twinning for Production Lines Using 3D Gaussian Splatting and Vision Models
...
#### [362] Visibility-Uncertainty-guided 3D Gaussian Inpainting via Scene Conceptional Learning
...
#### [363] CasualHDRSplat: Robust High Dynamic Range 3D Gaussian Splatting from Casually Captured Videos
...
#### [364] When Gaussian Meets Surfel: Ultra-fast High-fidelity Radiance Field Rendering
- **🧑‍🔬 作者**：Keyang Ye, Tianjia Shao, Kun Zhou
...
#### [365] Gaussian Splatting is an Effective Data Generator for 3D Object Detection
...
#### [366] HUG: Hierarchical Urban Gaussian Splatting with Block-Based Reconstruction
...
#### [367] ToF-Splatting: Dense SLAM using Sparse Time-of-Flight Depth and Multi-Frame Integration
...
#### [368] StyleMe3D: Stylization with Disentangled Priors by Multiple Encoders on 3D Gaussians
...
#### [369] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [370] IXGS-Intraoperative 3D Reconstruction from Sparse, Arbitrarily Posed Real X-rays
...
#### [371] NVSMask3D: Hard Visual Prompting with Camera Pose Interpolation for 3D Open Vocabulary Instance Segmentation
...
#### [372] VGNC: Reducing the Overfitting of Sparse-view 3DGS via Validation-guided Gaussian Number Control
...
#### [373] Metamon-GS: Enhancing Representability with Variance-Guided Densification and Light Encoding
...
#### [374] SEGA: Drivable 3D Gaussian Head Avatar from a Single Image
...
#### [375] Green Robotic Mixed Reality with Gaussian Splatting
...
#### [376] EG-Gaussian: Epipolar Geometry and Graph Network Enhanced 3D Gaussian Splatting
...
#### [377] Volume Encoding Gaussians: Transfer Function-Agnostic 3D Gaussians for Volume Rendering
...
#### [378] BEV-GS: Feed-forward Gaussian Splatting in Bird's-Eye-View for Road Reconstruction
...
#### [379] EDGS: Eliminating Densification for Efficient Convergence of 3DGS
...
#### [380] Training-Free Hierarchical Scene Understanding for Gaussian Splatting with Superpoint Graphs
...
#### [381] CompGS++: Compressed Gaussian Splatting for Static and Dynamic Scene Representation
...
#### [382] GSAC: Leveraging Gaussian Splatting for Photorealistic Avatar Creation with Unity Integration
...
#### [383] Second-order Optimization of Gaussian Splats with Importance Sampling
...
#### [384] AAA-Gaussians: Anti-Aliased and Artifact-Free 3D Gaussian Rendering
...
#### [385] CAGE-GS: High-fidelity Cage Based 3D Gaussian Splatting Deformation
...
#### [386] TSGS: Improving Gaussian Splatting for Transparent Surface Reconstruction via Normal and De-lighting Priors
...
#### [387] ARAP-GS: Drag-driven As-Rigid-As-Possible 3D Gaussian Splatting Editing with Diffusion Prior
...
#### [388] SHeaP: Self-Supervised Head Geometry Predictor Learned via 2D Gaussians
...
#### [389] CAGS: Open-Vocabulary 3D Scene Understanding with Context-Aware Gaussian Splatting
...
#### [390] 3DAffordSplat: Efficient Affordance Reasoning with 3D Gaussians
...
#### [391] Easy3D: A Simple Yet Effective Method for 3D Interactive Segmentation
...
#### [392] 3D Gabor Splatting: Reconstruction of High-frequency Surface Texture using Gabor Noise
...
#### [393] GaSLight: Gaussian Splats for Spatially-Varying Lighting in HDR
...
#### [394] DNF-Avatar: Distilling Neural Fields for Real-time Animatable Avatar Relighting
...
#### [395] LL-Gaussian: Low-Light Scene Reconstruction and Enhancement via Gaussian Splatting for Novel View Synthesis
...
#### [396] ESCT3D: Efficient and Selectively Controllable Text-Driven 3D Content Generation with Gaussian Splatting
...
#### [397] EBAD-Gaussian: Event-driven Bundle Adjusted Deblur Gaussian Splatting
...
#### [398] GaussVideoDreamer: 3D Scene Generation with Video Diffusion and Inconsistency-Aware Gaussian Splatting
...
#### [399] MCBlock: Boosting Neural Radiance Field Training Speed by MCTS-based Dynamic-Resolution Ray Sampling
...
#### [400] LightHeadEd: Relightable & Editable Head Avatars from a Smartphone
...
#### [401] TextSplat: Text-Guided Semantic Fusion for Generalizable Gaussian Splatting
...
#### [402] EmbodiedOcc++: Boosting Embodied 3D Occupancy Prediction with Plane Regularization and Uncertainty Sampler
...
#### [403] A Constrained Optimization Approach for Gaussian Splatting from Coarsely-posed Images and Noisy Lidar Point Clouds
...
#### [404] You Need a Transition Plane: Bridging Continuous Panoramic 3D Reconstruction with Perspective Gaussian Splatting
...
#### [405] BlockGaussian: Efficient Large-Scale Scene Novel View Synthesis via Adaptive Block-Based Gaussian Splatting
...
#### [406] FMLGS: Fast Multilevel Language Embedded Gaussians for Part-level Interactive Agents
...
#### [407] Cut-and-Splat: Leveraging Gaussian Splatting for Synthetic Data Generation
...
#### [408] In-2-4D: Inbetweening from Two Single-View Images to 4D Generation
...
#### [409] ContrastiveGaussian: High-Fidelity 3D Generation with Contrastive Learning and Gaussian Splatting
...
#### [410] InteractAvatar: Modeling Hand-Face Interaction in Photorealistic Avatars with Deformable Gaussians
...
#### [411] View-Dependent Uncertainty Estimation of 3D Gaussian Splatting
...
#### [412] GIGA: Generalizable Sparse Image-driven Gaussian Avatars
...
#### [413] SIGMAN: Scaling 3D Human Gaussian Generation with Millions of Assets
...
#### [414] Wheat3DGS: In-field 3D Reconstruction, Instance Segmentation and Phenotyping of Wheat Heads with Gaussian Splatting
...
#### [415] IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
...
#### [416] SVG-IR: Spatially-Varying Gaussian Splatting for Inverse Rendering
...
#### [417] GSta: Efficient Training Scheme with Siestaed Gaussians for Monocular 3D Scene Reconstruction
...
#### [418] Stochastic Ray Tracing of 3D Transparent Gaussians
...
#### [419] econSG: Efficient and Multi-view Consistent Open-Vocabulary 3D Semantic Gaussians
- **🧑‍🔬 作者**：Can Zhang, Gim Hee Lee
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2504.06003.md)] [[arXiv:2504.06003](https://arxiv.org/abs/2504.06003)] [Code]
- **📝 说明**：

#### [420] Micro-splatting: Maximizing Isotropic Constraints for Refined Optimization in 3D Gaussian Splatting
...
#### [421] View-Dependent Deformation Fields for 2D Editing of 3D Models
...
#### [422] L3GS: Layered 3D Gaussian Splats for Efficient 3D Scene Delivery
...
#### [423] Let it Snow! Animating Static Gaussian Scenes With Dynamic Weather Effects
...
#### [424] 3D Gaussian Particle Approximation of VDB Datasets: A Study for Scientific Visualization
...
#### [425] Embracing Dynamics: Dynamics-aware 4D Gaussian Splatting SLAM
...
#### [426] 3R-GS: Best Practice in Optimizing Camera Poses Along with 3DGS
...
#### [427] Interpretable Single-View 3D Gaussian Splatting using Unsupervised Hierarchical Disentangled Representation Learning
...
#### [428] HumanDreamer-X: Photorealistic Single-image Human Avatars Reconstruction via Gaussian Restoration
...
#### [429] MonoGS++: Fast and Accurate Monocular RGB Gaussian SLAM
...
#### [430] ConsDreamer: Advancing Multi-View Consistency for Zero-Shot Text-to-3D Generation
...
#### [431] Digital-twin imaging based on descattering Gaussian splatting
...
#### [432] UAVTwin: Neural Digital Twins for UAVs using Gaussian Splatting
...
#### [433] WorldPrompter: Traversable Text-to-Scene Generation
...
#### [434] BOGausS: Better Optimized Gaussian Splatting
...
#### [435] FlowR: Flowing from Sparse to Dense 3D Reconstructions
...
#### [436] RealityAvatar: Towards Realistic Loose Clothing Modeling in Animatable 3D Gaussian Avata
...
#### [437] High-fidelity 3D Object Generation from Single Image with RGBN-Volume Gaussian Reconstruction Model
...
#### [438] 3D Gaussian Inverse Rendering with Approximated Global Illumination
...
#### [439] Coca-Splat: Collaborative Optimization for Camera Parameters and 3D Gaussians
...
#### [440] Distilling Multi-view Diffusion Models into 3D Generators
...
#### [441] ADGaussian: Generalizable Gaussian Splatting for Autonomous Driving with Multi-modal Inputs
...
#### [442] SonarSplat: Novel View Synthesis of Imaging Sonar via Gaussian Splatting
