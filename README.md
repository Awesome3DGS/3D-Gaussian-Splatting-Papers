...
#### [9] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [11] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [12] DeGauss: Dynamic-Static Decomposition with Gaussian Splatting for Distractor-free 3D Reconstruction
...
#### [13] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [14] RGBAvatar: Reduced Gaussian Blendshapes for Online Modeling of Head Avatars
...
#### [16] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [17] Deblur Gaussian Splatting SLAM
...
#### [18] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [19] MTGS: Multi-Traversal Gaussian Splatting
...
#### [20] SPC-GS: Gaussian Splatting with Semantic-Prompt Consistency for Indoor Open-World Free-view Synthesis from Sparse Inputs
...
#### [21] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
- **🧑‍🔬 作者**：Songen Gu, Haoxuan Song, Binjie Liu, Qian Yu, Sanyi Zhang, Haiyong Jiang, Jin Huang, Feng Tian
...
#### [23] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [24] Swift4D:Adaptive divide-and-conquer Gaussian Splatting for compact and efficient reconstruction of dynamic scene
...
#### [25] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [26] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [27] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [28] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [29] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [30] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [31] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [32] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [33] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [34] RI3D: Few-Shot Gaussian Splatting With Repair and Inpainting Diffusion Priors
...
#### [35] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [36] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [37] 4D LangSplat: 4D Language Gaussian Splatting via Multimodal Large Language Models
...
#### [38] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
- **🧑‍🔬 作者**：Zhiqi Li, Chengrui Dong, Yiming Chen, Zhangchi Huang, Peidong Liu
...
#### [39] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [40] GS-SDF: LiDAR-Augmented Gaussian Splatting and Neural SDF for Geometrically Consistent Rendering and Reconstruction
...
#### [41] 3D Student Splatting and Scooping
...
#### [42] GaussHDR: High Dynamic Range Gaussian Splatting via Learning Unified 3D and 2D Local Tone Mapping
...
#### [43] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [44] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [45] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [46] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [48] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [49] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [50] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [51] Motion Blender Gaussian Splatting for Dynamic Reconstruction
...
#### [52] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [53] TT-GaussOcc: Test-Time Compute for Self-Supervised Occupancy Prediction via Spatio-Temporal Gaussian Splatting
...
#### [54] Mitigating Ambiguities in 3D Classification with Gaussian Splatting
...
#### [55] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [56] HRAvatar: High-Quality and Relightable Gaussian Head Avatar
...
#### [57] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [58] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [59] ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
...
#### [60] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [61] GigaSLAM: Large-Scale Monocular SLAM with Hierachical Gaussian Splats
...
#### [62] 7DGS: Unified Spatial-Temporal-Angular Gaussian Splatting
...
#### [63] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [64] SOGS: Second-Order Anchor for Advanced 3D Gaussian Splatting
...
#### [65] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [66] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [67] Frequency-Aware Density Control via Reparameterization for High-Quality Rendering of 3D Gaussian Splatting
...
#### [68] DirectTriGS: Triplane-based Gaussian Splatting Field Representation for 3D Generation
...
#### [69] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [70] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [71] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [72] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [73] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [74] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [75] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [76] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
...
#### [77] SplatTalk: 3D VQA with Gaussian Splatting
...
#### [78] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [79] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [80] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [81] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [82] SecureGS: Boosting the Security and Fidelity of 3D Gaussian Splatting Steganography
...
#### [83] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [84] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [85] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [86] DecoupledGaussian: Object-Scene Decoupling for Physics-Based Interaction
...
#### [87] LiDAR-enhanced 3D Gaussian Splatting Mapping
- **🧑‍🔬 作者**：Jian Shen, Huai Yu, Ji Wu, Wen Yang, Gui-Song Xia
...
#### [88] Self-Modeling Robots by Photographing
- **🧑‍🔬 作者**：Kejun Hu, Peng Yu, Ning Tan
- **🏫 单位**: School of Computer Science and Engineering, Sun Yat-sen University, Guangzhou, Guangdong, China
- **🔗 链接**：[[中英摘要](./abs/2503.05398.md)] [[arXiv:2503.05398](https://arxiv.org/abs/2503.05398)] [Code]
- **📝 说明**：

#### [89] CoMoGaussian: Continuous Motion-Aware Gaussian Splatting from Motion-Blurred Images
...
#### [90] STGA: Selective-Training Gaussian Head Avatars
...
#### [91] Persistent Object Gaussian Splat (POGS) for Tracking Human and Robot Manipulation of Irregularly Shaped Objects
...
#### [92] MGSR: 2D/3D Mutual-boosted Gaussian Splatting for High-fidelity Surface Reconstruction under Various Light Conditions
...
#### [93] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [94] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [95] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [96] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [97] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [98] Taming Video Diffusion Prior with Scene-Grounding Guidance for 3D Gaussian Splatting from Sparse Inputs
- **🧑‍🔬 作者**：Yingji Zhong, Zhihao Li, Dave Zhenyu Chen, Lanqing Hong, Dan Xu
...
#### [99] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [100] S2Gaussian: Sparse-View Super-Resolution 3D Gaussian Splatting
...
#### [101] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
- **🧑‍🔬 作者**：Shuojue Yang, Zijian Wu, Mingxuan Hong, Qian Li, Daiyun Shen, Septimiu E. Salcudean, Yueming Jin
...
#### [102] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [103] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [104] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [105] GRaD-Nav: Efficiently Learning Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics
...
#### [106] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [107] NTR-Gaussian: Nighttime Dynamic Thermal Reconstruction with 4D Gaussian Splatting Based on Thermodynamics
...
#### [108] 2DGS-Avatar: Animatable High-fidelity Clothed Avatar via 2D Gaussian Splatting
...
#### [109] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [110] Morpheus: Text-Driven 3D Gaussian Splat Shape and Color Stylization
...
#### [111] Difix3D+: Improving 3D Reconstructions with Single-Step Diffusion Models
...
#### [112] OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding
...
#### [113] Vid2Avatar-Pro: Authentic Avatar from Videos in the Wild via Universal Prior
...
#### [114] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**:
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [115] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [116] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [117] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [118] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [119] DoF-Gaussian: Controllable Depth-of-Field for 3D Gaussian Splatting
...
#### [120] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [121] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [122] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [123] CAT-3DGS: A Context-Adaptive Triplane Approach to Rate-Distortion-Optimized 3DGS Compression
...
#### [128] ATLAS Navigator: Active Task-driven LAnguage-embedded Gaussian Splatting
...
#### [129] Efficient Gaussian Splatting for Monocular Dynamic Scene Rendering via Sparse Time-Variant Attribute Modeling
...
#### [130] Avat3r: Large Animatable Gaussian Reconstruction Model for High-fidelity 3D Head Avatars
...
#### [131] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [132] Open-Vocabulary Semantic Part Segmentation of 3D Human
...
#### [133] LUCAS: Layered Universal Codec Avatars
...
#### [134] Building Interactable Replicas of Complex Articulated Objects via Gaussian Splatting
...
#### [135] Does 3D Gaussian Splatting Need Accurate Volumetric Rendering?
...
#### [136] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [137] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [138] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [139] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [140] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [141] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [142] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [143] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [144] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [145] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [146] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [147] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [148] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [149] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [150] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [151] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [152] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [153] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [154] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [155] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [156] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [157] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [158] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [159] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [160] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [161] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [162] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [163] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [164] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [165] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [166] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [167] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [168] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [169] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [170] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [171] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [172] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [173] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [174] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [175] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [176] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [177] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [178] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [179] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [180] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [181] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [182] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [183] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [184] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [185] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [186] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [188] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [189] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [190] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [191] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [192] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [193] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [194] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [195] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [196] Dense-SfM: Structure from Motion with Dense Consistent Matching
- **🧑‍🔬 作者**：JongMin Lee, Sungjoo Yoo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2501.14277.md)] [[arXiv:2501.14277](https://arxiv.org/abs/2501.14277)] [Code]
- **📝 说明**：

#### [197] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [198] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [199] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [200] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [201] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [202] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [203] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [204] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [205] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [206] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [207] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [208] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [209] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [210] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [211] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [212] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [213] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [214] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [215] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [216] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [217] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [218] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [219] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [220] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [221] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [222] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [223] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [224] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [225] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [226] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [227] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [228] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [229] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [230] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [231] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [232] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [233] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [234] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [235] Gaussian Masked Autoencoders
...
#### [236] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [237] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [238] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [239] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [240] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [241] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [242] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [243] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [244] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [245] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [246] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [247] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [248] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [249] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [250] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [251] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [252] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [253] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [254] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [255] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [256] Reflective Gaussian Splatting
...
#### [257] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [258] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [259] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [260] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [261] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [262] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [263] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [264] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [265] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [266] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [267] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [268] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [269] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [270] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [271] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [272] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [273] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [274] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [275] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [276] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [277] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [278] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [279] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [280] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [281] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [282] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [283] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [284] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [285] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [286] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [287] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [288] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [289] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [290] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [291] EOGS: Gaussian Splatting for Earth Observation
...
#### [292] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [293] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [294] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [295] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [296] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [297] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [298] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [299] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [300] Deformable Radial Kernel Splatting
...
#### [301] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [302] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [303] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [304] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [305] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [306] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [307] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [308] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [309] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [310] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [311] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [312] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [313] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [314] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [315] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [316] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [317] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [318] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [319] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [320] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [321] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [322] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [323] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [324] GASP: Gaussian Avatars with Synthetic Priors
...
#### [325] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [326] Faster and Better 3D Splatting via Group Training
...
#### [327] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [328] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [329] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [330] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [331] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [332] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [333] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [334] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [335] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [336] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [337] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [338] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [339] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [340] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [341] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [342] Street Gaussians without 3D Object Tracker
...
#### [343] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [344] Extrapolated Urban View Synthesis Benchmark
...
#### [345] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [346] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [347] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [348] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [349] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [350] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [351] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [352] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [353] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [354] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [355] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [356] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [357] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [358] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [359] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [360] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [361] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [362] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [363] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [364] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [365] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [366] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [367] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [368] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [369] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [370] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [371] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [372] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [373] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [374] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [375] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [376] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [377] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [378] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [379] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [380] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [381] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [382] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [383] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [384] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [385] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [386] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [387] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [388] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [389] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [390] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [391] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [392] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [393] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [394] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [395] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [396] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [397] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [398] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [399] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [400] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [401] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [402] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [403] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [404] Neural Surface Priors for Editable Gaussian Splatting
...
#### [405] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [406] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [407] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [408] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [409] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [410] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [411] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [412] Geometry Field Splatting with Gaussian Surfels
...
#### [413] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [414] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [415] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [416] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [417] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [418] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [419] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [420] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [421] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [422] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [423] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [424] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [425] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [426] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [427] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [428] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [429] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [430] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [431] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [432] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [433] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [434] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [435] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [436] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [437] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [438] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [439] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [440] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [441] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [442] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [443] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [444] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [445] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [446] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [447] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [448] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [449] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [450] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [451] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [452] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [453] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [454] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [455] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [456] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [457] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [458] VeGaS: Video Gaussian Splatting
...
#### [459] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [460] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [461] Efficient Density Control for 3D Gaussian Splatting
...
#### [462] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [463] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [464] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [465] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [466] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [467] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [468] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [469] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [470] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [471] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [472] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [473] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [474] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [475] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
- **🧑‍🔬 作者**：Huibin Zhao, Weipeng Guan, Peng Lu
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2411.02703.md)] [[arXiv:2411.02703](https://arxiv.org/abs/2411.02703)] [Code]
- **📝 说明**：

#### [476] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [477] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [478] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [479] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [480] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [481] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [482] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [483] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [484] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [485] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [486] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [487] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [488] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [489] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [490] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [491] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [492] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [493] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [494] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [495] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [496] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [497] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [498] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [499] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [500] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [501] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [502] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [503] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [504] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [505] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [506] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [507] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [508] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [509] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [510] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [511] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [512] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [513] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [514] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [515] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [516] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [517] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [518] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [519] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [520] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [521] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [522] 3D Vision-Language Gaussian Splatting
...
#### [523] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [524] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [525] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [526] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [527] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [528] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [529] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [530] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [531] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [532] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
- **🧑‍🔬 作者**：Zhongpai Gao, Benjamin Planche, Meng Zheng, Anwesa Choudhuri, Terrence Chen, Ziyan Wu
- **🏫 单位**：United Imaging Intelligence, Boston MA, USA
- **🔗 链接**：[[中英摘要](./abs/2410.04974.md)] [[arXiv:2410.04974](https://arxiv.org/abs/2410.04974)] [Code]
- **📝 说明**：

#### [533] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [534] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [535] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [536] Variational Bayes Gaussian Splatting
...
#### [537] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [538] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [539] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [540] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [541] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [542] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [543] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [544] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [545] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [546] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [547] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [548] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [549] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [550] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [551] RNG: Relightable Neural Gaussians
...
#### [552] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [553] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [554] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [555] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [556] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [557] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [558] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [559] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [560] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [561] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [562] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [563] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [564] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [565] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [566] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [567] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [568] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [569] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [570] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [571] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [572] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [573] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [574] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [575] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [576] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [577] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [578] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [579] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [580] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [581] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [582] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [583] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [584] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [585] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [586] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [587] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [588] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [589] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [590] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [591] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [592] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [593] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [594] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [595] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [596] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [597] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [598] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [599] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [600] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [601] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [602] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [603] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [604] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [605] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [606] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [607] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [608] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [609] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [610] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [611] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [612] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [613] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [614] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [615] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [616] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [617] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [618] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [619] OmniRe: Omni Urban Scene Reconstruction
...
#### [620] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [621] G-Style: Stylized Gaussian Splatting
...
#### [622] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [623] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [624] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [625] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [626] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [627] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [628] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [629] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [630] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [631] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [632] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [633] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [634] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [635] Subsurface Scattering for 3D Gaussian Splatting
...
#### [636] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [637] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [638] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [639] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [640] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [641] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [642] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [643] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [644] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [645] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [646] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [647] 3D Gaussian Editing with A Single Image
...
#### [648] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [649] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [650] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [651] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [652] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [653] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [654] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [655] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [656] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [657] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [658] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [659] IG-SLAM: Instant Gaussian SLAM
...
#### [660] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [661] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [662] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [663] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [664] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [665] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [666] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [667] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [668] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [669] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [670] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [671] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [672] Gaussian Splatting Lucas-Kanade
...
#### [673] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [674] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [675] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [676] PICA: Physics-Integrated Clothed Avatar
...
#### [677] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [678] Gaussian Eigen Models for Human Heads
...
#### [680] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [681] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [682] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [683] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [684] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [685] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [686] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [687] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [688] Lightweight Predictive 3D Gaussian Splats
...
#### [689] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [690] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [691] On Scaling Up 3D Gaussian Splatting Training
...
#### [692] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [693] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [694] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [695] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [696] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [697] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [698] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [699] E2GS: Event Enhanced Gaussian Splatting
...
#### [700] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [701] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [702] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [703] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [704] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [705] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [706] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [707] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [708] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [709] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [710] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [711] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [712] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [713] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [714] Generalizable Human Gaussians from Single-View Image
...
#### [715] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [716] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [717] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [718] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [719] Localized Gaussian Point Management
...
#### [720] Gaussian Representation for Deformable Image Registration
...
#### [721] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [722] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [723] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [724] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [725] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [726] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [727] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [728] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [729] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
