...
#### [1] UniGS: Unified Language-Image-3D Pretraining with Gaussian Splatting
...
#### [2] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [3] Graph-Guided Scene Reconstruction from Images with 3D Gaussian Splatting
...
#### [4] GaussianFlowOcc: Sparse and Weakly Supervised Occupancy Estimation using Gaussian Splatting and Temporal Flow
...
#### [5] GS-TransUNet: Integrated 2D Gaussian Splatting and Transformer UNet for Accurate Skin Lesion Analysis
...
#### [6] Dr. Splat: Directly Referring 3D Gaussian Splatting via Direct Language Embedding Registration
...
#### [7] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**: Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [8] RGB-Only Gaussian Splatting SLAM for Unbounded Outdoor Scenes
...
#### [9] DynamicGSG: Dynamic 3D Gaussian Scene Graphs for Environment Adaptation
...
#### [10] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [11] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [12] High-Dynamic Radar Sequence Prediction for Weather Nowcasting Using Spatiotemporal Coherent Gaussian Representation
...
#### [13] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [14] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [15] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [16] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [17] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [18] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [19] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [20] PUGS: Zero-shot Physical Understanding with Gaussian Splatting
...
#### [21] 3D Gaussian Inpainting with Depth-Guided Cross-View Consistency
...
#### [22] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [23] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [24] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [25] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [26] Self-Calibrating Gaussian Splatting for Large Field of View Reconstruction
...
#### [27] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [28] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [29] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [30] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [31] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [32] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [33] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [34] AuraFusion360: Augmented Unseen Region Alignment for Reference-based 360° Unbounded Scene Inpainting
...
#### [35] GaussRender: Learning 3D Occupancy with Gaussian Rendering
...
#### [36] OccGS: Zero-shot 3D Occupancy Reconstruction with Semantic and Geometric-Aware Gaussian Splatting
...
#### [37] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [38] GARAD-SLAM: 3D GAussian splatting for Real-time Anti Dynamic SLAM
...
#### [39] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [40] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [41] UVGS: Reimagining Unstructured 3D Gaussian Splatting using UV Mapping
...
#### [42] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [43] VR-Robo: A Real-to-Sim-to-Real Framework for Visual Robot Navigation and Locomotion
...
#### [44] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [45] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [46] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [47] Advancing Dense Endoscopic Reconstruction with Gaussian Splatting-driven Surface Normal-aware Tracking and Mapping
...
#### [48] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [49] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [50] Drag Your Gaussian: Effective Drag-Based Editing with Score Distillation for 3D Gaussian Splatting
...
#### [52] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [53] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [54] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [55] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [56] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [57] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [58] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [59] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [60] Dense-SfM: Structure from Motion with Dense Consistent Matching
...
#### [61] HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting
...
#### [62] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [63] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [64] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [65] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [66] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [67] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [68] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [69] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [70] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [71] HAC++: Towards 100X Compression of 3D Gaussian Splatting
...
#### [72] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
...
#### [73] See In Detail: Enhancing Sparse-view 3D Gaussian Splatting with Local Depth and Semantic Regularization
...
#### [74] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [75] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [76] GSTAR: Gaussian Surface Tracking and Reconstruction
...
#### [77] Creating Virtual Environments with 3D Gaussian Splatting: A Comparative Study
- **🧑‍🔬 作者**：Shi Qiu, Binzhu Xie, Qixuan Liu, Pheng-Ann Heng
- **🏫 单位**：The Chinese University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2501.09302.md)] [[arXiv:2501.09302](https://arxiv.org/abs/2501.09302)] [Code]
- **📝 说明**：🏆 Accepted to IEEE VR 2025

#### [78] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [79] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [80] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [81] Object-Centric 2D Gaussian Splatting: Background Removal and Occlusion-Aware Pruning for Compact Object Models
...
#### [82] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [83] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [84] RMAvatar: Photorealistic Human Avatar Reconstruction from Monocular Video Based on Rectified Mesh-embedded Gaussians
...
#### [85] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [86] ActiveGAMER: Active GAussian Mapping through Efficient Rendering
...
#### [87] Generalized and Efficient 2D Gaussian Splatting for Arbitrary-scale Super-Resolution
...
#### [88] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [89] Locality-aware Gaussian Compression for Fast and High-quality Rendering
...
#### [90] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [91] Arc2Avatar: Generating Expressive 3D Avatars from a Single Image via ID Guidance
...
#### [92] Scaffold-SLAM: Structured 3D Gaussians for Simultaneous Localization and Photorealistic Mapping
...
#### [93] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [94] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [95] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [96] MoDec-GS: Global-to-Local Motion Decomposition and Temporal Interval Adjustment for Compact Dynamic 3D Gaussian Splatting
...
#### [97] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [98] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [99] Gaussian Masked Autoencoders
...
#### [100] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [101] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [102] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
...
#### [103] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [104] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [105] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [106] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [107] STORM: Spatio-Temporal Reconstruction Model for Large-Scale Outdoor Scenes
...
#### [108] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [109] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [110] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [111] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
...
#### [112] PERSE: Personalized 3D Generative Avatars from A Single Portrait
...
#### [113] 4D Gaussian Splatting: Modeling Dynamic Scenes with Native 4D Primitives
...
#### [114] MaskGaussian: Adaptive 3D Gaussian Representation from Probabilistic Masks
...
#### [115] GSplatLoc: Ultra-Precise Camera Localization via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Atticus J. Zeller
...
#### [116] FlameGS: Reconstruct flame light field via Gaussian Splatting
...
#### [117] DAS3R: Dynamics-Aware Gaussian Splatting for Static Scene Reconstruction
...
#### [118] Dust to Tower: Coarse-to-Fine Photo-Realistic Scene Reconstruction from Sparse Uncalibrated Images
...
#### [119] Learning Radiance Fields from a Single Snapshot Compressive Image
...
#### [120] Reflective Gaussian Splatting
...
#### [121] Generating Editable Head Avatars with 3D Gaussian GANs
...
#### [122] CLIP-GS: Unifying Vision-Language Representation with 3D Gaussian Splatting
...
#### [123] MVS-GS: High-Quality 3D Gaussian Splatting Mapping via Online Multi-View Stereo
...
#### [124] WeatherGS: 3D Scene Reconstruction in Adverse Weather Conditions via Gaussian Splatting
...
#### [125] ArtNVG: Content-Style Separated Artistic Neighboring-View Gaussian Stylization
...
#### [126] RSGaussian:3D Gaussian Splatting with LiDAR for Aerial Remote Sensing Novel View Synthesis
...
#### [127] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [128] ActiveGS: Active Scene Reconstruction using Gaussian Splatting
...
#### [129] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [130] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [131] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [132] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [133] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [134] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [135] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [136] OmniSplat: Taming Feed-Forward 3D Gaussian Splatting for Omnidirectional Images with Editable Capabilities
...
#### [137] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [138] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [139] CoCoGaussian: Leveraging Circle of Confusion for Gaussian Splatting from Defocused Images
...
#### [140] IRGS: Inter-Reflective Gaussian Splatting with 2D Gaussian Ray Tracing
...
#### [141] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [142] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [143] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [144] EnvGS: Modeling View-Dependent Appearance with Environment Gaussian
...
#### [145] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [146] IDOL: Instant Photorealistic 3D Human Creation from a Single Image
...
#### [147] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [148] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [149] GraphAvatar: Compact Head Avatars with GNN-Generated 3D Gaussians
...
#### [150] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [151] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [152] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [153] GaussTR: Foundation Model-Aligned Gaussian Transformer for Self-Supervised 3D Spatial Understanding
...
#### [154] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [155] EOGS: Gaussian Splatting for Earth Observation
...
#### [156] 4DRGS: 4D Radiative Gaussian Splatting for Efficient 3D Vessel Reconstruction from Sparse-View Dynamic DSA Images
...
#### [157] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [158] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [159] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [160] 3DGUT: Enabling Distorted Cameras and Secondary Rays in Gaussian Splatting
...
#### [161] PanSplat: 4K Panorama Synthesis with Feed-Forward Gaussian Splatting
...
#### [162] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [163] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [164] Deformable Radial Kernel Splatting
...
#### [165] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [166] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [167] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [168] DCSEG: Decoupled 3D Open-Set Segmentation using Gaussian Splatting
...
#### [169] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [170] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [171] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [172] GAF: Gaussian Avatar Reconstruction from Monocular Videos via Multi-view Diffusion
...
#### [173] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [174] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [175] SplineGS: Robust Motion-Adaptive Spline for Real-Time Dynamic 3D Gaussians from Monocular Video
...
#### [176] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [177] MAC-Ego3D: Multi-Agent Gaussian Consensus for Real-Time Collaborative Ego-Motion and Photorealistic 3D Reconstruction
...
#### [178] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [179] Feat2GS: Probing Visual Foundation Models with Gaussian Splatting
...
#### [180] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
- **🧑‍🔬 作者**：Yabo Chen, Chen Yang, Jiemin Fang, Xiaopeng Zhang, Lingxi Xie, Wei Shen, Wenrui Dai, Hongkai Xiong, Qi Tian
...
#### [181] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [182] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [183] GEAL: Generalizable 3D Affordance Learning with Cross-Modal Consistency
...
#### [184] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [185] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [186] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [187] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [188] GASP: Gaussian Avatars with Synthetic Priors
...
#### [189] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [190] Faster and Better 3D Splatting via Group Training
...
#### [191] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [192] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [193] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [194] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [195] MAtCha Gaussians: Atlas of Charts for High-Quality Geometry and Photorealism From Sparse Views
...
#### [196] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [197] Omni-Scene: Omni-Gaussian Representation for Ego-Centric Sparse-View Scene Reconstruction
...
#### [198] Splatter-360: Generalizable 360∘ Gaussian Splatting for Wide-baseline Panoramic Images
...
#### [199] Generative Densification: Learning to Densify Gaussians for High-Fidelity Generalizable 3D Reconstruction
...
#### [200] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [201] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [202] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [203] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [204] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [205] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [206] Street Gaussians without 3D Object Tracker
...
#### [207] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [208] Extrapolated Urban View Synthesis Benchmark
...
#### [209] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [210] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [211] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [212] Turbo3D: Ultra-fast Text-to-3D Generation
...
#### [213] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [214] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [215] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [216] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [217] Multi-View Pose-Agnostic Change Localization with Zero Labels
...
#### [218] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [219] HybridGS: Decoupling Transients and Statics with 2D and 3D Gaussian Splatting
...
#### [220] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [221] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [222] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [223] Volumetrically Consistent 3D Gaussian Rasterization
...
#### [224] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [225] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [226] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [227] AniGS: Animatable Gaussian Avatar from a Single Image with Inconsistent Gaussian Reconstruction
...
#### [228] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [229] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [230] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [231] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [232] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [233] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [234] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [235] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [236] Horizon-GS: Unified 3D Gaussian Splatting for Large-Scale Aerial-to-Ground Scenes
...
#### [237] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [238] SfM-Free 3D Gaussian Splatting via Hierarchical Training
- **🧑‍🔬 作者**：Bo Ji, Angela Yao
- **🏫 单位**：National University of Singapore
...
#### [239] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [240] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [241] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [242] Ref-GS: Directional Factorization for 2D Gaussian Splatting
...
#### [243] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [244] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [245] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [246] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [247] Speedy-Splat: Fast 3D Gaussian Splatting with Sparse Pixels and Sparse Primitives
...
#### [248] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Chenggang Yang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2412.00477.md)] [[arXiv:2412.00477](https://arxiv.org/abs/2412.00477)] [Code]
- **📝 说明**：

#### [249] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [250] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [251] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [252] GuardSplat: Robust and Efficient Watermarking for 3D Gaussian Splatting
...
#### [253] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [254] TexGaussian: Generating High-quality PBR Material via Octree-based 3D Gaussian Splatting
...
#### [255] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [256] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [257] Bootstraping Clustering of Gaussians for View-consistent 3D Scene Understanding
...
#### [258] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [259] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [260] InstanceGaussian: Appearance-Semantic Joint Gaussian Representation for 3D Instance-Level Perception
...
#### [261] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [262] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [263] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [264] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [265] Textured Gaussians for Enhanced 3D Scene Appearance Modeling
...
#### [266] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [267] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [268] Neural Surface Priors for Editable Gaussian Splatting
...
#### [269] Make-It-Animatable: An Efficient Framework for Authoring Animation-Ready 3D Characters
...
#### [270] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [271] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [272] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [273] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [274] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [275] SelfSplat: Pose-Free and 3D Prior-Free Generalizable 3D Gaussian Splatting
...
#### [276] Geometry Field Splatting with Gaussian Surfels
...
#### [277] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [278] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [279] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [280] SplatAD: Real-Time Lidar and Camera Rendering with 3D Gaussian Splatting for Autonomous Driving
...
#### [281] MAGiC-SLAM: Multi-Agent Gaussian Globally Consistent SLAM
...
#### [282] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [283] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [284] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [285] SplatFlow: Multi-View Rectified Flow Model for 3D Gaussian Splatting Synthesis
...
#### [286] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [287] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [288] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [289] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [290] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [291] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [292] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [293] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [294] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [295] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [296] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [297] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [298] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [299] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [300] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [301] 3D Convex Splatting: Radiance Field Rendering with 3D Smooth Convexes
...
#### [302] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [303] VisionPAD: A Vision-Centric Pre-training Paradigm for Autonomous Driving
...
#### [304] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [305] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [306] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [307] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [308] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [309] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
- **🧑‍🔬 作者**：Guangchi Fang, Bing Wang
- **🏫 单位**：The Hong Kong Polytechnic University
- **🔗 链接**：[[中英摘要](./abs/2411.12788.md)] [[arXiv:2411.12788](https://arxiv.org/abs/2411.12788)] [Code]
- **📝 说明**：

#### [310] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [311] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [312] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [313] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [314] DGTR: Distributed Gaussian Turbo-Reconstruction for Sparse-View Vast Scenes
...
#### [315] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [316] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [317] FruitNinja: 3D Object Interior Texture Generation with Gaussian Splatting
...
#### [318] TimeFormer: Capturing Temporal Relationships of Deformable 3D Gaussians for Robust Reconstruction
...
#### [319] DeSiRe-GS: 4D Street Gaussians for Static-Dynamic Decomposition and Surface Reconstruction for Urban Driving Scenes
...
#### [320] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [321] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [322] VeGaS: Video Gaussian Splatting
...
#### [323] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [324] USP-Gaussian: Unifying Spike-based Image Reconstruction, Pose Correction and Gaussian Splatting
...
#### [325] Efficient Density Control for 3D Gaussian Splatting
...
#### [326] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [327] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [328] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [329] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
- **🧑‍🔬 作者**：Han Qi, Tao Cai, Xiyue Han
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2411.07579.md)] [[arXiv:2411.07579](https://arxiv.org/abs/2411.07579)] [Code]
- **📝 说明**：

#### [330] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [331] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [332] Adaptive and Temporally Consistent Gaussian Surfels for Multi-view Dynamic Reconstruction
...
#### [333] SplatFormer: Point Transformer for Robust 3D Gaussian Splatting
...
#### [334] GaussianSpa: An Optimizing-Sparsifying Simplification Framework for Compact and High-Quality 3D Gaussian Splatting
...
#### [335] PEP-GS: Perceptually-Enhanced Precise Structured 3D Gaussians for View-Adaptive Rendering
...
#### [336] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
- **🧑‍🔬 作者**：Jilan Mei, Junbo Li, Cai Meng
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2411.03807.md)] [[arXiv:2411.03807](https://arxiv.org/abs/2411.03807)] [Code]
- **📝 说明**：

#### [337] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [338] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [339] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [340] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [341] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [342] CityGaussianV2: Efficient and Geometrically Accurate Reconstruction for Large-Scale Scenes
...
#### [343] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [344] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [345] No Pose, No Problem: Surprisingly Simple 3D Gaussian Splats from Sparse Unposed Images
...
#### [346] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [347] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [348] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [349] ActiveSplat: High-Fidelity Scene Reconstruction through Active Gaussian Splatting
...
#### [350] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [351] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [352] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [353] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [354] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [355] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [356] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [357] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [358] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [359] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [360] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [361] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [362] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [363] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [364] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [365] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [366] MEGA: Memory-Efficient 4D Gaussian Splatting for Dynamic Scenes
...
#### [367] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [368] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [369] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [370] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [371] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [372] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [373] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [374] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [375] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [376] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [377] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [378] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [379] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [380] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [381] Poison-splat: Computation Cost Attack on 3D Gaussian Splatting
...
#### [382] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [383] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [384] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [385] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [386] 3D Vision-Language Gaussian Splatting
...
#### [387] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [388] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [389] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [390] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [391] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [392] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [393] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [394] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [395] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [396] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [397] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [398] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [399] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [400] Variational Bayes Gaussian Splatting
...
#### [401] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [402] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [403] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [404] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [405] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [406] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [407] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [408] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [409] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [410] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [411] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [412] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [413] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [414] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [415] RNG: Relightable Neural Gaussians
...
#### [416] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [417] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [418] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [419] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [420] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [421] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [422] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [423] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [424] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [425] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [426] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [427] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [428] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [429] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [430] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [431] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [432] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [433] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [434] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [435] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [436] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [437] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [438] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [439] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [440] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [441] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [442] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [443] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [444] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [445] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [446] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [447] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [448] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
- **🧑‍🔬 作者**：Joji Joseph, Bharadwaj Amrutur, Shalabh Bhatnagar
...
#### [449] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [450] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [451] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [452] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [453] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [454] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [455] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [456] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [457] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [458] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [459] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [460] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [461] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [462] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [463] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [464] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [465] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [466] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [467] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [468] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [469] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [470] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [471] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [472] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [473] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [474] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [475] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [476] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [477] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [478] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [479] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [480] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [481] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [482] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [483] OmniRe: Omni Urban Scene Reconstruction
...
#### [484] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [485] G-Style: Stylized Gaussian Splatting
...
#### [486] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [487] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [488] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [489] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [490] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [491] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [492] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [493] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [494] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [495] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [496] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [497] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [498] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [499] Subsurface Scattering for 3D Gaussian Splatting
...
#### [500] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [501] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [502] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [503] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [504] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：This paper has been withdrawn

#### [505] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [506] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [507] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [508] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [509] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [510] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [511] 3D Gaussian Editing with A Single Image
...
#### [512] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [513] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [514] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [515] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [516] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [517] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [518] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [519] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [520] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [521] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [522] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [523] IG-SLAM: Instant Gaussian SLAM
...
#### [524] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [525] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [526] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [527] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [528] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [529] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [530] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [531] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [532] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [533] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [534] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [535] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [536] Gaussian Splatting Lucas-Kanade
...
#### [537] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [538] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [539] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [540] PICA: Physics-Integrated Clothed Avatar
...
#### [541] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [542] Gaussian Eigen Models for Human Heads
...
#### [544] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [545] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [546] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [547] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [548] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [549] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [550] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [551] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [552] Lightweight Predictive 3D Gaussian Splats
...
#### [553] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [554] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
- **🧑‍🔬 作者**：Zuo-Liang Zhu, Beibei Wang, Jian Yang
- **🏫 单位**：Nankai University
- **🔗 链接**：[[中英摘要](./abs/2406.18544.md)] [[arXiv:2406.18544](https://arxiv.org/abs/2406.18544)] [Code]
- **📝 说明**：

#### [555] On Scaling Up 3D Gaussian Splatting Training
...
#### [556] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [557] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [558] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [559] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [560] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [561] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [562] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [563] E2GS: Event Enhanced Gaussian Splatting
...
#### [564] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [565] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [566] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [567] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [568] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [569] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [570] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [571] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [572] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [573] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [574] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [575] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [576] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [577] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [578] Generalizable Human Gaussians from Single-View Image
...
#### [579] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [580] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [581] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [582] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [583] Localized Gaussian Point Management
...
#### [584] Gaussian Representation for Deformable Image Registration
...
#### [585] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [586] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [587] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [588] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [589] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [590] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [591] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [592] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [593] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
