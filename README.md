...
#### [1] MIGS: Multi-Identity Gaussian Splatting via Tensor Decomposition
...
#### [2] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [3] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [4] PICA: Physics-Integrated Clothed Avatar
...
#### [5] GaussReg: Fast 3D Registration with Gaussian Splatting
...
#### [6] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [7] Gaussian Eigen Models for Human Heads
...
#### [9] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [10] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [11] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [12] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [13] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [14] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [33] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [34] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [35] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [36] E2GS: Event Enhanced Gaussian Splatting
...
#### [37] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [38] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [39] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [40] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [41] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [42] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [43] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [44] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [45] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [46] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [49] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [50] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [51] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [52] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [55] From Chaos to Clarity: 3DGS in the Dark
...
#### [56] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [57] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [58] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [61] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [62] Generalizable Human Gaussians from Single-View Image
...
#### [63] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [64] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [65] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [66] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [67] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [70] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [71] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [72] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [75] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [76] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [77] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [78] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [79] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [80] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [81] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [82] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [87] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
