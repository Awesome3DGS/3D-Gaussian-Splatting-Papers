...
#### [1] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [2] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [4] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [5] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [6] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [7] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [9] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [10] MesonGS: Post-training Compression of 3D Gaussians via Efficient Attribute Transformation
...
#### [11] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [12] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [14] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [15] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [16] Robust Dual Gaussian Splatting for Immersive Human-centric Volumetric Videos
...
#### [17] FlashSplat: 2D to 3D Gaussian Splatting Segmentation Solved Optimally
...
#### [18] Thermal3D-GS: Physics-induced 3D Gaussians for Thermal Infrared Novel-view Synthesis
...
#### [20] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [21] Hi3D: Pursuing High-Resolution Image-to-3D Generation with Video Diffusion Models
...
#### [22] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [23] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [24] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [25] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [26] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [27] SpecGaussian with Latent Features: A High-quality Modeling of the View-dependent Appearance for 3D Gaussian Splatting
...
#### [28] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [29] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [30] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [31] Fisheye-GS: Lightweight and Extensible Gaussian Splatting Module for Fisheye Cameras
...
#### [32] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [33] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [34] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [35] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [36] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [37] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [38] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [39] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [40] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [41] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [42] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [43] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [44] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [45] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [46] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [47] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [48] OmniRe: Omni Urban Scene Reconstruction
...
#### [49] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [50] G-Style: Stylized Gaussian Splatting
...
#### [51] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [52] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [53] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [57] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [60] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [61] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [64] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [65] Subsurface Scattering for 3D Gaussian Splatting
...
#### [66] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [67] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [68] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [69] Pano2Room: Novel View Synthesis from a Single Indoor Panorama
...
#### [70] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [71] Large Point-to-Gaussian Model for Image-to-3D Generation
...
#### [72] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [73] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [74] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [75] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [76] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [77] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [78] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [79] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [80] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [81] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [82] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [83] 3D Gaussian Editing with A Single Image
...
#### [84] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [85] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [86] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [87] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [88] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [89] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [90] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
- **🧑‍🔬 作者**：Lingbei Meng, Bi'an Du, Wei Hu
- **🏫 单位**：Peking University
- **🔗 链接**：[[中英摘要](./abs/2408.04831.md)] [[arXiv:2408.04831](https://arxiv.org/abs/2408.04831)] [Code]
- **📝 说明**：

#### [91] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [92] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [93] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [94] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [95] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [96] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [97] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [98] IG-SLAM: Instant Gaussian SLAM
...
#### [99] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [100] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [101] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [102] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [103] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [104] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [105] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [106] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [107] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [108] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [109] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [110] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [111] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [112] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [113] Gaussian Splatting Lucas-Kanade
...
#### [114] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [115] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [116] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [117] WildGaussians: 3D Gaussian Splatting in the Wild
...
#### [118] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [119] 3D Gaussian Ray Tracing: Fast Tracing of Particle Scenes
...
#### [120] PICA: Physics-Integrated Clothed Avatar
...
#### [121] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [122] Gaussian Eigen Models for Human Heads
...
#### [124] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [125] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [126] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [127] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [128] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [129] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [130] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [131] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [132] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [133] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [134] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [135] Lightweight Predictive 3D Gaussian Splats
...
#### [136] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [137] Dynamic Gaussian Marbles for Novel View Synthesis of Casual Monocular Videos
...
#### [138] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [139] On Scaling Up 3D Gaussian Splatting Training
...
#### [140] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [141] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [142] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [143] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [144] Director3D: Real-world Camera Trajectory and 3D Scene Generation from Text
...
#### [145] Reducing the Memory Footprint of 3D Gaussian Splatting
...
#### [146] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [147] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [148] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [149] GeoLRM: Geometry-Aware Large Reconstruction Model for High-Quality 3D Gaussian Generation
...
#### [150] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [151] E2GS: Event Enhanced Gaussian Splatting
...
#### [152] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [153] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [154] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [155] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [156] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [157] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [158] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [159] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [160] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [161] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [162] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [163] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [164] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [165] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [166] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [167] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [168] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [169] Human 3Diffusion: Realistic Avatar Creation via Explicit 3D Consistent Diffusion Models
...
#### [170] From Chaos to Clarity: 3DGS in the Dark
...
#### [171] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [172] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [173] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [174] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [175] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [176] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [177] Generalizable Human Gaussians from Single-View Image
...
#### [178] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [179] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [180] VCR-GauS: View Consistent Depth-Normal Regularizer for Gaussian Surface Reconstruction
...
#### [181] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [182] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [183] Localized Gaussian Point Management
...
#### [184] Gaussian Representation for Deformable Image Registration
...
#### [185] Dynamic 3D Gaussian Fields for Urban Areas
...
#### [186] Event3DGS: Event-based 3D Gaussian Splatting for Fast Egomotion
...
#### [187] Adversarial Generation of Hierarchical Gaussians for 3D Generative Model
...
#### [188] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [189] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [190] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [191] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [192] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [193] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [194] OpenGaussian: Towards Point-Level 3D Gaussian-based Open Vocabulary Understanding
...
#### [195] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [196] End-to-End Rate-Distortion Optimized 3D Gaussian Representation
...
#### [197] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [198] Tetrahedron Splatting for 3D Generation
...
#### [199] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [200] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [201] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [202] MoDGS: Dynamic Gaussian Splatting from Causually-captured Monocular Videos
