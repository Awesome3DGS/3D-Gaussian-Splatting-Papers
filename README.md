...
#### [1] Clustered Error Correction with Grouped 4D Gaussian Splatting
...
#### [2] Rad-GS: Radar-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [3] CuriGS: Curriculum-Guided Gaussian Splatting for Sparse View Synthesis
...
#### [4] Gaussian Blending: Rethinking Alpha Blending in 3D Gaussian Splatting
...
#### [5] Gaussian See, Gaussian Do: Semantic 3D Motion Transfer from Multiview Video
...
#### [6] SparseSurf: Sparse-View 3D Gaussian Splatting for Surface Reconstruction
...
#### [7] Interaction-Aware 4D Gaussian Splatting for Dynamic Hand-Object Interaction Reconstruction
...
#### [8] IBGS: Image-Based Gaussian Splatting
...
#### [9] Dental3R: Geometry-Aware Pairing for Intraoral 3D Reconstruction from Sparse-View Photographs
...
#### [10] GEN3D: Generating Domain-Free 3D Scenes from a Single Image
...
#### [11] iGaussian: Real-Time Camera Pose Estimation via Feed-Forward 3D Gaussian Splatting Inversion
...
#### [12] Training-Free Multi-View Extension of IC-Light for Textual Position-Aware Scene Relighting
...
#### [13] Opt3DGS: Optimizing 3D Gaussian Splatting with Adaptive Exploration and Curvature-Aware Exploitation
...
#### [14] SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting
...
#### [15] SymGS : Leveraging Local Symmetries for 3D Gaussian Splatting Compression
...
#### [16] Monocular 3D Lane Detection via Structure Uncertainty-Aware Network with Curve-Point Queries
...
#### [17] Beyond Darkness: Thermal-Supervised 3D Gaussian Splatting for Low-Light Novel View Synthesis
...
#### [18] TR-Gaussians: High-fidelity Real-time Rendering of Planar Transmission and Reflection with 3D Gaussian Splatting
...
#### [19] SplatSearch: Instance Image Goal Navigation for Mobile Robots using 3D Gaussian Splatting and Diffusion Models
...
#### [20] GUIDE: Gaussian Unified Instance Detection for Enhanced Obstacle Perception in Autonomous Driving
...
#### [21] Neo: Real-Time On-Device 3D Gaussian Splatting with Reuse-and-Update Sorting Acceleration
...
#### [22] Reconstructing 3D Scenes in Native High Dynamic Range
...
#### [23] Changes in Real Time: Online Scene Change Detection with Multi-View Fusion
...
#### [24] SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images
...
#### [25] 3D Gaussian and Diffusion-Based Gaze Redirection
...
#### [26] RealisticDreamer: Guidance Score Distillation for Few-shot Gaussian Splatting
...
#### [27] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
...
#### [28] Depth-Consistent 3D Gaussian Splatting via Physical Defocus Modeling and Multi-View Geometric Supervision
...
#### [29] Multivariate Gaussian Representation Learning for Medical Action Evaluation
...
#### [30] TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting
...
#### [31] AHA! Animating Human Avatars in Diverse Scenes with Gaussian Splatting
...
#### [32] Lumos3D: A Single-Forward Framework for Low-Light 3D Scene Restoration
...
#### [33] OUGS: Active View Selection via Object-aware Uncertainty Estimation in 3DGS
...
#### [34] SkelSplat: Robust Multi-view 3D Human Pose Estimation with Differentiable Gaussian Rendering
...
#### [35] Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric
...
#### [36] YoNoSplat: You Only Need One Model for Feedforward 3D Gaussian Splatting
...
#### [37] 4DSTR: Advancing Generative 4D Gaussians with Spatial-Temporal Rectification for High-Quality and Consistent 4D Generation
...
#### [38] GFix: Perceptually Enhanced Gaussian Splatting Video Compression
...
#### [39] MUGSQA: Novel Multi-Uncertainty-Based Gaussian Splatting Quality Assessment Method, Dataset, and Benchmarks
...
#### [40] ConeGS: Error-Guided Densification Using Pixel Cones for Improved Reconstruction with Fewer Primitives
...
#### [41] Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning
...
#### [42] DIAL-GS: Dynamic Instance Aware Reconstruction for Label-free Street Scenes with 4D Gaussian Splatting
...
#### [43] Inpaint360GS: Efficient Object-Aware 3D Inpainting via Gaussian Splatting for 360° Scenes
...
#### [44] Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field
...
#### [45] StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video
...
#### [46] 4D3R: Motion-Aware Neural Reconstruction and Rendering of Dynamic Scenes from Monocular Videos
...
#### [47] Efficient representation of 3D spatial data for defense-related applications
...
#### [49] Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions
...
#### [50] UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction
...
#### [51] FastGS: Training 3D Gaussian Splatting in 100 Seconds
...
#### [52] CaRF: Enhancing Multi-View Consistency in Referring 3D Gaussian Splatting Segmentation
...
#### [54] DentalSplat: Dental Occlusion Novel View Synthesis from Sparse Intra-Oral Photographs
...
#### [55] PercHead: Perceptual Head Model for Single-Image 3D Head Reconstruction & Editing
...
#### [56] Object-Centric 3D Gaussian Splatting for Strawberry Plant Reconstruction and Phenotyping
...
#### [57] 3D Gaussian Radiation Field Modeling for Integrated RIS-FAS Systems: Analysis and Optimization
...
#### [58] 4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Guassian Splatting
...
#### [59] Diff4Splat: Controllable 4D Scene Generation with Latent Dynamic Reconstruction Models
...
#### [60] Object-Aware 4D Human Motion Generation
...
#### [61] SAGS: Self-Adaptive Alias-Free Gaussian Splatting for Dynamic Surgical Endoscopic Reconstruction
...
#### [62] AgriGS-SLAM: Orchard Mapping Across Seasons via Multi-View Gaussian Splatting SLAM
...
#### [63] 6D Channel Knowledge Map Construction via Bidirectional Wireless Gaussian Splatting
...
#### [64] JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting
...
#### [65] DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes
...
#### [66] NVSim: Novel View Synthesis Simulator for Large Scale Indoor Navigation
...
#### [67] LagMemo: Language 3D Gaussian Splatting Memory for Multi-modal Open-vocabulary Multi-goal Visual Navigation
...
#### [68] EndoWave: Rational-Wavelet 4D Gaussian Splatting for Endoscopic Reconstruction
...
#### [69] Gen-LangSplat: Generalized Language Gaussian Splatting with Pre-Trained Feature Compression
- **🧑‍🔬 作者**：Pranav Saxena
...
#### [70] Region-Adaptive Learned Hierarchical Encoding for 3D Gaussian Splatting Data
...
#### [71] LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering
...
#### [72] RoGER-SLAM: A Robust Gaussian Splatting SLAM System for Noisy and Low-light Environment Resilience
...
#### [73] DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss
...
#### [74] DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum
...
#### [75] Towards Physically Executable 3D Gaussian for Embodied Navigation
...
#### [76] GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation
...
#### [80] Moving Light Adaptive Colonoscopy Reconstruction via Illumination-Attenuation-Aware 3D Gaussian Splatting
...
#### [81] OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion
...
#### [82] Raindrop GS: A Benchmark for 3D Gaussian Splatting under Raindrop Conditions
...
#### [83] Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS
...
#### [84] GSPlane: Concise and Accurate Planar Reconstruction via Structured Representation
...
#### [85] 2DGS-R: Revisiting the Normal Consistency Regularization in 2D Gaussian Splatting
...
#### [86] GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation
...
#### [87] REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting
...
#### [89] GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
...
#### [90] SaLon3R: Structure-aware Long-term Generalizable 3D Reconstruction from Unposed Images
...
#### [91] Terra: Explorable Native 3D World Model with Point Latents
...
#### [92] GauSSmart: Enhanced 3D Reconstruction through 2D Foundation Models and Geometric Filtering
...
#### [93] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [94] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [95] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [96] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [97] PAGS: Priority-Adaptive Gaussian Splatting for Dynamic Driving Scenes
...
#### [98] UniGS: Unified Geometry-Aware Gaussian Splatting for Multimodal Rendering
...
#### [99] Gaussian Semantic Field for One-shot LiDAR Global Localization
...
#### [100] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [101] GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality
...
#### [102] Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation
...
#### [103] Perspective-aware 3D Gaussian Inpainting with Multi-view Consistency
...
#### [104] WorldMirror: Universal 3D World Reconstruction with Any-Prior Prompting
...
#### [105] High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting
...
#### [106] Towards Efficient 3D Gaussian Human Avatar Compression: A Prior-Guided Framework
...
#### [107] Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting
...
#### [108] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [109] Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting
...
#### [110] P-4DGS: Predictive 4D Gaussian Splatting with 90× Compression
...
#### [111] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [112] VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping
...
#### [113] LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates
...
#### [114] Mono4DEditor: Text-Driven 4D Scene Editing from Monocular Video via Point-Level Localization of Language-Embedded Gaussians
...
#### [115] Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes
...
#### [116] ReSplat: Learning Recurrent Gaussian Splats
...
#### [117] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [118] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [119] Splat the Net: Radiance Fields with Splattable Neural Primitives
...
#### [120] CVD-STORM: Cross-View Video Diffusion with Spatial-Temporal Reconstruction Model for Autonomous Driving
...
#### [121] PrismGS: Physically-Grounded Anti-Aliasing for High-Fidelity Large-Scale 3D Gaussian Splatting
...
#### [122] ComGS: Efficient 3D Object-Scene Composition via Surface Octahedral Probes
...
#### [123] Generating Surface for Text-to-3D using 2D Gaussian Splatting
...
#### [124] Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity
...
#### [125] ArchitectHead: Continuous Level of Detail Control for 3D Gaussian Head Avatars
...
#### [126] Progressive Gaussian Transformer with Anisotropy-aware Sampling for Open Vocabulary Occupancy Prediction
- **🧑‍🔬 作者**：Chi Yan, Dan Xu
...
#### [127] SketchPlan: Diffusion Based Drone Planning From Human Sketches
...
#### [129] GS-Share: Enabling High-fidelity Map Sharing with Incremental Gaussian Splatting
...
#### [130] From Tokens to Nodes: Semantic-Guided Motion Control for Dynamic 3D Gaussian Splatting
...
#### [131] GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing
...
#### [132] ROI-GS: Interest-based Local Quality 3D Gaussian Splatting
...
#### [133] LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction
...
#### [134] HART: Human Aligned Reconstruction Transformer
...
#### [135] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [136] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [137] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [138] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [139] UniLat3D: Geometry-Appearance Unified Latents for Single-Stage 3D Generation
...
#### [140] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [141] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [142] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [143] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [144] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [145] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [146] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [147] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [148] Learning Unified Representation of 3D Gaussian Splatting
...
#### [149] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [150] GS-2M: Gaussian Splatting for Joint Mesh Reconstruction and Material Decomposition
...
#### [151] Polysemous Language Gaussian Splatting via Matching-based Mask Lifting
...
#### [152] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [153] Large Material Gaussian Model for Relightable 3D Generation
...
#### [154] Dynamic Novel View Synthesis in High Dynamic Range
...
#### [155] 4D Driving Scene Generation With Stereo Forcing
...
#### [156] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [157] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [158] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [159] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [160] WaveletGaussian: Wavelet-domain Diffusion for Sparse-view 3D Gaussian Object Reconstruction
...
#### [162] DeblurSplat: SfM-free 3D Gaussian Splatting with Event Camera for Robust Deblurring
...
#### [163] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [164] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [165] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [166] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [167] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [168] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [169] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [170] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [171] ST-GS: Vision-Based 3D Semantic Occupancy Prediction with Spatial-Temporal Gaussian Splatting
...
#### [172] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [173] RadarGaussianDet3D: An Efficient and Effective Gaussian-based 3D Detector with 4D Automotive Radars
...
#### [174] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [175] Camera Splatting for Continuous View Optimization
...
#### [176] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [177] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [178] MS-GS: Multi-Appearance Sparse-View 3D Gaussian Splatting in the Wild
...
#### [179] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [180] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [181] RealMirror: A Comprehensive, Open-Source Vision-Language-Action Platform for Embodied AI
...
#### [182] MCGS-SLAM: A Multi-Camera SLAM Framework Using Gaussian Splatting for High-Fidelity Mapping
...
#### [183] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
- **🧑‍🔬 作者**：Yifan Mo, Youcheng Cai, Ligang Liu
- **🏫 单位**：University of Science and Technology of China
- **🔗 链接**：[[中英摘要](./abs/2509.13938.md)] [[arXiv:2509.13938](https://arxiv.org/abs/2509.13938)] [Code]
- **📝 说明**:

#### [184] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [185] Improving 3D Gaussian Splatting Compression by Scene-Adaptive Lattice Vector Quantization
...
#### [186] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [187] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [188] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [189] Distributed 3D Gaussian Splatting for High-Resolution Isosurface Visualization
...
#### [190] E2-BKI: Evidential Ellipsoidal Bayesian Kernel Inference for Uncertainty-aware Gaussian Semantic Mapping
...
#### [191] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [192] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [193] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [195] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [196] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [197] Accurate and Complete Surface Reconstruction from 3D Gaussians via Direct SDF Learning
...
#### [198] DreamLifting: A Plug-in Module Lifting MV Diffusion Models for 3D Asset Generation
...
#### [199] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [200] 3DOF+Quantization: 3DGS quantization for large scenes with limited Degrees of Freedom
...
#### [201] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [202] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [203] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [204] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [205] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [206] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [207] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [208] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [209] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [210] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [211] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [212] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [213] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [214] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [215] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [216] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [217] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [218] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [219] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [220] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [221] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [222] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [223] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [225] IDU: Incremental Dynamic Update of Existing 3D Virtual Environments with New Imagery Data
...
#### [226] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [227] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
- **🧑‍🔬 作者**：Diram Tabaa, Gianni Di Caro
- **🏫 单位**：Carnegie Mellon University
- **🔗 链接**：[[中英摘要](./abs/2508.17012.md)] [[arXiv:2508.17012](https://arxiv.org/abs/2508.17012)] [Code]
- **📝 说明**:

#### [228] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [229] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [230] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [231] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [232] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [233] Zero-shot Volumetric CT Super-Resolution using 3D Gaussian Splatting with Upsampled 2D X-ray Projection Priors
...
#### [234] Snap-Snap: Taking Two Images to Reconstruct 3D Human Gaussians in Milliseconds
...
#### [235] GaussianArt: Unified Modeling of Geometry and Motion for Articulated Objects
...
#### [236] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [237] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [238] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [239] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [240] D^3-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [241] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [242] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [243] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [244] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [245] PhysGM: Large Physical Gaussian Model for Feed-Forward 4D Synthesis
...
#### [246] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [247] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [248] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [249] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [250] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [251] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [252] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [253] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [254] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [255] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [256] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [257] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [258] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [259] Gradient-Direction-Aware Density Control for 3D Gaussian Splatting
...
#### [260] SAGOnline: Segment Any Gaussians Online
...
#### [261] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [262] NeeCo: Image Synthesis of Novel Instrument States Based on Dynamic and Deformable 3D Gaussian Reconstruction
...
#### [263] Touch-Augmented Gaussian Splatting for Enhanced 3D Scene Reconstruction
...
#### [264] Novel View Synthesis with Gaussian Splatting: Impact on Photogrammetry Model Accuracy and Resolution
- **🧑‍🔬 作者**：Pranav Chougule
...
#### [265] DIP-GS: Deep Image Prior For Gaussian Splatting Sparse View Recovery
...
#### [266] Fading the Digital Ink: A Universal Black-Box Attack Framework for 3DGS Watermarking Systems
...
#### [267] 3D Gaussian Representations with Motion Trajectory Field for Dynamic Scene Reconstruction
...
#### [268] 3DGS-VBench: A Comprehensive Video Quality Evaluation Benchmark for 3DGS Compression
...
#### [269] Evaluating Fisheye-Compatible 3D Gaussian Splatting Methods on Real Images Beyond 180 Degree Field of View
...
#### [270] UW-3DGS: Underwater 3D Reconstruction with Physics-Aware Gaussian Splatting
...
#### [271] A 3DGS-Diffusion Self-Supervised Framework for Normal Estimation from a Single Image
...
#### [272] Optimization-Free Style Transfer for 3D Gaussian Splats
...
#### [273] Refining Gaussian Splatting: A Volumetric Densification Approach
...
#### [274] UGOD: Uncertainty-Guided Differentiable Opacity and Soft Dropout for Enhanced Sparse-View 3DGS
...
#### [275] Laplacian Analysis Meets Dynamics Modelling: Gaussian Splatting for 4D Reconstruction
...
#### [276] Perceive-Sample-Compress: Towards Real-Time 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zijian Wang, Beizhen Zhao, Hao Wang
- **🏫 单位**：The Hong Kong University of Science and Technology (Guangzhou)
- **🔗 链接**：[[中英摘要](./abs/2508.04965.md)] [[arXiv:2508.04965](https://arxiv.org/abs/2508.04965)] [Code]
- **📝 说明**:

#### [277] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
...
#### [278] Surf3R: Rapid Surface Reconstruction from Sparse RGB Views in Seconds
...
#### [279] SplitGaussian: Reconstructing Dynamic Scenes via Visual Geometry Decomposition
...
#### [280] DET-GS: Depth- and Edge-Aware Regularization for High-Fidelity 3D Gaussian Splatting
...
#### [281] RLGS: Reinforcement Learning-Based Adaptive Hyperparameter Tuning for Gaussian Splatting
...
#### [282] Uni3R: Unified 3D Reconstruction and Semantic Understanding via Generalizable Gaussian Splatting from Unposed Multi-View Images
...
#### [283] Duplex-GS: Proxy-Guided Weighted Blending for Real-Time Order-Independent Gaussian Splatting
...
#### [284] RobustGS: Unified Boosting of Feedforward 3D Gaussian Splatting under Low-Quality Conditions
...
#### [285] SA-3DGS: A Self-Adaptive Compression Method for 3D Gaussian Splatting
...
#### [286] GENIE: Gaussian Encoding for Neural Radiance Fields Interactive Editing
...
#### [287] PMGS: Reconstruction of Projectile Motion across Large Spatiotemporal Spans via 3D Gaussian Splatting
...
#### [288] GR-Gaussian: Graph-Based Radiative Gaussian Splatting for Sparse-View CT Reconstruction
...
#### [289] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [290] AG2aussian: Anchor-Graph Structured Gaussian Splatting for Instance-Level 3D Scene Understanding and Editing
...
#### [291] OCSplats: Observation Completeness Quantification and Label Noise Separation in 3DGS
...
#### [292] MoGaFace: Momentum-Guided and Texture-Aware Gaussian Avatars for Consistent Facial Geometry
...
#### [293] PointGauss: Point Cloud-Guided Multi-Object Segmentation for Gaussian Splatting
...
#### [294] SeqAffordSplat: Scene-level Sequential Affordance Reasoning on 3D Gaussian Splatting
...
#### [295] Enhanced Velocity Field Modeling for Gaussian Video Reconstruction
...
#### [296] I2V-GS: Infrastructure-to-Vehicle View Transformation with Gaussian Splatting for Autonomous Driving Data Generation
...
#### [297] Stereo 3D Gaussian Splatting SLAM for Outdoor Urban Scenes
...
#### [298] iLRM: An Iterative Large 3D Reconstruction Model
...
#### [299] GSFusion:Globally Optimized LiDAR-Inertial-Visual Mapping for Gaussian Splatting
...
#### [300] UFV-Splatter: Pose-Free Feed-Forward 3D Gaussian Splatting Adapted to Unfavorable Views
...
#### [301] MultiEditor: Controllable Multimodal Object Editing for Driving Scenarios Using 3D Gaussian Splatting Priors
...
#### [302] S3LAM: Surfel Splatting SLAM for Geometrically Accurate Tracking and Mapping
...
#### [303] From Gallery to Wrist: Realistic 3D Bracelet Insertion in Videos
...
#### [304] Decomposing Densification in Gaussian Splatting for Faster 3D Scene Reconstruction
- **🧑‍🔬 作者**：Binxiao Huang, Zhengwu Liu, Ngai Wong
- **🏫 单位**：The University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2507.20239.md)] [[arXiv:2507.20239](https://arxiv.org/abs/2507.20239)] [Code]
- **📝 说明**:

#### [305] RaGS: Unleashing 3D Gaussian Splatting from 4D Radar and Monocular Cues for 3D Object Detection
...
#### [306] Taking Language Embedded 3D Gaussian Splatting into the Wild
- **🧑‍🔬 作者**：Yuze Wang, Yue Qi
- **🏫 单位**：Beihang University
...
#### [307] GSCache: Real-Time Radiance Caching for Volume Path Tracing using 3D Gaussian Splatting
...
#### [308] Gaussian Set Surface Reconstruction through Per-Gaussian Optimization
...
#### [309] Learning Efficient and Generalizable Human Representation with Human Gaussian Model
...
#### [310] Unposed 3DGS Reconstruction with Probabilistic Procrustes Mapping
...
#### [311] GaussianFusionOcc: A Seamless Sensor Fusion Approach for 3D Occupancy Prediction Using 3D Gaussians
...
#### [312] MVG4D: Image Matrix-Based Multi-View and Motion Generation for 4D Content Creation from a Single Image
...
#### [313] G2S-ICP SLAM: Geometry-aware Gaussian Splatting ICP SLAM
...
#### [314] PS-GS: Gaussian Splatting for Multi-View Photometric Stereo
...
#### [315] High-fidelity 3D Gaussian Inpainting: preserving multi-view consistency and photorealistic details
...
#### [316] StreamME: Simplify 3D Gaussian Avatar within Live Stream
...
#### [317] LongSplat: Online Generalizable 3D Gaussian Splatting from Long Sequence Images
...
#### [318] Dream, Lift, Animate: From Single Images to Animatable Gaussian Avatars
...
#### [319] Appearance Harmonization via Bilateral Grid Prediction with Transformers for 3DGS
...
#### [320] Hi^2-GSLoc: Dual-Hierarchical Gaussian-Specific Visual Relocalization for Remote Sensing
...
#### [321] Adaptive 3D Gaussian Splatting Video Streaming: Visual Saliency-Aware Tiling and Meta-Learning-Based Bitrate Adaptation
...
#### [322] Adaptive 3D Gaussian Splatting Video Streaming
...
#### [323] DreamScene: 3D Gaussian-based End-to-end Text-to-3D Scene Generation
...
#### [324] PCR-GS: COLMAP-Free 3D Gaussian Splatting via Pose Co-Regularizations
...
#### [325] VolSegGS: Segmentation and Tracking in Dynamic Volumetric Scenes via Deformable 3D Gaussians
...
#### [326] Wavelet-GS: 3D Gaussian Splatting with Wavelet Decomposition
...
#### [327] BRUM: Robust 3D Vehicle Reconstruction from 360 Sparse Images
...
#### [328] Dark-EvGS: Event Camera as an Eye for Radiance Field in the Dark
...
#### [329] A Mixed-Primitive-based Gaussian Splatting Method for Surface Reconstruction
...
#### [330] MoVieS: Motion-Aware 4D Dynamic View Synthesis in One Second
...
#### [331] 3DGAA: Realistic and Robust 3D Gaussian-based Adversarial Attack for Autonomous Driving
...
#### [332] RePaintGS: Reference-Guided Gaussian Splatting for Realistic and View-Consistent 3D Scene Inpainting
...
#### [333] RTR-GS: 3D Gaussian Splatting for Inverse Rendering with Radiance Transfer and Reflection
...
#### [334] SD-GS: Structured Deformable 3D Gaussians for Efficient Dynamic Scene Reconstruction
...
#### [335] LighthouseGS: Indoor Structure-aware 3D Gaussian Splatting for Panorama-Style Mobile Captures
...
#### [336] Reflections Unlock: Geometry-Aware Reflection Disentanglement in 3D Gaussian Splatting for Photorealistic Scenes Rendering
...
#### [337] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
#### [338] 3DGS_LSR:Large_Scale Relocation for Autonomous Driving Based on 3D Gaussian Splatting
...
#### [339] Mastering Regional 3DGS: Locating, Initializing, and Editing with Diverse 2D Priors
...
#### [340] InterGSEdit: Interactive 3D Gaussian Splatting Editing with 3D Geometry-Consistent Attention Prior
...
#### [341] ArmGS: Composite Gaussian Appearance Refinement for Modeling Dynamic Urban Environments
...
#### [342] HyperGaussians: High-Dimensional Gaussian Splatting for High-Fidelity Animatable Face Avatars
...
#### [343] AvatarMakeup: Realistic Makeup Transfer for 3D Animatable Head Avatars
...
#### [344] VISTA: Open-Vocabulary, Task-Relevant Robot Exploration with Online Semantic Gaussian Splatting
...
#### [345] Masks make discriminative models great again!
...
#### [346] GaussianVLM: Scene-centric 3D Vision-Language Models using Language-aligned Gaussian Splats for Embodied Reasoning and Beyond
...
#### [347] LOD-GS: Level-of-Detail-Sensitive 3D Gaussian Splatting for Detail Conserved Anti-Aliasing
...
#### [348] GDGS: 3D Gaussian Splatting Via Geometry-Guided Initialization And Dynamic Density Control
