...
#### [1] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [2] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [4] Sort-free Gaussian Splatting via Weighted Sum Rendering
...
#### [5] Dynamic 3D Gaussian Tracking for Graph-Based Neural Dynamics Modeling
...
#### [6] VR-Splatting: Foveated Radiance Field Rendering via 3D Gaussian Splatting and Neural Points
...
#### [7] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [8] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [9] SpectroMotion: Dynamic 3D Reconstruction of Specular Scenes
...
#### [10] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [11] E-3DGS: Gaussian Splatting with Exposure and Motion Events
...
#### [12] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [13] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [14] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [15] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [16] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [17] DepthSplat: Connecting Gaussian Splatting and Depth
...
#### [19] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [20] Hybrid bundle-adjusting 3D Gaussians for view consistent rendering with pose optimization
...
#### [21] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [22] Long-LRM: Long-sequence Large Reconstruction Model for Wide-coverage Gaussian Splats
...
#### [23] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [24] SurFhead: Affine Rig Blending for Geometrically Accurate 2D Gaussian Surfel Head Avatars
...
#### [25] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [26] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [28] 4-LEGS: 4D Language Embedded Gaussian Splatting
...
#### [29] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [30] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [32] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [33] MeshGS: Adaptive Mesh-Aligned Gaussian Splatting for High-Quality Rendering
...
#### [34] Look Gauss, No Pose: Novel View Synthesis using Gaussian Splatting without Accurate Pose Initialization
...
#### [35] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [37] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [38] Efficient Perspective-Correct 3D Gaussian Splatting Using Hybrid Transparency
...
#### [39] IncEventGS: Pose-Free Gaussian Splatting from a Single Event Camera
...
#### [40] Fast Feedforward 3D Gaussian Splatting Compression
...
#### [41] 3D Vision-Language Gaussian Splatting
...
#### [42] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [43] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [44] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [45] RelitLRM: Generative Relightable Radiance for Large Reconstruction Models
...
#### [46] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [47] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [48] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [49] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [50] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [51] 6DGS: Enhanced Direction-Aware Gaussian Splatting for Volumetric Rendering
...
#### [52] Next Best Sense: Guiding Vision and Touch with FisherRF for 3D Gaussian Splatting
...
#### [53] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [54] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [55] Variational Bayes Gaussian Splatting
...
#### [56] GI-GS: Global Illumination Decomposition on Gaussian Splatting for Inverse Rendering
...
#### [57] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [58] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [59] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [60] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [61] Gaussian Splatting in Mirrors: Reflection-Aware Rendering via Virtual Camera Optimization
...
#### [62] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [63] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [64] UW-GS: Distractor-Aware 3D Gaussian Splatting for Enhanced Underwater Scene Reconstruction
...
#### [65] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [66] Gaussian-Det: Learning Closed-Surface Gaussians for 3D Object Detection
- **🧑‍🔬 作者**：Hongru Yan, Yu Zheng, Yueqi Duan
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2410.01404.md)] [[arXiv:2410.01404](https://arxiv.org/abs/2410.01404)] [Code]
- **📝 说明**：

#### [67] CaRtGS: Computational Alignment for Real-Time Gaussian Splatting SLAM
...
#### [68] Seamless Augmented Reality Integration in Arthroscopy: A Pipeline for Articular Reconstruction and Guidance
...
#### [69] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
...
#### [70] RL-GSBridge: 3D Gaussian Splatting Based Real2Sim2Real Method for Robotic Manipulation Learning
...
#### [71] Robust Gaussian Splatting SLAM by Leveraging Loop Closure
...
#### [72] RNG: Relightable Neural Gaussians
...
#### [73] GS-EVT: Cross-Modal Event Camera Tracking based on Gaussian Splatting
...
#### [74] 1st Place Solution to the 8th HANDS Workshop Challenge -- ARCTIC Track: 3DGS-based Bimanual Category-agnostic Interaction Reconstruction
...
#### [75] Space-time 2D Gaussian Splatting for Accurate Surface Reconstruction under Complex Dynamic Scenes
...
#### [76] RT-GuIDE: Real-Time Gaussian splatting for Information-Driven Exploration
...
#### [77] Language-Embedded Gaussian Splats (LEGS): Incrementally Building Room-Scale Representations with a Mobile Robot
...
#### [78] WaSt-3D: Wasserstein-2 Distance for Scene-to-Scene Stylization on 3D Gaussians
...
#### [79] HGS-Planner: Hierarchical Planning Framework for Active Scene Reconstruction Using 3D Gaussian Splatting
...
#### [80] SeaSplat: Representing Underwater Scenes with 3D Gaussian Splatting and a Physically Grounded Image Formation Model
...
#### [81] Disco4D: Disentangled 4D Human Generation and Animation from a Single Image
...
#### [82] Go-SLAM: Grounded Object Segmentation and Localization with Gaussian Splatting SLAM
...
#### [83] Generative Object Insertion in Gaussian Splatting with a Multi-View Diffusion Model
...
#### [84] Let's Make a Splan: Risk-Aware Trajectory Optimization in a Normalized Gaussian Splat
...
#### [85] GSplatLoc: Grounding Keypoint Descriptors into 3D Gaussian Splatting for Improved Visual Localization
...
#### [86] Frequency-based View Selection in Gaussian Splatting Reconstruction
...
#### [87] LiDAR-3DGS: LiDAR Reinforced 3D Gaussian Splatting for Multimodal Radiance Field Rendering
...
#### [88] Gaussian Deja-vu: Creating Controllable 3D Gaussian Head-Avatars with Enhanced Generalization and Personalization Abilities
...
#### [89] Semantics-Controlled Gaussian Splatting for Outdoor Scene Reconstruction and Rendering in Virtual Reality
...
#### [90] Plenoptic PNG: Real-Time Neural Radiance Fields in 150 KB
...
#### [91] Human Hair Reconstruction with Strand-Aligned 3D Gaussians
...
#### [92] SplatLoc: 3D Gaussian Splatting-based Visual Localization for Augmented Reality
...
#### [93] Elite-EvGS: Learning Event-based 3D Gaussian Splatting by Distilling Event-to-Video Priors
...
#### [94] 3D-GSW: 3D Gaussian Splatting Watermark for Protecting Copyrights in Radiance Fields
...
#### [95] MGSO: Monocular Real-time Photometric SLAM with Efficient 3D Gaussian Splatting
...
#### [96] GStex: Per-Primitive Texturing of 2D Gaussian Splatting for Decoupled Appearance and Geometry Modeling
...
#### [97] LI-GS: Gaussian Splatting with LiDAR Incorporated for Accurate Large-Scale Reconstruction
...
#### [98] 3DGS-LM: Faster Gaussian-Splatting Optimization with Levenberg-Marquardt
...
#### [99] EdgeGaussians -- 3D Edge Mapping via Gaussian Splatting
...
#### [100] GaRField++: Reinforced Gaussian Radiance Fields for Large-Scale 3D Scene Reconstruction
...
#### [101] Spectral-GS: Taming 3D Gaussian Splatting with Spectral Entropy
...
#### [102] DrivingForward: Feed-forward 3D Gaussian Splatting for Driving Scene Reconstruction from Flexible Surround-view Input
...
#### [103] CrossRT: A cross platform programming technology for hardware-accelerated ray tracing in CG and CV applications
...
#### [104] Hi-SLAM: Scaling-up Semantics in SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [105] Depth Estimation Based on 3D Gaussian Splatting Siamese Defocus
...
#### [106] Gradient-Driven 3D Segmentation and Affordance Transfer in Gaussian Splatting Using 2D Masks
...
#### [107] RenderWorld: World Model with Self-Supervised 3D Label
...
#### [108] GS-Net: Generalizable Plug-and-Play 3D Gaussian Splatting Module
...
#### [109] GLC-SLAM: Gaussian Splatting SLAM with Efficient Loop Closure
...
#### [110] Phys3DGS: Physically-based 3D Gaussian Splatting for Inverse Rendering
...
#### [111] BEINGS: Bayesian Embodied Image-goal Navigation with Gaussian Splatting
...
#### [112] SplatSim: Zero-Shot Sim2Real Transfer of RGB Manipulation Policies Using Gaussian Splatting
...
#### [113] DENSER: 3D Gaussians Splatting for Scene Reconstruction of Dynamic Urban Environments
...
#### [114] SAFER-Splat: A Control Barrier Function for Safe Navigation with Online Gaussian Splatting Maps
...
#### [115] GEVO: Memory-Efficient Monocular Visual Odometry Using Gaussians
...
#### [116] A Diffusion Approach to Radiance Field Relighting using Multi-Illumination Synthesis
...
#### [117] Dense Point Clouds Matter: Dust-GS for Scene Reconstruction from Sparse Viewpoints
...
#### [118] CSS: Overcoming Pose and Scene Challenges in Crowd-Sourced 3D Gaussian Splatting
...
#### [119] SwinGS: Sliding Window Gaussian Splatting for Volumetric Video Streaming with Arbitrary Length
...
#### [120] Self-Evolving Depth-Supervised 3D Gaussian Splatting from Rendered Stereo Pairs
...
#### [121] Instant Facial Gaussians Translator for Relightable and Interactable Facial Rendering
...
#### [122] Single-View 3D Reconstruction via SO(2)-Equivariant Gaussian Sculpting Networks
...
#### [123] ThermalGaussian: Thermal 3D Gaussian Splatting
...
#### [124] gsplat: An Open-Source Library for Gaussian Splatting
...
#### [125] GigaGS: Scaling up Planar-Based 3D Gaussians for Large Scene Surface Reconstruction
...
#### [126] GASP: Gaussian Splatting for Physic-Based Simulations
...
#### [127] Lagrangian Hashing for Compressed Neural Field Representations
...
#### [128] GS-PT: Exploiting 3D Gaussian Splatting for Comprehensive Point Cloud Understanding via Self-supervised Learning
...
#### [129] GST: Precise 3D Human Body from a Single Image with Gaussian Splatting Transformers
...
#### [130] 3D-GP-LMVIC: Learning-based Multi-View Image Coding with 3D Gaussian Geometric Priors
...
#### [131] LM-Gaussian: Boost Sparse-view 3D Gaussian Splatting with Large Model Priors
...
#### [132] Optimizing 3D Gaussian Splatting for Sparse Viewpoint Scene Reconstruction
...
#### [133] Human-VDM: Learning Single-Image 3D Human Gaussian Splatting from Video Diffusion Models
...
#### [134] Object Gaussian for Monocular 6D Pose Estimation from Sparse Views
...
#### [135] GGS: Generalizable Gaussian Splatting for Lane Switching in Autonomous Driving
...
#### [136] DynOMo: Online Point Tracking by Dynamic Online Monocular Gaussian Reconstruction
...
#### [137] PRoGS: Progressive Rendering of Gaussian Splats
...
#### [138] GaussianPU: A Hybrid 2D-3D Upsampling Framework for Enhancing Color Point Clouds via 3D Gaussian Splatting
...
#### [139] Free-DyGS: Camera-Pose-Free Scene Reconstruction based on Gaussian Splatting for Dynamic Surgical Videos
...
#### [140] 3D Gaussian Splatting for Large-scale 3D Surface Reconstruction from Aerial Images
- **🧑‍🔬 作者**：YuanZheng Wu, Jin Liu, Shunping Ji
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2409.00381.md)] [[arXiv:2409.00381](https://arxiv.org/abs/2409.00381)] [Code]
- **📝 说明**：

#### [141] UDGS-SLAM : UniDepth Assisted Gaussian Splatting for Monocular SLAM
...
#### [142] OG-Mapping: Octree-based Structured 3D Gaussians for Online Dense Mapping
...
#### [143] 2DGH: 2D Gaussian-Hermite Splatting for High-quality Rendering and Better Geometry Reconstruction
...
#### [144] ReconX: Reconstruct Any Scene from Sparse Views with Video Diffusion Model
...
#### [145] OmniRe: Omni Urban Scene Reconstruction
...
#### [146] Towards Realistic Example-based Modeling via 3D Gaussian Stitching
...
#### [147] G-Style: Stylized Gaussian Splatting
...
#### [148] Drone-assisted Road Gaussian Splatting with Cross-view Uncertainty
...
#### [149] Robo-GS: A Physics Consistent Spatial-Temporal Model for Robotic Arm with Hybrid Representation
...
#### [150] LapisGS: Layered Progressive 3D Gaussian Splatting for Adaptive Streaming
...
#### [151] Avatar Concept Slider: Manipulate Concepts In Your Human Avatar With Fine-grained Control
...
#### [152] DynaSurfGS: Dynamic Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [153] Splatt3R: Zero-shot Gaussian Splatting from Uncalibrated Image Pairs
...
#### [154] TranSplat: Generalizable 3D Gaussian Splatting from Sparse Multi-View Images with Transformers
...
#### [155] SceneDreamer360: Text-Driven 3D-Consistent Scene Generation with Panoramic Gaussian Splatting
...
#### [156] BiGS: Bidirectional Gaussian Primitives for Relightable 3D Gaussian Splatting
...
#### [157] LayerPano3D: Layered 3D Panorama for Hyper-Immersive Scene Generation
...
#### [158] Atlas Gaussians Diffusion for 3D Generation with Infinite Number of Points
...
#### [159] S4D: Streaming 4D Real-World Reconstruction with Gaussians and 3D Control Points
...
#### [160] FLoD: Integrating Flexible Level of Detail into 3D Gaussian Splatting for Customizable Rendering
...
#### [161] GSFusion: Online RGB-D Mapping Where Gaussian Splatting Meets TSDF Fusion
...
#### [162] Subsurface Scattering for 3D Gaussian Splatting
...
#### [163] Robust 3D Gaussian Splatting for Novel View Synthesis in Presence of Distractors
...
#### [164] DeRainGS: Gaussian Splatting for Enhanced Scene Reconstruction in Rainy Environments
...
#### [165] GaussianOcc: Fully Self-supervised and Efficient 3D Occupancy Estimation with Gaussian Splatting
...
#### [166] GSLoc: Efficient Camera Pose Refinement via 3D Gaussian Splatting
...
#### [167] ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining
...
#### [168] DEGAS: Detailed Expressions on Full-Body Gaussian Avatars
...
#### [169] LoopSplat: Loop Closure by Registering 3D Gaussian Splats
...
#### [170] Implicit Gaussian Splatting with Efficient Multi-Level Tri-Plane Representation
- **🧑‍🔬 作者**：Minye Wu, Tinne Tuytelaars
- **🏫 单位**：KU Leuven
- **🔗 链接**：[[中英摘要](./abs/2408.10041.md)] [[arXiv:2408.10041](https://arxiv.org/abs/2408.10041)] [Code]
- **📝 说明**：

#### [171] SG-GS: Photo-realistic Animatable Human Avatars with Semantically-Guided Gaussian Splatting
...
#### [172] CHASE: 3D-Consistent Human Avatars with Sparse Inputs via Gaussian Splatting and Contrastive Learning
...
#### [173] Gaussian in the Dark: Real-Time View Synthesis From Inconsistent Dark Images Using Gaussian Splatting
...
#### [174] Correspondence-Guided SfM-Free 3D Gaussian Splatting for NVS
...
#### [175] GS-ID: Illumination Decomposition on Gaussian Splatting via Diffusion Prior and Parametric Light Source Optimization
...
#### [176] WaterSplatting: Fast Underwater 3D Scene Reconstruction Using Gaussian Splatting
...
#### [177] FlashGS: Efficient 3D Gaussian Splatting for Large-scale and High-resolution Rendering
...
#### [178] 3D Gaussian Editing with A Single Image
...
#### [179] SpectralGaussians: Semantic, spectral 3D Gaussian splatting for multi-spectral scene representation, visualization and analysis
...
#### [180] HDRGS: High Dynamic Range Gaussian Splatting
...
#### [181] Mipmap-GS: Let Gaussians Deform with Scale-specific Mipmap for Anti-aliasing Rendering
...
#### [182] HeadGAP: Few-shot 3D Head Avatar via Generalizable Gaussian Priors
...
#### [183] Visual SLAM with 3D Gaussian Primitives and Depth Priors Enabling Novel View Synthesis
...
#### [184] PRTGaussian: Efficient Relighting Using 3D Gaussians with Precomputed Radiance Transfer
...
#### [185] Self-augmented Gaussian Splatting with Structure-aware Masks for Sparse-view 3D Reconstruction
...
#### [186] LumiGauss: High-Fidelity Outdoor Relighting with 2D Gaussian Splatting
...
#### [187] InstantStyleGaussian: Efficient Art Style Transfer with 3D Gaussian Splatting
...
#### [188] Towards Real-Time Gaussian Splatting: Accelerating 3DGS through Photometric SLAM
...
#### [189] Compact 3D Gaussian Splatting for Static and Dynamic Radiance Fields
...
#### [190] PRTGS: Precomputed Radiance Transfer of Gaussian Splats for Real-Time High-Quality Relighting
...
#### [191] MGFs: Masked Gaussian Fields for Meshing Building based on Multi-View Images
...
#### [192] Reality Fusion: Robust Real-time Immersive Mobile Robot Teleoperation with Volumetric Visual Data Fusion
...
#### [193] IG-SLAM: Instant Gaussian SLAM
...
#### [194] LoopSparseGS: Loop Based Sparse-View Friendly Gaussian Splatting
...
#### [195] Localized Gaussian Splatting Editing with Contextual Awareness
...
#### [196] Registering Neural 4D Gaussians for Endoscopic Surgery
...
#### [197] ScalingGaussian: Enhancing 3D Content Creation with Generative Gaussian Splatting
...
#### [198] DHGS: Decoupled Hybrid Gaussian Splatting for Driving Scene
...
#### [199] HDRSplat: Gaussian Splatting for High Dynamic Range 3D Scene Reconstruction from Raw Images
...
#### [200] Integrating Meshes and 3D Gaussians for Indoor Scene Reconstruction with SAM Mask Guidance
...
#### [201] Enhancement of 3D Gaussian Splatting using Raw Mesh for Photorealistic Recreation of Architectures
...
#### [202] HoloDreamer: Holistic 3D Panoramic World Generation from Text Descriptions
...
#### [203] GaussianBeV: 3D Gaussian Representation meets Perception Models for BeV Segmentation
...
#### [204] EaDeblur-GS: Event assisted 3D Deblur Reconstruction with Gaussian Splatting
...
#### [205] Splatfacto-W: A Nerfstudio Implementation of Gaussian Splatting for Unconstrained Photo Collections
...
#### [206] MVG-Splatting: Multi-View Guided Gaussian Splatting with Adaptive Quantile-Based Geometric Consistency Densification
...
#### [207] Ev-GS: Event-based Gaussian splatting for Efficient and Accurate Radiance Field Rendering
...
#### [208] Gaussian Splatting Lucas-Kanade
...
#### [209] RecGS: Removing Water Caustic with Recurrent Gaussian Splatting
...
#### [210] SpikeGS: 3D Gaussian Splatting from Spike Streams with High-Speed Camera Motion
...
#### [211] StyleSplat: 3D Object Style Transfer with Gaussian Splatting
...
#### [212] Reference-based Controllable Scene Stylization with Gaussian Splatting
...
#### [213] PICA: Physics-Integrated Clothed Avatar
...
#### [214] SurgicalGaussian: Deformable 3D Gaussians for High-Fidelity Surgical Scene Reconstruction
...
#### [215] Gaussian Eigen Models for Human Heads
...
#### [217] CRiM-GS: Continuous Rigid Motion-Aware Gaussian Splatting from Motion Blur Images
...
#### [218] PFGS: High Fidelity Point Cloud Rendering via Feature Splatting
...
#### [219] Expressive Gaussian Human Avatars from Monocular RGB Video
...
#### [220] AutoSplat: Constrained Gaussian Splatting for Autonomous Driving Scene Reconstruction
...
#### [221] TrAME: Trajectory-Anchored Multi-View Editing for Text-Guided 3D Gaussian Splatting Manipulation
...
#### [222] DRAGON: Drone and Ground Gaussian Splatting for 3D Building Reconstruction
...
#### [223] GaussianStego: A Generalizable Stenography Pipeline for Generative 3D Gaussians Splatting
...
#### [224] RTGS: Enabling Real-Time Gaussian Splatting on Mobile Devices Using Efficiency-Guided Pruning and Foveated Rendering
...
#### [225] OccFusion: Rendering Occluded Humans with Generative Diffusion Priors
...
#### [226] SpotlessSplats: Ignoring Distractors in 3D Gaussian Splatting
...
#### [227] EgoGaussian: Dynamic Scene Understanding from Egocentric Video with 3D Gaussian Splatting
...
#### [228] Lightweight Predictive 3D Gaussian Splats
...
#### [229] FAGhead: Fully Animate Gaussian Head from Monocular Videos
...
#### [230] GS-ROR: 3D Gaussian Splatting for Reflective Object Relighting via SDF Priors
...
#### [231] On Scaling Up 3D Gaussian Splatting Training
...
#### [232] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [233] Trimming the Fat: Efficient Compression of 3D Gaussian Splats through Pruning
...
#### [234] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [235] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [240] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [241] E2GS: Event Enhanced Gaussian Splatting
...
#### [242] Gaussian-Informed Continuum for Physical Property Identification and Simulation
...
#### [243] Splatter a Video: Video Gaussian Representation for Versatile Processing
...
#### [244] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [245] HumanSplat: Generalizable Single-Image Human Gaussian Splatting with Structure Priors
...
#### [246] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [247] Effective Rank Analysis and Regularization for Enhanced 3D Gaussian Splatting
...
#### [248] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [249] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
- **🧑‍🔬 作者**：Jiacong Xu, Yiqun Mei, Vishal M. Patel
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2406.10373.md)] [[arXiv:2406.10373](https://arxiv.org/abs/2406.10373)] [Code]
- **📝 说明**：

#### [250] L4GM: Large 4D Gaussian Reconstruction Model
...
#### [251] PUP 3D-GS: Principled Uncertainty Pruning for 3D Gaussian Splatting
...
#### [252] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [253] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [254] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [255] Modeling Ambient Scene Dynamics for Free-view Synthesis
...
#### [256] WonderWorld: Interactive 3D Scene Generation from a Single Image
...
#### [257] GGHead: Fast and Generalizable 3D Gaussian Heads
...
#### [258] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [259] From Chaos to Clarity: 3DGS in the Dark
...
#### [260] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [261] Cinematic Gaussians: Real-Time HDR Radiance Fields with Depth of Field
...
#### [262] GaussianCity: Generative Gaussian Splatting for Unbounded 3D City Generation
...
#### [263] PGSR: Planar-based Gaussian Splatting for Efficient and High-Fidelity Surface Reconstruction
...
#### [264] MVGamba: Unify 3D Content Generation as State Space Sequence Modeling
...
#### [265] Lighting Every Darkness with 3DGS: Fast Training and Real-Time Rendering for HDR View Synthesis
...
#### [266] Generalizable Human Gaussians from Single-View Image
...
#### [267] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [268] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [275] 3D-HGS: 3D Half-Gaussian Splatting
...
#### [276] Enhancing Temporal Consistency in Video Editing by Reconstructing Videos with 3D Gaussian Splatting
...
#### [277] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [278] DDGS-CT: Direction-Disentangled Gaussian Splatting for Realistic Volume Rendering
...
#### [279] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
- **🧑‍🔬 作者**：Yuze Wang, Junyi Wang, Yue Qi
- **🏫 单位**：Beihang University
- **🔗 链接**：[[中英摘要](./abs/2406.02407.md)] [[arXiv:2406.02407](https://arxiv.org/abs/2406.02407)] [Code]
- **📝 说明**：

#### [280] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [281] FastLGS: Speeding up Language Embedded Gaussians with Feature Grid Mapping
...
#### [282] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [283] DreamPhysics: Learning Physical Properties of Dynamic 3D Gaussians with Video Diffusion Priors
...
#### [284] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [285] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
