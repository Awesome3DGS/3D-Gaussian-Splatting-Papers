...
#### [26] GaussianAvatar: Towards Realistic Human Avatar Modeling from a Single Video via Animatable 3D Gaussians
...
#### [27] MANUS: Markerless Hand-Object Grasp Capture using Articulated 3D Gaussians
...
#### [28] GPS-Gaussian: Generalizable Pixel-wise 3D Gaussian Splatting for Real-time Human Novel View Synthesis
...
#### [29] GauHuman: Articulated Gaussian Splatting for Real-Time 3D Human Rendering
...
#### [30] Gaussian Head Avatar: Ultra High-fidelity Head Avatar via Dynamic Gaussians
...
#### [31] Feature 3DGS: Supercharging 3D Gaussian Splatting to Enable Distilled Feature Fields
...
#### [32] Gaussian-Flow: 4D Reconstruction with Dynamic 3D Gaussian Particle
...
#### [33] HiFi4G: High-Fidelity Human Performance Rendering via Compact Gaussian Splatting
...
#### [34] Relightable Gaussian Codec Avatars
...
#### [35] ASH: Animatable Gaussian Splats for Efficient and Photoreal Human Rendering
...
#### [37] COLMAP-Free 3D Gaussian Splatting
...
#### [38] DrivingGaussian: Composite Gaussian Splatting for Surrounding Dynamic Autonomous Driving Scenes
...
#### [39] Triplane Meets Gaussian Splatting: Fast and Generalizable Single-View 3D Reconstruction with Transformers
...
#### [40] 3DGS-Avatar: Animatable Avatars via Deformable 3D Gaussian Splatting
...
#### [41] GAvatar: Animatable 3D Gaussian Avatars with Implicit Mesh Learning
...
#### [42] pixelSplat: 3D Gaussian Splats from Image Pairs for Scalable Generalizable 3D Reconstruction
...
#### [43] SpecNeRF: Gaussian Directional Encoding for Specular Reflections
...
#### [44] Splatter Image: Ultra-Fast Single-View 3D Reconstruction
...
#### [45] Align Your Gaussians: Text-to-4D with Dynamic 3D Gaussians and Composed Diffusion Models
...
#### [46] SC-GS: Sparse-Controlled Gaussian Splatting for Editable Dynamic Scenes
...
#### [47] LangSplat: 3D Language Gaussian Splatting
...
#### [48] Spacetime Gaussian Feature Splatting for Real-Time Dynamic View Synthesis
...
#### [49] GES: Generalized Exponential Splatting for Efficient Radiance Field Rendering
...
#### [50] VastGaussian: Vast 3D Gaussians for Large Scene Reconstruction
...
#### [51] 3DGStream: On-the-Fly Training of 3D Gaussians for Efficient Streaming of Photo-Realistic Free-Viewpoint Videos
...
#### [53] Splat-SLAM: Dense RGB-D SLAM via 3D Gaussian Splatting
...
#### [55] Compressed 3D Gaussian Splatting for Accelerated Novel View Synthesis
...
#### [56] FreGS: 3D Gaussian Splatting with Progressive Frequency Regularization
...
#### [57] DNGaussian: Optimizing Sparse-View 3D Gaussian Radiance Fields with Global-Local Depth Normalization
...
#### [58] HUGS: Holistic Urban 3D Scene Understanding via Gaussian Splatting
...
#### [59] Gaussian Shadow Casting for Neural Characters
...
#### [62] Guess The Unseen: Dynamic 3D Scene Reconstruction from Partial 2D Glimpses
- **🧑‍🔬 作者**：Inhee Lee, Byungjun Kim, Hanbyul Joo
- **🏫 单位**：Seoul National University
- **🔗 链接**：[[中英摘要](./abs/2404.14410.md)] [[arXiv:2404.14410](https://arxiv.org/abs/2404.14410)] [Code]
- **📝 说明**：🏆 Accepted to CVPR 2024

#### [63] Gaussian Splatting Decoder for 3D‑aware Generative Adversarial Networks
