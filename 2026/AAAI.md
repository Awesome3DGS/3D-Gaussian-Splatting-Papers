# 3D Gaussian Splatting Papers Accepted to AAAI2026

#### [1] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
- **🔗 链接**：[[中英摘要](./abs/2410.22070.md)] [[arXiv:2410.22070](https://arxiv.org/abs/2410.22070)] [[Code](https://github.com/Tavish9/freegaussian)]
- **📝 说明**： 🏆 Accepted to AAAI 2026

#### [2] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [3] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [4] MoBGS: Motion Deblurring Dynamic 3D Gaussian Splatting for Blurry Monocular Video
...
#### [5] GT^2-GS: Geometry-aware Texture Transfer for Gaussian Splatting
...
#### [6] D-FCGS: Feedforward Compression of Dynamic Gaussian Splatting for Free-Viewpoint Videos
...
- **🔗 链接**：[[中英摘要](./abs/2507.05859.md)] [[arXiv:2507.05859](https://arxiv.org/abs/2507.05859)] [[Code](https://github.com/Mr-Zwkid/D-FCGS)]
- **📝 说明**： 🏆 Accepted to AAAI 2026

#### [7] SplatSSC: Decoupled Depth-Guided Gaussian Splatting for Semantic Scene Completion
...
#### [8] FantasyStyle: Controllable Stylized Distillation for 3D Gaussian Splatting
...
#### [9] SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images
...
#### [10] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [11] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [12] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [13] StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video
...
#### [14] Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field
...
#### [15] Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning
...
#### [16] 4DSTR: Advancing Generative 4D Gaussians with Spatial-Temporal Rectification for High-Quality and Consistent 4D Generation
...
#### [17] Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric
...
#### [18] TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting
...
#### [19] Multivariate Gaussian Representation Learning for Medical Action Evaluation
...
#### [20] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
...
#### [21] SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images
...
#### [22] GUIDE: Gaussian Unified Instance Detection for Enhanced Obstacle Perception in Autonomous Driving
...
#### [23] Opt3DGS: Optimizing 3D Gaussian Splatting with Adaptive Exploration and Curvature-Aware Exploitation
...
#### [24] SparseSurf: Sparse-View 3D Gaussian Splatting for Surface Reconstruction
...
#### [25] Gaussian Blending: Rethinking Alpha Blending in 3D Gaussian Splatting
...
#### [26] GS-Checker: Tampering Localization for 3D Gaussian Splatting
...
#### [27] Debiasing Diffusion Priors via 3D Attention for Consistent Gaussian Splatting
...
#### [28] UniC-Lift: Unified 3D Instance Segmentation via Contrastive Learning
...
#### [29] OceanSplat: Object-aware Gaussian Splatting with Trinocular View Consistency for Underwater Scene Reconstruction
...
#### [30] TG-Field: Geometry-Aware Radiative Gaussian Fields for Tomographic Reconstruction
...
#### [31] DipGuava: Disentangling Personalized Gaussian Features for 3D Head Avatars from Monocular Video
...
#### [32] DiffNR: Diffusion-Enhanced Neural Representation Optimization for Sparse-View 3D Tomographic Reconstruction
