...
#### [9] Vision-Only Gaussian Splatting for Collaborative Semantic Occupancy Prediction
...
#### [10] Arbitrary-Scale 3D Gaussian Super-Resolution
...
#### [11] MeshSplat: Generalizable Sparse-View Surface Reconstruction via Gaussian Splatting
...
#### [12] StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video
...
#### [13] Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field
...
#### [14] Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning
...
#### [15] 4DSTR: Advancing Generative 4D Gaussians with Spatial-Temporal Rectification for High-Quality and Consistent 4D Generation
...
#### [16] Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric
...
#### [17] TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting
...
#### [18] Multivariate Gaussian Representation Learning for Medical Action Evaluation
...
#### [19] PINGS-X: Physics-Informed Normalized Gaussian Splatting with Axes Alignment for Efficient Super-Resolution of 4D Flow MRI
...
#### [20] SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images
...
#### [21] GUIDE: Gaussian Unified Instance Detection for Enhanced Obstacle Perception in Autonomous Driving
...
#### [22] Opt3DGS: Optimizing 3D Gaussian Splatting with Adaptive Exploration and Curvature-Aware Exploitation
...
#### [23] SparseSurf: Sparse-View 3D Gaussian Splatting for Surface Reconstruction
...
#### [24] Gaussian Blending: Rethinking Alpha Blending in 3D Gaussian Splatting
...
#### [25] GS-Checker: Tampering Localization for 3D Gaussian Splatting
...
#### [26] Debiasing Diffusion Priors via 3D Attention for Consistent Gaussian Splatting
...
#### [27] UniC-Lift: Unified 3D Instance Segmentation via Contrastive Learning
...
#### [29] TG-Field: Geometry-Aware Radiative Gaussian Fields for Tomographic Reconstruction
...
#### [30] DipGuava: Disentangling Personalized Gaussian Features for 3D Head Avatars from Monocular Video
