# 3D Gaussian Splatting Papers Accepted to ICLR2026

#### [1] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [2] 3DGEER: Exact and Efficient Volumetric Rendering with 3D Gaussians
- **🧑‍🔬 作者**：Zixun Huang, Cho-Ying Wu, Yuliang Guo, Xinyu Huang, Liu Ren
- **🏫 单位**：Bosch Research North America & Bosch Center for AI
- **🔗 链接**：[[中英摘要](./abs/2505.24053.md)] [[arXiv:2505.24053](https://arxiv.org/abs/2505.24053)] [[Code](https://github.com/boschresearch/3dgeer)]
- **📝 说明**： 🏆 Accepted to ICLR 2026

#### [3] StreamSplat: Towards Online Dynamic 3D Reconstruction from Uncalibrated Video Streams
...
#### [4] Self-Supervised Multi-Part Articulated Objects Modeling via Deformable Gaussian Splatting and Progressive Primitive Segmentation
...
#### [5] CryoGS: Gaussian Splatting for Cryo-EM Homogeneous Reconstruction
- **🧑‍🔬 作者**：Suyi Chen, Haibin Ling
- **🏫 单位**：Stony Brook University
- **🔗 链接**：[[中英摘要](./abs/2508.04929.md)] [[arXiv:2508.04929](https://arxiv.org/abs/2508.04929)] [[Code](https://github.com/Chen-Suyi/cryosplat)]
- **📝 说明**： 🏆 Accepted to ICLR 2026
...
#### [7] FastAvatar: Towards Unified Fast High-Fidelity 3D Avatar Reconstruction with Large Gaussian Reconstruction Transformers
...
#### [8] MEGS2: Memory-Efficient Gaussian Splatting via Spherical Gaussians and Unified Pruning
...
#### [9] Lyra: Generative 3D Scene Reconstruction via Video Diffusion Model Self-Distillation
...
#### [10] Dynamic Novel View Synthesis in High Dynamic Range
...
- **🔗 链接**：[[中英摘要](./abs/2509.21853.md)] [[arXiv:2509.21853](https://arxiv.org/abs/2509.21853)] [[Code](https://github.com/prinasi/HDR-4DGS)]
- **📝 说明**： 🏆 Accepted to ICLR 2026

#### [11] Learning Unified Representation of 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuelin Xin, Yuheng Liu, Xiaohui Xie, Xinke Li
- **🏫 单位**：UC Irvine ⟐ City University of Hong Kong
- **🔗 链接**：[[中英摘要](./abs/2509.22917.md)] [[arXiv:2509.22917](https://arxiv.org/abs/2509.22917)] [[Code](https://github.com/cilix-ai/gs-embedding)]
- **📝 说明**： 🏆 Accepted to ICLR 2026

#### [12] WorldSplat: Gaussian-Centric Feed-Forward 4D Scene Generation for Autonomous Driving
...
#### [13] Stylos: Multi-View 3D Stylization with Single-Forward Gaussian Splatting
...
#### [16] ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation
...
#### [17] D2GS: Depth-and-Density Guided Gaussian Splatting for Stable and Accurate Sparse-View Reconstruction
...
#### [18] CLoD-GS: Continuous Level-of-Detail via 3D Gaussian Splatting
...
#### [19] Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer
...
#### [20] G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior
...
#### [21] Uncertainty Matters in Dynamic Gaussian Splatting for Monocular 4D Reconstruction
...
#### [22] SimULi: Real-Time LiDAR and Camera Simulation with Unscented Transforms
...
#### [23] VIST3A: Text-to-3D by Stitching a Multi-view Reconstruction Network to a Video Generator
...
#### [24] FlashWorld: High-quality 3D Scene Generation within Seconds
...
#### [25] MoE-GS: Mixture of Experts for Dynamic Gaussian Splatting
...
#### [26] UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction
...
#### [27] Sharp Monocular View Synthesis in Less Than a Second
...
#### [28] A Step to Decouple Optimization in 3DGS
...
#### [29] SurfSplat: Conquering Feedforward 2D Gaussian Splatting with Surface Continuity Priors
...
#### [30] UrbanGS: A Scalable and Efficient Architecture for Geometrically Accurate Large-Scene Reconstruction
...
#### [31] Splat and Distill: Augmenting Teachers with Feed-Forward 3D Reconstruction For 3D-Aware Distillation
...
#### [32] Augmented Radiance Field: A General Framework for Enhanced Gaussian Splatting
...
#### [33] UFO-4D: Unposed Feedforward 4D Reconstruction from Two Images
...
#### [34] Articulation in Motion: Prior-free Part Mobility Analysis for Articulated Objects By Dynamic-Static Disentanglement
...
#### [35] DiffWind: Physics-Informed Differentiable Modeling of Wind-Driven Object Dynamics
...
#### [36] Flash-Mono: Feed-Forward Accelerated Gaussian Splatting Monocular SLAM
