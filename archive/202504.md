...
#### [15] High-Quality Spatial Reconstruction and Orthoimage Generation Using Efficient 2D Gaussian Splatting
...
#### [17] MATT-GS: Masked Attention-based 3DGS for Robot Perception and Object Detection
...
#### [18] GS-Marker: Generalizable and Robust Watermarking for 3D Gaussian Splatting
...
#### [19] LLGS: Unsupervised Gaussian Splatting for Image Enhancement and Reconstruction in Pure Dark Environment
...
#### [20] StableGS: A Floater-Free Framework for 3D Gaussian Splatting
...
#### [21] ReconDreamer++: Harmonizing Generative and Reconstructive Models for Driving Scene Representation
...
#### [22] GI-SLAM: Gaussian-Inertial SLAM
...
#### [23] Unraveling the Effects of Synthetic Data on End-to-End Autonomous Driving
...
#### [24] PanopticSplatting: End-to-End Panoptic Gaussian Splatting
...
#### [25] SceneSplat: Gaussian Splatting-based Scene Understanding with Vision-Language Pretraining
...
#### [26] Real-time Global Illumination for Dynamic 3D Gaussian Scenes
...
#### [27] GaussianFocus: Constrained Attention Focus for 3D Gaussian Splatting
...
#### [28] GS-LTS: 3D Gaussian Splatting-Based Adaptive Modeling for Long-Term Service Robots
...
#### [29] Is there anything left? Measuring semantic residuals of objects removed from 3D Gaussian Splatting
...
#### [30] Splat-LOAM: Gaussian Splatting LiDAR Odometry and Mapping
...
#### [31] ProtoGS: Efficient and High-Quality Rendering with 3D Gaussian Prototypes
...
#### [32] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [33] Optimized Minimal 3D Gaussian Splatting
...
#### [34] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [36] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [37] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [38] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [39] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [40] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [41] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [42] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [43] Improving Adaptive Density Control for 3D Gaussian Splatting
...
#### [44] Lightweight Gradient-Aware Upscaling of 3D Gaussian Splatting Images
...
#### [45] BG-Triangle: Bézier Gaussian Triangle for 3D Vectorization and Rendering
...
#### [46] Light4GS: Lightweight Compact 4D Gaussian Splatting Generation via Context Model
...
#### [47] Generative Gaussian Splatting: Generating 3D Scenes with Video Diffusion Priors
...
#### [48] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [49] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [50] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [51] Deblur Gaussian Splatting SLAM
...
#### [52] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [53] MTGS: Multi-Traversal Gaussian Splatting
...
#### [54] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [55] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [56] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [57] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [58] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [59] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [60] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [61] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [62] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [63] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [64] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [65] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [70] 3D Student Splatting and Scooping
...
#### [71] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [72] Physics-Aware Human-Object Rendering from Sparse Views via 3D Gaussian Splatting
...
#### [73] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [74] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [76] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [77] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [78] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [79] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [80] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [81] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [82] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [83] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [84] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [85] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [86] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [87] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [88] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [89] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [90] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [91] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [92] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [93] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zexu Huang, Min Xu, Stuart Perry
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2503.06462.md)] [[arXiv:2503.06462](https://arxiv.org/abs/2503.06462)] [Code]
- **📝 说明**：

#### [94] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [95] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [96] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [97] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [98] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [99] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [100] STGA: Selective-Training Gaussian Head Avatars
...
#### [101] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [102] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [103] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [104] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [105] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [106] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [107] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [108] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [109] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [110] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [112] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [113] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [114] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [115] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [116] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [117] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [118] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [120] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [121] Seeing A 3D World in A Grain of Sand
...
#### [122] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [123] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [124] LUCAS: Layered Universal Codec Avatars
...
#### [125] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [126] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [127] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [128] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [129] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [130] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [131] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [132] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [133] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [134] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [135] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [136] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [137] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [138] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [139] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [140] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [141] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [142] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [143] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [144] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [145] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [149] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [150] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [151] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [152] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [153] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [154] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [155] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [156] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [157] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [158] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [159] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [160] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [161] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [162] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [163] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [164] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [165] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [166] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [167] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [168] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [169] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [170] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [171] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [172] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [173] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [174] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [175] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [176] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [177] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [178] Evaluating Human Perception of Novel View Synthesis: Subjective Quality Assessment of Gaussian Splatting and NeRF in Dynamic Scenes
...
#### [179] 3DGS-to-PC: Convert a 3D Gaussian Splatting Scene into a Dense Point Cloud or Mesh
...
#### [180] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [181] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [185] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [186] Gaussian Masked Autoencoders
...
#### [187] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [188] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [189] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [190] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [191] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [192] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [193] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [194] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [195] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [196] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
