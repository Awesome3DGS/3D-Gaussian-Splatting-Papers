...
#### [100] Introducing Unbiased Depth into 2D Gaussian Splatting for High-accuracy Surface Reconstruction
...
#### [101] StructGS: Adaptive Spherical Harmonics and Rendering Enhancements for Superior 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zexu Huang, Min Xu, Stuart Perry
- **🏫 单位**：University of Technology Sydney
- **🔗 链接**：[[中英摘要](./abs/2503.06462.md)] [[arXiv:2503.06462](https://arxiv.org/abs/2503.06462)] [Code]
- **📝 说明**：

#### [102] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [103] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [104] Feature-EndoGaussian: Feature Distilled Gaussian Splatting in Surgical Deformable Scene Reconstruction
...
#### [105] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [106] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [107] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [108] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [109] Self-Modeling Robots by Photographing
...
#### [111] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [112] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [114] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [115] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [116] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [117] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [118] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [119] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [120] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [121] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [122] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [123] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [124] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [125] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [126] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [127] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [128] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [129] GaussianSeal: Rooting Adaptive Watermarks for 3D Gaussian Generation Model
...
#### [130] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [131] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [132] Seeing A 3D World in A Grain of Sand
...
#### [133] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [134] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [135] No Parameters, No Problem: 3D Gaussian Splatting without Camera Intrinsics and Extrinsics
...
#### [136] LUCAS: Layered Universal Codec Avatars
...
#### [137] OpenFly: A Versatile Toolchain and Large-scale Benchmark for Aerial Vision-Language Navigation
...
#### [150] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [151] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [152] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [153] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [154] DenseSplat: Densifying Gaussian Splatting SLAM with Neural Radiance Prior
...
#### [155] TranSplat: Surface Embedding-guided 3D Gaussian Splatting for Transparent Object Manipulation
...
#### [156] MeshSplats: Mesh-Based Rendering with Gaussian Splatting Initialization
...
#### [157] SIREN: Semantic, Initialization-Free Registration of Multi-Robot Gaussian Splatting Maps
...
#### [158] Three-Dimensional MRI Reconstruction with Gaussian Representations: Tackling the Undersampling Problem
...
#### [159] Digital Twin Buildings: 3D Modeling, GIS Integration, and Visual Descriptions Using Gaussian Splatting, ChatGPT/Deepseek, and Google Maps Platform
...
#### [160] PINGS: Gaussian Splatting Meets Distance Fields within a Point-Based Implicit Neural Map
...
#### [161] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [162] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [163] LAYOUTDREAMER: Physics-guided Layout for Text-to-3D Compositional Scene Generation
...
#### [164] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [165] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [166] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
- **🧑‍🔬 作者**：Qixuan Li, Chao Wang, Zongjin He, Yan Peng
- **🏫 单位**：Shanghai University
- **🔗 链接**：[[中英摘要](./abs/2502.00708.md)] [[arXiv:2502.00708](https://arxiv.org/abs/2502.00708)] [Code]
- **📝 说明**：

#### [167] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [168] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [169] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [170] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [171] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [172] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [173] FeatureGS: Eigenvalue-Feature Optimization in 3D Gaussian Splatting for Geometrically Accurate and Artifact-Reduced Reconstruction
...
#### [174] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [175] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [176] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [177] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [178] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [179] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [180] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [181] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [182] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [183] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [184] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [185] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [186] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [187] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [188] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [189] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [190] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [191] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [192] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [195] SplatMAP: Online Dense Monocular SLAM with 3D Gaussian Splatting
...
#### [196] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [198] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [199] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [200] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [201] DehazeGS: Seeing Through Fog with 3D Gaussian Splatting
...
#### [202] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [203] Gaussian Masked Autoencoders
...
#### [204] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [205] EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation
...
#### [206] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [207] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [208] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [209] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [210] Gaussian Building Mesh (GBM): Extract a Building's 3D Mesh with Google Earth and Gaussian Splatting
...
#### [211] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [212] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [213] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [214] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
