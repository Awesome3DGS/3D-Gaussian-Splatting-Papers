...
#### [26] GaussianFocus: Constrained Attention Focus for 3D Gaussian Splatting
...
#### [27] GS-LTS: 3D Gaussian Splatting-Based Adaptive Modeling for Long-Term Service Robots
...
#### [28] Is there anything left? Measuring semantic residuals of objects removed from 3D Gaussian Splatting
...
#### [29] Splat-LOAM: Gaussian Splatting LiDAR Odometry and Mapping
...
#### [30] ProtoGS: Efficient and High-Quality Rendering with 3D Gaussian Prototypes
...
#### [31] DroneSplat: 3D Gaussian Splatting for Robust 3D Reconstruction from In-the-Wild Drone Imagery
...
#### [32] Optimized Minimal 3D Gaussian Splatting
...
#### [33] SAGE: Semantic-Driven Adaptive Gaussian Splatting in Extended Reality
...
#### [35] 1000+ FPS 4D Gaussian Splatting for Dynamic Scene Rendering
...
#### [36] VideoRFSplat: Direct Scene-Level Text-to-3D Gaussian Splatting Generation with Flexible Pose and Multi-View Joint Modeling
...
#### [37] Controlling Avatar Diffusion with Learnable Gaussian Embedding
...
#### [38] ClimateGS: Real-Time Climate Simulation with 3D Gaussian Style Transfer
- **🧑‍🔬 作者**：Yuezhen Xie, Meiying Zhang, Qi Hao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.14845.md)] [[arXiv:2503.14845](https://arxiv.org/abs/2503.14845)] [Code]
- **📝 说明**：

#### [39] SketchSplat: 3D Edge Reconstruction via Differentiable Multi-view Sketch Splatting
...
#### [40] HandSplat: Embedding-Driven Gaussian Splatting for High-Fidelity Hand Rendering
...
#### [41] Optimized 3D Gaussian Splatting using Coarse-to-Fine Image Frequency Modulation
...
#### [46] Gaussian On-the-Fly Splatting: A Progressive Framework for Robust Near Real-Time 3DGS Optimization
...
#### [47] CAT-3DGS Pro: A New Benchmark for Efficient 3DGS Compression
...
#### [48] CompMarkGS: Robust Watermarking for Compression 3D Gaussian Splatting
...
#### [49] Deblur Gaussian Splatting SLAM
...
#### [50] Niagara: Normal-Integrated Geometric Affine Field for Scene Reconstruction from a Single View
...
#### [51] MTGS: Multi-Traversal Gaussian Splatting
...
#### [52] VRsketch2Gaussian: 3D VR Sketch Guided 3D Object Generation with Gaussian Splatting
...
#### [53] TopoGaussian: Inferring Internal Topology Structures from Visual Clues
...
#### [54] GS-I3: Gaussian Splatting for Surface Reconstruction from Illumination-Inconsistent Images
...
#### [55] REdiSplats: Ray Tracing for Editable Gaussian Splatting
...
#### [56] 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction
...
#### [57] DecompDreamer: Advancing Structured 3D Asset Generation with Multi-Object Decomposition and Gaussian Splatting
...
#### [58] DynaGSLAM: Real-Time Gaussian-Splatting SLAM for Online Rendering, Tracking, Motion Predictions of Moving Objects in Dynamic Scenes
...
#### [59] Snapmoji: Instant Generation of Animatable Dual-Stylized Avatars
...
#### [60] Industrial-Grade Sensor Simulation via Gaussian Splatting: A Modular Framework for Scalable Editing and Full-Stack Validation
...
#### [61] Advancing 3D Gaussian Splatting Editing with Complementary and Consensus Information
...
#### [62] EgoSplat: Open-Vocabulary Egocentric Scene Understanding with Language Embedded 3D Gaussian Splatting
...
#### [63] Uncertainty-Aware Normal-Guided Gaussian Splatting for Surface Reconstruction from Sparse Image Sequences
...
#### [64] LHM: Large Animatable Human Reconstruction Model from a Single Image in Seconds
...
#### [65] MuDG: Taming Multi-modal Diffusion with Gaussian Splatting for Urban Scene Reconstruction
...
#### [66] VicaSplat: A Single Run is All You Need for 3D Gaussian Splatting and Camera Estimation from Unposed Video Frames
...
#### [67] ROODI: Reconstructing Occluded Objects with Denoising Inpainters
...
#### [68] 3D Student Splatting and Scooping
...
#### [69] TGP: Two-modal occupancy prediction with 3D Gaussian and sparse points for 3D Environment Awareness
...
#### [70] FPGS: Feed-Forward Semantic-aware Photorealistic Style Transfer of Large-Scale Gaussian Splatting
...
#### [71] Hybrid Rendering for Multimodal Autonomous Driving: Merging Neural and Physics-Based Simulation
...
#### [73] Close-up-GS: Enhancing Close-Up View Synthesis in 3D Gaussian Splatting with Progressive Self-Training
...
#### [74] GASPACHO: Gaussian Splatting for Controllable Humans and Objects
...
#### [75] SDD-4DGS: Static-Dynamic Aware Decoupling in Gaussian Splatting for 4D Scene Reconstruction
...
#### [76] PCGS: Progressive Compression of 3D Gaussian Splatting
...
#### [77] Uni-Gaussians: Unifying Camera and Lidar Simulation with Gaussians for Dynamic Driving Scenarios
...
#### [78] MVD-HuGaS: Human Gaussians from a Single Image via 3D Human Multi-view Diffusion Prior
...
#### [79] S3R-GS: Streamlining the Pipeline for Large-Scale Street Scene Reconstruction
...
#### [80] MVGSR: Multi-View Consistency Gaussian Splatting for Robust Surface Reconstruction
...
#### [81] POp-GS: Next Best View in 3D-Gaussian Splatting with P-Optimality
...
#### [82] EigenGS Representation: From Eigenspace to Gaussian Image Space
...
#### [83] All That Glitters Is Not Gold: Key-Secured 3D Secrets within 3D Gaussian Splatting
...
#### [84] ActiveInitSplat: How Active Image Selection Helps Gaussian Splatting
...
#### [85] Gaussian RBFNet: Gaussian Radial Basis Functions for Fast and Accurate Representation and Reconstruction of Neural Fields
...
#### [86] CoDa-4DGS: Dynamic Gaussian Splatting with Context and Deformation Awareness for Autonomous Driving
...
#### [87] D3DR: Lighting-Aware Object Insertion in Gaussian Splatting
...
#### [88] REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
...
#### [89] Pixel to Gaussian: Ultra-Fast Continuous Super-Resolution with 2D Gaussian Modeling
...
#### [90] StreamGS: Online Generalizable Gaussian Splatting Reconstruction for Unposed Image Streams
...
#### [91] ForestSplats: Deformable transient field for Gaussian Splatting in the Wild
...
#### [92] GSV3D: Gaussian Splatting-based Geometric Distillation with Stable Video Diffusion for Single-Image 3D Object Generation
...
#### [93] Bayesian Fields: Task-driven Open-Set Semantic Gaussian Splatting
...
#### [94] D2GV: Deformable 2D Gaussian Splatting for Video Representation in 400FPS
...
#### [95] Free Your Hands: Lightweight Relightable Turntable Capture Pipeline
...
#### [96] STGA: Selective-Training Gaussian Head Avatars
...
#### [97] SplatPose: Geometry-Aware 6-DoF Pose Estimation from Single RGB Image via 3D Gaussian Splatting
...
#### [98] SeeLe: A Unified Acceleration Framework for Real-Time Gaussian Splatting
...
#### [99] EvolvingGS: High-Fidelity Streamable Volumetric Video via Evolving 3D Gaussian Representation
...
#### [100] GaussianCAD: Robust Self-Supervised CAD Reconstruction from Three Orthographic Views Using 3D Gaussian Splatting
...
#### [101] GSplatVNM: Point-of-View Synthesis for Visual Navigation Models Using Gaussian Splatting
...
#### [102] GaussianVideo: Efficient Video Representation and Compression by Gaussian Splatting
...
#### [103] Instrument-Splatting: Controllable Photorealistic Reconstruction of Surgical Instruments Using Gaussian Splatting
...
#### [104] Surgical Gaussian Surfels: Highly Accurate Real-time Surgical Scene Rendering
...
#### [105] Beyond Existance: Fulfill 3D Reconstructed Scenes with Pseudo Details
...
#### [106] GaussianGraph: 3D Gaussian-based Scene Graph Generation for Open-world Scene Understanding
...
#### [107] LensDFF: Language-enhanced Sparse Feature Distillation for Efficient Few-Shot Dexterous Manipulation
...
#### [108] DQO-MAP: Dual Quadrics Multi-Object mapping with Gaussian Splatting
...
#### [109] LiteGS: A High-Performance Modular Framework for Gaussian Splatting Training
- **🧑‍🔬 作者**：Kaimin Liao
- **🏫 单位**：
- **🔗 链接**：[[中英摘要](./abs/2503.01199.md)] [[arXiv:2503.01199](https://arxiv.org/abs/2503.01199)] [[Code](https://github.com/MooreThreads/LiteGS)]
- **📝 说明**：

#### [110] FGS-SLAM: Fourier-based Gaussian Splatting for Real-time SLAM with Sparse and Dense Map Fusion
...
#### [111] Evolving High-Quality Rendering and Reconstruction in a Unified Framework with Contribution-Adaptive Regularization
...
#### [112] Vid2Fluid: 3D Dynamic Fluid Assets from Single-View Videos with Generative Gaussian Splatting
...
#### [113] PSRGS:Progressive Spectral Residual of 3D Gaussian for High-Frequency Recovery
...
#### [114] Enhancing Monocular 3D Scene Completion with Diffusion Model
...
#### [115] Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups
...
#### [116] Abstract Rendering: Computing All that is Seen in Gaussian Splat Scenes
...
#### [117] Seeing A 3D World in A Grain of Sand
...
#### [118] FlexDrive: Toward Trajectory Flexibility in Driving Scene Reconstruction and Rendering
...
#### [119] EndoPBR: Material and Lighting Estimation for Photorealistic Surgical Simulations via Physically-based Rendering
...
#### [120] LUCAS: Layered Universal Codec Avatars
...
#### [121] Laplace-Beltrami Operator for Gaussian Splatting
...
#### [122] Dragen3D: Multiview Geometry Consistent 3D Gaussian Generation with Drag-Based Control
- **🧑‍🔬 作者**：Jinbo Yan, Alan Zhao, Yixin Hu
- **🏫 单位**：Tencent
- **🔗 链接**：[[中英摘要](./abs/2502.16475.md)] [[arXiv:2502.16475](https://arxiv.org/abs/2502.16475)] [Code]
- **📝 说明**：

#### [123] GS-Cache: A GS-Cache Inference Framework for Large-scale Gaussian Splatting Models
...
#### [124] Hier-SLAM++: Neuro-Symbolic Semantic SLAM with a Hierarchically Categorical Gaussian Splatting
...
#### [125] CDGS: Confidence-Aware Depth Regularization for 3D Gaussian Splatting
...
#### [126] OG-Gaussian: Occupancy Based Street Gaussians for Autonomous Driving
...
#### [127] GlossGau: Efficient Inverse Rendering for Glossy Surface with Anisotropic Spherical Gaussian
...
#### [128] Inter3D: A Benchmark and Strong Baseline for Human-Interactive 3D Object Reconstruction
...
#### [129] 3D Gaussian Splatting aided Localization for Large and Complex Indoor-Environments
- **🧑‍🔬 作者**：Vincent Ress, Jonas Meyer, Wei Zhang, David Skuddis, Uwe Soergel, Norbert Haala
...
#### [130] GS-QA: Comprehensive Quality Assessment Benchmark for Gaussian Splatting View Synthesis
...
#### [131] RadSplatter: Extending 3D Gaussian Splatting to Radio Frequencies for Wireless Radiomap Extrapolation
...
#### [132] Exploring the Versal AI Engine for 3D Gaussian Splatting
...
#### [133] GaussianMotion: End-to-End Learning of Animatable Gaussian Avatars with Pose Guidance from Text
...
#### [134] GS-GVINS: A Tightly-integrated GNSS-Visual-Inertial Navigation System Augmented by 3D Gaussian Splatting
...
#### [135] X-SG2S: Safe and Generalizable Gaussian Splatting with X-dimensional Watermarks
...
#### [141] High-Speed Dynamic 3D Imaging with Sensor Fusion Splatting
...
#### [142] GP-GS: Gaussian Processes for Enhanced Gaussian Splatting
...
#### [143] Scalable 3D Gaussian Splatting-Based RF Signal Spatial Propagation Modeling
...
#### [144] Radiant Foam: Real-Time Differentiable Ray Tracing
...
#### [145] PhiP-G: Physics-Guided Text-to-3D Compositional Scene Generation
...
#### [146] EmoTalkingGaussian: Continuous Emotion-conditioned Talking Head Synthesis
...
#### [147] RaySplats: Ray Tracing based Gaussian Splatting
...
#### [148] JGHand: Joint-Driven Animatable Hand Avater via 3D Gaussian Splatting
...
#### [149] StructuredField: Unifying Structured Geometry and Radiance Field
...
#### [150] VoD-3DGS: View-opacity-Dependent 3D Gaussian Splatting
...
#### [151] CrowdSplat: Exploring Gaussian Splatting For Crowd Rendering
...
#### [152] Evaluating CrowdSplat: Perceived Level of Detail for Gaussian Crowds
- **🧑‍🔬 作者**：Xiaohan Sun, Yinghan Xu, John Dingliana, Carol O'Sullivan
- **🏫 单位**：Trinity College Dublin, Ireland
- **🔗 链接**：[[中英摘要](./abs/2501.17085.md)] [[arXiv:2501.17085](https://arxiv.org/abs/2501.17085)] [Code]
- **📝 说明**：

#### [153] GaussianToken: An Effective Image Tokenizer with 2D Gaussian Splatting
...
#### [154] Towards Better Robustness: Progressively Joint Pose-3DGS Learning for Arbitrarily Long Videos
...
#### [155] HuGDiffusion: Generalizable Single-Image Human Rendering via 3D Gaussian Diffusion
...
#### [156] 3DGS2: Near Second-order Converging 3D Gaussian Splatting
...
#### [157] GS-LiDAR: Generating Realistic LiDAR Point Clouds with Panoramic Gaussian Splatting
...
#### [158] GoDe: Gaussians on Demand for Progressive Level of Detail and Scalable Compression
...
#### [159] MultiDreamer3D: Multi-concept 3D Customization with Concept-Aware Diffusion Guidance
...
#### [160] GeomGS: LiDAR-Guided Geometry-Aware Gaussian Splatting for Robot Localization
...
#### [161] VIGS SLAM: IMU-based Large-Scale 3D Gaussian Splatting SLAM
- **🧑‍🔬 作者**：Gyuhyeon Pak, Euntai Kim
- **🏫 单位**：Yonsei University
- **🔗 链接**：[[中英摘要](./abs/2501.13402.md)] [[arXiv:2501.13402](https://arxiv.org/abs/2501.13402)] [Code]
- **📝 说明**：

#### [162] Deblur-Avatar: Animatable Avatars from Motion-Blurred Monocular Videos
...
#### [163] Sketch and Patch: Efficient 3D Gaussian Representation for Man-Made Scenes
...
#### [164] DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions
...
#### [165] GaussianVideo: Efficient Video Representation Through 2D Gaussian Splatting
- **🧑‍🔬 作者**：Longan Wang, Yuang Shi, Wei Tsang Ooi
- **🏫 单位**：National University of Singapore
- **🔗 链接**：[[中英摘要](./abs/2501.12060.md)] [[arXiv:2501.12060](https://arxiv.org/abs/2501.12060)] [Code]
- **📝 说明**：

#### [166] RDG-GS: Relative Depth Guidance with Gaussian Splatting for Real-time Sparse-View 3D Rendering
...
#### [167] Car-GS: Addressing Reflective and Transparent Surface Challenges in 3D Car Reconstruction
...
#### [168] CityLoc: 6 DoF Localization of Text Descriptions in Large-Scale Scenes with Gaussian Representation
...
#### [169] GS-LIVO: Real-Time LiDAR, Inertial, and Visual Multi-sensor Fused Odometry with Gaussian Mapping
...
#### [170] VINGS-Mono: Visual-Inertial Gaussian Splatting Monocular SLAM in Large Scenes
...
#### [173] F3D-Gaus: Feed-forward 3D-aware Generation on ImageNet with Cycle-Consistent Gaussian Splatting
...
#### [174] Zero-1-to-G: Taming Pretrained 2D Diffusion Model for Direct 3D Generation
...
#### [175] GaussianVideo: Efficient Video Representation via Hierarchical Gaussian Splatting
...
#### [176] Spatiotemporal Gaussian Optimization for 4D Cone Beam CT Reconstruction from Sparse Projections
...
#### [177] ZDySS -- Zero-Shot Dynamic Scene Stylization using Gaussian Splatting
...
#### [178] Compression of 3D Gaussian Splatting with Optimized Feature Planes and Standard Video Codecs
...
#### [179] Gaussian Masked Autoencoders
...
#### [180] GS-DiT: Advancing Video Generation with Pseudo 4D Gaussian Fields through Efficient Dense 3D Point Tracking
...
#### [181] CrossView-GS: Cross-view Gaussian Splatting For Large-scale Scene Reconstruction
- **🧑‍🔬 作者**：Chenhao Zhang, Yuanping Cao, Lei Zhang
- **🏫 单位**：Beijing Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2501.01695.md)] [[arXiv:2501.01695](https://arxiv.org/abs/2501.01695)] [Code]
- **📝 说明**：

#### [182] PG-SAG: Parallel Gaussian Splatting for Fine-Grained Large-Scale Urban Buildings Reconstruction via Semantic-Aware Grouping
...
#### [183] Deformable Gaussian Splatting for Efficient and High-Fidelity Reconstruction of Surgical Scenes
...
#### [184] EasySplat: View-Adaptive Learning makes 3D Gaussian Splatting Easy
...
#### [185] DreamDrive: Generative 4D Scene Modeling from Street View Images
...
#### [186] PanoSLAM: Panoptic 3D Scene Reconstruction via Gaussian SLAM
...
#### [187] SG-Splatting: Accelerating 3D Gaussian Splatting with Spherical Gaussians
...
#### [188] OVGaussian: Generalizable 3D Gaussian Segmentation with Open Vocabularies
