...
#### [12] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [13] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [14] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [15] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [16] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [17] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [18] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [19] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [20] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [21] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [24] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [25] NFL-BA: Improving Endoscopic SLAM with Near-Field Light Bundle Adjustment
...
#### [26] CATSplat: Context-Aware Transformer with Spatial Guidance for Generalizable 3D Gaussian Splatting from A Single-View Image
...
#### [27] HyperGS: Hyperspectral 3D Gaussian Splatting
...
#### [28] Gaussian Billboards: Expressive 2D Gaussian Splatting with Textures
- **🧑‍🔬 作者**：Sebastian Weiss, Derek Bradley
- **🏫 单位**：DisneyResearch
- **🔗 链接**：[[中英摘要](./abs/2412.12734.md)] [[arXiv:2412.12734](https://arxiv.org/abs/2412.12734)] [Code]
- **📝 说明**：

#### [29] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [30] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [31] Deformable Radial Kernel Splatting
...
#### [32] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [33] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [34] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [35] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [36] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [37] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [38] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [39] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [40] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [41] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [42] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [43] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [44] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [45] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [46] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [47] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [48] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [53] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [54] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [55] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [56] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [57] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [58] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [64] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [65] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [66] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [67] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [68] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [69] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [70] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [71] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [72] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [73] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [74] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [75] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [76] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [77] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [78] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [79] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [80] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [81] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [85] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
...
#### [86] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [87] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [88] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [89] DeSplat: Decomposed Gaussian Splatting for Distractor-Free Rendering
...
#### [90] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [91] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [92] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [93] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [94] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [95] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [96] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [97] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [98] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [99] Neural Surface Priors for Editable Gaussian Splatting
...
#### [100] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [101] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [102] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [103] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [104] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [105] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [106] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [108] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [109] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [110] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [111] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [112] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [113] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [114] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [115] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [116] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [117] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [118] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [119] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [120] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [121] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [122] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [123] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [124] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [125] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [126] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
- **🔗 链接**：[[中英摘要](./abs/2411.12452.md)] [[arXiv:2411.12452](https://arxiv.org/abs/2411.12452)] [[Code](https://github.com/Public-BOTs/GaussianPretrain)]
- **📝 说明**：

#### [127] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [128] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [129] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [130] VeGaS: Video Gaussian Splatting
...
#### [131] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [133] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [134] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [135] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [136] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [137] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [138] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [139] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
- **🧑‍🔬 作者**：Ziqi Lu, Jianbo Ye, John Leonard
- **🏫 单位**：Massachusetts Institute of Technology ⟐ Amazon
- **🔗 链接**：[[中英摘要](./abs/2411.03706.md)] [[arXiv:2411.03706](https://arxiv.org/abs/2411.03706)] [[Code](https://github.com/520xyxyzq/3DGS-CD)]
- **📝 说明**：

#### [140] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [141] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [142] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [143] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [144] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [145] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [146] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [147] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [148] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [149] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [150] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [151] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [152] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [153] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [154] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [155] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [160] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [161] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [162] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [163] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [164] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [165] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [166] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [167] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [168] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [169] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [170] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [171] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [172] Variational Bayes Gaussian Splatting
...
#### [173] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [174] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [175] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [176] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [177] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [178] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [179] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [180] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
