...
#### [12] FaceLift: Single Image to 3D Head with View Generation and GS-LRM
...
#### [13] LangSurf: Language-Embedded Surface Gaussians for 3D Scene Understanding
...
#### [14] CoSurfGS:Collaborative 3D Surface Gaussian Splatting with Distributed Learning for Large Scene Reconstruction
...
#### [15] Exploring Dynamic Novel View Synthesis Technologies for Cinematography
...
#### [16] Balanced 3DGS: Gaussian-wise Parallelism Rendering with Fine-Grained Tiling
...
#### [17] GSemSplat: Generalizable Semantic 3D Gaussian Splatting from Uncalibrated Image Pairs
...
#### [18] GeoTexDensifier: Geometry-Texture-Aware Densification for High-Quality Photorealistic 3D Gaussian Splatting
...
#### [19] Topology-Aware 3D Gaussian Splatting: Leveraging Persistent Homology for Optimized Structural Integrity
...
#### [20] SOUS VIDE: Cooking Visual Drone Navigation Policies in a Gaussian Splatting Vacuum
...
#### [21] Interactive Scene Authoring with Specialized Generative Primitives
...
#### [22] AvatarPerfect: User-Assisted 3D Gaussian Splatting Avatar Refinement with Automatic Pose Suggestion
...
#### [23] LiHi-GS: LiDAR-Supervised Gaussian Splatting for Highway Driving Scene Reconstruction
...
#### [24] SolidGS: Consolidating Gaussian Surfel Splatting for Sparse-View Surface Reconstruction
...
#### [25] SqueezeMe: Efficient Gaussian Avatars for VR
...
#### [26] GSRender: Deduplicated Occupancy Prediction via Weakly Supervised 3D Gaussian Splatting
...
#### [27] Improving Geometry in Sparse-View 3DGS via Reprojection-based DoF Separation
...
#### [28] GAGS: Granularity-Aware Feature Distillation for Language Gaussian Splatting
...
#### [29] 4D Radar-Inertial Odometry based on Gaussian Modeling and Multi-Hypothesis Scan Matching
...
#### [30] Turbo-GS: Accelerating 3D Gaussian Fitting for High-Quality Radiance Fields
...
#### [35] Wonderland: Navigating 3D Scenes from a Single Image
...
#### [36] GS-ProCams: Gaussian Splatting-based Projector-Camera Systems
...
#### [37] Deformable Radial Kernel Splatting
...
#### [38] SweepEvGS: Event-Based 3D Gaussian Splatting for Macro and Micro Radiance Field Rendering from a Single Sweep
...
#### [39] EditSplat: Multi-View Fusion and Attention-Guided Optimization for View-Consistent 3D Scene Editing with 3D Gaussian Splatting
...
#### [40] GaussianProperty: Integrating Physical Properties to 3D Gaussians with LMMs
...
#### [41] GaussianWorld: Gaussian World Model for Streaming 3D Occupancy Prediction
...
#### [42] GaussianAD: Gaussian-Centric End-to-End Autonomous Driving
...
#### [43] SuperGSeg: Open-Vocabulary 3D Segmentation with Structured Super-Gaussians
...
#### [44] Toy-GS: Assembling Local Gaussians for Precisely Rendering Large-Scale Free Camera Trajectories
...
#### [45] TSGaussian: Semantic and Depth-Guided Target-Specific Gaussian Splatting from Sparse Views
...
#### [46] RP-SLAM: Real-time Photorealistic SLAM with Efficient 3D Gaussian Splatting
...
#### [47] DSplats: 3D Generation by Denoising Splats-Based Multiview Diffusion Models
...
#### [48] LiftImage3D: Lifting Any Single Image to 3D Gaussians with Video Generation Priors
...
#### [49] FreeSplatter: Pose-free Gaussian Splatting for Sparse-view 3D Reconstruction
...
#### [50] SimAvatar: Simulation-Ready Avatars with Layered Hair and Clothing
...
#### [51] LIVE-GS: LLM Powers Interactive VR by Enhancing Gaussian Splatting
...
#### [52] SLGaussian: Fast Language Gaussian Splatting in Sparse Views
...
#### [53] ProGDF: Progressive Gaussian Differential Field for Controllable and Flexible 3D Editing
...
#### [54] Diffusion-Based Attention Warping for Consistent 3D Scene Editing
...
#### [55] Proc-GS: Procedural Building Generation for City Assembly with 3D Gaussians
...
#### [56] Faster and Better 3D Splatting via Group Training
...
#### [57] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [58] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [59] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [60] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [61] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [62] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [63] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [64] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [65] Temporally Compressed 3D Gaussian Splatting for Dynamic Scenes
...
#### [66] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [67] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [68] Street Gaussians without 3D Object Tracker
...
#### [69] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [70] Extrapolated Urban View Synthesis Benchmark
...
#### [71] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [72] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [73] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [74] Monocular Dynamic Gaussian Splatting is Fast and Brittle but Smooth Motion Helps
...
#### [75] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [76] EmbodiedOcc: Embodied 3D Occupancy Prediction for Vision-based Online Scene Understanding
...
#### [77] InfiniCube: Unbounded and Controllable Dynamic 3D Driving Scene Generation with World-Guided Video Models
...
#### [79] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [80] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [81] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [82] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [83] Splats in Splats: Embedding Invisible 3D Watermark within Gaussian Splatting
...
#### [84] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [85] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [86] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [87] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [88] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [89] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [90] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [91] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [92] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [93] 3DSceneEditor: Controllable 3D Scene Editing with Gaussian Splatting
...
#### [94] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [95] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [96] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [97] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [98] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [99] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [100] A Lesson in Splats: Teacher-Guided Diffusion for 3D Gaussian Splats Generation with 2D Supervision
...
#### [101] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
...
#### [102] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [103] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [104] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [106] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [107] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [108] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [109] SADG: Segment Any Dynamic Gaussian Without Object Trackers
...
#### [110] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [111] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [112] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [113] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [114] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [115] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [116] Neural Surface Priors for Editable Gaussian Splatting
...
#### [117] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [118] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [119] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [120] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [121] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [122] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [123] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [124] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [125] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [126] GAST: Sequential Gaussian Avatars with Hierarchical Spatio-temporal Context
...
#### [127] Bundle Adjusted Gaussian Avatars Deblurring
...
#### [128] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [129] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [130] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [131] Gaussian Scenes: Pose-Free Sparse-View Scene Reconstruction using Depth-Enhanced Diffusion Priors
...
#### [132] PG-SLAM: Photo-realistic and Geometry-aware RGB-D SLAM in Dynamic Environments
...
#### [133] ZeroGS: Training 3D Gaussian Splatting from Unposed Images
...
#### [134] DynamicAvatars: Accurate Dynamic Facial Avatars Reconstruction and Precise Editing with Diffusion Models
...
#### [135] GSurf: 3D Reconstruction via Signed Distance Fields with Direct Gaussian Supervision
...
#### [136] EMD: Explicit Motion Modeling for High-Quality Street Gaussian Splatting
...
#### [137] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [138] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [139] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [140] UniGaussian: Driving Scene Reconstruction from Multiple Camera Models via Unified Gaussian Representations
...
#### [141] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [142] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [143] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [144] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [145] Baking Gaussian Splatting into Diffusion Denoiser for Fast and Scalable Single-stage Image-to-3D Generation
...
#### [146] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [147] GazeGaussian: High-Fidelity Gaze Redirection with 3D Gaussian Splatting
...
#### [148] Sim Anything: Automated 3D Physical Simulation of Open-world Scene with Gaussian Splatting
...
#### [149] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [150] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [151] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [152] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [153] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [158] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [159] GPS-Gaussian+: Generalizable Pixel-wise 3D Gaussian Splatting for Real-Time Human-Scene Rendering from Sparse Views
...
#### [160] VeGaS: Video Gaussian Splatting
...
#### [161] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [162] Efficient Density Control for 3D Gaussian Splatting
...
#### [163] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [164] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [165] MBA-SLAM: Motion Blur Aware Dense Visual SLAM with Radiance Fields Representation
...
#### [166] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [167] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [168] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [169] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [170] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [171] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [172] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [173] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [174] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [175] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [176] Self-Ensembling Gaussian Splatting for Few-shot Novel View Synthesis
...
#### [177] GeoSplatting: Towards Geometry Guided Gaussian Splatting for Physically-based Inverse Rendering
...
#### [178] PF3plat: Pose-Free Feed-Forward 3D Gaussian Splatting
...
#### [179] FreeGaussian: Guidance-free Controllable 3D Gaussian Splats with Flow Derivatives
...
#### [180] LoDAvatar: Hierarchical Embedding and Adaptive Levels of Detail with Gaussian Splatting for Enhanced Human Avatars
...
#### [181] CompGS: Unleashing 2D Compositionality for Compositional Text-to-3D via Dynamically Optimizing 3D Gaussians
...
#### [182] PixelGaussian: Generalizable 3D Gaussian Reconstruction from Arbitrary Views
...
#### [183] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [184] AG-SLAM: Active Gaussian Splatting SLAM
...
#### [185] GS-LIVM: Real-Time Photo-Realistic LiDAR-Inertial-Visual Mapping with Gaussian Splatting
...
#### [186] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [187] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [188] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [189] EF-3DGS: Event-Aided Free-Trajectory 3D Gaussian Splatting
...
#### [190] LUDVIG: Learning-free Uplifting of 2D Visual features to Gaussian Splatting scenes
...
#### [196] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [197] MCGS: Multiview Consistency Enhancement for Sparse-View 3D Gaussian Radiance Fields
...
#### [198] GSORB-SLAM: Gaussian Splatting SLAM benefits from ORB features and Transmittance information
...
#### [199] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [200] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [201] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [202] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [203] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [204] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [205] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [206] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [207] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [208] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [209] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [210] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [211] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [212] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [213] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [214] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [215] Variational Bayes Gaussian Splatting
...
#### [216] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [217] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [218] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [219] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [220] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [221] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [222] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [223] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
