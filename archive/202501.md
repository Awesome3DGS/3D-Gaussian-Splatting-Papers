...
#### [52] ReCap: Better Gaussian Relighting with Cross-Environment Captures
...
#### [53] ResGS: Residual Densification of 3D Gaussian for Efficient Detail Recovery
...
#### [54] EventSplat: 3D Gaussian Splatting from Moving Event Cameras for Real-time Rendering
...
#### [55] MV-DUSt3R+: Single-Stage Scene Reconstruction from Sparse Views In 2 Seconds
...
#### [56] Deblur4DGS: 4D Gaussian Splatting from Blurry Monocular Video
...
#### [57] Efficient Semantic Splatting for Remote Sensing Multi-view Segmentation
...
#### [58] GBR: Generative Bundle Refinement for High-fidelity Gaussian Splatting and Meshing
...
#### [59] SizeGS: Size-aware Compression of 3D Gaussians with Hierarchical Mixed Precision Quantization
...
#### [60] WATER-GS: Toward Copyright Protection for 3D Gaussian Splatting via Universal Watermarking
...
#### [61] Text-to-3D Gaussian Splatting with Physics-Grounded Motion Generation
...
#### [62] Radiant: Large-scale 3D Gaussian Rendering based on Hierarchical Framework
...
#### [63] Extrapolated Urban View Synthesis Benchmark
...
#### [64] MixedGaussianAvatar: Realistically and Geometrically Accurate Head Avatar via Mixed 2D-3D Gaussian Splatting
...
#### [65] Momentum-GS: Momentum Gaussian Self-Distillation for High-Quality Large Scene Reconstruction
...
#### [66] Pushing Rendering Boundaries: Hard Gaussian Splatting
...
#### [67] PBDyG: Position Based Dynamic Gaussians for Motion-Aware Clothed Human Avatars
...
#### [68] DGNS: Deformable Gaussian Splatting and Dynamic Neural Surface for Monocular Dynamic 3D Reconstruction
...
#### [69] Feed-Forward Bullet-Time Reconstruction of Dynamic Scenes from Monocular Videos
...
#### [70] Urban4D: Semantic-Guided 4D Gaussian Splatting for Urban Scene Reconstruction
...
#### [71] 2DGS-Room: Seed-Guided 2D Gaussian Splatting with Geometric Constrains for High-Fidelity Indoor Scene Reconstruction
...
#### [72] SGSST: Scaling Gaussian Splatting StyleTransfer
...
#### [73] RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos
...
#### [74] RelayGS: Reconstructing Dynamic Scenes with Large-Scale and Complex Motions via Relay Gaussians
...
#### [75] GSGTrack: Gaussian Splatting-Guided Object Pose Tracking from RGB Videos
...
#### [76] Multi-robot autonomous 3D reconstruction using Gaussian splatting with Semantic guidance
...
#### [77] SparseLGS: Sparse View Language Embedded Gaussian Splatting
...
#### [78] SparseGrasp: Robotic Grasping via 3D Semantic Gaussian Splatting from Sparse Multi-View RGB Images
...
#### [79] Gaussian Object Carver: Object-Compositional Gaussian Splatting with surfaces completion
...
#### [80] HDGS: Textured 2D Gaussian Splatting for Enhanced Scene Rendering
...
#### [81] Occam's LGS: A Simple Approach for Language Gaussian Splatting
- **🧑‍🔬 作者**：Jiahuan Cheng, Jan-Nico Zaech, Luc Van Gool, Danda Pani Paudel
...
#### [82] 6DOPE-GS: Online 6D Object Pose Estimation using Gaussian Splatting
...
#### [83] ULSR-GS: Ultra Large-scale Surface Reconstruction Gaussian Splatting with Multi-View Geometric Consistency
...
#### [84] RGBDS-SLAM: A RGB-D Semantic Dense SLAM Based on 3D Multi Level Pyramid Gaussian Splatting
...
#### [85] DynSUP: Dynamic Gaussian Splatting from An Unposed Image Pair
...
#### [86] ChatSplat: 3D Conversational Gaussian Splatting
...
#### [87] FlashSLAM: Accelerated RGB-D SLAM for Real-Time 3D Scene Reconstruction with Gaussian Splatting
...
#### [88] LineGS : 3D Line Segment Representation on 3D Gaussian Splatting
...
#### [89] GradiSeg: Gradient-Guided Gaussian Segmentation with Enhanced 3D Boundary Precision
...
#### [90] Gaussians on their Way: Wasserstein-Constrained 4D Gaussian Splatting with State-Space Modeling
...
#### [91] T-3DGS: Removing Transient Objects for 3D Scene Reconstruction
...
#### [93] Tortho-Gaussian: Splatting True Digital Orthophoto Maps
...
#### [94] Gaussian Splashing: Direct Volumetric Rendering Underwater
...
#### [95] GausSurf: Geometry-Guided 3D Gaussian Splatting for Surface Reconstruction
...
#### [96] SuperGaussians: Enhancing Gaussian Splatting Using Primitives with Spatially Varying Colors
...
#### [97] RIGI: Rectifying Image-to-3D Generation Inconsistency via Uncertainty-aware Learning
...
#### [98] GaussianSpeech: Audio-Driven Gaussian Avatars
...
#### [99] Point Cloud Unsupervised Pre-training via 3D Gaussian Splatting
...
#### [100] PhyCAGE: Physically Plausible Compositional 3D Asset Generation from a Single Image
...
#### [101] HEMGS: A Hybrid Entropy Model for 3D Gaussian Splatting Data Compression
...
#### [102] Neural Surface Priors for Editable Gaussian Splatting
...
#### [103] SmileSplat: Generalizable Gaussian Splats for Unconstrained Sparse Images
...
#### [104] GLS: Geometry-aware 3D Language Gaussian Splatting
...
#### [105] HI-SLAM2: Geometry-Aware Gaussian SLAM for Fast Monocular Scene Reconstruction
...
#### [106] DROID-Splat: Combining end-to-end SLAM with 3D Gaussian Splatting
...
#### [107] Distractor-free Generalizable 3D Gaussian Splatting
...
#### [108] 4D Scaffold Gaussian Splatting for Memory Efficient Dynamic Scene Reconstruction
...
#### [109] G2SDF: Surface Reconstruction from Explicit Gaussians with Implicit SDFs
...
#### [110] PreF3R: Pose-Free Feed-Forward 3D Gaussian Splatting from Variable-length Image Sequence
...
#### [111] NovelGS: Consistent Novel-view Denoising via Large Gaussian Reconstruction Model
...
#### [112] Quadratic Gaussian Splatting for Efficient and Detailed Surface Reconstruction
...
#### [113] Event-boosted Deformable 3D Gaussians for Fast Dynamic Scene Reconstruction
...
#### [114] UnitedVLN: Generalizable Gaussian Splatting for Continuous Vision-Language Navigation
...
#### [119] SplatFlow: Self-Supervised Dynamic Gaussian Splatting in Neural Motion Flow Field for Autonomous Driving
...
#### [120] Gassidy: Gaussian Splatting SLAM in Dynamic Environments
...
#### [121] SplatSDF: Boosting Neural Implicit SDF via Gaussian Splatting Fusion
...
#### [122] Gradient-Weighted Feature Back-Projection: A Fast Alternative to Feature Distillation in 3D Gaussian Splatting
...
#### [123] Neural 4D Evolution under Large Topological Changes from 2D Images
...
#### [124] Dynamics-Aware Gaussian Splatting Streaming Towards Fast On-the-Fly Training for 4D Reconstruction
...
#### [125] NexusSplats: Efficient 3D Gaussian Splatting in the Wild
...
#### [126] FAST-Splat: Fast, Ambiguity-Free Semantics Transfer in Gaussian Splatting
- **🧑‍🔬 作者**：Ola Shorinwa, Jiankai Sun, Mac Schwager
- **🏫 单位**：Stanford University
- **🔗 链接**：[[中英摘要](./abs/2411.13753.md)] [[arXiv:2411.13753](https://arxiv.org/abs/2411.13753)] [Code]
- **📝 说明**：

#### [127] Mini-Splatting2: Building 360 Scenes within Minutes via Aggressive Gaussian Densification
...
#### [128] PR-ENDO: Physically Based Relightable Gaussian Splatting for Endoscopy
...
#### [129] SCIGS: 3D Gaussians Splatting from a Snapshot Compressive Image
...
#### [130] GaussianPretrain: A Simple Unified 3D Gaussian Representation for Visual Pre-training in Autonomous Driving
...
#### [131] Beyond Gaussians: Fast and High-Fidelity 3D Splatting with Linear Kernels
...
#### [132] LiV-GS: LiDAR-Vision Integration for 3D Gaussian Splatting SLAM in Outdoor Environments
...
#### [133] Sketch-guided Cage-based 3D Gaussian Splatting Deformation
...
#### [134] RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator
...
#### [135] VeGaS: Video Gaussian Splatting
...
#### [136] DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
#### [137] Efficient Density Control for 3D Gaussian Splatting
...
#### [138] DyGASR: Dynamic Generalized Exponential Splatting with Surface Alignment for Accelerated 3D Mesh Reconstruction
...
#### [139] BillBoard Splatting (BBSplat): Learnable Textured Primitives for Novel View Synthesis
...
#### [140] Projecting Gaussian Ellipsoids While Avoiding Affine Projection Approximation
...
#### [141] GUS-IR: Gaussian Splatting with Unified Shading for Inverse Rendering
...
#### [142] A Hierarchical Compression Technique for 3D Gaussian Splatting Compression
...
#### [143] GS2Pose: Two-stage 6D Object Pose Estimation Guided by Gaussian Splatting
...
#### [144] 3DGS-CD: 3D Gaussian Splatting-based Change Detection for Physical Object Rearrangement
...
#### [145] HFGaussian: Learning Generalizable Gaussian Human with Integrated Human Features
...
#### [146] LVI-GS: Tightly-coupled LiDAR-Visual-Inertial SLAM using 3D Gaussian Splatting
...
#### [147] Modeling Uncertainty in 3D Gaussian Splatting through Continuous Semantic Splatting
...
#### [148] Real-Time Spatio-Temporal Reconstruction of Dynamic Endoscopic Scenes with 4D Gaussian Splatting
...
#### [149] Aquatic-GS: A Hybrid 3D Representation for Underwater Scenes
...
#### [153] PLGS: Robust Panoptic Lifting with 3D Gaussian Splatting
...
#### [155] Multi-Layer Gaussian Splatting for Immersive Anatomy Visualization
...
#### [156] MvDrag3D: Drag-based Creative 3D Editing via Multi-view Generation-Reconstruction Priors
...
#### [157] LucidFusion: Generating 3D Gaussians with Arbitrary Unposed Images
...
#### [158] GlossyGS: Inverse Rendering of Glossy Objects with 3D Gaussian Splatting
...
#### [159] UniG: Modelling Unitary 3D Gaussians for View-consistent 3D Reconstruction
...
#### [160] SplatPose+: Real-time Image-Based Pose-Agnostic 3D Anomaly Detection
...
#### [161] LoGS: Visual Localization via Gaussian Splatting with Fewer Training Images
...
#### [162] 4DStyleGaussian: Zero-shot 4D Style Transfer with Gaussian Splatting
...
#### [163] Gaussian Splatting Visual MPC for Granular Media Manipulation
...
#### [164] Enhancing Single Image to 3D Generation using Gaussian Splatting and Hybrid Diffusion Priors
...
#### [165] SurgicalGS: Dynamic 3D Gaussian Splatting for Accurate Robotic-Assisted Surgical Scene Reconstruction
...
#### [166] FusionSense: Bridging Common Sense, Vision, and Touch for Robust Sparse-View Reconstruction
...
#### [167] RGM: Reconstructing High-fidelity 3D Car Assets with Relightable 3D-GS Generative Model from a Single Image
...
#### [168] Spiking GS: Towards High-Accuracy and Low-Cost Surface Reconstruction via Spiking Neuron-based Gaussian Splatting
...
#### [169] ES-Gaussian: Gaussian Splatting Mapping via Error Space-Based Gaussian Completion
...
#### [170] HiSplat: Hierarchical 3D Gaussian Splatting for Generalizable Sparse-View Reconstruction
...
#### [171] GSLoc: Visual Localization with 3D Gaussian Splatting
...
#### [172] SplaTraj: Camera Trajectory Generation with Semantic Gaussian Splatting
...
#### [173] GS-VTON: Controllable 3D Virtual Try-on with Gaussian Splatting
...
#### [174] LiDAR-GS:Real-time LiDAR Re-Simulation using Gaussian Splatting
...
#### [175] PhotoReg: Photometrically Registering 3D Gaussian Splatting Models
...
#### [176] Mode-GS: Monocular Depth Guided Anchored 3D Gaussian Splatting for Robust Ground-View Scene Rendering
...
#### [177] StreetSurfGS: Scalable Urban Street Surface Reconstruction with Planar-based Gaussian Splatting
...
#### [178] Variational Bayes Gaussian Splatting
...
#### [179] SuperGS: Super-Resolution 3D Gaussian Splatting via Latent Feature Field and Gradient-guided Splitting
...
#### [180] MVGS: Multi-view-regulated Gaussian Splatting for Novel View Synthesis
...
#### [181] EVER: Exact Volumetric Ellipsoid Rendering for Real-time View Synthesis
...
#### [182] 3DGS-DET: Empower 3D Gaussian Splatting with Boundary Guidance and Box-Focused Sampling for 3D Object Detection
...
#### [183] GaussianBlock: Building Part-Aware Compositional and Editable 3D Scene by Primitives and Gaussians
...
#### [184] MiraGe: Editable 2D Images using Gaussian Splatting
...
#### [185] EVA-Gaussian: 3D Gaussian-based Real-time Human Novel View Synthesis under Diverse Camera Settings
...
#### [186] GSPR: Multimodal Place Recognition Using 3D Gaussian Splatting for Autonomous Driving
