...
#### [65] 4D3R: Motion-Aware Neural Reconstruction and Rendering of Dynamic Scenes from Monocular Videos
...
#### [66] DIAL-GS: Dynamic Instance Aware Reconstruction for Label-free Street Scenes with 4D Gaussian Splatting
...
#### [67] ConeGS: Error-Guided Densification Using Pixel Cones for Improved Reconstruction with Fewer Primitives
...
#### [68] GFix: Perceptually Enhanced Gaussian Splatting Video Compression
...
#### [69] YoNoSplat: You Only Need One Model for Feedforward 3D Gaussian Splatting
...
#### [70] Lumos3D: A Single-Forward Framework for Low-Light 3D Scene Restoration
...
#### [71] AHA! Animating Human Avatars in Diverse Scenes with Gaussian Splatting
...
#### [72] Depth-Consistent 3D Gaussian Splatting via Physical Defocus Modeling and Multi-View Geometric Supervision
...
#### [73] RealisticDreamer: Guidance Score Distillation for Few-shot Gaussian Splatting
...
#### [74] 3D Gaussian and Diffusion-Based Gaze Redirection
...
#### [75] Reconstructing 3D Scenes in Native High Dynamic Range
...
#### [76] Neo: Real-Time On-Device 3D Gaussian Splatting with Reuse-and-Update Sorting Acceleration
...
#### [77] SplatSearch: Instance Image Goal Navigation for Mobile Robots using 3D Gaussian Splatting and Diffusion Models
...
#### [78] TR-Gaussians: High-fidelity Real-time Rendering of Planar Transmission and Reflection with 3D Gaussian Splatting
...
#### [79] Beyond Darkness: Thermal-Supervised 3D Gaussian Splatting for Low-Light Novel View Synthesis
...
#### [80] Monocular 3D Lane Detection via Structure Uncertainty-Aware Network with Curve-Point Queries
...
#### [81] SymGS : Leveraging Local Symmetries for 3D Gaussian Splatting Compression
...
#### [82] SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting
...
#### [83] Training-Free Multi-View Extension of IC-Light for Textual Position-Aware Scene Relighting
...
#### [84] GEN3D: Generating Domain-Free 3D Scenes from a Single Image
...
#### [85] Dental3R: Geometry-Aware Pairing for Intraoral 3D Reconstruction from Sparse-View Photographs
...
#### [86] Interaction-Aware 4D Gaussian Splatting for Dynamic Hand-Object Interaction Reconstruction
...
#### [87] CuriGS: Curriculum-Guided Gaussian Splatting for Sparse View Synthesis
...
#### [89] LEGO-SLAM: Language-Embedded Gaussian Optimization SLAM
...
#### [90] Optimizing 3D Gaussian Splattering for Mobile GPUs
...
#### [91] Vorion: A RISC-V GPU with Hardware-Accelerated 3D Gaussian Rendering and Training
...
#### [92] One Walk is All You Need: Data-Efficient 3D RF Scene Reconstruction with Human Movements
...
#### [93] Gradient-Driven Natural Selection for Compact 3D Gaussian Splatting
...
#### [94] PhysMorph-GS: Differentiable Shape Morphing via Joint Optimization of Physics and Rendering Objectives
...
#### [95] RoomPlanner: Explicit Layout Planner for Easier LLM-Driven 3D Room Generation
...
#### [96] SPAGS: Sparse-View Articulated Object Reconstruction from Single State via Planar Gaussian Splatting
...
#### [97] PEGS: Physics-Event Enhanced Large Spatiotemporal Motion Reconstruction via 3D Gaussian Splatting
...
#### [98] SING3R-SLAM: Submap-based Indoor Monocular Gaussian SLAM with 3D Reconstruction Priors
...
#### [99] AEGIS: Preserving privacy of 3D Facial Avatars with Adversarial Perturbations
...
#### [100] CUS-GS: A Compact Unified Structured Gaussian Splatting Framework for Multimodal Scene Representation
...
#### [101] Frequency-Adaptive Sharpness Regularization for Improving 3D Gaussian Splatting Generalization
...
#### [102] RoboArmGS: High-Quality Robotic Arm Splatting via Bézier Curve Refinement
...
#### [103] SegSplat: Feed-forward Gaussian Splatting and Open-Set Semantic Segmentation
...
#### [104] PhysGS: Bayesian-Inferred Gaussian Splatting for Physical Property Estimation
...
#### [105] MetroGS: Efficient and Stable Reconstruction of Geometrically Accurate High-Fidelity Large-Scale Scenes
...
#### [106] NVGS: Neural Visibility for Occlusion Culling in 3D Gaussian Splatting
...
#### [107] IDSplat: Instance-Decomposed 3D Gaussian Splatting for Driving Scenes
...
#### [108] DensifyBeforehand: LiDAR-assisted Content-aware Densification for Efficient and Quality 3D Gaussian Splatting
...
#### [109] GigaWorld-0: World Models as Data Engine to Empower Embodied AI
...
#### [110] Active3D: Active High-Fidelity 3D Reconstruction via Hierarchical Uncertainty Quantification
...
#### [111] Tessellation GS: Neural Mesh Gaussians for Robust Monocular Reconstruction of Dynamic Objects
...
#### [112] HybridSplat: Fast Reflection-baked Gaussian Tracing using Hybrid Splatting
...
#### [114] D²GSLAM: 4D Dynamic Gaussian Splatting SLAM
...
#### [115] Super4DR: 4D Radar-centric Self-supervised Odometry and Gaussian-based Map Optimization
...
#### [116] YOPO-Nav: Visual Navigation using 3DGS Graphs from One-Pass Videos
...
#### [117] Splatent: Splatting Diffusion Latents for Novel View Synthesis
...
#### [118] GAINS: Gaussian-based Inverse Rendering from Sparse Multi-View Captures
...
#### [119] TraceFlow: Dynamic 3D Reconstruction of Specular Scenes Driven by Ray Tracing
...
#### [120] Long-LRM++: Preserving Fine Details in Feed-Forward Wide-Coverage Reconstruction
...
#### [121] Breaking the Vicious Cycle: Coherent 3D Gaussian Splatting from Sparse and Motion-Blurred Views
...
#### [122] Prior-Enhanced Gaussian Splatting for Dynamic Scene Reconstruction from Casual Video
...
#### [124] Moment-Based 3D Gaussian Splatting: Resolving Volumetric Occlusion with Order-Independent Transmittance
...
#### [125] Computer vision training dataset generation for robotic environments using Gaussian splatting
...
#### [126] Nexels: Neurally-Textured Surfels for Real-Time Novel View Synthesis with Sparse Geometries
...
#### [127] ASAP-Textured Gaussians: Enhancing Textured Gaussians with Adaptive Sampling and Anisotropic Parameterization
...
#### [128] GaussianPlant: Structure-aligned Gaussian Splatting for 3D Reconstruction of Plants
...
#### [129] Consistent Instance Field for Dynamic Scene Understanding
...
#### [130] Spherical Voronoi: Directional Appearance as a Differentiable Partition of the Sphere
...
#### [131] Beyond a Single Light: A Large-Scale Aerial Dataset for Urban Scene Reconstruction Under Varying Illumination
...
#### [132] HGS: Hybrid Gaussian Splatting with Static-Dynamic Decomposition for Compact Dynamic View Synthesis
...
#### [133] Broadening View Synthesis of Dynamic Scenes from Constrained Monocular Videos
...
#### [134] MVGSR: Multi-View Consistent 3D Gaussian Super-Resolution via Epipolar Guidance
...
#### [135] VLA-AN: An Efficient and Onboard Vision-Language-Action Framework for Aerial Navigation in Complex Environments
...
#### [136] Gaussian Pixel Codec Avatars: A Hybrid Representation for Efficient Rendering
...
#### [137] Using Gaussian Splats to Create High-Fidelity Facial Geometry and Texture
...
#### [138] SDFoam: Signed-Distance Foam for explicit surface reconstruction
...
#### [139] Instant Expressive Gaussian Head Avatar via 3D-Aware Expression Distillation
...
#### [140] Flying in Clutter on Monocular RGB by Learning in 3D Radiance Fields with Domain Adaptation
...
#### [141] FLEG: Feed-Forward Language Embedded Gaussian Splatting from Any Views
...
#### [142] G3Splat: Geometrically Consistent Generalizable Gaussian Splatting
...
#### [143] Animate Any Character in Any World
...
#### [144] Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding
...
#### [145] MatSpray: Fusing 2D Material World Knowledge on 3D Geometry
...
#### [146] SplatBright: Generalizable Low-Light Scene Reconstruction from Sparse Views via Physically-Guided Gaussian Enhancement
...
#### [147] 4D Gaussian Splatting as a Learned Dynamical System
...
#### [148] WorldWarp: Propagating 3D Geometry with Asynchronous Video Diffusion
...
#### [149] HyGE-Occ: Hybrid View-Transformation with 3D Gaussian and Edge Priors for 3D Panoptic Occupancy Prediction
...
#### [150] Enhancing annotations for 5D apple pose estimation through 3D Gaussian Splatting (3DGS)
...
#### [151] Nebula: Enable City-Scale 3D Gaussian Splatting in Virtual Reality via Collaborative Rendering and Accelerated Stereo Rasterization
...
#### [152] Quantile Rendering: Efficiently Embedding High-dimensional Feature on 3D Gaussian Splatting
...
#### [153] Next Best View Selections for Semantic and Dynamic 3D Gaussian Splatting
...
#### [154] Improved 3D Gaussian Splatting of Unknown Spacecraft Structure Using Space Environment Illumination Knowledge
...
#### [155] Splatwizard: A Benchmark Toolkit for 3D Gaussian Splatting Compression
...
#### [156] PhysTalk: Language-driven Real-time Physics in 3D Gaussian Scenes
