...
#### [15] Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics
...
#### [16] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [17] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [18] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [19] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [21] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [24] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [25] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [26] Gaussian Representation for Deformable Image Registration
...
#### [27] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [28] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [29] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [30] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [31] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [32] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [33] GS-Phong: Meta-Learned 3D Gaussians for Relightable Novel View Synthesis
...
#### [34] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [35] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [36] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [37] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [38] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [39] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [40] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [41] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [42] NPGA: Neural Parametric Gaussian Avatars
...
#### [43] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [44] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [45] NegGS: Negative Gaussian Splatting
...
#### [46] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [47] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [48] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
- **🧑‍🔬 作者**：Yongjae Lee, Zhaoliang Zhang, Deliang Fan
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2405.17793.md)] [[arXiv:2405.17793](https://arxiv.org/abs/2405.17793)] [Code]
- **📝 说明**：

#### [49] GOI: Find 3D Gaussians of Interest with an Optimizable Open-vocabulary Semantic-space Hyperplane
...
#### [50] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [51] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [52] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [53] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [54] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [55] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [56] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [57] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [58] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [62] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [63] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [64] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [65] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [66] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [67] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [68] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [69] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [70] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [71] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [72] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [73] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06408.md)] [[arXiv:2405.06408](https://arxiv.org/abs/2405.06408)] [Code]
- **📝 说明**：✏️

#### [74] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [75] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [76] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [77] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [78] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [79] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [80] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [81] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [82] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [83] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [84] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [85] 3D Gaussian Splatting with Deferred Reflection
...
#### [86] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [87] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [88] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [89] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [90] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [91] CLIP-GS: CLIP-Informed Gaussian Splatting for Real-time and View-consistent 3D Semantic Understanding
...
#### [92] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [93] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [94] Does Gaussian Splatting need SFM Initialization?
...
#### [95] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [97] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [98] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [99] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [100] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [101] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [102] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2404.09105.md)] [[arXiv:2404.09105](https://arxiv.org/abs/2404.09105)] [Code]
- **📝 说明**：✏️

#### [103] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [104] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [105] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [106] Revising Densification in Gaussian Splatting
...
#### [107] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [108] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [109] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [111] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [112] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [113] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [114] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [115] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [116] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [117] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [118] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [119] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [120] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [121] Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction
...
#### [122] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [123] Modeling uncertainty for Gaussian Splatting
...
#### [124] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [125] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [126] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [127] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [129] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [131] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [132] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [133] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [134] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [135] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [136] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [137] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [138] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [139] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [140] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [141] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [142] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [143] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [144] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [145] A New Split Algorithm for 3D Gaussian Splatting
...
#### [146] SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM
...
#### [147] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [148] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [149] 3D Gaussian Model for Animation and Texturing
...
#### [150] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [151] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
...
#### [152] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [153] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [154] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [155] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [156] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [157] Segment Anything in 3D Gaussians
...
#### [158] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [159] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [160] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [161] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [162] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [163] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [164] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
- **🧑‍🔬 作者**：Van Minh Nguyen, Emma Sandidge, Trupti Mahendrakar, Ryan T. White
- **🏫 单位**：Florida Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2401.02588.md)] [[arXiv:2401.02588](https://arxiv.org/abs/2401.02588)] [Code]
- **📝 说明**：✏️

#### [165] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [166] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [167] 2D-Guided 3D Gaussian Segmentation
...
#### [168] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [169] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [170] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [171] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [172] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [173] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [174] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [175] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [176] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [177] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [178] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [179] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [180] LucidDreamer: Domain-free Generation of 3D Gaussian Splatting Scenes
...
#### [181] GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise
...
#### [182] SplatArmor: Articulated Gaussian splatting for animatable humans from monocular RGB videos
...
#### [183] Flexible Techniques for Differentiable Rendering with 3D Gaussians
