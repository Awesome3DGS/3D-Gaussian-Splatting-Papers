...
#### [4] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [5] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [7] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [8] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [9] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [10] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [11] E2GS: Event Enhanced Gaussian Splatting
...
#### [12] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [13] RetinaGS: Scalable Training for Dense Scene Rendering with Billion-Scale 3D Gaussians
...
#### [14] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [15] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [16] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [17] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [18] Gaussian-Forest: Hierarchical-Hybrid 3D Gaussian Splatting for Compressed Scene Modeling
...
#### [19] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [20] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [21] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [22] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [23] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [24] Gaussian Representation for Deformable Image Registration
...
#### [25] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [26] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [27] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [28] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [31] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [32] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [33] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [34] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [35] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [36] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [37] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [38] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [39] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [40] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [41] NegGS: Negative Gaussian Splatting
...
#### [42] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [43] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [44] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
- **🧑‍🔬 作者**：Yongjae Lee, Zhaoliang Zhang, Deliang Fan
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2405.17793.md)] [[arXiv:2405.17793](https://arxiv.org/abs/2405.17793)] [Code]
- **📝 说明**：

#### [45] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [46] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [47] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [48] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [49] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [50] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [51] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [52] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [53] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [54] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [55] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [56] Gaussian Time Machine: A Real-Time Rendering Methodology for Time-Variant Appearances
...
#### [57] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [58] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [59] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [60] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [61] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [62] MotionGS : Compact Gaussian Splatting SLAM by Motion Filter
...
#### [63] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [64] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [65] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [66] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [67] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [68] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06408.md)] [[arXiv:2405.06408](https://arxiv.org/abs/2405.06408)] [Code]
- **📝 说明**：✏️

#### [69] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [70] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [71] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [72] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [73] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [74] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [75] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [76] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [77] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [78] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [79] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [80] 3D Gaussian Splatting with Deferred Reflection
...
#### [81] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [82] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [83] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [84] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [85] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [86] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [87] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [88] Does Gaussian Splatting need SFM Initialization?
...
#### [89] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [90] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [91] AbsGS: Recovering Fine Details for 3D Gaussian Splatting
...
#### [92] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [94] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [95] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [96] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2404.09105.md)] [[arXiv:2404.09105](https://arxiv.org/abs/2404.09105)] [Code]
- **📝 说明**：✏️

#### [97] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [98] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [99] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [100] Revising Densification in Gaussian Splatting
...
#### [101] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [102] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [104] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [105] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [106] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [107] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [108] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [110] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [111] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [112] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [113] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [114] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [115] Modeling uncertainty for Gaussian Splatting
...
#### [116] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [117] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [118] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [119] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [120] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [121] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [124] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [125] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [126] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [127] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [128] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [129] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [130] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [131] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [132] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [133] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [134] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [135] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [136] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [137] A New Split Algorithm for 3D Gaussian Splatting
...
#### [138] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [139] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [140] 3D Gaussian Model for Animation and Texturing
...
#### [141] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [142] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
...
#### [143] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [144] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [145] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [146] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [147] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [148] Segment Anything in 3D Gaussians
...
#### [149] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [150] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [151] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [152] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [153] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [154] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [155] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
- **🧑‍🔬 作者**：Van Minh Nguyen, Emma Sandidge, Trupti Mahendrakar, Ryan T. White
- **🏫 单位**：Florida Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2401.02588.md)] [[arXiv:2401.02588](https://arxiv.org/abs/2401.02588)] [Code]
- **📝 说明**：✏️

#### [156] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [157] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [158] 2D-Guided 3D Gaussian Segmentation
...
#### [159] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [160] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [161] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [162] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [163] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [164] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [165] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [166] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [167] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [168] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [169] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [170] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [171] LucidDreamer: Domain-free Generation of 3D Gaussian Splatting Scenes
...
#### [172] GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise
...
#### [173] SplatArmor: Articulated Gaussian splatting for animatable humans from monocular RGB videos
...
#### [174] Flexible Techniques for Differentiable Rendering with 3D Gaussians
