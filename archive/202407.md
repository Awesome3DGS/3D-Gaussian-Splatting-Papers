...
#### [103] StylizedGS: Controllable Stylization for 3D Gaussian Splatting
...
#### [104] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [105] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [107] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [108] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [110] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [111] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [112] HGS-Mapping: Online Dense Mapping Using Hybrid Gaussian Representation in Urban Scenes
...
#### [113] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [114] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [115] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [116] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [117] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [118] Modeling uncertainty for Gaussian Splatting
...
#### [120] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [121] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [122] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [123] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [125] Isotropic Gaussian Splatting for Real-Time Radiance Field Rendering
...
#### [126] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [127] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [128] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [129] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [130] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [131] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [132] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [133] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [134] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [135] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [136] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [137] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [138] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [139] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [140] A New Split Algorithm for 3D Gaussian Splatting
...
#### [141] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [142] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [143] 3D Gaussian Model for Animation and Texturing
...
#### [144] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [145] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
...
#### [146] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [147] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [148] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [149] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [150] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [151] Segment Anything in 3D Gaussians
...
#### [152] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [153] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [154] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [155] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [156] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [157] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [158] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
- **🧑‍🔬 作者**：Van Minh Nguyen, Emma Sandidge, Trupti Mahendrakar, Ryan T. White
- **🏫 单位**：Florida Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2401.02588.md)] [[arXiv:2401.02588](https://arxiv.org/abs/2401.02588)] [Code]
- **📝 说明**：✏️

#### [159] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [160] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [161] 2D-Guided 3D Gaussian Segmentation
...
#### [162] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [163] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [164] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [165] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [166] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [167] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [168] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [169] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [170] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [171] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [172] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [173] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [174] LucidDreamer: Domain-free Generation of 3D Gaussian Splatting Scenes
...
#### [175] GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise
...
#### [176] SplatArmor: Articulated Gaussian splatting for animatable humans from monocular RGB videos
...
#### [177] Flexible Techniques for Differentiable Rendering with 3D Gaussians
