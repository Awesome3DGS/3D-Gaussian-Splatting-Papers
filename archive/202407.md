...
#### [3] GaussianDreamerPro: Text to Manipulable 3D Gaussians with Highly Enhanced Quality
...
#### [4] GS-Octree: Octree-based 3D Gaussian Splatting for Robust Object-level 3D Reconstruction Under Strong Lighting
...
#### [5] VDG: Vision-Only Dynamic Gaussian for Driving Simulation
...
#### [6] ClotheDreamer: Text-Guided Garment Generation with 3D Gaussians
...
#### [7] Geometry-Aware Score Distillation via 3D Consistent Noising and Gradient Consistency Modeling
...
#### [8] Taming 3DGS: High-Quality Radiance Fields with Limited Resources
...
#### [9] Gaussian Splatting to Real World Flight Navigation Transfer with Liquid Networks
...
#### [10] Sampling 3D Gaussian Scenes in Seconds with Latent Diffusion Models
...
#### [12] Wild-GS: Real-Time Novel View Synthesis from Unconstrained Photo Collections
...
#### [13] GaussianSR: 3D Gaussian Super-Resolution with 2D Diffusion Priors
...
#### [14] GradeADreamer: Enhanced Text-to-3D Generation Using Gaussian Splatting and Multi-View Diffusion
...
#### [15] Unified Gaussian Primitives for Scene Representation and Rendering
...
#### [17] Trim 3D Gaussian Splatting for Accurate Geometry Representation
...
#### [18] InfoGaussian: Structure-Aware Dynamic Gaussians through Lightweight Information Shaping
...
#### [19] RefGaussian: Disentangling Reflections from 3D Gaussian Splatting for Realistic Rendering
...
#### [20] Flash3D: Feed-Forward Generalisable 3D Scene Reconstruction from a Single Image
...
#### [21] Physics3D: Learning Physical Properties of 3D Gaussians via Video Diffusion
...
#### [22] SatSplatYOLO: 3D Gaussian Splatting-based Virtual Object Detection Ensembles for Satellite Feature Recognition
...
#### [23] WE-GS: An In-the-wild Efficient 3D Gaussian Representation for Unconstrained Photo Collections
...
#### [24] Query-based Semantic Gaussian Field for Scene Representation in Reinforcement Learning
...
#### [25] Reconstructing and Simulating Dynamic 3D Objects with Mesh-adsorbed Gaussian Splatting
...
#### [26] RaDe-GS: Rasterizing Depth in Gaussian Splatting
...
#### [27] Self-Calibrating 4D Novel View Synthesis from Monocular Videos Using Gaussian Splatting
...
#### [28] Fourier123: One Image to High-Quality 3D Object Generation with Hybrid Fourier Score Distillation
...
#### [29] S3Gaussian: Self-Supervised Street Gaussians for Autonomous Driving
...
#### [30] A Pixel Is Worth More Than One 3D Gaussians in Single-View 3D Reconstruction
...
#### [31] EvaGaussians: Event Stream Assisted Gaussian Splatting from Blurry Images
...
#### [32] PLA4D: Pixel-Level Alignments for Text-to-4D Gaussian Splatting
- **🧑‍🔬 作者**：Qiaowei Miao, Yawei Luo, Yi Yang
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.19957.md)] [[arXiv:2405.19957](https://arxiv.org/abs/2405.19957)] [Code]
- **📝 说明**：

#### [33] GaussianRoom: Improving 3D Gaussian Splatting with SDF Guidance and Monocular Cues for Indoor Scene Reconstruction
...
#### [34] Uncertainty-guided Optimal Transport in Depth Supervised Sparse-View 3D Gaussian
...
#### [35] TAMBRIDGE: Bridging Frame-Centered Tracking and 3D Gaussian Splatting for Enhanced SLAM
...
#### [36] E3Gen: Efficient, Expressive and Editable Avatars Generation
...
#### [37] LP-3DGS: Learning to Prune 3D Gaussian Splatting
...
#### [38] NegGS: Negative Gaussian Splatting
...
#### [39] A Grid-Free Fluid Solver based on Gaussian Spatial Representation
...
#### [40] A Refined 3D Gaussian Representation for High-Quality Dynamic Scene Reconstruction
...
#### [41] SafeguardGS: 3D Gaussian Primitive Pruning While Avoiding Catastrophic Scene Destruction
- **🧑‍🔬 作者**：Yongjae Lee, Zhaoliang Zhang, Deliang Fan
- **🏫 单位**：Johns Hopkins University
- **🔗 链接**：[[中英摘要](./abs/2405.17793.md)] [[arXiv:2405.17793](https://arxiv.org/abs/2405.17793)] [Code]
- **📝 说明**：

#### [42] SA-GS: Semantic-Aware Gaussian Splatting for Large Scene Reconstruction with Geometry Constrain
...
#### [43] Sync4D: Video Guided Controllable Dynamics for Physics-Based 4D Generation
...
#### [44] PyGS: Large-scale Scene Representation with Pyramidal 3D Gaussian Splatting
- **🧑‍🔬 作者**：Zipeng Wang, Dan Xu
- **🏫 单位**：HKUST
- **🔗 链接**：[[中英摘要](./abs/2405.16829.md)] [[arXiv:2405.16829](https://arxiv.org/abs/2405.16829)] [Code]
- **📝 说明**：

#### [45] Splat-SLAM: Globally Optimized RGB-only SLAM with 3D Gaussians
...
#### [46] Sp2360: Sparse-view 360 Scene Reconstruction using Cascaded 2D Diffusion Priors
...
#### [47] Feature Splatting for Better Novel View Synthesis with Low Overlap
...
#### [48] GSDeformer: Direct Cage-based Deformation for 3D Gaussian Splatting
...
#### [49] MagicDrive3D: Controllable 3D Generation for Any-View Rendering in Street Scenes
...
#### [50] TIGER: Text-Instructed 3D Gaussian Retrieval and Coherent Editing
...
#### [51] RoGS: Large Scale Road Surface Reconstruction based on 2D Gaussian Splatting
...
#### [52] Monocular Gaussian SLAM with Language Extended Loop Closure
- **🧑‍🔬 作者**：Tian Lan, Qinwei Lin, Haoqian Wang
- **🏫 单位**：Tsinghua University
- **🔗 链接**：[[中英摘要](./abs/2405.13748.md)] [[arXiv:2405.13748](https://arxiv.org/abs/2405.13748)] [Code]
- **📝 说明**：

#### [53] Gaussian Time Machine: A Real-Time Rendering Methodology for Time-Variant Appearances
...
#### [54] MOSS: Motion-based 3D Clothed Human Synthesis from Monocular Video
...
#### [55] LAGA: Layered 3D Avatar Generation and Customization via Gaussian Splatting
...
#### [56] Gaussian Control with Hierarchical Semantic Graphs in 3D Human Recovery
...
#### [57] Gaussian Head & Shoulders: High Fidelity Neural Upper Body Avatars with Anchor Gaussian Guided Texture Warping
...
#### [58] GGAvatar: Geometric Adjustment of Gaussian Head Avatar
...
#### [60] Photorealistic 3D Urban Scene Reconstruction and Point Cloud Extraction using Google Earth Imagery and Gaussian Splatting
...
#### [61] GS-Planner: A Gaussian-Splatting-based Planning Framework for Active High-Fidelity Reconstruction
- **🧑‍🔬 作者**：Rui Jin, Yuman Gao, Haojian Lu, Fei Gao
- **🏫 单位**：Zhejiang University
- **🔗 链接**：[[中英摘要](./abs/2405.10142.md)] [[arXiv:2405.10142](https://arxiv.org/abs/2405.10142)] [Code]
- **📝 说明**：✏️

#### [62] GaussianVTON: 3D Human Virtual Try-ON via Multi-Stage Gaussian Splatting Editing with Image Prompting
...
#### [63] Direct Learning of Mesh and Appearance via 3D Gaussian Splatting
...
#### [64] OneTo3D: One Image to Re-editable Dynamic 3D Model and Video Generation
- **🧑‍🔬 作者**：Jinwei Lin
...
#### [65] I3DGS: Improve 3D Gaussian Splatting from Multiple Dimension
- **🧑‍🔬 作者**：Jinwei Lin
- **🏫 单位**：Monash University, Clayton Victoria, Australia
- **🔗 链接**：[[中英摘要](./abs/2405.06408.md)] [[arXiv:2405.06408](https://arxiv.org/abs/2405.06408)] [Code]
- **📝 说明**：✏️

#### [66] DragGaussian: Enabling Drag-style Manipulation on 3D Gaussian Representation
...
#### [67] NGM-SLAM: Gaussian Splatting SLAM with Radiance Field Submap
...
#### [68] GDGS: Gradient Domain Gaussian Splatting for Sparse Representation of Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
...
#### [69] Splat-MOVER: Multi-Stage, Open-Vocabulary Robotic Manipulation via Editable Gaussian Splatting
...
#### [70] DreamScene4D: Dynamic Multi-Object Scene Generation from Monocular Videos
...
#### [71] Efficient Data-driven Scene Simulation using Robotic Surgery Videos via Physics-embedded 3D Gaussians
...
#### [72] Spectrally Pruned Gaussian Fields with Neural Compensation
...
#### [73] GS-LRM: Large Reconstruction Model for 3D Gaussian Splatting
...
#### [74] MicroDreamer: Zero-shot 3D Generation in ∼20 Seconds by Score-based Iterative Reconstruction
...
#### [75] GSTalker: Real-time Audio-Driven Talking Face Generation via Deformable Gaussian Splatting
...
#### [76] Bootstrap 3D Reconstructed Scenes from 3D Gaussian Splatting
...
#### [77] 3D Gaussian Splatting with Deferred Reflection
...
#### [78] Reconstructing Satellites in 3D from Amateur Telescope Images
...
#### [79] SLAM for Indoor Mapping of Wide Area Construction Environments
...
#### [80] DIG3D: Marrying Gaussian Splatting with Deformable Transformer for Single Image 3D Reconstruction
...
#### [81] GaussianTalker: Real-Time High-Fidelity Talking Head Synthesis with Audio-Driven 3D Gaussian Splatting
...
#### [82] OMEGAS: Object Mesh Extraction from Large Scenes Guided by Gaussian Segmentation
...
#### [83] Contrastive Gaussian Clustering: Weakly Supervised 3D Scene Segmentation
...
#### [84] EfficientGS: Streamlining Gaussian Splatting for Large-Scale High-Resolution Scene Representation
...
#### [85] Does Gaussian Splatting need SFM Initialization?
...
#### [86] InFusion: Inpainting 3D Gaussians via Learning Depth Completion from Diffusion Prior
...
#### [87] DeblurGS: Gaussian Splatting for Camera Motion Blur
...
#### [89] SRGS: Super-Resolution 3D Gaussian Splatting
...
#### [90] CompGS: Efficient 3D Scene Representation via Compressed Gaussian Splatting
...
#### [91] DeferredGS: Decoupled and Editable Gaussian Splatting with Deferred Shading
...
#### [92] DreamScape: 3D Scene Creation via Gaussian Splatting joint Correlation Modeling
...
#### [93] EGGS: Edge Guided Gaussian Splatting for Radiance Fields
- **🧑‍🔬 作者**：Yuanhao Gong
- **🏫 单位**：Electronics and Information Engineering, Shenzhen University, China
- **🔗 链接**：[[中英摘要](./abs/2404.09105.md)] [[arXiv:2404.09105](https://arxiv.org/abs/2404.09105)] [Code]
- **📝 说明**：✏️

#### [94] OccGaussian: 3D Gaussian Splatting for Occluded Human Rendering
...
#### [95] Reinforcement Learning with Generalizable Gaussian Splatting
...
#### [96] Gaussian Pancakes: Geometrically-Regularized 3D Gaussian Splatting for Realistic Endoscopic Reconstruction
...
#### [97] Revising Densification in Gaussian Splatting
...
#### [98] GauU-Scene V2: Expanse Lidar Image Dataset Shows Unreliable Geometric Reconstruction Using Gaussian Splatting and NeRF
...
#### [99] Z-Splat: Z-Axis Gaussian Splatting for Camera-Sonar Fusion
...
#### [101] GaSpCT: Gaussian Splatting for Novel CT Projection View Synthesis
...
#### [102] TCLC-GS: Tightly Coupled LiDAR-Camera Gaussian Splatting for Surrounding Autonomous Driving Scenes
...
#### [103] 3DGSR: Implicit Surface Reconstruction with 3D Gaussian Splatting
...
#### [104] InstantSplat: Unbounded Sparse-view Pose-free Gaussian Splatting in 40 Seconds
...
#### [105] Snap-it, Tap-it, Splat-it: Tactile-Informed 3D Gaussian Splatting for Reconstructing Challenging Surfaces
...
#### [107] SGD: Street View Synthesis with Gaussian Splatting and Diffusion Prior
...
#### [108] HO-Gaussian: Hybrid Optimization of 3D Gaussian Splatting for Urban Scenes
...
#### [109] GauStudio: A Modular Framework for 3D Gaussian Splatting and Beyond
...
#### [110] SA-GS: Scale-Adaptive Gaussian Splatting for Training-Free Anti-Aliasing
...
#### [111] SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface
...
#### [112] Modeling uncertainty for Gaussian Splatting
...
#### [113] Octree-GS: Towards Consistent Real-time Rendering with LOD-Structured 3D Gaussians
...
#### [114] 2D Gaussian Splatting for Geometrically Accurate Radiance Fields
...
#### [115] DreamPolisher: Towards High-Quality Text-to-3D Generation via Geometric Diffusion
...
#### [116] Semantic Gaussians: Open-Vocabulary Scene Understanding with 3D Gaussian Splatting
...
#### [117] EndoGSLAM: Real-Time Dense Reconstruction and Tracking in Endoscopic Surgeries using Gaussian Splatting
...
#### [118] GRM: Large Gaussian Reconstruction Model for Efficient 3D Reconstruction and Generation
...
#### [119] Isotropic Gaussian Splatting for Real-Time Radiance Field Rendering
...
#### [120] GaussianFlow: Splatting Gaussian Dynamics for 4D Content Creation
...
#### [121] VideoMV: Consistent Multi-View Generation Based on Large Video Generative Model
...
#### [122] GaussNav: Gaussian Splatting for Visual Navigation
...
#### [123] UV Gaussians: Joint Learning of Mesh Deformation and Gaussian Textures for Human Avatar Modeling
...
#### [124] Fed3DGS: Scalable 3D Gaussian Splatting with Federated Learning
- **🧑‍🔬 作者**：Teppei Suzuki
...
#### [125] Bridging 3D Gaussian and Mesh for Freeview Video Rendering
...
#### [126] Motion-aware 3D Gaussian Splatting for Efficient Dynamic Scene Reconstruction
...
#### [127] BAGS: Building Animatable Gaussian Splatting from a Monocular Video with Diffusion Priors
...
#### [128] BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis
...
#### [129] Compact 3D Gaussian Splatting For Dense Visual SLAM
...
#### [130] SWAG: Splatting in the Wild images with Appearance-conditioned Gaussians
...
#### [131] FDGaussian: Fast Gaussian Splatting from Single Image via Geometric-aware Diffusion Model
...
#### [132] Texture-GS: Disentangling the Geometry and Texture for 3D Gaussian Splatting Editing
...
#### [133] Relaxing Accurate Initialization Constraint for 3D Gaussian Splatting
...
#### [134] A New Split Algorithm for 3D Gaussian Splatting
...
#### [135] GSEdit: Efficient Text-Guided Editing of 3D Objects via Gaussian Splatting
...
#### [136] Splat-Nav: Safe Real-Time Robot Navigation in Gaussian Splatting Maps
...
#### [137] 3D Gaussian Model for Animation and Texturing
...
#### [138] GEA: Reconstructing Expressive 3D Gaussian Avatar from Monocular Video
...
#### [139] Identifying Unnecessary 3D Gaussians using Clustering for Fast Rendering of 3D Gaussian Splatting
...
#### [140] GaussianHair: Hair Modeling and Rendering with Light-aware Gaussians
...
#### [141] Mesh-based Gaussian Splatting for Real-time Large-scale Deformation
...
#### [142] Rig3DGS: Creating Controllable Portraits from Casual Monocular Videos
...
#### [143] GaMeS: Mesh-Based Adapting and Modification of Gaussian Splatting
...
#### [144] 360-GS: Layout-guided Panoramic Gaussian Splatting For Indoor Roaming
...
#### [145] Segment Anything in 3D Gaussians
...
#### [146] PSAvatar: A Point-based Morphable Shape Model for Real-Time Head Avatar Creation with 3D Gaussian Splatting
...
#### [147] GaussianBody: Clothed Human Reconstruction via 3d Gaussian Splatting
...
#### [148] Fast Dynamic 3D Object Generation from a Single-view Video
...
#### [149] CoSSegGaussians: Compact and Swift Scene Segmenting 3D Gaussians
...
#### [150] DISTWAR: Fast Differentiable Rendering on Raster-based Rendering Pipelines
...
#### [151] AGG: Amortized Generative 3D Gaussians for Single Image to 3D
...
#### [152] Characterizing Satellite Geometry via Accelerated 3D Gaussian Splatting
- **🧑‍🔬 作者**：Van Minh Nguyen, Emma Sandidge, Trupti Mahendrakar, Ryan T. White
- **🏫 单位**：Florida Institute of Technology
- **🔗 链接**：[[中英摘要](./abs/2401.02588.md)] [[arXiv:2401.02588](https://arxiv.org/abs/2401.02588)] [Code]
- **📝 说明**：✏️

#### [153] 4DGen: Grounded 4D Content Generation with Spatial-temporal Consistency
...
#### [154] DreamGaussian4D: Generative 4D Gaussian Splatting
...
#### [155] 2D-Guided 3D Gaussian Segmentation
...
#### [156] Sparse-view CT Reconstruction with 3D Gaussian Volumetric Representation
...
#### [157] Human101: Training 100+FPS Human Gaussians in 100s from 1 View
...
#### [158] Deformable 3D Gaussian Splatting for Animatable Human Avatars
...
#### [159] Gaussian Splatting with NeRF-based Color and Opacity
...
#### [160] SWAGS: Sampling Windows Adaptively for Dynamic 3D Gaussian Splatting
...
#### [161] Exploring the Feasibility of Generating Realistic 3D Models of Endangered Species Using DreamGaussian: An Analysis of Elevation Angle's Impact on Model Generation
...
#### [162] Text2Immersion: Generative Immersive Scene with 3D Gaussians
...
#### [163] iComMa: Inverting 3D Gaussians Splatting for Camera Pose Estimation via Comparing and Matching
...
#### [164] NeuSG: Neural Implicit Surface Reconstruction with 3D Gaussian Splatting Guidance
...
#### [165] Periodic Vibration Gaussian: Dynamic Urban Scene Reconstruction and Real-time Rendering
...
#### [166] CG3D: Compositional Generation for Text-to-3D via Gaussian Splatting
...
#### [167] Animatable 3D Gaussian: Fast and High-Quality Reconstruction of Multiple Human Avatars
...
#### [168] LucidDreamer: Domain-free Generation of 3D Gaussian Splatting Scenes
...
#### [169] GaussianDiffusion: 3D Gaussian Splatting for Denoising Diffusion Probabilistic Models with Structured Noise
...
#### [170] SplatArmor: Articulated Gaussian splatting for animatable humans from monocular RGB videos
...
#### [171] Flexible Techniques for Differentiable Rendering with 3D Gaussians
