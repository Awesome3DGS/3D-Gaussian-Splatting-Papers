...
#### [75] DualPhys-GS: Dual Physically-Guided 3D Gaussian Splatting for Underwater Scene Reconstruction
...
#### [76] Semantic-aware DropSplat: Adaptive Pruning of Redundant Gaussians for 3D Aerial-View Segmentation
...
#### [77] GSFixer: Improving 3D Gaussian Splatting with Reference-Guided Video Diffusion Priors
...
#### [78] EntropyGS: An Efficient Entropy Coding on 3D Gaussian Splatting
...
#### [79] Multi-Sample Anti-Aliasing and Constrained Optimization for 3D Gaussian Splatting
...
#### [80] ComplicitSplat: Downstream Models are Vulnerable to Blackbox Attacks by 3D Gaussian Splat Camouflages
...
#### [81] InstDrive: Instance-Aware 3D Gaussian Splatting for Driving Scenes
...
#### [82] Improving Densification in 3D Gaussian Splatting for High-Fidelity Rendering
...
#### [83] IGFuse: Interactive 3D Gaussian Scene Reconstruction via Multi-Scans Fusion
...
#### [84] InnerGS: Internal Scenes Rendering via Factorized 3D Gaussian Splatting
...
#### [85] EAvatar: Expression-Aware Head Avatar Reconstruction with Generative Geometry Priors
...
#### [86] Online 3D Gaussian Splatting Modeling with Novel View Selection
...
#### [87] Distilled-3DGS:Distilled 3D Gaussian Splatting
...
#### [88] GALA: Guided Attention with Language Alignment for Open Vocabulary Gaussian Splatting
...
#### [89] Reconstruction Using the Invisible: Intuition from NIR and Metadata for Enhanced 3D Gaussian Splatting
...
#### [90] D³-Talker: Dual-Branch Decoupled Deformation Fields for Few-Shot 3D Talking Head Synthesis
...
#### [91] From Slices to Structures: Unsupervised 3D Reconstruction of Female Pelvic Anatomy from Freehand Transvaginal Ultrasound
...
#### [92] GOGS: High-Fidelity Geometry and Relighting for Glossy Objects via Gaussian Surfels
...
#### [93] GeMS: Efficient Gaussian Splatting for Extreme Motion Blur
...
#### [94] GSFix3D: Diffusion-Guided Repair of Novel Views in Gaussian Splatting
...
#### [96] MeSS: City Mesh-Guided Outdoor Scene Generation with Cross-View Consistent Diffusion
...
#### [97] Image-Conditioned 3D Gaussian Splat Quantization
...
#### [98] DriveSplat: Decoupled Driving Scene Reconstruction with Geometry-enhanced Partitioned Neural Gaussians
...
#### [99] Enhancing Novel View Synthesis from extremely sparse views with SfM-free 3D Gaussian Splatting Framework
...
#### [100] Fiducial Marker Splatting for High-Fidelity Robotics Simulations
...
#### [101] Pixie: Fast and Generalizable Supervised Learning of 3D Physics from Pixels
...
#### [102] Camera Pose Refinement via 3D Gaussian Splatting
...
#### [103] FastAvatar: Instant 3D Gaussian Splatting for Faces from Single Unconstrained Poses
...
#### [104] ColorGS: High-fidelity Surgical Scene Reconstruction with Colored Gaussian Splatting
...
#### [105] Style4D-Bench: A Benchmark Suite for 4D Stylization
...
#### [106] MAPo: Motion-Aware Partitioning of Deformable 3D Gaussian Splatting for High-Fidelity Dynamic Scene Reconstruction
...
#### [107] Realistic and Controllable 3D Gaussian-Guided Object Editing for Driving Video Generation
...
#### [108] AvatarBack: Back-Head Generation for Complete 3D Avatars from Front-View Images
...
#### [109] DrivingGaussian++: Towards Realistic Reconstruction and Editable Simulation for Surrounding Dynamic Driving Scenes
...
#### [110] ARGS: Advanced Regularization on Aligning Gaussians over the Surface
- **🧑‍🔬 作者**：Jeong Uk Lee, Sung Hee Choi
- **🏫 单位**：KAIST
- **🔗 链接**：[[中英摘要](./abs/2508.21344.md)] [[arXiv:2508.21344](https://arxiv.org/abs/2508.21344)] [Code]
- **📝 说明**:

#### [111] Scale-GS: Efficient Scalable Gaussian Splatting via Redundancy-filtering Training on Streaming Content
...
#### [112] Complete Gaussian Splats from a Single Image with Denoising Diffusion Models
...
#### [113] AGS: Accelerating 3D Gaussian Splatting SLAM via CODEC-Assisted Frame Covisibility Detection
...
#### [114] MarkSplatter: Generalizable Watermarking for 3D Gaussian Splatting Model via Splatter Image Structure
...
#### [115] SWAGSplatting: Semantic-guided Water-scene Augmented Gaussian Splatting
...
#### [116] UPGS: Unified Pose-aware Gaussian Splatting for Dynamic Scene Deblurring
...
#### [117] 2D Gaussian Splatting with Semantic Alignment for Image Inpainting
...
#### [118] GRMM: Real-Time High-Fidelity Gaussian Morphable Head Model with Learned Residuals
...
#### [119] ContraGS: Codebook-Condensed and Trainable Gaussian Splatting for Fast, Memory-Efficient Reconstruction
...
#### [120] SSGaussian: Semantic-Aware and Structure-Preserving 3D Style Transfer
...
#### [121] GeoSplat: A Deep Dive into Geometry-Constrained Gaussian Splatting
...
#### [122] Visibility-Aware Language Aggregation for Open-Vocabulary Segmentation in 3D Gaussian Splatting
...
#### [123] Reconstruction and Reenactment Separated Method for Realistic Gaussian Head
...
#### [125] PanoLAM: Large Avatar Model for Gaussian Full-Head Synthesis from One-shot Unposed Image
...
#### [126] SplatFill: 3D Scene Inpainting via Depth-Guided Gaussian Splatting
...
#### [127] SVR-GS: Spatially Variant Regularization for Probabilistic Masks in 3D Gaussian Splatting
...
#### [128] ROSGS: Relightable Outdoor Scenes With Gaussian Splatting
...
#### [129] Gaussian-Plus-SDF SLAM: High-fidelity 3D Reconstruction at 150+ fps
...
#### [130] Segmentation-Driven Initialization for Sparse-view 3D Gaussian Splatting
...
#### [131] 4DRadar-GS: Self-Supervised Dynamic Driving Scene Reconstruction with 4D Radar
...
#### [132] Beyond Averages: Open-Vocabulary 3D Scene Understanding with Gaussian Splatting and Bag of Embeddings
...
#### [133] Dream3DAvatar: Text-Controlled 3D Avatar Reconstruction from a Single Image
...
#### [134] MemGS: Memory-Efficient Gaussian Splatting for Real-Time SLAM
...
#### [135] Plug-and-Play PDE Optimization for 3D Gaussian Splatting: Toward High-Quality Rendering and Reconstruction
...
#### [136] FMGS-Avatar: Mesh-Guided 2D Gaussian Splatting with Foundation Model Priors for 3D Monocular Avatar Reconstruction
...
#### [137] Causal Reasoning Elicits Controllable 3D Scene Generation
...
#### [139] GS-Scale: Unlocking Large-Scale 3D Gaussian Splatting Training via Host Offloading
...
#### [140] FingerSplat: Contactless Fingerprint 3D Reconstruction and Generation based on 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yuwei Jia, Yutang Lu, Zhe Cui, Fei Su
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.15648.md)] [[arXiv:2509.15648](https://arxiv.org/abs/2509.15648)] [Code]
- **📝 说明**:

#### [141] Camera Splatting for Continuous View Optimization
...
#### [142] Zero-Shot Visual Grounding in 3D Gaussians via View Retrieval
...
#### [143] 3D Gaussian Flats: Hybrid 2D/3D Photometric Scene Reconstruction
...
#### [144] MedGS: Gaussian Splatting for Multi-Modal 3D Medical Imaging
...
#### [145] SPFSplatV2: Efficient Self-Supervised Pose-Free 3D Gaussian Splatting from Sparse Views
...
#### [146] SmokeSeer: 3D Gaussian Splatting for Smoke Removal and Scene Reconstruction
...
#### [147] FGGS-LiDAR: Ultra-Fast, GPU-Accelerated Simulation from General 3DGS Models to LiDAR
...
#### [148] From Restoration to Reconstruction: Rethinking 3D Gaussian Splatting for Underwater Scenes
...
#### [149] ProDyG: Progressive Dynamic Scene Reconstruction via Gaussian Splatting from Monocular Videos
...
#### [150] Event-guided 3D Gaussian Splatting for Dynamic Human and Scene Reconstruction
...
#### [151] FixingGS: Enhancing 3D Gaussian Splatting via Training-Free Score Distillation
...
#### [153] VolSplat: Rethinking Feed-Forward 3D Gaussian Splatting with Voxel-Aligned Prediction
...
#### [154] BiTAA: A Bi-Task Adversarial Attack for Object Detection and Depth Estimation via 3D Gaussian Splatting
- **🧑‍🔬 作者**：Yixun Zhang, Feng Zhou, Jianqin Yin
- **🏫 单位**：Beijing University of Posts and Telecommunications
- **🔗 链接**：[[中英摘要](./abs/2509.19793.md)] [[arXiv:2509.19793](https://arxiv.org/abs/2509.19793)] [Code]
- **📝 说明**:

#### [155] Aerial-Ground Image Feature Matching via 3D Gaussian Splatting-based Intermediate View Rendering
...
#### [156] 4D Driving Scene Generation With Stereo Forcing
...
#### [157] Large Material Gaussian Model for Relightable 3D Generation
...
#### [158] Rigidity-Aware 3D Gaussian Deformation from a Single Image
...
#### [159] HELIOS: Hierarchical Exploration for Language-grounded Interaction in Open Scenes
...
#### [160] OracleGS: Grounding Generative Priors for Sparse-View Gaussian Splatting
...
#### [161] CrashSplat: 2D to 3D Vehicle Damage Segmentation in Gaussian Splatting
...
#### [162] Forge4D: Feed-Forward 4D Human Reconstruction and Interpolation from Uncalibrated Sparse-view Videos
...
#### [163] Proxy-GS: Efficient 3D Gaussian Splatting via Proxy Mesh
...
#### [164] ExGS: Extreme 3D Gaussian Compression with Diffusion Priors
...
#### [165] HBSplat: Robust Sparse-View Gaussian Reconstruction with Hybrid-Loss Guided Depth and Bidirectional Warping
...
#### [166] GEM: 3D Gaussian Splatting for Efficient and Accurate Cryo-EM Reconstruction
...
#### [168] Triangle Splatting+: Differentiable Rendering with Opaque Triangles
...
#### [169] GaussianLens: Localized High-Resolution Reconstruction via On-Demand Gaussian Densification
...
#### [170] LLM-Powered Code Analysis and Optimization for Gaussian Splatting Kernels
...
#### [171] HART: Human Aligned Reconstruction Transformer
